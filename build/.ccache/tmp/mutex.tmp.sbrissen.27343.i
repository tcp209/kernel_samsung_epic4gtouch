...
# 1 "../../kernel/mutex.h" 1
# 20 "../../kernel/mutex.h"
static inline __attribute__((always_inline)) void mutex_set_owner(struct mutex *lock)
{
 lock->owner = current_thread_info();
}

static inline __attribute__((always_inline)) void mutex_clear_owner(struct mutex *lock)
{
 lock->owner = ((void *)0);
}
# 45 "../../kernel/mutex.h"
...
# 36 "../../kernel/mutex.c" 2
# 1 "../../arch/arm/include/asm/mutex.h" 1
# 26 "../../arch/arm/include/asm/mutex.h"
static inline __attribute__((always_inline)) void
...
__mutex_fastpath_unlock(atomic_t *count, void (*fail_fn)(atomic_t *))
{
 ...
 __orig |= __ex_flag;
 if (__builtin_expect(!!(__orig != 0), 0))
  fail_fn(count);
}
# 105 "../../arch/arm/include/asm/mutex.h"
static inline __attribute__((always_inline)) int
...
extern typeof(__mutex_init) __mutex_init; static const char __kstrtab___mutex_init[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__mutex_init"; static const struct kernel_symbol __ksymtab___mutex_init __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__mutex_init, __kstrtab___mutex_init };
# 68 "../../kernel/mutex.c"
static __attribute__((__used__)) __attribute__((noinline)) void __attribute__((__section__(".sched.text")))
...
extern typeof(mutex_lock) mutex_lock; static const char __kstrtab_mutex_lock[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "mutex_lock"; static const struct kernel_symbol __ksymtab_mutex_lock __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&mutex_lock, __kstrtab_mutex_lock };


static __attribute__((__used__)) __attribute__((noinline)) void __attribute__((__section__(".sched.text"))) __mutex_unlock_slowpath(atomic_t *lock_count);
# 119 "../../kernel/mutex.c"
void __attribute__((__section__(".sched.text"))) mutex_unlock(struct mutex *lock)
{
# 131 "../../kernel/mutex.c"
 mutex_clear_owner(lock);
...
extern typeof(mutex_unlock) mutex_unlock; static const char __kstrtab_mutex_unlock[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "mutex_unlock"; static const struct kernel_symbol __ksymtab_mutex_unlock __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&mutex_unlock, __kstrtab_mutex_unlock };




static inline __attribute__((always_inline)) int __attribute__((__section__(".sched.text")))
...
# 171 "../../kernel/mutex.c"
 for (;;) {
  ...
  if (__builtin_expect(!!((get_current())->lock_depth >= 0), 0))
   break;
  ...
  owner = (*(volatile typeof(lock->owner) *)&(lock->owner));
 ...
 do { spin_lock(&lock->wait_lock); (void)(flags); } while (0);
 ...
 if ((((__typeof__(*(&((&lock->count)->counter))))__xchg((unsigned long)(-1),(&((&lock->count)->counter)),sizeof(*(&((&lock->count)->counter)))))) == 1)
  goto done;
...
# 238 "../../kernel/mutex.c"
  ...
  if (__builtin_expect(!!(signal_pending_state(state, task)), 0)) {
   __list_del((&waiter)->list.prev, (&waiter)->list.next);

   do { } while (0);
   do { spin_unlock(&lock->wait_lock); (void)(flags); } while (0);
 ...
 if (__builtin_expect(!!(list_empty(&lock->wait_list)), 1))
  (((&lock->count)->counter) = (0));
...
{
 struct mutex *lock = ({ const typeof( ((struct mutex *)0)->count ) *__mptr = (lock_count); (struct mutex *)( (char *)__mptr - __builtin_offsetof(struct mutex,count) );});
 unsigned long flags;
 ...
 if (!list_empty(&lock->wait_list)) {
  ...
  struct mutex_waiter *waiter =
    ({ const typeof( ((struct mutex_waiter *)0)->list ) *__mptr = (lock->wait_list.next); (struct mutex_waiter *)( (char *)__mptr - __builtin_offsetof(struct mutex_waiter,list) );});
...
static __attribute__((__used__)) __attribute__((noinline)) void
...
static __attribute__((noinline)) int __attribute__((__section__(".sched.text")))
__mutex_lock_killable_slowpath(atomic_t *lock_count);

static __attribute__((noinline)) int __attribute__((__section__(".sched.text")))
__mutex_lock_interruptible_slowpath(atomic_t *lock_count);
# 378 "../../kernel/mutex.c"
int __attribute__((__section__(".sched.text"))) mutex_lock_interruptible(struct mutex *lock)
{
 int ret;
...
extern typeof(mutex_lock_interruptible) mutex_lock_interruptible; static const char __kstrtab_mutex_lock_interruptible[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "mutex_lock_interruptible"; static const struct kernel_symbol __ksymtab_mutex_lock_interruptible __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&mutex_lock_interruptible, __kstrtab_mutex_lock_interruptible };

int __attribute__((__section__(".sched.text"))) mutex_lock_killable(struct mutex *lock)
{
 int ret;
...
extern typeof(mutex_lock_killable) mutex_lock_killable; static const char __kstrtab_mutex_lock_killable[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "mutex_lock_killable"; static const struct kernel_symbol __ksymtab_mutex_lock_killable __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&mutex_lock_killable, __kstrtab_mutex_lock_killable };
...
__mutex_lock_slowpath(atomic_t *lock_count)
{
 ...
 __mutex_lock_common(lock, 2, 0, (unsigned long)__builtin_return_address(0));
}
...
__mutex_lock_killable_slowpath(atomic_t *lock_count)
{
 ...
 return __mutex_lock_common(lock, (128 | 2), 0, (unsigned long)__builtin_return_address(0));
}
...
__mutex_lock_interruptible_slowpath(atomic_t *lock_count)
{
 ...
 return __mutex_lock_common(lock, 1, 0, (unsigned long)__builtin_return_address(0));
}
...
static inline __attribute__((always_inline)) int __mutex_trylock_slowpath(atomic_t *lock_count)
{
 struct mutex *lock = ({ const typeof( ((struct mutex *)0)->count ) *__mptr = (lock_count); (struct mutex *)( (char *)__mptr - __builtin_offsetof(struct mutex,count) );});
 unsigned long flags;
 int prev;
 ...
 prev = (((__typeof__(*(&((&lock->count)->counter))))__xchg((unsigned long)(-1),(&((&lock->count)->counter)),sizeof(*(&((&lock->count)->counter))))));
 if (__builtin_expect(!!(prev == 1), 1)) {
  mutex_set_owner(lock);
  do { } while (0);
 }
...
# 473 "../../kernel/mutex.c"
int __attribute__((__section__(".sched.text"))) mutex_trylock(struct mutex *lock)
{
 int ret;
...
extern typeof(mutex_trylock) mutex_trylock; static const char __kstrtab_mutex_trylock[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "mutex_trylock"; static const struct kernel_symbol __ksymtab_mutex_trylock __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&mutex_trylock, __kstrtab_mutex_trylock };
# 492 "../../kernel/mutex.c"
...
extern typeof(atomic_dec_and_mutex_lock) atomic_dec_and_mutex_lock; static const char __kstrtab_atomic_dec_and_mutex_lock[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "atomic_dec_and_mutex_lock"; static const struct kernel_symbol __ksymtab_atomic_dec_and_mutex_lock __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&atomic_dec_and_mutex_lock, __kstrtab_atomic_dec_and_mutex_lock };
