# 1 "../../net/netfilter/xt_CLASSIFY.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../net/netfilter/xt_CLASSIFY.c"
# 13 "../../net/netfilter/xt_CLASSIFY.c"
...
# 14 "../../net/netfilter/xt_CLASSIFY.c" 2
...
# 15 "../../net/netfilter/xt_CLASSIFY.c" 2
...
# 16 "../../net/netfilter/xt_CLASSIFY.c" 2
...
extern __sum16 nf_ip_checksum(struct sk_buff *skb, unsigned int hook,
       unsigned int dataoff, u_int8_t protocol);
# 19 "../../net/netfilter/xt_CLASSIFY.c" 2
...
# 20 "../../net/netfilter/xt_CLASSIFY.c" 2
...
# 21 "../../net/netfilter/xt_CLASSIFY.c" 2
# 1 "../../include/linux/netfilter/xt_CLASSIFY.h" 1
...
# 22 "../../net/netfilter/xt_CLASSIFY.c" 2
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) classify_tg_init(void)
{
 return xt_register_target(&classify_tg_reg);
}

static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) classify_tg_exit(void)
{
 xt_unregister_target(&classify_tg_reg);
}

static initcall_t __initcall_classify_tg_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = classify_tg_init;;
static exitcall_t __exitcall_classify_tg_exit __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = classify_tg_exit;;
