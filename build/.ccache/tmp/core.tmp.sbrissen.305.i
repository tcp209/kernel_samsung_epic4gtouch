...
# 142 "../../include/linux/suspend.h"
extern void arch_suspend_enable_irqs(void);

extern int pm_suspend(suspend_state_t state);
# 156 "../../include/linux/suspend.h"
struct pbe {
 void *address;
 void *orig_address;
 struct pbe *next;
...
static inline __attribute__((always_inline)) void lock_system_sleep(void) {}
static inline __attribute__((always_inline)) void unlock_system_sleep(void) {}
...
# 94 "../../include/linux/regulator/machine.h"
...
# 142 "../../include/linux/regulator/machine.h"
struct regulator_consumer_supply {
 struct device *dev;
 const char *dev_name;
 const char *supply;
};
# 174 "../../include/linux/regulator/machine.h"
struct regulator_init_data {
...
# 27 "../../drivers/regulator/core.c" 2

# 1 "../../drivers/regulator/dummy.h" 1
# 21 "../../drivers/regulator/dummy.h"
struct regulator_dev;
...
static inline __attribute__((always_inline)) void regulator_dummy_init(void) { }
# 29 "../../drivers/regulator/core.c" 2



static struct mutex regulator_list_mutex = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } } , .wait_list = { &(regulator_list_mutex.wait_list), &(regulator_list_mutex.wait_list) } };
static struct list_head regulator_list = { &(regulator_list), &(regulator_list) };
static struct list_head regulator_map_list = { &(regulator_map_list), &(regulator_map_list) };
...
{
 struct regulator *regulator = ((void *)0);
 struct regulator_dev *rdev;

 mutex_lock(&regulator_list_mutex);
 for (rdev = ({ const typeof( ((typeof(*rdev) *)0)->list ) *__mptr = ((&regulator_list)->next); (typeof(*rdev) *)( (char *)__mptr - __builtin_offsetof(typeof(*rdev),list) );}); prefetch(rdev->list.next), &rdev->list != (&regulator_list); rdev = ({ const typeof( ((typeof(*rdev) *)0)->list ) *__mptr = (rdev->list.next); (typeof(*rdev) *)( (char *)__mptr - __builtin_offsetof(typeof(*rdev),list) );})) {
  mutex_lock(&rdev->mutex);
  for (regulator = ({ const typeof( ((typeof(*regulator) *)0)->list ) *__mptr = ((&rdev->consumer_list)->next); (typeof(*regulator) *)( (char *)__mptr - __builtin_offsetof(typeof(*regulator),list) );}); prefetch(regulator->list.next), &regulator->list != (&rdev->consumer_list); regulator = ({ const typeof( ((typeof(*regulator) *)0)->list ) *__mptr = (regulator->list.next); (typeof(*regulator) *)( (char *)__mptr - __builtin_offsetof(typeof(*regulator),list) );})) {
...
static int regulator_check_voltage(struct regulator_dev *rdev,
       int *min_uV, int *max_uV)
{
 do { if (__builtin_expect(!!(*min_uV > *max_uV), 0)) do { *(int *)0 = 0; } while (1); } while(0);

 if (!rdev->constraints) {
  printk("<3>" "%s: no constraints for %s\n", __func__,
         rdev_get_name(rdev));
  return -19;
 }
 if (!(rdev->constraints->valid_ops_mask & 0x1)) {
  printk("<3>" "%s: operation not allowed for %s\n",
...
static int regulator_check_current_limit(struct regulator_dev *rdev,
     int *min_uA, int *max_uA)
{
 do { if (__builtin_expect(!!(*min_uA > *max_uA), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 ...
 if (!(rdev->constraints->valid_ops_mask & 0x2)) {
  printk("<3>" "%s: operation not allowed for %s\n",
         __func__, rdev_get_name(rdev));
  return -1;
 }
...
static int regulator_check_mode(struct regulator_dev *rdev, int mode)
{
 ...
 if (!(rdev->constraints->valid_ops_mask & 0x4)) {
  printk("<3>" "%s: operation not allowed for %s\n",
         __func__, rdev_get_name(rdev));
  return -1;
 }
 if (!(rdev->constraints->valid_modes_mask & mode)) {
  printk("<3>" "%s: invalid mode %x for %s\n",
...
static int regulator_check_drms(struct regulator_dev *rdev)
{
 ...
 if (!(rdev->constraints->valid_ops_mask & 0x10)) {
  printk("<3>" "%s: operation not allowed for %s\n",
         __func__, rdev_get_name(rdev));
  return -1;
 }
...
static struct device_attribute dev_attr_microvolts = { .attr = {.name = "microvolts", .mode = 0444 }, .show = regulator_uV_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_microamps = { .attr = {.name = "microamps", .mode = 0444 }, .show = regulator_uA_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_opmode = { .attr = {.name = "opmode", .mode = 0444 }, .show = regulator_opmode_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_state = { .attr = {.name = "state", .mode = 0444 }, .show = regulator_state_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_status = { .attr = {.name = "status", .mode = 0444 }, .show = regulator_status_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_min_microamps = { .attr = {.name = "min_microamps", .mode = 0444 }, .show = regulator_min_uA_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_max_microamps = { .attr = {.name = "max_microamps", .mode = 0444 }, .show = regulator_max_uA_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_min_microvolts = { .attr = {.name = "min_microvolts", .mode = 0444 }, .show = regulator_min_uV_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_max_microvolts = { .attr = {.name = "max_microvolts", .mode = 0444 }, .show = regulator_max_uV_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_requested_microamps = { .attr = {.name = "requested_microamps", .mode = 0444 }, .show = regulator_total_uA_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_suspend_mem_microvolts = { .attr = {.name = "suspend_mem_microvolts", .mode = 0444 }, .show = regulator_suspend_mem_uV_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_suspend_disk_microvolts = { .attr = {.name = "suspend_disk_microvolts", .mode = 0444 }, .show = regulator_suspend_disk_uV_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_suspend_standby_microvolts = { .attr = {.name = "suspend_standby_microvolts", .mode = 0444 }, .show = regulator_suspend_standby_uV_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_suspend_mem_mode = { .attr = {.name = "suspend_mem_mode", .mode = 0444 }, .show = regulator_suspend_mem_mode_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_suspend_disk_mode = { .attr = {.name = "suspend_disk_mode", .mode = 0444 }, .show = regulator_suspend_disk_mode_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_suspend_standby_mode = { .attr = {.name = "suspend_standby_mode", .mode = 0444 }, .show = regulator_suspend_standby_mode_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_suspend_mem_state = { .attr = {.name = "suspend_mem_state", .mode = 0444 }, .show = regulator_suspend_mem_state_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_suspend_disk_state = { .attr = {.name = "suspend_disk_state", .mode = 0444 }, .show = regulator_suspend_disk_state_show, .store = ((void *)0), };
...
static struct device_attribute dev_attr_suspend_standby_state = { .attr = {.name = "suspend_standby_state", .mode = 0444 }, .show = regulator_suspend_standby_state_show, .store = ((void *)0), };
...
static struct device_attribute regulator_dev_attrs[] = {
 { .attr = {.name = "name", .mode = 0444 }, .show = regulator_name_show, .store = ((void *)0), },
 { .attr = {.name = "num_users", .mode = 0444 }, .show = regulator_num_users_show, .store = ((void *)0), },
 { .attr = {.name = "type", .mode = 0444 }, .show = regulator_type_show, .store = ((void *)0), },
 { .attr = { .name = ((void *)0) } },
};
...
static void drms_uA_update(struct regulator_dev *rdev)
{
 ...
 for (sibling = ({ const typeof( ((typeof(*sibling) *)0)->list ) *__mptr = ((&rdev->consumer_list)->next); (typeof(*sibling) *)( (char *)__mptr - __builtin_offsetof(typeof(*sibling),list) );}); prefetch(sibling->list.next), &sibling->list != (&rdev->consumer_list); sibling = ({ const typeof( ((typeof(*sibling) *)0)->list ) *__mptr = (sibling->list.next); (typeof(*sibling) *)( (char *)__mptr - __builtin_offsetof(typeof(*sibling),list) );}))
 ...
 struct regulator_state *rstate)
{
 ...
 if (!rstate->enabled && !rstate->disabled) {
  if (can_set_state)
   printk("<4>" "%s: No configuration for %s\n",
          __func__, rdev_get_name(rdev));
  return 0;
 }

 if (rstate->enabled && rstate->disabled) {
  printk("<3>" "%s: invalid configuration for %s\n",
         __func__, rdev_get_name(rdev));
  return -22;
 }

 if (!can_set_state) {
  printk("<3>" "%s: no way to set suspend state\n",
   __func__);
  return -22;
 }
 ...
 if (ret < 0) {
  printk("<3>" "%s: failed to enabled/disable\n", __func__);
  return ret;
 }
 ...
 if (rdev->desc->ops->set_suspend_voltage && rstate->uV > 0) {
  ...
  if (ret < 0) {
   printk("<3>" "%s: failed to set voltage\n",
    __func__);
   return ret;
  }
 }
...
static int suspend_prepare(struct regulator_dev *rdev, suspend_state_t state)
{
 ...
 switch (state) {
 case (( suspend_state_t) 1):
  return suspend_set_state(rdev,
   &rdev->constraints->state_standby);
 case (( suspend_state_t) 3):
  return suspend_set_state(rdev,
   &rdev->constraints->state_mem);
 case (( suspend_state_t) 4):
  return suspend_set_state(rdev,
...
static void print_constraints(struct regulator_dev *rdev)
{
 ...
 if (constraints->valid_modes_mask & 0x1)
  count += sprintf(buf + count, "fast ");
 if (constraints->valid_modes_mask & 0x2)
  count += sprintf(buf + count, "normal ");
 if (constraints->valid_modes_mask & 0x4)
  count += sprintf(buf + count, "idle ");
 if (constraints->valid_modes_mask & 0x8)
  count += sprintf(buf + count, "standby");

 printk("<6>" "regulator: %s: %s\n", rdev_get_name(rdev), buf);
}
 ...
 struct regulation_constraints *constraints)
{
 ...
 if (rdev->constraints->apply_uV &&
  ...
  ret = ops->set_voltage(rdev,
   rdev->constraints->min_uV, rdev->constraints->max_uV);
   if (ret < 0) {
    printk("<3>" "%s: failed to apply %duV constraint to %s\n",
           __func__,
           rdev->constraints->min_uV, name);
    rdev->constraints = ((void *)0);
    return ret;
   }
 }
 ...
 if (ops->list_voltage && rdev->desc->n_voltages) {
  ...
  if (cmin <= 0 || cmax <= 0 || cmax < cmin) {
   printk("<3>" "%s: %s '%s' voltage constraints\n", __func__, "invalid", name);
  ...
  if (constraints->min_uV < min_uV) {
   ({ if (0) printk("<7>" "%s: override '%s' %s, %d -> %d\n", __func__, name, "min_uV", constraints->min_uV, min_uV); 0; });


   constraints->min_uV = min_uV;
  }
  if (constraints->max_uV > max_uV) {
   ({ if (0) printk("<7>" "%s: override '%s' %s, %d -> %d\n", __func__, name, "max_uV", constraints->max_uV, max_uV); 0; });
 ...
 struct regulation_constraints *constraints)
{
 ...
 if (constraints->initial_state) {
  ...
  if (ret < 0) {
   printk("<3>" "%s: failed to set suspend state for %s\n",
          __func__, name);
   rdev->constraints = ((void *)0);
   goto out;
  }
 ...
 if (constraints->initial_mode) {
  if (!ops->set_mode) {
   printk("<3>" "%s: no set_mode operation for %s\n",
          __func__, name);
   ret = -22;
   goto out;
  }
 ...
 const char *supply)
{
 ...
 if (consumer_dev_name != ((void *)0))
  has_dev = 1;
 else
  has_dev = 0;

 for (node = ({ const typeof( ((typeof(*node) *)0)->list ) *__mptr = ((&regulator_map_list)->next); (typeof(*node) *)( (char *)__mptr - __builtin_offsetof(typeof(*node),list) );}); prefetch(node->list.next), &node->list != (&regulator_map_list); node = ({ const typeof( ((typeof(*node) *)0)->list ) *__mptr = (node->list.next); (typeof(*node) *)( (char *)__mptr - __builtin_offsetof(typeof(*node),list) );})) {
  ...
  ({ if (0) printk("<7>" "%s %s: " "%s/%s is '%s' supply; fail %s/%s\n" , dev_driver_string(consumer_dev) , dev_name(consumer_dev) , dev_name(&node->regulator->dev), node->regulator->desc->name, supply, dev_name(&rdev->dev), rdev_get_name(rdev)); 0; });
 ...
 node = kzalloc(sizeof(struct regulator_map), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (node == ((void *)0))
  return -12;
 ...
 if (has_dev) {
  node->dev_name = kstrdup(consumer_dev_name, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
  if (node->dev_name == ((void *)0)) {
   kfree(node);
   return -12;
  }
 }
...
static void unset_regulator_supplies(struct regulator_dev *rdev)
{
 ...
 for (node = ({ const typeof( ((typeof(*node) *)0)->list ) *__mptr = ((&regulator_map_list)->next); (typeof(*node) *)( (char *)__mptr - __builtin_offsetof(typeof(*node),list) );}), n = ({ const typeof( ((typeof(*node) *)0)->list ) *__mptr = (node->list.next); (typeof(*node) *)( (char *)__mptr - __builtin_offsetof(typeof(*node),list) );}); &node->list != (&regulator_map_list); node = n, n = ({ const typeof( ((typeof(*n) *)0)->list ) *__mptr = (n->list.next); (typeof(*n) *)( (char *)__mptr - __builtin_offsetof(typeof(*n),list) );})) {
       ...
       const char *supply_name)
{
 ...
 regulator = kzalloc(sizeof(*regulator), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (regulator == ((void *)0))
  return ((void *)0);
 ...
 if (dev) {
  ...
  size = scnprintf(buf, 32, "microamps_requested_%s",
   supply_name);
  if (size >= 32)
   goto overflow_err;
  ...
  regulator->dev = dev;
  do {} while(0);
  regulator->dev_attr.attr.name = kstrdup(buf, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
  if (regulator->dev_attr.attr.name == ((void *)0))
   goto attr_name_err;

  regulator->dev_attr.attr.owner = ((struct module *)0);
  regulator->dev_attr.attr.mode = 0444;
  regulator->dev_attr.show = device_requested_uA_show;
  err = device_create_file(dev, &regulator->dev_attr);
  if (err < 0) {
   printk("<4>" "%s: could not add regulator_dev"
    " load sysfs\n", __func__);
   goto attr_name_err;
  }


  size = scnprintf(buf, 32, "%s-%s",
     dev->kobj.name, supply_name);
  if (size >= 32)
   goto attr_err;

  regulator->supply_name = kstrdup(buf, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
     ...
     int exclusive)
{
 ...
 struct regulator *regulator = ERR_PTR(-19);
 const char *devname = ((void *)0);
 int ret;

 if (id == ((void *)0)) {
  printk("<3>" "regulator: get() with no identifier\n");
  return regulator;
 }
 ...
 for (map = ({ const typeof( ((typeof(*map) *)0)->list ) *__mptr = ((&regulator_map_list)->next); (typeof(*map) *)( (char *)__mptr - __builtin_offsetof(typeof(*map),list) );}); prefetch(map->list.next), &map->list != (&regulator_map_list); map = ({ const typeof( ((typeof(*map) *)0)->list ) *__mptr = (map->list.next); (typeof(*map) *)( (char *)__mptr - __builtin_offsetof(typeof(*map),list) );})) {
...
# 1180 "../../drivers/regulator/core.c"
struct regulator *regulator_get(struct device *dev, const char *id)
{
 return _regulator_get(dev, id, 0);
}
extern typeof(regulator_get) regulator_get; static const char __kstrtab_regulator_get[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_get"; static const struct kernel_symbol __ksymtab_regulator_get __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_get, __kstrtab_regulator_get };
# 1207 "../../drivers/regulator/core.c"
struct regulator *regulator_get_exclusive(struct device *dev, const char *id)
{
 return _regulator_get(dev, id, 1);
}
extern typeof(regulator_get_exclusive) regulator_get_exclusive; static const char __kstrtab_regulator_get_exclusive[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_get_exclusive"; static const struct kernel_symbol __ksymtab_regulator_get_exclusive __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_get_exclusive, __kstrtab_regulator_get_exclusive };
# 1221 "../../drivers/regulator/core.c"
void regulator_put(struct regulator *regulator)
{
 struct regulator_dev *rdev;
...
extern typeof(regulator_put) regulator_put; static const char __kstrtab_regulator_put[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_put"; static const struct kernel_symbol __ksymtab_regulator_put __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_put, __kstrtab_regulator_put };
...
static int _regulator_can_change_status(struct regulator_dev *rdev)
{
 ...
 if (rdev->constraints->valid_ops_mask & 0x8)
  return 1;
 else
  return 0;
}
...
static int _regulator_enable(struct regulator_dev *rdev)
{
 ...
 if (rdev->supply) {
  ...
  if (ret < 0) {
   printk("<3>" "%s: failed to enable %s: %d\n",
 ...
 if (rdev->constraints &&
     (rdev->constraints->valid_ops_mask & 0x10))
  drms_uA_update(rdev);
 ...
 if (rdev->use_count == 0) {
  ...
  if (ret == -22 || ret == 0) {
   ...
   if (delay >= 1000)
    ( (__builtin_constant_p(delay / 1000) && (delay / 1000)<=2) ? (__builtin_constant_p((delay / 1000)*1000) ? (((delay / 1000)*1000) > (2 * 1000) ? __bad_udelay() : __const_udelay(((delay / 1000)*1000) * ((2199023U*200)>>11))) : __udelay((delay / 1000)*1000)) : ({unsigned long __ms=(delay / 1000); while (__ms--) (__builtin_constant_p(1000) ? ((1000) > (2 * 1000) ? __bad_udelay() : __const_udelay((1000) * ((2199023U*200)>>11))) : __udelay(1000));}));
   else if (delay)
    (__builtin_constant_p(delay) ? ((delay) > (2 * 1000) ? __bad_udelay() : __const_udelay((delay) * ((2199023U*200)>>11))) : __udelay(delay));

  } else if (ret < 0) {
   printk("<3>" "%s: is_enabled() failed for %s: %d\n",
          __func__, rdev_get_name(rdev), ret);
   return ret;
  }
...
extern typeof(regulator_enable) regulator_enable; static const char __kstrtab_regulator_enable[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_enable"; static const struct kernel_symbol __ksymtab_regulator_enable __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_enable, __kstrtab_regulator_enable };
...
static int _regulator_disable(struct regulator_dev *rdev)
{
 ...
 if (({ int __ret_warn_on = !!(rdev->use_count <= 0); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_fmt("../../drivers/regulator/core.c", 1358, "unbalanced disables for %s\n", rdev_get_name(rdev)); __builtin_expect(!!(__ret_warn_on), 0); }))
 ...
 if (rdev->use_count == 1 &&
  ...
  if (_regulator_can_change_status(rdev) &&
   ...
   if (ret < 0) {
    printk("<3>" "%s: failed to disable %s\n",
           __func__, rdev_get_name(rdev));
    return ret;
   }

   _notifier_call_chain(rdev, 0x80,
          ((void *)0));
  }
...
extern typeof(regulator_disable) regulator_disable; static const char __kstrtab_regulator_disable[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_disable"; static const struct kernel_symbol __ksymtab_regulator_disable __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_disable, __kstrtab_regulator_disable };
...
static int _regulator_force_disable(struct regulator_dev *rdev)
{
 ...
 if (rdev->desc->ops->disable) {
  ...
  ret = rdev->desc->ops->disable(rdev);
  if (ret < 0) {
   printk("<3>" "%s: failed to force disable %s\n",
          __func__, rdev_get_name(rdev));
   return ret;
  }

  _notifier_call_chain(rdev, 0x20 |
   0x80, ((void *)0));
 }
...
extern typeof(regulator_force_disable) regulator_force_disable; static const char __kstrtab_regulator_force_disable[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_force_disable"; static const struct kernel_symbol __ksymtab_regulator_force_disable __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_force_disable, __kstrtab_regulator_force_disable };
...
extern typeof(regulator_is_enabled) regulator_is_enabled; static const char __kstrtab_regulator_is_enabled[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_is_enabled"; static const struct kernel_symbol __ksymtab_regulator_is_enabled __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_is_enabled, __kstrtab_regulator_is_enabled };
# 1509 "../../drivers/regulator/core.c"
int regulator_count_voltages(struct regulator *regulator)
{
 struct regulator_dev *rdev = regulator->rdev;

 return rdev->desc->n_voltages ? : -22;
}
extern typeof(regulator_count_voltages) regulator_count_voltages; static const char __kstrtab_regulator_count_voltages[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_count_voltages"; static const struct kernel_symbol __ksymtab_regulator_count_voltages __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_count_voltages, __kstrtab_regulator_count_voltages };
# 1527 "../../drivers/regulator/core.c"
int regulator_list_voltage(struct regulator *regulator, unsigned selector)
{
 struct regulator_dev *rdev = regulator->rdev;
 struct regulator_ops *ops = rdev->desc->ops;
...
extern typeof(regulator_list_voltage) regulator_list_voltage; static const char __kstrtab_regulator_list_voltage[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_list_voltage"; static const struct kernel_symbol __ksymtab_regulator_list_voltage __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_list_voltage, __kstrtab_regulator_list_voltage };
# 1560 "../../drivers/regulator/core.c"
int regulator_is_supported_voltage(struct regulator *regulator,
       int min_uV, int max_uV)
{
 int i, voltages, ret;
...
out:
 _notifier_call_chain(rdev, 0x40, ((void *)0));
 mutex_unlock(&rdev->mutex);
 return ret;
}
extern typeof(regulator_set_voltage) regulator_set_voltage; static const char __kstrtab_regulator_set_voltage[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_set_voltage"; static const struct kernel_symbol __ksymtab_regulator_set_voltage __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_set_voltage, __kstrtab_regulator_set_voltage };
...
extern typeof(regulator_get_voltage) regulator_get_voltage; static const char __kstrtab_regulator_get_voltage[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_get_voltage"; static const struct kernel_symbol __ksymtab_regulator_get_voltage __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_get_voltage, __kstrtab_regulator_get_voltage };
# 1674 "../../drivers/regulator/core.c"
int regulator_set_current_limit(struct regulator *regulator,
          int min_uA, int max_uA)
{
 struct regulator_dev *rdev = regulator->rdev;
...
extern typeof(regulator_set_current_limit) regulator_set_current_limit; static const char __kstrtab_regulator_set_current_limit[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_set_current_limit"; static const struct kernel_symbol __ksymtab_regulator_set_current_limit __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_set_current_limit, __kstrtab_regulator_set_current_limit };
...
# 1727 "../../drivers/regulator/core.c"
int regulator_get_current_limit(struct regulator *regulator)
{
 return _regulator_get_current_limit(regulator->rdev);
}
extern typeof(regulator_get_current_limit) regulator_get_current_limit; static const char __kstrtab_regulator_get_current_limit[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_get_current_limit"; static const struct kernel_symbol __ksymtab_regulator_get_current_limit __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_get_current_limit, __kstrtab_regulator_get_current_limit };
# 1744 "../../drivers/regulator/core.c"
int regulator_set_mode(struct regulator *regulator, unsigned int mode)
{
 struct regulator_dev *rdev = regulator->rdev;
 int ret;
...
extern typeof(regulator_set_mode) regulator_set_mode; static const char __kstrtab_regulator_set_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_set_mode"; static const struct kernel_symbol __ksymtab_regulator_set_mode __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_set_mode, __kstrtab_regulator_set_mode };
...
extern typeof(regulator_get_mode) regulator_get_mode; static const char __kstrtab_regulator_get_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_get_mode"; static const struct kernel_symbol __ksymtab_regulator_get_mode __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_get_mode, __kstrtab_regulator_get_mode };
# 1835 "../../drivers/regulator/core.c"
int regulator_set_optimum_mode(struct regulator *regulator, int uA_load)
{
 ...
 output_uV = rdev->desc->ops->get_voltage(rdev);
 if (output_uV <= 0) {
  printk("<3>" "%s: invalid output voltage found for %s\n",
   __func__, rdev_get_name(rdev));
  goto out;
 }
 ...
 if (rdev->supply && rdev->supply->desc->ops->get_voltage)
  ...
  input_uV = rdev->constraints->input_uV;
 if (input_uV <= 0) {
  printk("<3>" "%s: invalid input voltage found for %s\n",
   __func__, rdev_get_name(rdev));
  goto out;
 }


 for (consumer = ({ const typeof( ((typeof(*consumer) *)0)->list ) *__mptr = ((&rdev->consumer_list)->next); (typeof(*consumer) *)( (char *)__mptr - __builtin_offsetof(typeof(*consumer),list) );}); prefetch(consumer->list.next), &consumer->list != (&rdev->consumer_list); consumer = ({ const typeof( ((typeof(*consumer) *)0)->list ) *__mptr = (consumer->list.next); (typeof(*consumer) *)( (char *)__mptr - __builtin_offsetof(typeof(*consumer),list) );}))
 ...
 ret = regulator_check_mode(rdev, mode);
 if (ret < 0) {
  printk("<3>" "%s: failed to get optimum mode for %s @"
   " %d uA %d -> %d uV\n", __func__, rdev_get_name(rdev),
 ...
 ret = rdev->desc->ops->set_mode(rdev, mode);
 if (ret < 0) {
  printk("<3>" "%s: failed to set optimum mode %x for %s\n",
   __func__, mode, rdev_get_name(rdev));
  goto out;
 }
 ret = mode;
...
extern typeof(regulator_set_optimum_mode) regulator_set_optimum_mode; static const char __kstrtab_regulator_set_optimum_mode[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_set_optimum_mode"; static const struct kernel_symbol __ksymtab_regulator_set_optimum_mode __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_set_optimum_mode, __kstrtab_regulator_set_optimum_mode };
# 1908 "../../drivers/regulator/core.c"
int regulator_register_notifier(struct regulator *regulator,
         struct notifier_block *nb)
{
...
extern typeof(regulator_register_notifier) regulator_register_notifier; static const char __kstrtab_regulator_register_notifier[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_register_notifier"; static const struct kernel_symbol __ksymtab_regulator_register_notifier __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_register_notifier, __kstrtab_regulator_register_notifier };
# 1923 "../../drivers/regulator/core.c"
int regulator_unregister_notifier(struct regulator *regulator,
    struct notifier_block *nb)
{
...
extern typeof(regulator_unregister_notifier) regulator_unregister_notifier; static const char __kstrtab_regulator_unregister_notifier[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_unregister_notifier"; static const struct kernel_symbol __ksymtab_regulator_unregister_notifier __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_unregister_notifier, __kstrtab_regulator_unregister_notifier };
      ...
      unsigned long event, void *data)
{
 ...
 blocking_notifier_call_chain(&rdev->notifier, event, ((void *)0));


 for (_rdev = ({ const typeof( ((typeof(*_rdev) *)0)->slist ) *__mptr = ((&rdev->supply_list)->next); (typeof(*_rdev) *)( (char *)__mptr - __builtin_offsetof(typeof(*_rdev),slist) );}); prefetch(_rdev->slist.next), &_rdev->slist != (&rdev->supply_list); _rdev = ({ const typeof( ((typeof(*_rdev) *)0)->slist ) *__mptr = (_rdev->slist.next); (typeof(*_rdev) *)( (char *)__mptr - __builtin_offsetof(typeof(*_rdev),slist) );})) {
  mutex_lock(&_rdev->mutex);
  _notifier_call_chain(_rdev, event, data);
  mutex_unlock(&_rdev->mutex);
 }
}
# 1964 "../../drivers/regulator/core.c"
int regulator_bulk_get(struct device *dev, int num_consumers,
         struct regulator_bulk_data *consumers)
{
 int i;
 ...
 for (i = 0; i < num_consumers; i++) {
  ...
  if (IS_ERR(consumers[i].consumer)) {
   ...
   printk("<3>" "%s %s: " "Failed to get supply '%s': %d\n" , dev_driver_string(dev) , dev_name(dev) , consumers[i].supply, ret);
...
extern typeof(regulator_bulk_get) regulator_bulk_get; static const char __kstrtab_regulator_bulk_get[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_bulk_get"; static const struct kernel_symbol __ksymtab_regulator_bulk_get __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_bulk_get, __kstrtab_regulator_bulk_get };
# 2007 "../../drivers/regulator/core.c"
int regulator_bulk_enable(int num_consumers,
     struct regulator_bulk_data *consumers)
{
 int i;
...
err:
 printk("<3>" "Failed to enable %s: %d\n", consumers[i].supply, ret);
 for (--i; i >= 0; --i)
  regulator_disable(consumers[i].consumer);

 return ret;
}
extern typeof(regulator_bulk_enable) regulator_bulk_enable; static const char __kstrtab_regulator_bulk_enable[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_bulk_enable"; static const struct kernel_symbol __ksymtab_regulator_bulk_enable __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_bulk_enable, __kstrtab_regulator_bulk_enable };
# 2042 "../../drivers/regulator/core.c"
int regulator_bulk_disable(int num_consumers,
      struct regulator_bulk_data *consumers)
{
 int i;
...
err:
 printk("<3>" "Failed to disable %s: %d\n", consumers[i].supply,
        ret);
 for (--i; i >= 0; --i)
...
extern typeof(regulator_bulk_disable) regulator_bulk_disable; static const char __kstrtab_regulator_bulk_disable[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_bulk_disable"; static const struct kernel_symbol __ksymtab_regulator_bulk_disable __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_bulk_disable, __kstrtab_regulator_bulk_disable };
# 2075 "../../drivers/regulator/core.c"
void regulator_bulk_free(int num_consumers,
    struct regulator_bulk_data *consumers)
{
 int i;
...
extern typeof(regulator_bulk_free) regulator_bulk_free; static const char __kstrtab_regulator_bulk_free[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_bulk_free"; static const struct kernel_symbol __ksymtab_regulator_bulk_free __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_bulk_free, __kstrtab_regulator_bulk_free };
# 2097 "../../drivers/regulator/core.c"
int regulator_notifier_call_chain(struct regulator_dev *rdev,
      unsigned long event, void *data)
{
...
extern typeof(regulator_notifier_call_chain) regulator_notifier_call_chain; static const char __kstrtab_regulator_notifier_call_chain[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_notifier_call_chain"; static const struct kernel_symbol __ksymtab_regulator_notifier_call_chain __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_notifier_call_chain, __kstrtab_regulator_notifier_call_chain };
# 2113 "../../drivers/regulator/core.c"
...
extern typeof(regulator_mode_to_status) regulator_mode_to_status; static const char __kstrtab_regulator_mode_to_status[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_mode_to_status"; static const struct kernel_symbol __ksymtab_regulator_mode_to_status __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_mode_to_status, __kstrtab_regulator_mode_to_status };
...
# 2256 "../../drivers/regulator/core.c"
struct regulator_dev *regulator_register(struct regulator_desc *regulator_desc,
 struct device *dev, struct regulator_init_data *init_data,
 void *driver_data)
{
 static atomic_t regulator_no = { (0) };
 struct regulator_dev *rdev;
 int ret, i;

 if (regulator_desc == ((void *)0))
  return ERR_PTR(-22);

 if (regulator_desc->name == ((void *)0) || regulator_desc->ops == ((void *)0))
  return ERR_PTR(-22);
 ...
 rdev = kzalloc(sizeof(struct regulator_dev), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (rdev == ((void *)0))
  return ERR_PTR(-12);

 mutex_lock(&regulator_list_mutex);

 do { static struct lock_class_key __key; __mutex_init((&rdev->mutex), "&rdev->mutex", &__key); } while (0);
 ...
 do { do { static struct lock_class_key __key; __init_rwsem((&(&rdev->notifier)->rwsem), "&(&rdev->notifier)->rwsem", &__key); } while (0); (&rdev->notifier)->head = ((void *)0); } while (0);
 ...
 dev_set_name(&rdev->dev, "regulator.%d",
       (atomic_add_return(1, &regulator_no)) - 1);
 ...
 if (init_data->supply_regulator && init_data->supply_regulator_dev) {
  printk("<3>" "%s %s: " "Supply regulator specified by both name and dev\n" , dev_driver_string(dev) , dev_name(dev));
 ...
 if (init_data->supply_regulator) {
  ...
  for (r = ({ const typeof( ((typeof(*r) *)0)->list ) *__mptr = ((&regulator_list)->next); (typeof(*r) *)( (char *)__mptr - __builtin_offsetof(typeof(*r),list) );}); prefetch(r->list.next), &r->list != (&regulator_list); r = ({ const typeof( ((typeof(*r) *)0)->list ) *__mptr = (r->list.next); (typeof(*r) *)( (char *)__mptr - __builtin_offsetof(typeof(*r),list) );})) {
  ...
  if (!found) {
   printk("<3>" "%s %s: " "Failed to find supply %s\n" , dev_driver_string(dev) , dev_name(dev) , init_data->supply_regulator);
 ...
 if (init_data->supply_regulator_dev) {
  printk("<4>" "%s %s: " "Uses supply_regulator_dev instead of regulator_supply\n" , dev_driver_string(dev) , dev_name(dev));
  ret = set_supply(rdev,
...
extern typeof(regulator_register) regulator_register; static const char __kstrtab_regulator_register[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_register"; static const struct kernel_symbol __ksymtab_regulator_register __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_register, __kstrtab_regulator_register };
...
void regulator_unregister(struct regulator_dev *rdev)
{
 ...
 mutex_lock(&regulator_list_mutex);
 ({ int __ret_warn_on = !!(rdev->open_count); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../drivers/regulator/core.c", 2402); __builtin_expect(!!(__ret_warn_on), 0); });
 unset_regulator_supplies(rdev);
 list_del(&rdev->list);
 if (rdev->supply)
...
extern typeof(regulator_unregister) regulator_unregister; static const char __kstrtab_regulator_unregister[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_unregister"; static const struct kernel_symbol __ksymtab_regulator_unregister __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_unregister, __kstrtab_regulator_unregister };
# 2419 "../../drivers/regulator/core.c"
int regulator_suspend_prepare(suspend_state_t state)
{
 struct regulator_dev *rdev;
 int ret = 0;
 ...
 for (rdev = ({ const typeof( ((typeof(*rdev) *)0)->list ) *__mptr = ((&regulator_list)->next); (typeof(*rdev) *)( (char *)__mptr - __builtin_offsetof(typeof(*rdev),list) );}); prefetch(rdev->list.next), &rdev->list != (&regulator_list); rdev = ({ const typeof( ((typeof(*rdev) *)0)->list ) *__mptr = (rdev->list.next); (typeof(*rdev) *)( (char *)__mptr - __builtin_offsetof(typeof(*rdev),list) );})) {
  ...
  if (ret < 0) {
   printk("<3>" "%s: failed to prepare %s\n",
    __func__, rdev_get_name(rdev));
   goto out;
  }
 }
...
extern typeof(regulator_suspend_prepare) regulator_suspend_prepare; static const char __kstrtab_regulator_suspend_prepare[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_suspend_prepare"; static const struct kernel_symbol __ksymtab_regulator_suspend_prepare __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_suspend_prepare, __kstrtab_regulator_suspend_prepare };
# 2458 "../../drivers/regulator/core.c"
void regulator_has_full_constraints(void)
{
 has_full_constraints = 1;
}
extern typeof(regulator_has_full_constraints) regulator_has_full_constraints; static const char __kstrtab_regulator_has_full_constraints[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_has_full_constraints"; static const struct kernel_symbol __ksymtab_regulator_has_full_constraints __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_has_full_constraints, __kstrtab_regulator_has_full_constraints };
# 2471 "../../drivers/regulator/core.c"
void *rdev_get_drvdata(struct regulator_dev *rdev)
{
 return rdev->reg_data;
}
extern typeof(rdev_get_drvdata) rdev_get_drvdata; static const char __kstrtab_rdev_get_drvdata[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "rdev_get_drvdata"; static const struct kernel_symbol __ksymtab_rdev_get_drvdata __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&rdev_get_drvdata, __kstrtab_rdev_get_drvdata };
# 2484 "../../drivers/regulator/core.c"
void *regulator_get_drvdata(struct regulator *regulator)
{
 return regulator->rdev->reg_data;
}
extern typeof(regulator_get_drvdata) regulator_get_drvdata; static const char __kstrtab_regulator_get_drvdata[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_get_drvdata"; static const struct kernel_symbol __ksymtab_regulator_get_drvdata __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_get_drvdata, __kstrtab_regulator_get_drvdata };
...
extern typeof(regulator_set_drvdata) regulator_set_drvdata; static const char __kstrtab_regulator_set_drvdata[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_set_drvdata"; static const struct kernel_symbol __ksymtab_regulator_set_drvdata __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_set_drvdata, __kstrtab_regulator_set_drvdata };
...
extern typeof(rdev_get_id) rdev_get_id; static const char __kstrtab_rdev_get_id[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "rdev_get_id"; static const struct kernel_symbol __ksymtab_rdev_get_id __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&rdev_get_id, __kstrtab_rdev_get_id };

struct device *rdev_get_dev(struct regulator_dev *rdev)
{
 return &rdev->dev;
}
extern typeof(rdev_get_dev) rdev_get_dev; static const char __kstrtab_rdev_get_dev[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "rdev_get_dev"; static const struct kernel_symbol __ksymtab_rdev_get_dev __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&rdev_get_dev, __kstrtab_rdev_get_dev };

void *regulator_get_init_drvdata(struct regulator_init_data *reg_init_data)
{
 return reg_init_data->driver_data;
}
extern typeof(regulator_get_init_drvdata) regulator_get_init_drvdata; static const char __kstrtab_regulator_get_init_drvdata[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "regulator_get_init_drvdata"; static const struct kernel_symbol __ksymtab_regulator_get_init_drvdata __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&regulator_get_init_drvdata, __kstrtab_regulator_get_init_drvdata };

static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) regulator_init(void)
{
 int ret;

 printk("<6>" "regulator: core version %s\n", "0.5");

 ret = ({ static struct lock_class_key __key; __class_register(&regulator_class, &__key); });
...
static initcall_t __initcall_regulator_init1 __attribute__((__used__)) __attribute__((__section__(".initcall" "1" ".init"))) = regulator_init;

static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) regulator_init_complete(void)
{
 struct regulator_dev *rdev;
 struct regulator_ops *ops;
...
static initcall_t __initcall_regulator_init_complete7 __attribute__((__used__)) __attribute__((__section__(".initcall" "7" ".init"))) = regulator_init_complete;
