# 1 "../../net/netfilter/xt_connmark.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../net/netfilter/xt_connmark.c"
# 24 "../../net/netfilter/xt_connmark.c"
...
# 25 "../../net/netfilter/xt_connmark.c" 2
...
# 26 "../../net/netfilter/xt_connmark.c" 2
...
# 27 "../../net/netfilter/xt_connmark.c" 2
...
# 28 "../../net/netfilter/xt_connmark.c" 2

# 1 "../../include/linux/netfilter/xt_connmark.h" 1
...
# 30 "../../net/netfilter/xt_connmark.c" 2
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) connmark_mt_init(void)
{
 int ret;
...
static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) connmark_mt_exit(void)
{
 xt_unregister_match(&connmark_mt_reg);
 xt_unregister_target(&connmark_tg_reg);
}

static initcall_t __initcall_connmark_mt_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = connmark_mt_init;;
static exitcall_t __exitcall_connmark_mt_exit __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = connmark_mt_exit;;
