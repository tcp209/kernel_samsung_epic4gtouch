...
extern typeof(pipe_lock) pipe_lock; static const char __kstrtab_pipe_lock[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "pipe_lock"; static const struct kernel_symbol __ksymtab_pipe_lock __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&pipe_lock, __kstrtab_pipe_lock };
...
extern typeof(pipe_unlock) pipe_unlock; static const char __kstrtab_pipe_unlock[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "pipe_unlock"; static const struct kernel_symbol __ksymtab_pipe_unlock __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&pipe_unlock, __kstrtab_pipe_unlock };

void pipe_double_lock(struct pipe_inode_info *pipe1,
        struct pipe_inode_info *pipe2)
{
 do { if (__builtin_expect(!!(pipe1 == pipe2), 0)) do { *(int *)0 = 0; } while (1); } while(0);
...
void pipe_wait(struct pipe_inode_info *pipe)
{
 ...
 prepare_to_wait(&pipe->wait, &wait, 1);
 pipe_unlock(pipe);
 schedule();
   ...
   int atomic)
{
 ...
 while (len > 0) {
  while (!iov->iov_len)
   iov++;
  copy = ({ unsigned long __min1 = (len); unsigned long __min2 = (iov->iov_len); __min1 < __min2 ? __min1: __min2; });

  if (atomic) {
   if (__copy_from_user(to, iov->iov_base, copy))
    return -14;
  } else {
        ...
        int atomic)
{
 ...
 while (len > 0) {
  ...
  if (atomic) {
   if (__copy_to_user(iov->iov_base, from, copy))
    return -14;
  } else {
...
static int iov_fault_in_pages_write(struct iovec *iov, unsigned long len)
{
 ...
 while (len > 0) {
  ...
  this_len = ({ unsigned long __min1 = (len); unsigned long __min2 = (iov->iov_len); __min1 < __min2 ? __min1: __min2; });
...
extern typeof(generic_pipe_buf_map) generic_pipe_buf_map; static const char __kstrtab_generic_pipe_buf_map[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "generic_pipe_buf_map"; static const struct kernel_symbol __ksymtab_generic_pipe_buf_map __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&generic_pipe_buf_map, __kstrtab_generic_pipe_buf_map };
# 249 "../../fs/pipe.c"
...
extern typeof(generic_pipe_buf_unmap) generic_pipe_buf_unmap; static const char __kstrtab_generic_pipe_buf_unmap[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "generic_pipe_buf_unmap"; static const struct kernel_symbol __ksymtab_generic_pipe_buf_unmap __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&generic_pipe_buf_unmap, __kstrtab_generic_pipe_buf_unmap };
# 272 "../../fs/pipe.c"
...
extern typeof(generic_pipe_buf_steal) generic_pipe_buf_steal; static const char __kstrtab_generic_pipe_buf_steal[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "generic_pipe_buf_steal"; static const struct kernel_symbol __ksymtab_generic_pipe_buf_steal __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&generic_pipe_buf_steal, __kstrtab_generic_pipe_buf_steal };
# 301 "../../fs/pipe.c"
void generic_pipe_buf_get(struct pipe_inode_info *pipe, struct pipe_buffer *buf)
{
 get_page(buf->page);
}
extern typeof(generic_pipe_buf_get) generic_pipe_buf_get; static const char __kstrtab_generic_pipe_buf_get[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "generic_pipe_buf_get"; static const struct kernel_symbol __ksymtab_generic_pipe_buf_get __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&generic_pipe_buf_get, __kstrtab_generic_pipe_buf_get };
# 316 "../../fs/pipe.c"
...
extern typeof(generic_pipe_buf_confirm) generic_pipe_buf_confirm; static const char __kstrtab_generic_pipe_buf_confirm[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "generic_pipe_buf_confirm"; static const struct kernel_symbol __ksymtab_generic_pipe_buf_confirm __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&generic_pipe_buf_confirm, __kstrtab_generic_pipe_buf_confirm };
# 331 "../../fs/pipe.c"
...
extern typeof(generic_pipe_buf_release) generic_pipe_buf_release; static const char __kstrtab_generic_pipe_buf_release[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "generic_pipe_buf_release"; static const struct kernel_symbol __ksymtab_generic_pipe_buf_release __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&generic_pipe_buf_release, __kstrtab_generic_pipe_buf_release };
    ...
    unsigned long nr_segs, loff_t pos)
{
 ...
 if (__builtin_expect(!!(total_len == 0), 0))
  return 0;
...
redo:
  ...
  if (do_wakeup) {
   __wake_up_sync((&pipe->wait), 1, 1);
    kill_fasync(&pipe->fasync_writers, 29, ((2 << 16)|2));
  }
  pipe_wait(pipe);
 }
     ...
     unsigned long nr_segs, loff_t ppos)
{
 ...
 if (!pipe->readers) {
  send_sig(13, (get_current()), 0);
  ret = -32;
  goto out;
 }


 chars = total_len & (((1UL) << 12)-1);
 if (pipe->nrbufs && chars != 0) {
  ...
  if (ops->can_merge && offset + chars <= ((1UL) << 12)) {
   int error, atomic = 1;
   void *addr;
...
redo1:
 ...
 for (;;) {
  ...
  if (bufs < pipe->buffers) {
   ...
   if (!page) {
    page = alloc_pages_node(numa_node_id(), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u) | (( gfp_t)0x20000u) | (( gfp_t)0x02u)), 0);
...
static ssize_t
bad_pipe_w(struct file *filp, const char *buf, size_t count,
    loff_t *ppos)
{
 return -9;
}
...
pipe_poll(struct file *filp, poll_table *wait)
{
 ...
 if (filp->f_mode & (( fmode_t)0x1)) {
  mask = (nrbufs > 0) ? 0x0001 | 0x0040 : 0;
  if (!pipe->writers && filp->f_version != pipe->w_counter)
   mask |= 0x0010;
 }

 if (filp->f_mode & (( fmode_t)0x2)) {
  mask |= (nrbufs < pipe->buffers) ? 0x0004 | 0x0100 : 0;
...
pipe_rdwr_release(struct inode *inode, struct file *filp)
{
 ...
 decr = (filp->f_mode & (( fmode_t)0x1)) != 0;
 decw = (filp->f_mode & (( fmode_t)0x2)) != 0;
...
struct pipe_inode_info * alloc_pipe_info(struct inode *inode)
{
 ...
 pipe = kzalloc(sizeof(struct pipe_inode_info), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (pipe) {
  pipe->bufs = kzalloc(sizeof(struct pipe_buffer) * 16, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
  if (pipe->bufs) {
   do { static struct lock_class_key __key; __init_waitqueue_head((&pipe->wait), &__key); } while (0);
...
static struct inode * get_pipe_inode(void)
{
 ...
 inode->i_state = (1 | 2 | 4);
 inode->i_mode = 0010000 | 00400 | 00200;
 inode->i_uid = (({ (get_current())->cred->fsuid; }));
 inode->i_gid = (({ (get_current())->cred->fsgid; }));
...
struct file *create_write_pipe(int flags)
{
 ...
 err = -23;
 f = alloc_file(&path, (( fmode_t)0x2), &write_pipefifo_fops);
 if (!f)
  goto err_dentry;
 f->f_mapping = inode->i_mapping;

 f->f_flags = 00000001 | (flags & 00004000);
 f->f_version = 0;
...
{
 free_pipe_info(f->f_path.dentry->d_inode);
 path_put(&f->f_path);
 put_filp(f);
}
...
struct file *create_read_pipe(struct file *wrf, int flags)
{
 ...
 struct file *f = alloc_file(&wrf->f_path, (( fmode_t)0x1),
        &read_pipefifo_fops);
 if (!f)
  return ERR_PTR(-23);

 path_get(&wrf->f_path);
 f->f_flags = 00000000 | (flags & 00004000);
...
static long pipe_set_size(struct pipe_inode_info *pipe, unsigned long nr_pages)
{
 ...
 bufs = kcalloc(nr_pages, sizeof(struct pipe_buffer), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (__builtin_expect(!!(!bufs), 0))
  return -12;
...
static inline __attribute__((always_inline)) unsigned int round_pipe_size(unsigned int size)
{
 unsigned long nr_pages;

 nr_pages = (size + ((1UL) << 12) - 1) >> 12;
 return ( __builtin_constant_p(nr_pages) ? ( (nr_pages == 1) ? 1 : (1UL << (( __builtin_constant_p((nr_pages) - 1) ? ( ((nr_pages) - 1) < 1 ? ____ilog2_NaN() : ((nr_pages) - 1) & (1ULL << 63) ? 63 : ((nr_pages) - 1) & (1ULL << 62) ? 62 : ((nr_pages) - 1) & (1ULL << 61) ? 61 : ((nr_pages) - 1) & (1ULL << 60) ? 60 : ((nr_pages) - 1) & (1ULL << 59) ? 59 : ((nr_pages) - 1) & (1ULL << 58) ? 58 : ((nr_pages) - 1) & (1ULL << 57) ? 57 : ((nr_pages) - 1) & (1ULL << 56) ? 56 : ((nr_pages) - 1) & (1ULL << 55) ? 55 : ((nr_pages) - 1) & (1ULL << 54) ? 54 : ((nr_pages) - 1) & (1ULL << 53) ? 53 : ((nr_pages) - 1) & (1ULL << 52) ? 52 : ((nr_pages) - 1) & (1ULL << 51) ? 51 : ((nr_pages) - 1) & (1ULL << 50) ? 50 : ((nr_pages) - 1) & (1ULL << 49) ? 49 : ((nr_pages) - 1) & (1ULL << 48) ? 48 : ((nr_pages) - 1) & (1ULL << 47) ? 47 : ((nr_pages) - 1) & (1ULL << 46) ? 46 : ((nr_pages) - 1) & (1ULL << 45) ? 45 : ((nr_pages) - 1) & (1ULL << 44) ? 44 : ((nr_pages) - 1) & (1ULL << 43) ? 43 : ((nr_pages) - 1) & (1ULL << 42) ? 42 : ((nr_pages) - 1) & (1ULL << 41) ? 41 : ((nr_pages) - 1) & (1ULL << 40) ? 40 : ((nr_pages) - 1) & (1ULL << 39) ? 39 : ((nr_pages) - 1) & (1ULL << 38) ? 38 : ((nr_pages) - 1) & (1ULL << 37) ? 37 : ((nr_pages) - 1) & (1ULL << 36) ? 36 : ((nr_pages) - 1) & (1ULL << 35) ? 35 : ((nr_pages) - 1) & (1ULL << 34) ? 34 : ((nr_pages) - 1) & (1ULL << 33) ? 33 : ((nr_pages) - 1) & (1ULL << 32) ? 32 : ((nr_pages) - 1) & (1ULL << 31) ? 31 : ((nr_pages) - 1) & (1ULL << 30) ? 30 : ((nr_pages) - 1) & (1ULL << 29) ? 29 : ((nr_pages) - 1) & (1ULL << 28) ? 28 : ((nr_pages) - 1) & (1ULL << 27) ? 27 : ((nr_pages) - 1) & (1ULL << 26) ? 26 : ((nr_pages) - 1) & (1ULL << 25) ? 25 : ((nr_pages) - 1) & (1ULL << 24) ? 24 : ((nr_pages) - 1) & (1ULL << 23) ? 23 : ((nr_pages) - 1) & (1ULL << 22) ? 22 : ((nr_pages) - 1) & (1ULL << 21) ? 21 : ((nr_pages) - 1) & (1ULL << 20) ? 20 : ((nr_pages) - 1) & (1ULL << 19) ? 19 : ((nr_pages) - 1) & (1ULL << 18) ? 18 : ((nr_pages) - 1) & (1ULL << 17) ? 17 : ((nr_pages) - 1) & (1ULL << 16) ? 16 : ((nr_pages) - 1) & (1ULL << 15) ? 15 : ((nr_pages) - 1) & (1ULL << 14) ? 14 : ((nr_pages) - 1) & (1ULL << 13) ? 13 : ((nr_pages) - 1) & (1ULL << 12) ? 12 : ((nr_pages) - 1) & (1ULL << 11) ? 11 : ((nr_pages) - 1) & (1ULL << 10) ? 10 : ((nr_pages) - 1) & (1ULL << 9) ? 9 : ((nr_pages) - 1) & (1ULL << 8) ? 8 : ((nr_pages) - 1) & (1ULL << 7) ? 7 : ((nr_pages) - 1) & (1ULL << 6) ? 6 : ((nr_pages) - 1) & (1ULL << 5) ? 5 : ((nr_pages) - 1) & (1ULL << 4) ? 4 : ((nr_pages) - 1) & (1ULL << 3) ? 3 : ((nr_pages) - 1) & (1ULL << 2) ? 2 : ((nr_pages) - 1) & (1ULL << 1) ? 1 : ((nr_pages) - 1) & (1ULL << 0) ? 0 : ____ilog2_NaN() ) : (sizeof((nr_pages) - 1) <= 4) ? __ilog2_u32((nr_pages) - 1) : __ilog2_u64((nr_pages) - 1) ) + 1)) ) : __roundup_pow_of_two(nr_pages) ) << 12;
}
...
int pipe_proc_fn(struct ctl_table *table, int write, void *buf,
   size_t *lenp, loff_t *ppos)
{
 int ret;
...
long pipe_fcntl(struct file *file, unsigned int cmd, unsigned long arg)
{
 ...
 case (1024 + 7): {
  ...
  if (!capable(24) && size > pipe_max_size) {
   ret = -1;
   goto out;
  }
...
static int pipefs_get_sb(struct file_system_type *fs_type,
    ...
    struct vfsmount *mnt)
{
 return get_sb_pseudo(fs_type, "pipe:", ((void *)0), 0x50495045, mnt);
}
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) init_pipe_fs(void)
{
 int err = register_filesystem(&pipe_fs_type);

 if (!err) {
  pipe_mnt = kern_mount_data(&pipe_fs_type, ((void *)0));
  if (IS_ERR(pipe_mnt)) {
...
static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) exit_pipe_fs(void)
{
 unregister_filesystem(&pipe_fs_type);
 mntput(pipe_mnt);
}

static initcall_t __initcall_init_pipe_fs5 __attribute__((__used__)) __attribute__((__section__(".initcall" "5" ".init"))) = init_pipe_fs;
static exitcall_t __exitcall_exit_pipe_fs __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = exit_pipe_fs;;
