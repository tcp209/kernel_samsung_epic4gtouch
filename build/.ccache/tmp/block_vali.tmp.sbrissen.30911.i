# 1 "../../fs/ext4/block_validity.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../fs/ext4/block_validity.c"
# 11 "../../fs/ext4/block_validity.c"
...
int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) init_ext4_system_zone(void)
{
 ext4_system_zone_cachep = kmem_cache_create("ext4_system_zone", sizeof(struct ext4_system_zone), __alignof__(struct ext4_system_zone), (0x00020000UL), ((void *)0));

 if (ext4_system_zone_cachep == ((void *)0))
  return -12;
 return 0;
}
...
static inline __attribute__((always_inline)) int can_merge(struct ext4_system_zone *entry1,
...
static int add_system_zone(struct ext4_sb_info *sbi,
      ...
      unsigned int count)
{
 struct ext4_system_zone *new_entry = ((void *)0), *entry;
 struct rb_node **n = &sbi->system_blks.rb_node, *node;
 struct rb_node *parent = ((void *)0), *new_node = ((void *)0);

 while (*n) {
  parent = *n;
  entry = ({ const typeof( ((struct ext4_system_zone *)0)->node ) *__mptr = (parent); (struct ext4_system_zone *)( (char *)__mptr - __builtin_offsetof(struct ext4_system_zone,node) );});
  if (start_blk < entry->start_blk)
   ...
   if (start_blk + count > (entry->start_blk +
    ...
    entry->count = (start_blk + count -
      entry->start_blk);
   new_node = *n;
   new_entry = ({ const typeof( ((struct ext4_system_zone *)0)->node ) *__mptr = (new_node); (struct ext4_system_zone *)( (char *)__mptr - __builtin_offsetof(struct ext4_system_zone,node) );});
 ...
 if (node) {
  entry = ({ const typeof( ((struct ext4_system_zone *)0)->node ) *__mptr = (node); (struct ext4_system_zone *)( (char *)__mptr - __builtin_offsetof(struct ext4_system_zone,node) );});
...
int ext4_setup_system_zone(struct super_block *sb)
{
 ...
 if (!(EXT4_SB(sb)->s_mount_opt & 0x20000000)) {
...
void ext4_release_system_zone(struct super_block *sb)
{
 ...
 while (n) {
  ...
  parent = ((struct rb_node *)((n)->rb_parent_color & ~3));
  entry = ({ const typeof( ((struct ext4_system_zone *)0)->node ) *__mptr = (n); (struct ext4_system_zone *)( (char *)__mptr - __builtin_offsetof(struct ext4_system_zone,node) );});
  kmem_cache_free(ext4_system_zone_cachep, entry);
  if (!parent)
   EXT4_SB(sb)->system_blks = (struct rb_root) { ((void *)0), };
  else if (parent->rb_left == n)
   parent->rb_left = ((void *)0);
  else if (parent->rb_right == n)
   parent->rb_right = ((void *)0);
  n = parent;
 }
 EXT4_SB(sb)->system_blks = (struct rb_root) { ((void *)0), };
}
     ...
     unsigned int count)
{
 ...
 if ((start_blk <= (( __u32)(__le32)(sbi->s_es->s_first_data_block))) ||
