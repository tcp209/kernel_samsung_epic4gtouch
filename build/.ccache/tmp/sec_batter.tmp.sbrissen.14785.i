...
# 182 "../../drivers/power/sec_battery.c"
enum tmu_status_t {
 TMU_STATUS_NORMAL = 0,
 TMU_STATUS_TRIPPED,
...
# 214 "../../drivers/power/sec_battery.c"
...
# 550 "../../drivers/power/sec_battery.c"
  break;
...
# 731 "../../drivers/power/sec_battery.c"
...
# 1212 "../../drivers/power/sec_battery.c"
...
static bool sec_bat_charging_time_management(struct sec_bat_info *info)
{
 ...
 switch (info->charging_status) {
 case POWER_SUPPLY_STATUS_FULL:
  if ((({ unsigned long __dummy; typeof(info->charging_passed_time) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ({ unsigned long __dummy; typeof((unsigned long)(2 * 60 * 60 * 200)) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ((long)((unsigned long)(2 * 60 * 60 * 200)) - (long)(info->charging_passed_time) < 0)) &&
 ...
 case POWER_SUPPLY_STATUS_CHARGING:
  ...
  } else if ((({ unsigned long __dummy; typeof(info->charging_passed_time) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ({ unsigned long __dummy; typeof(info->charging_next_time) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ((long)(info->charging_next_time) - (long)(info->charging_passed_time) < 0))) {
...
# 1595 "../../drivers/power/sec_battery.c"
...
# 1843 "../../drivers/power/sec_battery.c"
  break;
 case POWER_SUPPLY_STATUS_CHARGING:
  switch (info->batt_health) {
# 1859 "../../drivers/power/sec_battery.c"
...
# 1966 "../../drivers/power/sec_battery.c"
...
# 2006 "../../drivers/power/sec_battery.c"
...
enum {
 ...
 SLATE_TEST_MODE,
# 2054 "../../drivers/power/sec_battery.c"
 BATT_CALL,
 BATT_BROWSER,
 BATT_HOTSOPT,
 BATT_CAMERA,
...
# 2090 "../../drivers/power/sec_battery.c"
         ...
         struct device_attribute *attr, char *buf)
{
 ...
 case SLATE_TEST_MODE:
  ...
  break;
# 2273 "../../drivers/power/sec_battery.c"
 case BATT_CALL:
  i += scnprintf(buf + i, ((1UL) << 12) - i, "%d\n", info->use_call);
  break;
 case BATT_BROWSER:
        ...
        const char *buf, size_t count)
{
 ...
 case SLATE_TEST_MODE:
  ...
  break;
# 2413 "../../drivers/power/sec_battery.c"
 case BATT_CALL:
...
# 2578 "../../drivers/power/sec_battery.c"
