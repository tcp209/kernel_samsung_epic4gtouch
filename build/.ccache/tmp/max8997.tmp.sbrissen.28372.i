# 1 "../../drivers/regulator/max8997.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../drivers/regulator/max8997.c"
# 23 "../../drivers/regulator/max8997.c"
...
# 24 "../../drivers/regulator/max8997.c" 2
...
# 26 "../../drivers/regulator/max8997.c" 2
...
# 27 "../../drivers/regulator/max8997.c" 2
...
# 28 "../../drivers/regulator/max8997.c" 2
...
# 29 "../../drivers/regulator/max8997.c" 2
...
# 30 "../../drivers/regulator/max8997.c" 2
...
# 32 "../../drivers/regulator/max8997.c" 2
...
# 33 "../../drivers/regulator/max8997.c" 2
...
# 34 "../../drivers/regulator/max8997.c" 2
# 1 "../../include/linux/mfd/max8997.h" 1
...
# 20 "../../include/linux/regulator/machine.h" 2
...
# 27 "../../include/linux/mfd/max8997.h" 2
...
# 159 "../../include/linux/mfd/max8997.h"
...
# 35 "../../drivers/regulator/max8997.c" 2
# 1 "../../include/linux/mfd/max8997-private.h" 1
...
# 350 "../../include/linux/mfd/max8997-private.h"
struct max8997_dev {
 struct device *dev;
 ...
 int irq;
 int ono;
 u8 irq_masks_cur[(4 + 3)];
 u8 irq_masks_cache[(4 + 3)];
 int type;
 int wakeup;
};
...
# 36 "../../drivers/regulator/max8997.c" 2
...
static const struct vol_cur_map_desc *ldo_vol_cur_map[] = {
 ...
 &ldos_vol_cur_map_desc,
 &ldos_vol_cur_map_desc,
 &buck1245_vol_cur_map_desc,
 &buck1245_vol_cur_map_desc,
 &buck37_vol_cur_map_desc,
 &buck1245_vol_cur_map_desc,
 &buck1245_vol_cur_map_desc,
 ((void *)0),
 &buck37_vol_cur_map_desc,
 ...
 ((void *)0),
 ((void *)0),
 &flash_vol_cur_map_desc,
 &movie_vol_cur_map_desc,
};

static inline __attribute__((always_inline)) int max8997_get_ldo(struct regulator_dev *rdev)
{
    ...
    unsigned int selector)
{
 ...
 if (ldo >= (sizeof(ldo_vol_cur_map) / sizeof((ldo_vol_cur_map)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(ldo_vol_cur_map), typeof(&ldo_vol_cur_map[0]))); }))))
  return -22;
    ...
    unsigned int selector)
{
 ...
 if (co >= (sizeof(ldo_vol_cur_map) / sizeof((ldo_vol_cur_map)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(ldo_vol_cur_map), typeof(&ldo_vol_cur_map[0]))); }))))
  return -22;
...
# 418 "../../drivers/regulator/max8997.c"
        ...
        int min_uV, int max_uV)
{
 ...
 if (buck >= (sizeof(ldo_vol_cur_map) / sizeof((ldo_vol_cur_map)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(ldo_vol_cur_map), typeof(&ldo_vol_cur_map[0]))); }))))
  return -22;
 ...
 if (previous_vol == max8997_list_voltage(rdev, i)) {
  ({ if (0) printk("<7>" "%s %s: " "No voltage change, old:%d, new:%d\n" , dev_driver_string(max8997->dev) , dev_name(max8997->dev) , previous_vol, max8997_list_voltage(rdev, i)); 0; });
...
# 519 "../../drivers/regulator/max8997.c"
  break;
 ...
 case MAX8997_BUCK2:
  ...
  ret = max8997_write_reg(i2c, reg, i);
# 565 "../../drivers/regulator/max8997.c"
  break;
 ...
 if (ret < 0) {
  printk("<3>" "%s %s: " "Failed to write buck%d voltage				register: %d\n" , dev_driver_string(max8997->dev) , dev_name(max8997->dev) , buck - MAX8997_BUCK1 + 1, ret);
 ...
 if (difference > 0) {
  ...
  (__builtin_constant_p(difference / ramp_mv) ? ((difference / ramp_mv) > (2 * 1000) ? __bad_udelay() : __const_udelay((difference / ramp_mv) * ((2199023U*200)>>11))) : __udelay(difference / ramp_mv));
 }
...
# 1089 "../../drivers/regulator/max8997.c"
  ...
  struct max8997_platform_data *pdata)
{
 ...
 if (ret < 0)
  printk("<3>" "%s %s: " "failed to write RAMP REG(%d)\n" , dev_driver_string(max8997->dev) , dev_name(max8997->dev) , ret);
}

static __attribute__ ((__section__(".devinit.text"))) __attribute__((__cold__)) int max8997_pmic_probe(struct platform_device *pdev)
{
 ...
 if (!pdata) {
  printk("<3>" "%s %s: " "No platform init data supplied\n" , dev_driver_string(pdev->dev.parent) , dev_name(pdev->dev.parent));
  return -19;
 }

 max8997 = kzalloc(sizeof(struct max8997_data), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!max8997)
  return -12;

 size = sizeof(struct regulator_dev *) * pdata->num_regulators;
 max8997->rdev = kzalloc(size, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!max8997->rdev) {
  ret = -12;
  goto err3;
 }
 ...
 dev_set_drvdata(&(pdev)->dev, (max8997));
 i2c = max8997->iodev->i2c;
# 1220 "../../drivers/regulator/max8997.c"
 ...
 if (pdata->flash_cntl_val) {
  ...
  if (ret < 0) {
   printk("<3>" "%s %s: " "flash init failed: %d\n" , dev_driver_string(max8997->dev) , dev_name(max8997->dev) , ret);
   goto err2;
  }
 }
 ...
 for (i = 0; i < pdata->num_regulators; i++) {
  ...
  if (IS_ERR(rdev[i])) {
   ret = PTR_ERR(rdev[i]);
   printk("<3>" "%s %s: " "regulator init failed\n" , dev_driver_string(max8997->dev) , dev_name(max8997->dev));
   rdev[i] = ((void *)0);
   goto err1;
  }
 }
...
static int __attribute__ ((__section__(".devexit.text"))) __attribute__((__used__)) __attribute__((__cold__)) max8997_pmic_remove(struct platform_device *pdev)
{
 struct max8997_data *max8997 = dev_get_drvdata(&(pdev)->dev);
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) max8997_pmic_init(void)
{
 return platform_driver_register(&max8997_pmic_driver);
}
static initcall_t __initcall_max8997_pmic_init4 __attribute__((__used__)) __attribute__((__section__(".initcall" "4" ".init"))) = max8997_pmic_init;

static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) max8997_pmic_cleanup(void)
{
 platform_driver_unregister(&max8997_pmic_driver);
}
static exitcall_t __exitcall_max8997_pmic_cleanup __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = max8997_pmic_cleanup;;
