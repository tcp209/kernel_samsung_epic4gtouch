# 1 "../../drivers/staging/android/lowmemorykiller.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../drivers/staging/android/lowmemorykiller.c"
# 32 "../../drivers/staging/android/lowmemorykiller.c"
...
# 33 "../../drivers/staging/android/lowmemorykiller.c" 2
...
# 35 "../../drivers/staging/android/lowmemorykiller.c" 2
...
# 36 "../../drivers/staging/android/lowmemorykiller.c" 2
...
# 37 "../../drivers/staging/android/lowmemorykiller.c" 2
...
static int lowmem_shrink(struct shrinker *s, int nr_to_scan, gfp_t gfp_mask)
{
 ...
 struct task_struct *selected = ((void *)0);
 int rem = 0;
 int tasksize;
 int i;
 int min_adj = 15 + 1;
 ...
 int array_size = (sizeof(lowmem_adj) / sizeof((lowmem_adj)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(lowmem_adj), typeof(&lowmem_adj[0]))); })));
 int other_free = global_page_state(NR_FREE_PAGES);
 int other_file = global_page_state(NR_FILE_PAGES) -
  global_page_state(NR_SHMEM);
# 104 "../../drivers/staging/android/lowmemorykiller.c"
 if (lowmem_deathpending &&
     (({ unsigned long __dummy; typeof(lowmem_deathpending_timeout) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ({ unsigned long __dummy; typeof(jiffies) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ((long)(lowmem_deathpending_timeout) - (long)(jiffies) >= 0)))
  return 0;
 ...
 if (nr_to_scan > 0)
  do { if (lowmem_debug_level >= (3)) printk("lowmem_shrink %d, %x, ofree %d %d, ma %d\n", nr_to_scan, gfp_mask, other_free, other_file, min_adj); } while (0);
 ...
 if (nr_to_scan <= 0) {
  do { if (lowmem_debug_level >= (5)) printk("lowmem_shrink %d, %x, return %d\n", nr_to_scan, gfp_mask, rem); } while (0);
 ...
 for (p = &init_task ; (p = ({ const typeof( ((struct task_struct *)0)->tasks ) *__mptr = (({ typeof((p)->tasks.next) _________p1 = (*(volatile typeof((p)->tasks.next) *)&((p)->tasks.next)); do { } while(0); (_________p1); })); (struct task_struct *)( (char *)__mptr - __builtin_offsetof(struct task_struct,tasks) );})) != &init_task ; ) {
  ...
  do { if (lowmem_debug_level >= (2)) printk("select %d (%s), adj %d, size %d, to kill\n", p->pid, p->comm, oom_adj, tasksize); } while (0);

 }
 if (selected) {
  do { if (lowmem_debug_level >= (1)) printk("send sigkill to %d (%s), adj %d, size %d\n", selected->pid, selected->comm, selected_oom_adj, selected_tasksize); } while (0);


  lowmem_deathpending = selected;
  lowmem_deathpending_timeout = jiffies + 200;
  force_sig(9, selected);
  rem -= selected_tasksize;
 } else
  rem = -1;
 do { if (lowmem_debug_level >= (4)) printk("lowmem_shrink %d, %x, return %d\n", nr_to_scan, gfp_mask, rem); } while (0);
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) lowmem_init(void)
{
...
static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) lowmem_exit(void)
{
 unregister_shrinker(&lowmem_shrinker);
 task_free_unregister(&task_nb);
}

static inline __attribute__((always_inline)) int *__check_cost(void) { return(&(lowmem_shrinker.seeks)); }; static int __param_perm_check_cost __attribute__((unused)) = (sizeof(struct { int:-!!(((00400|00040|00004) | 00200) < 0 || ((00400|00040|00004) | 00200) > 0777 || (((00400|00040|00004) | 00200) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""lowmemorykiller" ".") > (64 - sizeof(unsigned long))); })); static const char __param_str_cost[] = "lowmemorykiller" "." "cost"; static struct kernel_param const __param_cost __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_cost, (00400|00040|00004) | 00200, __builtin_types_compatible_p(typeof(*(&lowmem_shrinker.seeks)), typeof(bool)) ? 2 : 0, param_set_int, param_get_int, { &lowmem_shrinker.seeks } }; ;
static const struct kparam_array __param_arr_adj = { (sizeof(lowmem_adj) / sizeof((lowmem_adj)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(lowmem_adj), typeof(&lowmem_adj[0]))); }))), &lowmem_adj_size, param_set_int, param_get_int, sizeof(lowmem_adj[0]), lowmem_adj }; static int __param_perm_check_adj __attribute__((unused)) = (sizeof(struct { int:-!!(((00400|00040|00004) | 00200) < 0 || ((00400|00040|00004) | 00200) > 0777 || (((00400|00040|00004) | 00200) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""lowmemorykiller" ".") > (64 - sizeof(unsigned long))); })); static const char __param_str_adj[] = "lowmemorykiller" "." "adj"; static struct kernel_param const __param_adj __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_adj, (00400|00040|00004) | 00200, __builtin_types_compatible_p(typeof(lowmem_adj[0]), typeof(bool)) ? 2 : 0, param_array_set, param_array_get, { .arr = &__param_arr_adj } }; ;

static const struct kparam_array __param_arr_minfree = { (sizeof(lowmem_minfree) / sizeof((lowmem_minfree)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(lowmem_minfree), typeof(&lowmem_minfree[0]))); }))), &lowmem_minfree_size, param_set_uint, param_get_uint, sizeof(lowmem_minfree[0]), lowmem_minfree }; static int __param_perm_check_minfree __attribute__((unused)) = (sizeof(struct { int:-!!(((00400|00040|00004) | 00200) < 0 || ((00400|00040|00004) | 00200) > 0777 || (((00400|00040|00004) | 00200) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""lowmemorykiller" ".") > (64 - sizeof(unsigned long))); })); static const char __param_str_minfree[] = "lowmemorykiller" "." "minfree"; static struct kernel_param const __param_minfree __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_minfree, (00400|00040|00004) | 00200, __builtin_types_compatible_p(typeof(lowmem_minfree[0]), typeof(bool)) ? 2 : 0, param_array_set, param_array_get, { .arr = &__param_arr_minfree } }; ;

static inline __attribute__((always_inline)) unsigned int *__check_debug_level(void) { return(&(lowmem_debug_level)); }; static int __param_perm_check_debug_level __attribute__((unused)) = (sizeof(struct { int:-!!(((00400|00040|00004) | 00200) < 0 || ((00400|00040|00004) | 00200) > 0777 || (((00400|00040|00004) | 00200) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""lowmemorykiller" ".") > (64 - sizeof(unsigned long))); })); static const char __param_str_debug_level[] = "lowmemorykiller" "." "debug_level"; static struct kernel_param const __param_debug_level __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_debug_level, (00400|00040|00004) | 00200, __builtin_types_compatible_p(typeof(*(&lowmem_debug_level)), typeof(bool)) ? 2 : 0, param_set_uint, param_get_uint, { &lowmem_debug_level } }; ;

static initcall_t __initcall_lowmem_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = lowmem_init;;
static exitcall_t __exitcall_lowmem_exit __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = lowmem_exit;;
