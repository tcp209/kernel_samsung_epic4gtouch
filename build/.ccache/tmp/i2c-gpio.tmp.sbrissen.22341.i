...
# 1 "<command-line>" 2
# 1 "../../drivers/i2c/busses/i2c-gpio.c"
# 10 "../../drivers/i2c/busses/i2c-gpio.c"
...
# 11 "../../drivers/i2c/busses/i2c-gpio.c" 2
...
# 12 "../../drivers/i2c/busses/i2c-gpio.c" 2
# 1 "../../include/linux/i2c-gpio.h" 1
...
# 13 "../../drivers/i2c/busses/i2c-gpio.c" 2
...
# 16 "../../drivers/i2c/busses/i2c-gpio.c" 2
...
# 17 "../../drivers/i2c/busses/i2c-gpio.c" 2
...
# 19 "../../drivers/i2c/busses/i2c-gpio.c" 2
...
static int __attribute__ ((__section__(".devinit.text"))) __attribute__((__cold__)) i2c_gpio_probe(struct platform_device *pdev)
{
 ...
 ret = -12;
 adap = kzalloc(sizeof(struct i2c_adapter), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!adap)
  goto err_alloc_adap;
 bit_data = kzalloc(sizeof(struct i2c_algo_bit_data), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!bit_data)
 ...
 dev_set_drvdata(&(pdev)->dev, (adap));

 printk("<6>" "%s %s: " "using pins %u (SDA) and %u (SCL%s)\n" , dev_driver_string(&pdev->dev) , dev_name(&pdev->dev) , pdata->sda_pin, pdata->scl_pin, pdata->scl_is_output_only ? ", no clock stretching" : "");
...
static int __attribute__ ((__section__(".devexit.text"))) __attribute__((__used__)) __attribute__((__cold__)) i2c_gpio_remove(struct platform_device *pdev)
{
 struct i2c_gpio_platform_data *pdata;
 struct i2c_adapter *adap;

 adap = dev_get_drvdata(&(pdev)->dev);
 pdata = pdev->dev.platform_data;
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) i2c_gpio_init(void)
{
 int ret;

 ret = platform_driver_register(&i2c_gpio_driver);
 if (ret)
  printk("<3>" "i2c-gpio: probe failed: %d\n", ret);

 return ret;
}
static initcall_t __initcall_i2c_gpio_init4 __attribute__((__used__)) __attribute__((__section__(".initcall" "4" ".init"))) = i2c_gpio_init;

static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) i2c_gpio_exit(void)
{
 platform_driver_unregister(&i2c_gpio_driver);
}
static exitcall_t __exitcall_i2c_gpio_exit __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = i2c_gpio_exit;;
