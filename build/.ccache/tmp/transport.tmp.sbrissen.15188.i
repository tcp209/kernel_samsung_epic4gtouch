...
# 1 "<command-line>" 2
# 1 "../../drivers/usb/storage/transport.c"
# 46 "../../drivers/usb/storage/transport.c"
...
# 47 "../../drivers/usb/storage/transport.c" 2
...
# 48 "../../drivers/usb/storage/transport.c" 2


# 1 "../../include/linux/usb/quirks.h" 1
# 51 "../../drivers/usb/storage/transport.c" 2
...
# 53 "../../drivers/usb/storage/transport.c" 2
...
# 54 "../../drivers/usb/storage/transport.c" 2
...
# 55 "../../drivers/usb/storage/transport.c" 2
...
# 57 "../../drivers/usb/storage/transport.c" 2
...
# 58 "../../drivers/usb/storage/transport.c" 2
...
# 59 "../../drivers/usb/storage/transport.c" 2
...
# 60 "../../drivers/usb/storage/transport.c" 2
# 1 "../../drivers/usb/storage/debug.h" 1
# 61 "../../drivers/usb/storage/transport.c" 2


# 1 "../../drivers/usb/storage/../../scsi/sd.h" 1
# 40 "../../drivers/usb/storage/../../scsi/sd.h"
enum {
 SD_EXT_CDB_SIZE = 32,
 SD_MEMPOOL_SIZE = 2,
};
...
# 93 "../../drivers/usb/storage/../../scsi/sd.h"
...
# 117 "../../drivers/usb/storage/../../scsi/sd.h"
...
# 64 "../../drivers/usb/storage/transport.c" 2

# 1 "../../include/linux/usb/storage.h" 1
# 66 "../../drivers/usb/storage/transport.c" 2
# 116 "../../drivers/usb/storage/transport.c"
...
static int usb_stor_msg_common(struct us_data *us, int timeout)
{
 ...
 if (us->current_urb->transfer_buffer == us->iobuf)
  us->current_urb->transfer_flags |= 0x0004;
 us->current_urb->transfer_dma = us->iobuf_dma;


 status = usb_submit_urb(us->current_urb, ((( gfp_t)0x10u)));
 if (status) {
 ...
 _set_bit_le(0,&us->dflags);


 if (test_bit(2, &us->dflags)) {


  if (_test_and_clear_bit_le(0,&us->dflags)) {
   ;
 ...
 timeleft = wait_for_completion_interruptible_timeout(
   &urb_done, timeout ? : ((long)(~0UL>>1)));

 _clear_bit_le(0,&us->dflags);
   ...
   void *data, u16 size, int timeout)
{
 ...
 us->cr->wValue = (( __le16)(__u16)(value));
 us->cr->wIndex = (( __le16)(__u16)(index));
 us->cr->wLength = (( __le16)(__u16)(size));
...
extern typeof(usb_stor_control_msg) usb_stor_control_msg; static const char __kstrtab_usb_stor_control_msg[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_control_msg"; static const struct kernel_symbol __ksymtab_usb_stor_control_msg __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_control_msg, __kstrtab_usb_stor_control_msg };
# 237 "../../drivers/usb/storage/transport.c"
int usb_stor_clear_halt(struct us_data *us, unsigned int pipe)
{
 int result;
 int endp = (((pipe) >> 15) & 0xf);
...
extern typeof(usb_stor_clear_halt) usb_stor_clear_halt; static const char __kstrtab_usb_stor_clear_halt[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_clear_halt"; static const struct kernel_symbol __ksymtab_usb_stor_clear_halt __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_clear_halt, __kstrtab_usb_stor_clear_halt };
# 266 "../../drivers/usb/storage/transport.c"
...
extern typeof(usb_stor_ctrl_transfer) usb_stor_ctrl_transfer; static const char __kstrtab_usb_stor_ctrl_transfer[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_ctrl_transfer"; static const struct kernel_symbol __ksymtab_usb_stor_ctrl_transfer __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_ctrl_transfer, __kstrtab_usb_stor_ctrl_transfer };
# 364 "../../drivers/usb/storage/transport.c"
      ...
      unsigned int length)
{
 ...
 maxp = usb_maxpacket(us->pusb_dev, pipe, (!((pipe) & 0x80)));
 if (maxp > length)
  maxp = length;
...
extern typeof(usb_stor_bulk_transfer_buf) usb_stor_bulk_transfer_buf; static const char __kstrtab_usb_stor_bulk_transfer_buf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_bulk_transfer_buf"; static const struct kernel_symbol __ksymtab_usb_stor_bulk_transfer_buf __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_bulk_transfer_buf, __kstrtab_usb_stor_bulk_transfer_buf };
  ...
  unsigned int *act_len)
{
 ...
 _set_bit_le(1,&us->dflags);


 if (test_bit(2, &us->dflags)) {


  if (_test_and_clear_bit_le(1,&us->dflags)) {
   ;
...
extern typeof(usb_stor_bulk_srb) usb_stor_bulk_srb; static const char __kstrtab_usb_stor_bulk_srb[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_bulk_srb"; static const struct kernel_symbol __ksymtab_usb_stor_bulk_srb __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_bulk_srb, __kstrtab_usb_stor_bulk_srb };
# 490 "../../drivers/usb/storage/transport.c"
...
extern typeof(usb_stor_bulk_transfer_sg) usb_stor_bulk_transfer_sg; static const char __kstrtab_usb_stor_bulk_transfer_sg[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_bulk_transfer_sg"; static const struct kernel_symbol __ksymtab_usb_stor_bulk_transfer_sg __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_bulk_transfer_sg, __kstrtab_usb_stor_bulk_transfer_sg };
# 525 "../../drivers/usb/storage/transport.c"
static void last_sector_hacks(struct us_data *us, struct scsi_cmnd *srb)
{
 ...
 if (srb->cmnd[0] != 0x28 && srb->cmnd[0] != 0x2a)
  goto done;
 ...
 if (srb->result == 0x00 && scsi_get_resid(srb) == 0) {
...
# 579 "../../drivers/usb/storage/transport.c"
...
void usb_stor_invoke_transport(struct scsi_cmnd *srb, struct us_data *us)
{
 ...
 if ((us->protocol == 0x01 || us->protocol == 0xf0) &&
 ...
 if (__builtin_expect(!!((srb->cmnd[0] == 0x85 || srb->cmnd[0] == 0xa1) && result == 0 && !(us->fflags & US_FL_SANE_SENSE) && !(us->fflags & US_FL_BAD_SENSE) && !(srb->cmnd[2] & 0x20)), 0)) {
...
Retry_Sense:
  ...
  if (us->subclass == 0x01 || us->subclass == 0x06 ||
    us->subclass == 0xf1)
   srb->cmd_len = 6;
  else
   srb->cmd_len = 12;
  ...
  if (srb->sense_buffer[7] > (18 - 8) &&
   ...
   srb->sense_buffer[7] = (18 - 8);
  }

  ;
  ;
# 793 "../../drivers/usb/storage/transport.c"
  srb->result = 0x02;
  ...
  if (
   ...
   if (result == 0) {
    ...
    srb->result = 0x07 << 16;
    srb->sense_buffer[2] = 0x04;
   }
  }
 }
# 854 "../../drivers/usb/storage/transport.c"
 if ((srb->result == 0x00 || srb->sense_buffer[2] == 0) &&
 ...
 spin_lock_irq(us_to_host(us)->host_lock);
 _set_bit_le(4,&us->dflags);
 _clear_bit_le(2,&us->dflags);
 spin_unlock_irq(us_to_host(us)->host_lock);
...
int usb_stor_CB_transport(struct scsi_cmnd *srb, struct us_data *us)
{
 ...
 if (result != 0)
  return 3;
# 976 "../../drivers/usb/storage/transport.c"
 if (us->subclass == 0x04) {
  if (srb->cmnd[0] == 0x03 ||
      srb->cmnd[0] == 0x12)
   return 0;
...
extern typeof(usb_stor_CB_transport) usb_stor_CB_transport; static const char __kstrtab_usb_stor_CB_transport[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_CB_transport"; static const struct kernel_symbol __ksymtab_usb_stor_CB_transport __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_CB_transport, __kstrtab_usb_stor_CB_transport };
...
int usb_stor_Bulk_max_lun(struct us_data *us)
{
 ...
 if (result > 0)
  return us->iobuf[0];
# 1048 "../../drivers/usb/storage/transport.c"
 return 0;
}
...
int usb_stor_Bulk_transport(struct scsi_cmnd *srb, struct us_data *us)
{
 ...
 int fake_sense = 0;
 unsigned int cswlen;
 unsigned int cbwlen = 31;


 if (__builtin_expect(!!(us->fflags & US_FL_BULK32), 0)) {
  cbwlen = 32;
  us->iobuf[31] = 0;
 }


 bcb->Signature = (( __le32)(__u32)(0x43425355));
 bcb->DataTransferLength = (( __le32)(__u32)(transfer_length));
 ...
 ({ void *__p = (bcb->CDB); size_t __n = sizeof(bcb->CDB); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
 ...
 if (__builtin_expect(!!(us->fflags & US_FL_GO_SLOW), 0))
  (__builtin_constant_p(125) ? ((125) > (2 * 1000) ? __bad_udelay() : __const_udelay((125) * ((2199023U*200)>>11))) : __udelay(125));
 ...
 residue = (( __u32)(__le32)(bcs->Residue));
 ;
 ...
 if (!us->bcs_signature) {
  ...
  if (us->bcs_signature != (( __le32)(__u32)(0x53425355)))
   ;
 ...
 if (residue && !(us->fflags & US_FL_IGNORE_RESIDUE)) {
  ...
  if (bcs->Status == 0 &&
   ...
   residue = ({ typeof(residue) _min1 = (residue); typeof(transfer_length) _min2 = (transfer_length); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });
   scsi_set_resid(srb, ({ typeof(scsi_get_resid(srb)) _max1 = (scsi_get_resid(srb)); typeof((int) residue) _max2 = ((int) residue); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; }));
...
extern typeof(usb_stor_Bulk_transport) usb_stor_Bulk_transport; static const char __kstrtab_usb_stor_Bulk_transport[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_Bulk_transport"; static const struct kernel_symbol __ksymtab_usb_stor_Bulk_transport __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_Bulk_transport, __kstrtab_usb_stor_Bulk_transport };
# 1246 "../../drivers/usb/storage/transport.c"
  ...
  u16 value, u16 index, void *data, u16 size)
{
 ...
 ({ long __ret = 200*6; if (!(test_bit(3, &us->dflags))) do { wait_queue_t __wait = { .private = (get_current()), .func = autoremove_wake_function, .task_list = { &((__wait).task_list), &((__wait).task_list) }, }; for (;;) { prepare_to_wait(&us->delay_wait, &__wait, 1); if (test_bit(3, &us->dflags)) break; if (!signal_pending((get_current()))) { __ret = schedule_timeout(__ret); if (!__ret) break; continue; } __ret = -512; break; } finish_wait(&us->delay_wait, &__wait); } while (0); __ret; });
...
int usb_stor_CB_reset(struct us_data *us)
{
 ...
 ({ void *__p = (us->iobuf); size_t __n = 12; if ((__n) != 0) { if (__builtin_constant_p((0xFF)) && (0xFF) == 0) __memzero((__p),(__n)); else memset((__p),(0xFF),(__n)); } (__p); });
 us->iobuf[0] = 0x1d;
 us->iobuf[1] = 4;
 return usb_stor_reset_common(us, 0,
     (0x01 << 5) | 0x01,
     0, us->ifnum, us->iobuf, 12);
}
extern typeof(usb_stor_CB_reset) usb_stor_CB_reset; static const char __kstrtab_usb_stor_CB_reset[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_CB_reset"; static const struct kernel_symbol __ksymtab_usb_stor_CB_reset __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_CB_reset, __kstrtab_usb_stor_CB_reset };
...
int usb_stor_Bulk_reset(struct us_data *us)
{
 ...
 return usb_stor_reset_common(us, 0xff,
     (0x01 << 5) | 0x01,
     0, us->ifnum, ((void *)0), 0);
}
extern typeof(usb_stor_Bulk_reset) usb_stor_Bulk_reset; static const char __kstrtab_usb_stor_Bulk_reset[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_Bulk_reset"; static const struct kernel_symbol __ksymtab_usb_stor_Bulk_reset __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_Bulk_reset, __kstrtab_usb_stor_Bulk_reset };
...
int usb_stor_port_reset(struct us_data *us)
{
 ...
 if (us->pusb_dev->quirks & 0x00000010)
  return -1;
