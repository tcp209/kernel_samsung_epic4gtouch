...
# 17 "../../arch/arm/include/asm/uaccess.h"
...
# 210 "../../arch/arm/include/asm/page.h"
...
struct signalfd_siginfo {
 ...
 __u64 ssi_stime;
 __u64 ssi_addr;
# 46 "../../include/linux/signalfd.h"
 __u8 __pad[48];
};
# 57 "../../include/linux/signalfd.h"
...
static unsigned int signalfd_poll(struct file *file, poll_table *wait)
{
 ...
 poll_wait(file, &(get_current())->sighand->signalfd_wqh, wait);

 spin_lock_irq(&(get_current())->sighand->siglock);
 if (next_signal(&(get_current())->pending, &ctx->sigmask) ||
     next_signal(&(get_current())->signal->shared_pending,
   &ctx->sigmask))
  events |= 0x0001;
...
static int signalfd_copyinfo(struct signalfd_siginfo *uinfo,
        siginfo_t const *kinfo)
{
 long err;

 ((void)(sizeof(struct { int:-!!(sizeof(struct signalfd_siginfo) != 128); })));
 ...
 err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_signo)); __typeof__(*((&uinfo->ssi_signo))) __pu_val = ((kinfo->si_signo)); (void)0; switch (sizeof(*((&uinfo->ssi_signo)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
 err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_errno)); __typeof__(*((&uinfo->ssi_errno))) __pu_val = ((kinfo->si_errno)); (void)0; switch (sizeof(*((&uinfo->ssi_errno)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
 err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_code)); __typeof__(*((&uinfo->ssi_code))) __pu_val = (((short) kinfo->si_code)); (void)0; switch (sizeof(*((&uinfo->ssi_code)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
 switch (kinfo->si_code & 0xffff0000u) {
 case (0 << 16):
  err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_pid)); __typeof__(*((&uinfo->ssi_pid))) __pu_val = ((kinfo->_sifields._kill._pid)); (void)0; switch (sizeof(*((&uinfo->ssi_pid)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
  err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_uid)); __typeof__(*((&uinfo->ssi_uid))) __pu_val = ((kinfo->_sifields._kill._uid)); (void)0; switch (sizeof(*((&uinfo->ssi_uid)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
  break;
 case (1 << 16):
   err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_tid)); __typeof__(*((&uinfo->ssi_tid))) __pu_val = ((kinfo->_sifields._timer._tid)); (void)0; switch (sizeof(*((&uinfo->ssi_tid)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
   err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_overrun)); __typeof__(*((&uinfo->ssi_overrun))) __pu_val = ((kinfo->_sifields._timer._overrun)); (void)0; switch (sizeof(*((&uinfo->ssi_overrun)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
   err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_ptr)); __typeof__(*((&uinfo->ssi_ptr))) __pu_val = (((long) kinfo->_sifields._rt._sigval.sival_ptr)); (void)0; switch (sizeof(*((&uinfo->ssi_ptr)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
   err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_int)); __typeof__(*((&uinfo->ssi_int))) __pu_val = ((kinfo->_sifields._rt._sigval.sival_int)); (void)0; switch (sizeof(*((&uinfo->ssi_int)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
  break;
 case (2 << 16):
  err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_band)); __typeof__(*((&uinfo->ssi_band))) __pu_val = ((kinfo->_sifields._sigpoll._band)); (void)0; switch (sizeof(*((&uinfo->ssi_band)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
  err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_fd)); __typeof__(*((&uinfo->ssi_fd))) __pu_val = ((kinfo->_sifields._sigpoll._fd)); (void)0; switch (sizeof(*((&uinfo->ssi_fd)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
  break;
 case (3 << 16):
  err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_addr)); __typeof__(*((&uinfo->ssi_addr))) __pu_val = (((long) kinfo->_sifields._sigfault._addr)); (void)0; switch (sizeof(*((&uinfo->ssi_addr)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
 ...
 case (4 << 16):
  err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_pid)); __typeof__(*((&uinfo->ssi_pid))) __pu_val = ((kinfo->_sifields._kill._pid)); (void)0; switch (sizeof(*((&uinfo->ssi_pid)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
  err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_uid)); __typeof__(*((&uinfo->ssi_uid))) __pu_val = ((kinfo->_sifields._kill._uid)); (void)0; switch (sizeof(*((&uinfo->ssi_uid)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
  err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_status)); __typeof__(*((&uinfo->ssi_status))) __pu_val = ((kinfo->_sifields._sigchld._status)); (void)0; switch (sizeof(*((&uinfo->ssi_status)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
  err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_utime)); __typeof__(*((&uinfo->ssi_utime))) __pu_val = ((kinfo->_sifields._sigchld._utime)); (void)0; switch (sizeof(*((&uinfo->ssi_utime)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
  err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_stime)); __typeof__(*((&uinfo->ssi_stime))) __pu_val = ((kinfo->_sifields._sigchld._stime)); (void)0; switch (sizeof(*((&uinfo->ssi_stime)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
  break;
 case (5 << 16):
 case (6 << 16):
  err |= ({ long __pu_err = 0; do { unsigned long __pu_addr = (unsigned long)((&uinfo->ssi_pid)); __typeof__(*((&uinfo->ssi_pid))) __pu_val = ((kinfo->_sifields._kill._pid)); (void)0; switch (sizeof(*((&uinfo->ssi_pid)))) { case 1: __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 2: ({ unsigned long __temp = (unsigned long)(__pu_val); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp), "r" (__pu_addr), "i" (-14) : "cc"); __asm__ __volatile__( "1:	strbt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__temp >> 8), "r" (__pu_addr + 1), "i" (-14) : "cc"); }); break; case 4: __asm__ __volatile__( "1:	strt	%1,[%2]\n" "2:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "3:	mov	%0, %3\n" "	b	2b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 3b\n" "	.popsection" : "+r" (__pu_err) : "r" (__pu_val), "r" (__pu_addr), "i" (-14) : "cc"); break; case 8: __asm__ __volatile__( "1:	strt	" "%Q2" ", [%1], #4\n" "2:	strt	" "%R2" ", [%1]\n" "3:\n" "	.pushsection .fixup,\"ax\"\n" "	.align	2\n" "4:	mov	%0, %3\n" "	b	3b\n" "	.popsection\n" "	.pushsection __ex_table,\"a\"\n" "	.align	3\n" "	.long	1b, 4b\n" "	.long	2b, 4b\n" "	.popsection" : "+r" (__pu_err), "+r" (__pu_addr) : "r" (__pu_val), "i" (-14) : "cc"); break; default: __put_user_bad(); } } while (0); __pu_err; });
    ...
    int nonblock)
{
 ...
 spin_lock_irq(&(get_current())->sighand->siglock);
 ret = dequeue_signal((get_current()), &ctx->sigmask, info);
 switch (ret) {
 case 0:
  if (!nonblock)
   break;
 ...
 add_wait_queue(&(get_current())->sighand->signalfd_wqh, &wait);
 for (;;) {
 ...
 remove_wait_queue(&(get_current())->sighand->signalfd_wqh, &wait);
        ...
        loff_t *ppos)
{
 ...
 int nonblock = file->f_flags & 00004000;
 ssize_t ret, total = 0;
 siginfo_t info;
 ...
 siginfo = (struct signalfd_siginfo *) buf;
 do {
...

{
 ...
 if (sizemask != sizeof(sigset_t) ||
  ...
  return -22;
 sigdelsetmask(&sigmask, (1UL << ((9) - 1)) | (1UL << ((19) - 1)));
 signotset(&sigmask);

 if (ufd == -1) {
  ctx = kmalloc(sizeof(*ctx), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
  if (!ctx)
   return -12;
  ...
  ufd = anon_inode_getfd("[signalfd]", &signalfd_fops, ctx,
           00000002 | (flags & (02000000 | 00004000)));
  if (ufd < 0)
   kfree(ctx);
 } else {
  ...
  __wake_up(&(get_current())->sighand->signalfd_wqh, (1 | 2), 1, ((void *)0));
  fput(file);
 }
