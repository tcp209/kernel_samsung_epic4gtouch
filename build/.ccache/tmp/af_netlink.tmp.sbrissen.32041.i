...
# 37 "../../net/netlink/af_netlink.c" 2
# 1 "../../include/linux/termios.h" 1




# 1 "../../arch/arm/include/asm/termios.h" 1



# 1 "../../arch/arm/include/asm/termbits.h" 1
...
# 5 "../../arch/arm/include/asm/termios.h" 2
# 1 "../../arch/arm/include/asm/ioctls.h" 1
...
# 5 "../../arch/arm/include/asm/ioctls.h" 2
# 6 "../../arch/arm/include/asm/termios.h" 2
          ...
          struct scm_cookie *scm)
{
 ...
 scm->creds.uid = (({ (get_current())->cred->uid; }));
 scm->creds.gid = (({ (get_current())->cred->gid; }));
...
static wait_queue_head_t nl_table_wait = { .lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } }, .task_list = { &(nl_table_wait).task_list, &(nl_table_wait).task_list } };

static int netlink_dump(struct sock *sk);
static void netlink_destroy_callback(struct netlink_callback *cb);

static rwlock_t nl_table_lock = (rwlock_t) { .raw_lock = { 0 }, };
static atomic_t nl_table_users = { (0) };

static struct atomic_notifier_head netlink_chain = { .lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } }, .head = ((void *)0) };
...
static void netlink_sock_destruct(struct sock *sk)
{
 ...
 ({ int __ret_warn_on = !!((*(volatile int *)&(&sk->sk_rmem_alloc)->counter)); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../net/netlink/af_netlink.c", 169); __builtin_expect(!!(__ret_warn_on), 0); });
 ({ int __ret_warn_on = !!((*(volatile int *)&(&sk->sk_wmem_alloc)->counter)); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../net/netlink/af_netlink.c", 170); __builtin_expect(!!(__ret_warn_on), 0); });
 ({ int __ret_warn_on = !!(nlk_sk(sk)->groups); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../net/netlink/af_netlink.c", 171); __builtin_expect(!!(__ret_warn_on), 0); });
}
...

{
 ...
 _raw_write_lock_irq(&nl_table_lock);

 if ((*(volatile int *)&(&nl_table_users)->counter)) {
  ...
  for (;;) {
   ...
   if ((*(volatile int *)&(&nl_table_users)->counter) == 0)
    break;
   _raw_write_unlock_irq(&nl_table_lock);
   schedule();
   _raw_write_lock_irq(&nl_table_lock);
  }
...
{
 _raw_write_unlock_irq(&nl_table_lock);
 __wake_up(&nl_table_wait, (1 | 2), 1, ((void *)0));
}
...
netlink_lock_table(void)
{
 ...
 _raw_read_lock(&nl_table_lock);
 atomic_add(1, &nl_table_users);
 _raw_read_unlock(&nl_table_lock);
}

static inline __attribute__((always_inline)) void
netlink_unlock_table(void)
{
 if ((atomic_sub_return(1, &nl_table_users) == 0))
  __wake_up(&nl_table_wait, (1 | 2), 1, ((void *)0));
}
...
static int nl_pid_hash_rehash(struct nl_pid_hash *hash, int grow)
{
 ...
 hash->rehash_time = jiffies + 10 * 60 * 200;
 return 1;
}
...
static inline __attribute__((always_inline)) int nl_pid_hash_dilute(struct nl_pid_hash *hash, int len)
{
 ...
 if (__builtin_expect(!!(len > avg), 0) && (({ unsigned long __dummy; typeof(jiffies) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ({ unsigned long __dummy; typeof(hash->rehash_time) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ((long)(hash->rehash_time) - (long)(jiffies) < 0))) {
       ...
       struct mutex *cb_mutex, int protocol)
{
 ...
 sk = sk_alloc(net, 16, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)), &netlink_proto);
 if (!sk)
  return -12;
 ...
 if (cb_mutex)
  ...
  do { static struct lock_class_key __key; __mutex_init((nlk->cb_mutex), "nlk->cb_mutex", &__key); } while (0);
 }
 do { static struct lock_class_key __key; __init_waitqueue_head((&nlk->wait), &__key); } while (0);
     ...
     int kern)
{
 ...
 if (!nl_table[protocol].registered) {
  ...
  __request_module(true, "net-pf-%d-proto-%d", 16, protocol);
  netlink_lock_table();
 }
...
static int netlink_release(struct socket *sock)
{
 ...
 if (netlink_is_kernel(sk)) {
  do { if (__builtin_expect(!!(nl_table[sk->sk_protocol].registered == 0), 0)) do { *(int *)0 = 0; } while (1); } while(0);
...
static int netlink_autobind(struct socket *sock)
{
 ...
 struct sock *osk;
 struct hlist_node *node;
 s32 pid = task_tgid_vnr((get_current()));
 int err;
 static s32 rover = -4097;

retry:
 ({ __might_sleep("../../net/netlink/af_netlink.c", 553, 0); _cond_resched(); });
 netlink_table_grab();
 head = nl_pid_hashfn(hash, pid);
 for (node = (head)->first; node && ({ prefetch(node->next); 1;}) && ({ osk = ({ const typeof( ((typeof(*osk) *)0)->__sk_common.skc_node ) *__mptr = (node); (typeof(*osk) *)( (char *)__mptr - __builtin_offsetof(typeof(*osk),__sk_common.skc_node) );}); 1;}); node = node->next) {
...
static int netlink_realloc_groups(struct sock *sk)
{
 ...
 ({ void *__p = ((char *)new_groups + (((((nlk->ngroups)) + ((typeof((nlk->ngroups)))((sizeof(unsigned long) * 8)) - 1)) & ~((typeof((nlk->ngroups)))((sizeof(unsigned long) * 8)) - 1)) / 8)); size_t __n = (((((groups)) + ((typeof((groups)))((sizeof(unsigned long) * 8)) - 1)) & ~((typeof((groups)))((sizeof(unsigned long) * 8)) - 1)) / 8) - (((((nlk->ngroups)) + ((typeof((nlk->ngroups)))((sizeof(unsigned long) * 8)) - 1)) & ~((typeof((nlk->ngroups)))((sizeof(unsigned long) * 8)) - 1)) / 8); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
   ...
   int addr_len)
{
 ...
 netlink_update_subscriptions(sk, nlk->subscriptions +
      (__builtin_constant_p(nladdr->nl_groups) ? ((( (!!((nladdr->nl_groups) & (1ULL << 0))) + (!!((nladdr->nl_groups) & (1ULL << 1))) + (!!((nladdr->nl_groups) & (1ULL << 2))) + (!!((nladdr->nl_groups) & (1ULL << 3))) + (!!((nladdr->nl_groups) & (1ULL << 4))) + (!!((nladdr->nl_groups) & (1ULL << 5))) + (!!((nladdr->nl_groups) & (1ULL << 6))) + (!!((nladdr->nl_groups) & (1ULL << 7))) ) + ( (!!(((nladdr->nl_groups) >> 8) & (1ULL << 0))) + (!!(((nladdr->nl_groups) >> 8) & (1ULL << 1))) + (!!(((nladdr->nl_groups) >> 8) & (1ULL << 2))) + (!!(((nladdr->nl_groups) >> 8) & (1ULL << 3))) + (!!(((nladdr->nl_groups) >> 8) & (1ULL << 4))) + (!!(((nladdr->nl_groups) >> 8) & (1ULL << 5))) + (!!(((nladdr->nl_groups) >> 8) & (1ULL << 6))) + (!!(((nladdr->nl_groups) >> 8) & (1ULL << 7))) )) + (( (!!(((nladdr->nl_groups) >> 16) & (1ULL << 0))) + (!!(((nladdr->nl_groups) >> 16) & (1ULL << 1))) + (!!(((nladdr->nl_groups) >> 16) & (1ULL << 2))) + (!!(((nladdr->nl_groups) >> 16) & (1ULL << 3))) + (!!(((nladdr->nl_groups) >> 16) & (1ULL << 4))) + (!!(((nladdr->nl_groups) >> 16) & (1ULL << 5))) + (!!(((nladdr->nl_groups) >> 16) & (1ULL << 6))) + (!!(((nladdr->nl_groups) >> 16) & (1ULL << 7))) ) + ( (!!((((nladdr->nl_groups) >> 16) >> 8) & (1ULL << 0))) + (!!((((nladdr->nl_groups) >> 16) >> 8) & (1ULL << 1))) + (!!((((nladdr->nl_groups) >> 16) >> 8) & (1ULL << 2))) + (!!((((nladdr->nl_groups) >> 16) >> 8) & (1ULL << 3))) + (!!((((nladdr->nl_groups) >> 16) >> 8) & (1ULL << 4))) + (!!((((nladdr->nl_groups) >> 16) >> 8) & (1ULL << 5))) + (!!((((nladdr->nl_groups) >> 16) >> 8) & (1ULL << 6))) + (!!((((nladdr->nl_groups) >> 16) >> 8) & (1ULL << 7))) ))) : __arch_hweight32(nladdr->nl_groups)) -
      (__builtin_constant_p(nlk->groups[0]) ? ((( (!!((nlk->groups[0]) & (1ULL << 0))) + (!!((nlk->groups[0]) & (1ULL << 1))) + (!!((nlk->groups[0]) & (1ULL << 2))) + (!!((nlk->groups[0]) & (1ULL << 3))) + (!!((nlk->groups[0]) & (1ULL << 4))) + (!!((nlk->groups[0]) & (1ULL << 5))) + (!!((nlk->groups[0]) & (1ULL << 6))) + (!!((nlk->groups[0]) & (1ULL << 7))) ) + ( (!!(((nlk->groups[0]) >> 8) & (1ULL << 0))) + (!!(((nlk->groups[0]) >> 8) & (1ULL << 1))) + (!!(((nlk->groups[0]) >> 8) & (1ULL << 2))) + (!!(((nlk->groups[0]) >> 8) & (1ULL << 3))) + (!!(((nlk->groups[0]) >> 8) & (1ULL << 4))) + (!!(((nlk->groups[0]) >> 8) & (1ULL << 5))) + (!!(((nlk->groups[0]) >> 8) & (1ULL << 6))) + (!!(((nlk->groups[0]) >> 8) & (1ULL << 7))) )) + (( (!!(((nlk->groups[0]) >> 16) & (1ULL << 0))) + (!!(((nlk->groups[0]) >> 16) & (1ULL << 1))) + (!!(((nlk->groups[0]) >> 16) & (1ULL << 2))) + (!!(((nlk->groups[0]) >> 16) & (1ULL << 3))) + (!!(((nlk->groups[0]) >> 16) & (1ULL << 4))) + (!!(((nlk->groups[0]) >> 16) & (1ULL << 5))) + (!!(((nlk->groups[0]) >> 16) & (1ULL << 6))) + (!!(((nlk->groups[0]) >> 16) & (1ULL << 7))) ) + ( (!!((((nlk->groups[0]) >> 16) >> 8) & (1ULL << 0))) + (!!((((nlk->groups[0]) >> 16) >> 8) & (1ULL << 1))) + (!!((((nlk->groups[0]) >> 16) >> 8) & (1ULL << 2))) + (!!((((nlk->groups[0]) >> 16) >> 8) & (1ULL << 3))) + (!!((((nlk->groups[0]) >> 16) >> 8) & (1ULL << 4))) + (!!((((nlk->groups[0]) >> 16) >> 8) & (1ULL << 5))) + (!!((((nlk->groups[0]) >> 16) >> 8) & (1ULL << 6))) + (!!((((nlk->groups[0]) >> 16) >> 8) & (1ULL << 7))) ))) : __arch_hweight32(nlk->groups[0])));
      ...
      int alen, int flags)
{
 ...
 if (err == 0) {
  ...
  nlk->dst_group = ({ unsigned long __t = (nladdr->nl_groups); fls(__t & -__t); });
 }
      ...
      int *addr_len, int peer)
{
 struct sock *sk = sock->sk;
 struct netlink_sock *nlk = nlk_sk(sk);
 struct sockaddr_nl * nladdr = ({ ((void)(sizeof(struct { int:-!!(((sizeof(*nladdr)) > sizeof(struct __kernel_sockaddr_storage))); }))); (struct sockaddr_nl *) addr; });
...
static void netlink_overrun(struct sock *sk)
{
 ...
 if (!(nlk->flags & 0x8)) {
  if (!_test_and_set_bit_le(0,&nlk_sk(sk)->state)) {
   sk->sk_err = 105;
...
extern typeof(netlink_unicast) netlink_unicast; static const char __kstrtab_netlink_unicast[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_unicast"; static const struct kernel_symbol __ksymtab_netlink_unicast __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&netlink_unicast, __kstrtab_netlink_unicast };
...
int netlink_has_listeners(struct sock *sk, unsigned int group)
{
 ...
 do { if (__builtin_expect(!!(!netlink_is_kernel(sk)), 0)) do { *(int *)0 = 0; } while (1); } while(0);

 rcu_read_lock();
 listeners = ({ typeof(nl_table[sk->sk_protocol].listeners) _________p1 = (*(volatile typeof(nl_table[sk->sk_protocol].listeners) *)&(nl_table[sk->sk_protocol].listeners)); do { } while(0); (_________p1); });
...
extern typeof(netlink_has_listeners) netlink_has_listeners; static const char __kstrtab_netlink_has_listeners[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_has_listeners"; static const struct kernel_symbol __ksymtab_netlink_has_listeners __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&netlink_has_listeners, __kstrtab_netlink_has_listeners };
         ...
         struct sk_buff *skb)
{
 ...
 if ((*(volatile int *)&(&sk->sk_rmem_alloc)->counter) <= sk->sk_rcvbuf &&
  ...
  return (*(volatile int *)&(&sk->sk_rmem_alloc)->counter) > sk->sk_rcvbuf;
 }
 return -1;
}
 ...
 void *filter_data)
{
 ...
 for (node = (&nl_table[ssk->sk_protocol].mc_list)->first; node && ({ prefetch(node->next); 1;}) && ({ sk = ({ const typeof( ((typeof(*sk) *)0)->__sk_common.skc_bind_node ) *__mptr = (node); (typeof(*sk) *)( (char *)__mptr - __builtin_offsetof(typeof(*sk),__sk_common.skc_bind_node) );}); 1;}); node = node->next)
...
extern typeof(netlink_broadcast_filtered) netlink_broadcast_filtered; static const char __kstrtab_netlink_broadcast_filtered[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_broadcast_filtered"; static const struct kernel_symbol __ksymtab_netlink_broadcast_filtered __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&netlink_broadcast_filtered, __kstrtab_netlink_broadcast_filtered };
...
extern typeof(netlink_broadcast) netlink_broadcast; static const char __kstrtab_netlink_broadcast[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_broadcast"; static const struct kernel_symbol __ksymtab_netlink_broadcast __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&netlink_broadcast, __kstrtab_netlink_broadcast };
...
extern typeof(netlink_set_err) netlink_set_err; static const char __kstrtab_netlink_set_err[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_set_err"; static const struct kernel_symbol __ksymtab_netlink_set_err __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&netlink_set_err, __kstrtab_netlink_set_err };
         ...
         char *optval, unsigned int optlen)
{
 ...
 if (optlen >= sizeof(int) &&
     ({ register const typeof(*((unsigned int *)optval)) *__p asm("r0") = ((unsigned int *)optval); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } val = (typeof(*((unsigned int *)optval))) __r2; __e; }))
  return -14;
      ...
      struct msghdr *msg, size_t len)
{
 ...
 if (msg->msg_namelen) {
  if (addr->nl_family != 16)
   return -22;
  dst_pid = addr->nl_pid;
  dst_group = ({ unsigned long __t = (addr->nl_groups); fls(__t & -__t); });
 ...
 security_task_getsecid((get_current()), &((*(struct netlink_skb_parms*)&((skb)->cb)).sid));
...
# 1434 "../../net/netlink/af_netlink.c"
 ...
 if (nlk->cb && (*(volatile int *)&(&sk->sk_rmem_alloc)->counter) <= sk->sk_rcvbuf / 2)
  netlink_dump(sk);
        ...
        struct mutex *cb_mutex, struct module *module)
{
 ...
 do { if (__builtin_expect(!!(!nl_table), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 ...
 listeners = kzalloc((((((groups)) + ((typeof((groups)))((sizeof(unsigned long) * 8)) - 1)) & ~((typeof((groups)))((sizeof(unsigned long) * 8)) - 1)) / 8) + sizeof(struct listeners_rcu_head),
...
extern typeof(netlink_kernel_create) netlink_kernel_create; static const char __kstrtab_netlink_kernel_create[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_kernel_create"; static const struct kernel_symbol __ksymtab_netlink_kernel_create __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&netlink_kernel_create, __kstrtab_netlink_kernel_create };
...
extern typeof(netlink_kernel_release) netlink_kernel_release; static const char __kstrtab_netlink_kernel_release[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_kernel_release"; static const struct kernel_symbol __ksymtab_netlink_kernel_release __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&netlink_kernel_release, __kstrtab_netlink_kernel_release };
...
static void netlink_free_old_listeners(struct rcu_head *rcu_head)
{
 ...
 lrh = ({ const typeof( ((struct listeners_rcu_head *)0)->rcu_head ) *__mptr = (rcu_head); (struct listeners_rcu_head *)( (char *)__mptr - __builtin_offsetof(struct listeners_rcu_head,rcu_head) );});
 kfree(lrh->ptr);
}
...
int __netlink_change_ngroups(struct sock *sk, unsigned int groups)
{
 ...
 if ((((((tbl->groups)) + ((typeof((tbl->groups)))((sizeof(unsigned long) * 8)) - 1)) & ~((typeof((tbl->groups)))((sizeof(unsigned long) * 8)) - 1)) / 8) < (((((groups)) + ((typeof((groups)))((sizeof(unsigned long) * 8)) - 1)) & ~((typeof((groups)))((sizeof(unsigned long) * 8)) - 1)) / 8)) {
  listeners = kzalloc((((((groups)) + ((typeof((groups)))((sizeof(unsigned long) * 8)) - 1)) & ~((typeof((groups)))((sizeof(unsigned long) * 8)) - 1)) / 8) +
  ...
  ({ if (!__builtin_constant_p(listeners) || ((listeners) != ((void *)0))) __asm__ __volatile__ ("dmb" : : : "memory"); (tbl->listeners) = (listeners); });
  ...
  old_rcu_head = (void *)(tbl->listeners +
     ((((((tbl->groups)) + ((typeof((tbl->groups)))((sizeof(unsigned long) * 8)) - 1)) & ~((typeof((tbl->groups)))((sizeof(unsigned long) * 8)) - 1)) / 8)/sizeof(unsigned long)));
...
extern typeof(netlink_set_nonroot) netlink_set_nonroot; static const char __kstrtab_netlink_set_nonroot[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_set_nonroot"; static const struct kernel_symbol __ksymtab_netlink_set_nonroot __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&netlink_set_nonroot, __kstrtab_netlink_set_nonroot };
...
extern typeof(netlink_dump_start) netlink_dump_start; static const char __kstrtab_netlink_dump_start[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_dump_start"; static const struct kernel_symbol __ksymtab_netlink_dump_start __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&netlink_dump_start, __kstrtab_netlink_dump_start };
...
extern typeof(netlink_ack) netlink_ack; static const char __kstrtab_netlink_ack[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_ack"; static const struct kernel_symbol __ksymtab_netlink_ack __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&netlink_ack, __kstrtab_netlink_ack };
...
extern typeof(netlink_rcv_skb) netlink_rcv_skb; static const char __kstrtab_netlink_rcv_skb[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_rcv_skb"; static const struct kernel_symbol __ksymtab_netlink_rcv_skb __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&netlink_rcv_skb, __kstrtab_netlink_rcv_skb };
# 1873 "../../net/netlink/af_netlink.c"
...
extern typeof(nlmsg_notify) nlmsg_notify; static const char __kstrtab_nlmsg_notify[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "nlmsg_notify"; static const struct kernel_symbol __ksymtab_nlmsg_notify __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&nlmsg_notify, __kstrtab_nlmsg_notify };
...
static int netlink_seq_show(struct seq_file *seq, void *v)
{
 if (v == ((void *)1))
  ...
  seq_printf(seq, "%p %-3d %-6d %08x %-8d %-8d %p %-8d %-8d %-8lu\n",
      ...
      sk_wmem_alloc_get(s),
      nlk->cb,
      (*(volatile int *)&(&s->__sk_common.skc_refcnt)->counter),
      (*(volatile int *)&(&s->sk_drops)->counter),
      sock_i_ino(s)
   );
...
extern typeof(netlink_register_notifier) netlink_register_notifier; static const char __kstrtab_netlink_register_notifier[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_register_notifier"; static const struct kernel_symbol __ksymtab_netlink_register_notifier __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&netlink_register_notifier, __kstrtab_netlink_register_notifier };

int netlink_unregister_notifier(struct notifier_block *nb)
{
 return atomic_notifier_chain_unregister(&netlink_chain, nb);
}
extern typeof(netlink_unregister_notifier) netlink_unregister_notifier; static const char __kstrtab_netlink_unregister_notifier[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "netlink_unregister_notifier"; static const struct kernel_symbol __ksymtab_netlink_unregister_notifier __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&netlink_unregister_notifier, __kstrtab_netlink_unregister_notifier };
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) netlink_net_init(struct net *net)
{
...
static struct pernet_operations __attribute__ ((__section__(".init.data"))) netlink_net_ops = {
 .init = netlink_net_init,
 .exit = netlink_net_exit,
};

static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) netlink_proto_init(void)
{
 ...
 ((void)(sizeof(struct { int:-!!(sizeof(struct netlink_skb_parms) > sizeof(dummy_skb->cb)); })));

 nl_table = kcalloc(32, sizeof(*nl_table), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!nl_table)
  goto panic;

 if (totalram_pages >= (128 * 1024))
  limit = totalram_pages >> (21 - 12);
 else
  limit = totalram_pages >> (23 - 12);
...
static initcall_t __initcall_netlink_proto_init1 __attribute__((__used__)) __attribute__((__section__(".initcall" "1" ".init"))) = netlink_proto_init;
