# 1 "../../net/wireless/wext-priv.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../net/wireless/wext-priv.c"
# 10 "../../net/wireless/wext-priv.c"
...
# 75 "../../include/linux/wireless.h" 2
# 673 "../../include/linux/wireless.h"
struct iw_param
{
  __s32 value;
  __u8 fixed;
...
# 798 "../../include/linux/wireless.h"
 __u8 essid[32];
# 810 "../../include/linux/wireless.h"
 __u32 min_channel_time;
 __u32 max_channel_time;

 struct iw_freq channel_list[32];
};
# 842 "../../include/linux/wireless.h"
...
# 980 "../../include/linux/wireless.h"
struct iw_range
{

 __u32 throughput;
# 992 "../../include/linux/wireless.h"
 __u32 min_nwid;
 __u32 max_nwid;
...
# 13 "../../net/wireless/wext-priv.c" 2
# 1 "../../include/net/iw_handler.h" 1
...
static inline __attribute__((always_inline)) int iwe_stream_lcp_len(struct iw_request_info *info)
{
...
static inline __attribute__((always_inline)) int iwe_stream_point_len(struct iw_request_info *info)
{




 return ((sizeof(struct iw_event) - sizeof(union iwreq_data)) + sizeof(struct iw_point) - (((char *) &(((struct iw_point *) ((void *)0))->length)) - (char *) ((void *)0)));
}

static inline __attribute__((always_inline)) int iwe_stream_event_len_adjust(struct iw_request_info *info,
           int event_len)
{
       ...
       struct iw_event *iwe, char *extra)
{
 ...
 if(__builtin_expect(!!((stream + event_len) < ends), 1)) {
  ...
  memcpy(stream + lcp_len,
         ((char *) &iwe->u) + (((char *) &(((struct iw_point *) ((void *)0))->length)) - (char *) ((void *)0)),
...
# 14 "../../net/wireless/wext-priv.c" 2
# 1 "../../include/net/wext.h" 1
...
# 30 "../../include/net/wext.h"
extern int wext_proc_init(struct net *net);
extern void wext_proc_exit(struct net *net);
# 44 "../../include/net/wext.h"
       ...
       const struct iw_priv_args **descrp)
{
 ...
 if (descr) {
  if ((!((cmd) & 0x1))) {
   ...
   if ((descr->set_args & 0x0800) &&
      ((extra_size + offset) <= 16))
    extra_size = 0;
  } else {
      ...
      struct iw_request_info *info, int extra_size)
{
 ...
 if ((!((cmd) & 0x1))) {
  ...
  if (iwp->length > (descr->set_args & 0x07FF))
   return -7;
 } else if (!iwp->pointer)
  return -14;

 extra = kmalloc(extra_size, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!extra)
  return -12;


 if ((!((cmd) & 0x1)) && (iwp->length != 0)) {
