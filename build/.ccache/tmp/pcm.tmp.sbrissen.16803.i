...
# 27 "../../sound/core/pcm.c" 2
# 1 "../../include/sound/minors.h" 1
# 28 "../../sound/core/pcm.c" 2
...
static struct list_head snd_pcm_devices = { &(snd_pcm_devices), &(snd_pcm_devices) };
static struct list_head snd_pcm_notify_list = { &(snd_pcm_notify_list), &(snd_pcm_notify_list) };
static struct mutex register_mutex = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } } , .wait_list = { &(register_mutex.wait_list), &(register_mutex.wait_list) } };
...
static struct snd_pcm *snd_pcm_get(struct snd_card *card, int device)
{
 ...
 for (pcm = ({ const typeof( ((typeof(*pcm) *)0)->list ) *__mptr = ((&snd_pcm_devices)->next); (typeof(*pcm) *)( (char *)__mptr - __builtin_offsetof(typeof(*pcm),list) );}); prefetch(pcm->list.next), &pcm->list != (&snd_pcm_devices); pcm = ({ const typeof( ((typeof(*pcm) *)0)->list ) *__mptr = (pcm->list.next); (typeof(*pcm) *)( (char *)__mptr - __builtin_offsetof(typeof(*pcm),list) );})) {
     ...
     unsigned int cmd, unsigned long arg)
{
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('U')) << (0 +8)) | (((0x31)) << 0) | (((((sizeof(struct snd_pcm_info) == sizeof(struct snd_pcm_info[1]) && sizeof(struct snd_pcm_info) < (1 << 14)) ? sizeof(struct snd_pcm_info) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
  {
   ...
   info = (struct snd_pcm_info *)arg;
   if (({ register const typeof(*(&info->device)) *__p asm("r0") = (&info->device); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } device = (typeof(*(&info->device))) __r2; __e; }))
    return -14;
   if (({ register const typeof(*(&info->stream)) *__p asm("r0") = (&info->stream); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } stream = (typeof(*(&info->stream))) __r2; __e; }))
    return -14;
   if (stream < 0 || stream > 1)
    return -22;
   if (({ register const typeof(*(&info->subdevice)) *__p asm("r0") = (&info->subdevice); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } subdevice = (typeof(*(&info->subdevice))) __r2; __e; }))
    return -14;
   mutex_lock(&register_mutex);
 ...
 case (((1U) << (((0 +8)+8)+14)) | ((('U')) << (0 +8)) | (((0x32)) << 0) | (((((sizeof(int) == sizeof(int[1]) && sizeof(int) < (1 << 14)) ? sizeof(int) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
  {
   int val;

   if (({ register const typeof(*((int *)arg)) *__p asm("r0") = ((int *)arg); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } val = (typeof(*((int *)arg))) __r2; __e; }))
    return -14;
...
static char *snd_pcm_format_names[] = {
 [(( snd_pcm_format_t) 0)] = "S8",
 [(( snd_pcm_format_t) 1)] = "U8",
 [(( snd_pcm_format_t) 2)] = "S16_LE",
 [(( snd_pcm_format_t) 3)] = "S16_BE",
 [(( snd_pcm_format_t) 4)] = "U16_LE",
 [(( snd_pcm_format_t) 5)] = "U16_BE",
 [(( snd_pcm_format_t) 6)] = "S24_LE",
 [(( snd_pcm_format_t) 7)] = "S24_BE",
 [(( snd_pcm_format_t) 8)] = "U24_LE",
 [(( snd_pcm_format_t) 9)] = "U24_BE",
 [(( snd_pcm_format_t) 10)] = "S32_LE",
 [(( snd_pcm_format_t) 11)] = "S32_BE",
 [(( snd_pcm_format_t) 12)] = "U32_LE",
 [(( snd_pcm_format_t) 13)] = "U32_BE",
 [(( snd_pcm_format_t) 14)] = "FLOAT_LE",
 [(( snd_pcm_format_t) 15)] = "FLOAT_BE",
 [(( snd_pcm_format_t) 16)] = "FLOAT64_LE",
 [(( snd_pcm_format_t) 17)] = "FLOAT64_BE",
 [(( snd_pcm_format_t) 18)] = "IEC958_SUBFRAME_LE",
 [(( snd_pcm_format_t) 19)] = "IEC958_SUBFRAME_BE",
 [(( snd_pcm_format_t) 20)] = "MU_LAW",
 [(( snd_pcm_format_t) 21)] = "A_LAW",
 [(( snd_pcm_format_t) 22)] = "IMA_ADPCM",
 [(( snd_pcm_format_t) 23)] = "MPEG",
 [(( snd_pcm_format_t) 24)] = "GSM",
 [(( snd_pcm_format_t) 31)] = "SPECIAL",
 [(( snd_pcm_format_t) 32)] = "S24_3LE",
 [(( snd_pcm_format_t) 33)] = "S24_3BE",
 [(( snd_pcm_format_t) 34)] = "U24_3LE",
 [(( snd_pcm_format_t) 35)] = "U24_3BE",
 [(( snd_pcm_format_t) 36)] = "S20_3LE",
 [(( snd_pcm_format_t) 37)] = "S20_3BE",
 [(( snd_pcm_format_t) 38)] = "U20_3LE",
 [(( snd_pcm_format_t) 39)] = "U20_3BE",
 [(( snd_pcm_format_t) 40)] = "S18_3LE",
 [(( snd_pcm_format_t) 41)] = "S18_3BE",
 [(( snd_pcm_format_t) 42)] = "U18_3LE",
 [(( snd_pcm_format_t) 43)] = "U18_3BE",
};
...
extern typeof(snd_pcm_format_name) snd_pcm_format_name; static const char __kstrtab_snd_pcm_format_name[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "snd_pcm_format_name"; static const struct kernel_symbol __ksymtab_snd_pcm_format_name __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&snd_pcm_format_name, __kstrtab_snd_pcm_format_name };
# 226 "../../sound/core/pcm.c"
...
static char *snd_pcm_state_names[] = {
 [(( snd_pcm_state_t) 0)] = "OPEN",
 [(( snd_pcm_state_t) 1)] = "SETUP",
 [(( snd_pcm_state_t) 2)] = "PREPARED",
 [(( snd_pcm_state_t) 3)] = "RUNNING",
 [(( snd_pcm_state_t) 4)] = "XRUN",
 [(( snd_pcm_state_t) 5)] = "DRAINING",
 [(( snd_pcm_state_t) 6)] = "PAUSED",
 [(( snd_pcm_state_t) 7)] = "SUSPENDED",
};

static char *snd_pcm_access_names[] = {
 [(( snd_pcm_access_t) 0)] = "MMAP_INTERLEAVED",
 [(( snd_pcm_access_t) 1)] = "MMAP_NONINTERLEAVED",
 [(( snd_pcm_access_t) 2)] = "MMAP_COMPLEX",
 [(( snd_pcm_access_t) 3)] = "RW_INTERLEAVED",
 [(( snd_pcm_access_t) 4)] = "RW_NONINTERLEAVED",
};

static char *snd_pcm_subformat_names[] = {
 [(( snd_pcm_subformat_t) 0)] = "STD",
};

static char *snd_pcm_tstamp_mode_names[] = {
 [SNDRV_PCM_TSTAMP_NONE] = "NONE",
 [SNDRV_PCM_TSTAMP_ENABLE] = "ENABLE",
};
       ...
       struct snd_info_buffer *buffer)
{
 ...
 if (! info) {
  printk("<7>" "snd_pcm_proc_info_read: cannot malloc\n");
  return;
 }
        ...
        struct snd_info_buffer *buffer)
{
 ...
 if (runtime->status->state == (( snd_pcm_state_t) 0)) {
            ...
            struct snd_info_buffer *buffer)
{
 ...
 ({ void *__p = (&status); size_t __n = sizeof(status); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
...
static int snd_pcm_stream_proc_init(struct snd_pcm_str *pstr)
{
 ...
 if ((entry = snd_info_create_card_entry(pcm->card, name, pcm->card->proc_root)) == ((void *)0))
  return -12;
 entry->mode = 0040000 | (00400|00040|00004) | (00100|00010|00001);
 ...
 if ((entry = snd_info_create_card_entry(pcm->card, "info", pstr->proc_root)) != ((void *)0)) {
...
static int snd_pcm_stream_proc_done(struct snd_pcm_str *pstr)
{
 ...
 pstr->proc_info_entry = ((void *)0);
 snd_info_free_entry(pstr->proc_root);
 pstr->proc_root = ((void *)0);
 return 0;
}
...
static int snd_pcm_substream_proc_init(struct snd_pcm_substream *substream)
{
 ...
 if ((entry = snd_info_create_card_entry(card, name, substream->pstr->proc_root)) == ((void *)0))
  return -12;
 entry->mode = 0040000 | (00400|00040|00004) | (00100|00010|00001);
 if (snd_info_register(entry) < 0) {
  snd_info_free_entry(entry);
 ...
 if ((entry = snd_info_create_card_entry(card, "info", substream->proc_root)) != ((void *)0)) {
 ...
 if ((entry = snd_info_create_card_entry(card, "hw_params", substream->proc_root)) != ((void *)0)) {
  snd_info_set_text_ops(entry, substream,
 ...
 if ((entry = snd_info_create_card_entry(card, "sw_params", substream->proc_root)) != ((void *)0)) {
  snd_info_set_text_ops(entry, substream,
 ...
 if ((entry = snd_info_create_card_entry(card, "status", substream->proc_root)) != ((void *)0)) {
  snd_info_set_text_ops(entry, substream,
...
static int snd_pcm_substream_proc_done(struct snd_pcm_substream *substream)
{
 ...
 substream->proc_info_entry = ((void *)0);
 snd_info_free_entry(substream->proc_hw_params_entry);
 substream->proc_hw_params_entry = ((void *)0);
 snd_info_free_entry(substream->proc_sw_params_entry);
 substream->proc_sw_params_entry = ((void *)0);
 snd_info_free_entry(substream->proc_status_entry);
 substream->proc_status_entry = ((void *)0);
 snd_info_free_entry(substream->proc_root);
 substream->proc_root = ((void *)0);
 return 0;
}
# 620 "../../sound/core/pcm.c"
int snd_pcm_new_stream(struct snd_pcm *pcm, int stream, int substream_count)
{
 int idx, err;
 ...
 if (substream_count > 0) {
  ...
  if (err < 0) {
   printk("<3>" "Error in snd_pcm_stream_proc_init\n");
   return err;
  }
 }
 prev = ((void *)0);
 for (idx = 0, prev = ((void *)0); idx < substream_count; idx++) {
  substream = kzalloc(sizeof(*substream), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
  if (substream == ((void *)0)) {
   printk("<3>" "Cannot allocate PCM substream\n");
   return -12;
  }
  substream->pcm = pcm;
  substream->pstr = pstr;
  ...
  do { spinlock_check(&substream->self_group.lock); do { *(&(&substream->self_group.lock)->rlock) = (raw_spinlock_t) { .raw_lock = { 0 }, }; } while (0); } while (0);
  INIT_LIST_HEAD(&substream->self_group.substreams);
  list_add_tail(&substream->link_list, &substream->self_group.substreams);
  (((&substream->mmap_count)->counter) = (0));
  prev = substream;
 }
 return 0;
}

extern typeof(snd_pcm_new_stream) snd_pcm_new_stream; static const char __kstrtab_snd_pcm_new_stream[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "snd_pcm_new_stream"; static const struct kernel_symbol __ksymtab_snd_pcm_new_stream __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&snd_pcm_new_stream, __kstrtab_snd_pcm_new_stream };
# 694 "../../sound/core/pcm.c"
int snd_pcm_new(struct snd_card *card, const char *id, int device,
  int playback_count, int capture_count,
         struct snd_pcm ** rpcm)
{
 ...
 if (__snd_bug_on(0 && (!card)))
  return -6;
 if (rpcm)
  *rpcm = ((void *)0);
 pcm = kzalloc(sizeof(*pcm), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (pcm == ((void *)0)) {
  printk("<3>" "Cannot allocate PCM\n");
  return -12;
 }
 pcm->card = card;
 pcm->device = device;
 ...
 do { static struct lock_class_key __key; __mutex_init((&pcm->open_mutex), "&pcm->open_mutex", &__key); } while (0);
 do { static struct lock_class_key __key; __init_waitqueue_head((&pcm->open_wait), &__key); } while (0);
 if ((err = snd_device_new(card, (( snd_device_type_t) 0x1001), pcm, &ops)) < 0) {
  snd_pcm_free(pcm);
  return err;
 }
 if (rpcm)
...
extern typeof(snd_pcm_new) snd_pcm_new; static const char __kstrtab_snd_pcm_new[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "snd_pcm_new"; static const struct kernel_symbol __ksymtab_snd_pcm_new __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&snd_pcm_new, __kstrtab_snd_pcm_new };
...
static int snd_pcm_free(struct snd_pcm *pcm)
{
 ...
 if (!pcm)
  return 0;
 for (notify = ({ const typeof( ((typeof(*notify) *)0)->list ) *__mptr = ((&snd_pcm_notify_list)->next); (typeof(*notify) *)( (char *)__mptr - __builtin_offsetof(typeof(*notify),list) );}); prefetch(notify->list.next), &notify->list != (&snd_pcm_notify_list); notify = ({ const typeof( ((typeof(*notify) *)0)->list ) *__mptr = (notify->list.next); (typeof(*notify) *)( (char *)__mptr - __builtin_offsetof(typeof(*notify),list) );})) {
        ...
        struct snd_pcm_substream **rsubstream)
{
 ...
 if (__snd_bug_on(0 && (!pcm || !rsubstream)))
  return -6;
 *rsubstream = ((void *)0);
 pstr = &pcm->streams[stream];
 ...
 for (kctl = ({ const typeof( ((typeof(*kctl) *)0)->list ) *__mptr = ((&card->ctl_files)->next); (typeof(*kctl) *)( (char *)__mptr - __builtin_offsetof(typeof(*kctl),list) );}); prefetch(kctl->list.next), &kctl->list != (&card->ctl_files); kctl = ({ const typeof( ((typeof(*kctl) *)0)->list ) *__mptr = (kctl->list.next); (typeof(*kctl) *)( (char *)__mptr - __builtin_offsetof(typeof(*kctl),list) );})) {
  if (kctl->pid == task_pid((get_current()))) {
 ...
 if (prefer_subdevice >= 0) {
  for (substream = pstr->substream; substream; substream = substream->next)
   if (!((substream)->ref_count > 0) && substream->number == prefer_subdevice)
    goto __ok;
 }
 for (substream = pstr->substream; substream; substream = substream->next)
  if (!((substream)->ref_count > 0))
 ...
 runtime = kzalloc(sizeof(*runtime), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (runtime == ((void *)0))
  return -12;

 size = ((((sizeof(struct snd_pcm_mmap_status))) + ((typeof((sizeof(struct snd_pcm_mmap_status))))((((1UL) << 12))) - 1)) & ~((typeof((sizeof(struct snd_pcm_mmap_status))))((((1UL) << 12))) - 1));
 runtime->status = snd_malloc_pages(size, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (runtime->status == ((void *)0)) {
  kfree(runtime);
  return -12;
 }
 ({ void *__p = ((void*)runtime->status); size_t __n = size; if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });

 size = ((((sizeof(struct snd_pcm_mmap_control))) + ((typeof((sizeof(struct snd_pcm_mmap_control))))((((1UL) << 12))) - 1)) & ~((typeof((sizeof(struct snd_pcm_mmap_control))))((((1UL) << 12))) - 1));
 runtime->control = snd_malloc_pages(size, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (runtime->control == ((void *)0)) {
  snd_free_pages((void*)runtime->status,
          ((((sizeof(struct snd_pcm_mmap_status))) + ((typeof((sizeof(struct snd_pcm_mmap_status))))((((1UL) << 12))) - 1)) & ~((typeof((sizeof(struct snd_pcm_mmap_status))))((((1UL) << 12))) - 1)));
  kfree(runtime);
  return -12;
 }
 ({ void *__p = ((void*)runtime->control); size_t __n = size; if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });

 do { static struct lock_class_key __key; __init_waitqueue_head((&runtime->sleep), &__key); } while (0);
 do { static struct lock_class_key __key; __init_waitqueue_head((&runtime->tsleep), &__key); } while (0);

 runtime->status->state = (( snd_pcm_state_t) 0);

 substream->runtime = runtime;
 substream->private_data = pcm->private_data;
 substream->ref_count = 1;
 substream->f_flags = file->f_flags;
 substream->pid = get_pid(task_pid((get_current())));
...
void snd_pcm_detach_substream(struct snd_pcm_substream *substream)
{
 ...
 if (__snd_bug_on(0 && (!(substream) || !(substream)->runtime)))
  return;
 ...
 snd_free_pages((void*)runtime->control,
         ((((sizeof(struct snd_pcm_mmap_control))) + ((typeof((sizeof(struct snd_pcm_mmap_control))))((((1UL) << 12))) - 1)) & ~((typeof((sizeof(struct snd_pcm_mmap_control))))((((1UL) << 12))) - 1)));
...
static struct device_attribute pcm_attrs =
 { .attr = {.name = "pcm_class", .mode = (00400|00040|00004) }, .show = show_pcm_class, .store = ((void *)0), };
...
static int snd_pcm_dev_register(struct snd_device *device)
{
 ...
 if (__snd_bug_on(0 && (!device || !device->device_data)))
  return -6;
 ...
 for (cidx = 0; cidx < 2; cidx++)
  for (substream = pcm->streams[cidx].substream; substream; substream = substream->next)
   if (substream->runtime)
    substream->runtime->status->state = (( snd_pcm_state_t) 8);
 for (notify = ({ const typeof( ((typeof(*notify) *)0)->list ) *__mptr = ((&snd_pcm_notify_list)->next); (typeof(*notify) *)( (char *)__mptr - __builtin_offsetof(typeof(*notify),list) );}); prefetch(notify->list.next), &notify->list != (&snd_pcm_notify_list); notify = ({ const typeof( ((typeof(*notify) *)0)->list ) *__mptr = (notify->list.next); (typeof(*notify) *)( (char *)__mptr - __builtin_offsetof(typeof(*notify),list) );})) {
...
int snd_pcm_notify(struct snd_pcm_notify *notify, int nfree)
{
 ...
 if (__snd_bug_on(0 && (!notify || !notify->n_register || !notify->n_unregister || !notify->n_disconnect)))
...
extern typeof(snd_pcm_notify) snd_pcm_notify; static const char __kstrtab_snd_pcm_notify[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "snd_pcm_notify"; static const struct kernel_symbol __ksymtab_snd_pcm_notify __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&snd_pcm_notify, __kstrtab_snd_pcm_notify };
...
static void snd_pcm_proc_init(void)
{
 ...
 if ((entry = snd_info_create_module_entry(((struct module *)0), "pcm", ((void *)0))) != ((void *)0)) {
  snd_info_set_text_ops(entry, ((void *)0), snd_pcm_proc_read);
  if (snd_info_register(entry) < 0) {
   snd_info_free_entry(entry);
   entry = ((void *)0);
  }
...
# 1134 "../../sound/core/pcm.c"
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) alsa_pcm_init(void)
{
...
static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) alsa_pcm_exit(void)
{
...
static initcall_t __initcall_alsa_pcm_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = alsa_pcm_init;
static exitcall_t __exitcall_alsa_pcm_exit __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = alsa_pcm_exit;
