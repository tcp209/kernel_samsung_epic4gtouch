...
# 190 "../../include/linux/clocksource.h"
 cycle_t cycle_last __attribute__((__aligned__((1 << 5))));
...
static inline __attribute__((always_inline)) u32 clocksource_hz2mult(u32 hz, u32 shift_constant)
{
 ...
 tmp += hz/2;
 ({ unsigned int __r, __b = (hz); if (!__builtin_constant_p(__b) || __b == 0 || (7 < 4 && (__b & (__b - 1)) != 0)) { __r = ({ register unsigned int __base asm("r4") = __b; register unsigned long long __n asm("r0") = tmp; register unsigned long long __res asm("r2"); register unsigned int __rem asm("r1"); asm( ".ifnc " "%0" "," "r1" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%3" "," "r4" " ; .err ; .endif\n\t" "bl	__do_div64" : "=r" (__rem), "=r" (__res) : "r" (__n), "r" (__base) : "ip", "lr", "cc"); tmp = __res; __rem; }); } else if ((__b & (__b - 1)) == 0) { __r = tmp; __r &= (__b - 1); tmp /= __b; } else { unsigned long long __res, __x, __t, __m, __n = tmp; unsigned int __c, __p, __z = 0; __r = __n; __p = 1 << ({ unsigned int __left = (__b), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); __m = (~0ULL / __b) * __p; __m += (((~0ULL % __b + 1) * __p) + __b - 1) / __b; __x = ~0ULL / __b * __b - 1; __res = (__m & 0xffffffff) * (__x & 0xffffffff); __res >>= 32; __res += (__m & 0xffffffff) * (__x >> 32); __t = __res; __res += (__x & 0xffffffff) * (__m >> 32); __t = (__res < __t) ? (1ULL << 32) : 0; __res = (__res >> 32) + __t; __res += (__m >> 32) * (__x >> 32); __res /= __p; if (~0ULL % (__b / (__b & -__b)) == 0) { __n /= (__b & -__b); __m = ~0ULL / (__b / (__b & -__b)); __p = 1; __c = 1; } else if (__res != __x / __b) { __c = 1; __m = (~0ULL / __b) * __p; __m += ((~0ULL % __b + 1) * __p) / __b; } else { unsigned int __bits = -(__m & -__m); __bits |= __m >> 32; __bits = (~__bits) << 1; if (!__bits) { __p /= (__m & -__m); __m /= (__m & -__m); } else { __p >>= ({ unsigned int __left = (__bits), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); __m >>= ({ unsigned int __left = (__bits), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); } __c = 0; } if (!__c) { asm ( "umull	%Q0, %R0, %1, %Q2\n\t" "mov	%Q0, #0" : "=&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else if (!(__m & ((1ULL << 63) | (1ULL << 31)))) { __res = __m; asm ( "umlal	%Q0, %R0, %Q1, %Q2\n\t" "mov	%Q0, #0" : "+&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else { asm ( "umull	%Q0, %R0, %Q1, %Q2\n\t" "cmn	%Q0, %Q1\n\t" "adcs	%R0, %R0, %R1\n\t" "adc	%Q0, %3, #0" : "=&r" (__res) : "r" (__m), "r" (__n), "r" (__z) : "cc" ); } if (!(__m & ((1ULL << 63) | (1ULL << 31)))) { asm ( "umlal	%R0, %Q0, %R1, %Q2\n\t" "umlal	%R0, %Q0, %Q1, %R2\n\t" "mov	%R0, #0\n\t" "umlal	%Q0, %R0, %R1, %R2" : "+&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else { asm ( "umlal	%R0, %Q0, %R2, %Q3\n\t" "umlal	%R0, %1, %Q2, %R3\n\t" "mov	%R0, #0\n\t" "adds	%Q0, %1, %Q0\n\t" "adc	%R0, %R0, #0\n\t" "umlal	%Q0, %R0, %R2, %R3" : "+&r" (__res), "+&r" (__z) : "r" (__m), "r" (__n) : "cc" ); } __res /= __p; { unsigned int __res0 = __res; unsigned int __b0 = __b; __r -= __res0 * __b0; } tmp = __res; } __r; });
...
extern typeof(sys_tz) sys_tz; static const char __kstrtab_sys_tz[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "sys_tz"; static const struct kernel_symbol __ksymtab_sys_tz __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&sys_tz, __kstrtab_sys_tz };
# 62 "../../kernel/time.c"
 long sys_time(time_t * tloc)
{
 ...
 long sys_stime(time_t * tptr)
{
 ...
 if (({ register const typeof(*(tptr)) *__p asm("r0") = (tptr); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } tv.tv_sec = (typeof(*(tptr))) __r2; __e; }))
  return -14;

 tv.tv_nsec = 0;

 err = security_settime(&tv, ((void *)0));
 if (err)
  return err;
...
{
 if (__builtin_expect(!!(tv != ((void *)0)), 1)) {
  struct timeval ktv;
  do_gettimeofday(&ktv);
  if (copy_to_user(tv, &ktv, sizeof(ktv)))
   return -14;
 }
 if (__builtin_expect(!!(tz != ((void *)0)), 0)) {
...
# 133 "../../kernel/time.c"
static inline __attribute__((always_inline)) void warp_clock(void)
{
...
int do_sys_settimeofday(struct timespec *tv, struct timezone *tz)
{
 ...
 if (tv && !(((tv)->tv_sec >= 0) && (((unsigned long) (tv)->tv_nsec) < 1000000000L)))
  return -22;
...

{
 ...
 if (tv) {
  ...
  new_ts.tv_nsec = user_tv.tv_usec * 1000L;
 }
 if (tz) {
 ...
 return do_sys_settimeofday(tv ? &new_ts : ((void *)0), tz ? &new_tz : ((void *)0));
}
 ...
 long sys_adjtimex(struct timex * txc_p)
{
 ...
 if(copy_from_user(&txc, txc_p, sizeof(struct timex)))
  return -14;
 ret = do_adjtimex(&txc);
 return copy_to_user(txc_p, &txc, sizeof(struct timex)) ? -14 : ret;
}
# 228 "../../kernel/time.c"
...
extern typeof(current_fs_time) current_fs_time; static const char __kstrtab_current_fs_time[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "current_fs_time"; static const struct kernel_symbol __ksymtab_current_fs_time __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&current_fs_time, __kstrtab_current_fs_time };
...
unsigned int inline __attribute__((always_inline)) jiffies_to_msecs(const unsigned long j)
{

 return (1000L / 200) * j;
# 254 "../../kernel/time.c"
}
extern typeof(jiffies_to_msecs) jiffies_to_msecs; static const char __kstrtab_jiffies_to_msecs[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "jiffies_to_msecs"; static const struct kernel_symbol __ksymtab_jiffies_to_msecs __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&jiffies_to_msecs, __kstrtab_jiffies_to_msecs };

unsigned int inline __attribute__((always_inline)) jiffies_to_usecs(const unsigned long j)
{

 return (1000000L / 200) * j;
# 270 "../../kernel/time.c"
}
extern typeof(jiffies_to_usecs) jiffies_to_usecs; static const char __kstrtab_jiffies_to_usecs[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "jiffies_to_usecs"; static const struct kernel_symbol __ksymtab_jiffies_to_usecs __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&jiffies_to_usecs, __kstrtab_jiffies_to_usecs };
# 285 "../../kernel/time.c"
...
extern typeof(timespec_trunc) timespec_trunc; static const char __kstrtab_timespec_trunc[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "timespec_trunc"; static const struct kernel_symbol __ksymtab_timespec_trunc __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&timespec_trunc, __kstrtab_timespec_trunc };
# 334 "../../kernel/time.c"
unsigned long
...
extern typeof(mktime) mktime; static const char __kstrtab_mktime[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "mktime"; static const struct kernel_symbol __ksymtab_mktime __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&mktime, __kstrtab_mktime };
# 371 "../../kernel/time.c"
...
extern typeof(set_normalized_timespec) set_normalized_timespec; static const char __kstrtab_set_normalized_timespec[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "set_normalized_timespec"; static const struct kernel_symbol __ksymtab_set_normalized_timespec __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&set_normalized_timespec, __kstrtab_set_normalized_timespec };
...
extern typeof(ns_to_timespec) ns_to_timespec; static const char __kstrtab_ns_to_timespec[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "ns_to_timespec"; static const struct kernel_symbol __ksymtab_ns_to_timespec __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&ns_to_timespec, __kstrtab_ns_to_timespec };
...
extern typeof(ns_to_timeval) ns_to_timeval; static const char __kstrtab_ns_to_timeval[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "ns_to_timeval"; static const struct kernel_symbol __ksymtab_ns_to_timeval __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&ns_to_timeval, __kstrtab_ns_to_timeval };
# 450 "../../kernel/time.c"
unsigned long msecs_to_jiffies(const unsigned int m)
{
 ...
 return (m + (1000L / 200) - 1) / (1000L / 200);
# 489 "../../kernel/time.c"
}
extern typeof(msecs_to_jiffies) msecs_to_jiffies; static const char __kstrtab_msecs_to_jiffies[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "msecs_to_jiffies"; static const struct kernel_symbol __ksymtab_msecs_to_jiffies __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&msecs_to_jiffies, __kstrtab_msecs_to_jiffies };
...
unsigned long usecs_to_jiffies(const unsigned int u)
{
 ...
 return (u + (1000000L / 200) - 1) / (1000000L / 200);
...
extern typeof(usecs_to_jiffies) usecs_to_jiffies; static const char __kstrtab_usecs_to_jiffies[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usecs_to_jiffies"; static const struct kernel_symbol __ksymtab_usecs_to_jiffies __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&usecs_to_jiffies, __kstrtab_usecs_to_jiffies };
# 518 "../../kernel/time.c"
unsigned long
timespec_to_jiffies(const struct timespec *value)
{
 unsigned long sec = value->tv_sec;
 long nsec = value->tv_nsec + (( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))))) - 1;

 if (sec >= (long)((u64)((u64)((((long)(~0UL>>1)) >> 1)-1) * (( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))))) / 1000000000L)){
  sec = (long)((u64)((u64)((((long)(~0UL>>1)) >> 1)-1) * (( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))))) / 1000000000L);
  nsec = 0;
 }
 return (((u64)sec * ((unsigned long)((((u64)1000000000L << (32 - 8)) + (( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))))) -1) / (u64)(( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))))))) +
  (((u64)nsec * ((unsigned long)((((u64)1 << ((32 - 8) + 29)) + (( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))))) -1) / (u64)(( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))))))) >>
   (((32 - 8) + 29) - (32 - 8)))) >> (32 - 8);

}
extern typeof(timespec_to_jiffies) timespec_to_jiffies; static const char __kstrtab_timespec_to_jiffies[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "timespec_to_jiffies"; static const struct kernel_symbol __ksymtab_timespec_to_jiffies __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&timespec_to_jiffies, __kstrtab_timespec_to_jiffies };
...
jiffies_to_timespec(const unsigned long jiffies, struct timespec *value)
{
 ...
 u32 rem;
 value->tv_sec = div_u64_rem((u64)jiffies * (( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))))),
        1000000000L, &rem);
 value->tv_nsec = rem;
}
extern typeof(jiffies_to_timespec) jiffies_to_timespec; static const char __kstrtab_jiffies_to_timespec[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "jiffies_to_timespec"; static const struct kernel_symbol __ksymtab_jiffies_to_timespec __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&jiffies_to_timespec, __kstrtab_jiffies_to_timespec };
# 561 "../../kernel/time.c"
unsigned long
timeval_to_jiffies(const struct timeval *value)
{
 ...
 return (((u64)sec * ((unsigned long)((((u64)1000000000L << (32 - 8)) + (( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))))) -1) / (u64)(( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))))))) +
  (((u64)usec * ((unsigned long)((((u64)1000L << ((32 - 8) + 19)) + (( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))))) -1) / (u64)(( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))))))) + (u64)(((u64)1 << ((32 - 8) + 19)) - 1)) >>
   (((32 - 8) + 19) - (32 - 8)))) >> (32 - 8);
}
extern typeof(timeval_to_jiffies) timeval_to_jiffies; static const char __kstrtab_timeval_to_jiffies[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "timeval_to_jiffies"; static const struct kernel_symbol __ksymtab_timeval_to_jiffies __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&timeval_to_jiffies, __kstrtab_timeval_to_jiffies };
...
extern typeof(jiffies_to_timeval) jiffies_to_timeval; static const char __kstrtab_jiffies_to_timeval[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "jiffies_to_timeval"; static const struct kernel_symbol __ksymtab_jiffies_to_timeval __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&jiffies_to_timeval, __kstrtab_jiffies_to_timeval };
...
clock_t jiffies_to_clock_t(long x)
{
 ...
 return div_u64((u64)x * (( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))))), 1000000000L / 100);

}
extern typeof(jiffies_to_clock_t) jiffies_to_clock_t; static const char __kstrtab_jiffies_to_clock_t[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "jiffies_to_clock_t"; static const struct kernel_symbol __ksymtab_jiffies_to_clock_t __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&jiffies_to_clock_t, __kstrtab_jiffies_to_clock_t };
...
extern typeof(clock_t_to_jiffies) clock_t_to_jiffies; static const char __kstrtab_clock_t_to_jiffies[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "clock_t_to_jiffies"; static const struct kernel_symbol __ksymtab_clock_t_to_jiffies __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&clock_t_to_jiffies, __kstrtab_clock_t_to_jiffies };

u64 jiffies_64_to_clock_t(u64 x)
{
# 641 "../../kernel/time.c"
 x = div_u64(x * (( (((1000000UL * 1000) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((((1000000UL * 1000) % ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200)))))) << (8)) + ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))) / 2) / ((( (((12000000) / (((12000000 + 200/2) / 200))) << (8)) + ((((12000000) % (((12000000 + 200/2) / 200))) << (8)) + (((12000000 + 200/2) / 200)) / 2) / (((12000000 + 200/2) / 200))))))), (1000000000L / 100));

 return x;
}
extern typeof(jiffies_64_to_clock_t) jiffies_64_to_clock_t; static const char __kstrtab_jiffies_64_to_clock_t[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "jiffies_64_to_clock_t"; static const struct kernel_symbol __ksymtab_jiffies_64_to_clock_t __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&jiffies_64_to_clock_t, __kstrtab_jiffies_64_to_clock_t };
...
unsigned long nsecs_to_jiffies(u64 n)
{
 ...
 return div_u64(n, 1000000000L / 200);
# 691 "../../kernel/time.c"
}
...
extern typeof(get_jiffies_64) get_jiffies_64; static const char __kstrtab_get_jiffies_64[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "get_jiffies_64"; static const struct kernel_symbol __ksymtab_get_jiffies_64 __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&get_jiffies_64, __kstrtab_get_jiffies_64 };


extern typeof(jiffies) jiffies; static const char __kstrtab_jiffies[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "jiffies"; static const struct kernel_symbol __ksymtab_jiffies __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&jiffies, __kstrtab_jiffies };
