# 1 "../../drivers/usb/gadget/f_rndis.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../drivers/usb/gadget/f_rndis.c"
# 27 "../../drivers/usb/gadget/f_rndis.c"
...
# 28 "../../drivers/usb/gadget/f_rndis.c" 2
...
# 30 "../../drivers/usb/gadget/f_rndis.c" 2
...
static inline __attribute__((always_inline)) bool is_etherdev_addr(const struct net_device *dev,
        const u8 addr[6 + 2])
{
...
# 31 "../../drivers/usb/gadget/f_rndis.c" 2
# 1 "../../include/linux/usb/android_composite.h" 1
# 24 "../../include/linux/usb/android_composite.h"
# 1 "../../include/linux/usb/composite.h" 1
...
# 38 "../../include/linux/usb/composite.h" 2
...
# 141 "../../include/linux/usb/gadget.h"
struct usb_ep {
 void *driver_data;
...
# 175 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_ep_enable(struct usb_ep *ep,
    const struct usb_endpoint_descriptor *desc)
{
 return ep->ops->enable(ep, desc);
}
# 193 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_ep_disable(struct usb_ep *ep)
{
 return ep->ops->disable(ep);
}
# 212 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) struct usb_request *usb_ep_alloc_request(struct usb_ep *ep,
             gfp_t gfp_flags)
{
 return ep->ops->alloc_request(ep, gfp_flags);
}
# 227 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) void usb_ep_free_request(struct usb_ep *ep,
           struct usb_request *req)
{
 ep->ops->free_request(ep, req);
}
# 290 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_ep_queue(struct usb_ep *ep,
          struct usb_request *req, gfp_t gfp_flags)
{
 return ep->ops->queue(ep, req, gfp_flags);
}
# 310 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_ep_dequeue(struct usb_ep *ep, struct usb_request *req)
{
 return ep->ops->dequeue(ep, req);
}
# 336 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_ep_set_halt(struct usb_ep *ep)
{
 return ep->ops->set_halt(ep, 1);
}
# 354 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_ep_clear_halt(struct usb_ep *ep)
{
 return ep->ops->set_halt(ep, 0);
}
# 369 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int
...
# 393 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_ep_fifo_status(struct usb_ep *ep)
{
...
# 410 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) void usb_ep_fifo_flush(struct usb_ep *ep)
{
...
# 477 "../../include/linux/usb/gadget.h"
struct usb_gadget {
...
static inline __attribute__((always_inline)) void set_gadget_data(struct usb_gadget *gadget, void *data)
 { dev_set_drvdata(&gadget->dev, data); }
static inline __attribute__((always_inline)) void *get_gadget_data(struct usb_gadget *gadget)
 { return dev_get_drvdata(&gadget->dev); }
static inline __attribute__((always_inline)) struct usb_gadget *dev_to_usb_gadget(struct device *dev)
{
...
# 511 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int gadget_is_dualspeed(struct usb_gadget *g)
{
...
# 530 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int gadget_is_otg(struct usb_gadget *g)
{
...
# 546 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_gadget_frame_number(struct usb_gadget *gadget)
{
 return gadget->ops->get_frame(gadget);
}
# 564 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_gadget_wakeup(struct usb_gadget *gadget)
{
 if (!gadget->ops->wakeup)
  return -95;
 return gadget->ops->wakeup(gadget);
}
# 580 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_gadget_set_selfpowered(struct usb_gadget *gadget)
{
 if (!gadget->ops->set_selfpowered)
  return -95;
 return gadget->ops->set_selfpowered(gadget, 1);
}
# 597 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_gadget_clear_selfpowered(struct usb_gadget *gadget)
{
 if (!gadget->ops->set_selfpowered)
  return -95;
 return gadget->ops->set_selfpowered(gadget, 0);
}
# 617 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_gadget_vbus_connect(struct usb_gadget *gadget)
{
 if (!gadget->ops->vbus_session)
  return -95;
 return gadget->ops->vbus_session(gadget, 1);
}
# 636 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_gadget_vbus_draw(struct usb_gadget *gadget, unsigned mA)
{
 if (!gadget->ops->vbus_draw)
  return -95;
 return gadget->ops->vbus_draw(gadget, mA);
}
# 654 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_gadget_vbus_disconnect(struct usb_gadget *gadget)
{
 if (!gadget->ops->vbus_session)
  return -95;
 return gadget->ops->vbus_session(gadget, 0);
}
# 672 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_gadget_connect(struct usb_gadget *gadget)
{
 if (!gadget->ops->pullup)
  return -95;
 return gadget->ops->pullup(gadget, 1);
}
# 694 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) int usb_gadget_disconnect(struct usb_gadget *gadget)
{
 if (!gadget->ops->pullup)
  return -95;
 return gadget->ops->pullup(gadget, 0);
}
# 774 "../../include/linux/usb/gadget.h"
...
# 811 "../../include/linux/usb/gadget.h"
int usb_gadget_register_driver(struct usb_gadget_driver *driver);
# 826 "../../include/linux/usb/gadget.h"
int usb_gadget_unregister_driver(struct usb_gadget_driver *driver);
# 840 "../../include/linux/usb/gadget.h"
struct usb_string {
 u8 id;
 const char *s;
};
# 853 "../../include/linux/usb/gadget.h"
...
# 921 "../../include/linux/usb/gadget.h"
static inline __attribute__((always_inline)) void usb_free_descriptors(struct usb_descriptor_header **v)
{
 kfree(v);
}
...
extern struct usb_ep *usb_ep_autoconfig(struct usb_gadget *,
   struct usb_endpoint_descriptor *) __attribute__ ((__section__(".devinit.text"))) __attribute__((__cold__));

extern void usb_ep_autoconfig_reset(struct usb_gadget *) __attribute__ ((__section__(".devinit.text"))) __attribute__((__cold__));
# 39 "../../include/linux/usb/composite.h" 2
# 1 "../../include/linux/switch.h" 1
...
static inline __attribute__((always_inline)) int switch_get_state(struct switch_dev *sdev)
{
 return sdev->state;
}

extern void switch_set_state(struct switch_dev *sdev, int state);
# 40 "../../include/linux/usb/composite.h" 2


struct usb_composite_dev;
struct usb_configuration;
# 98 "../../include/linux/usb/composite.h"
struct usb_function {
 const char *name;
 ...
 int disabled;
# 121 "../../include/linux/usb/composite.h"
 ...
 struct list_head list;
 unsigned long endpoints[(((32) + (8 * sizeof(long)) - 1) / (8 * sizeof(long)))];
 struct device *dev;
};
...
static inline __attribute__((always_inline)) struct usb_endpoint_descriptor *
...
int usb_add_config(struct usb_composite_dev *,
  struct usb_configuration *);
# 280 "../../include/linux/usb/composite.h"
...
# 339 "../../include/linux/usb/composite.h"
struct usb_composite_dev {
...
# 25 "../../include/linux/usb/android_composite.h" 2
...
# 32 "../../drivers/usb/gadget/f_rndis.c" 2



# 1 "../../drivers/usb/gadget/u_ether.h" 1
# 29 "../../drivers/usb/gadget/u_ether.h"
# 1 "../../include/linux/usb/cdc.h" 1
...
# 30 "../../drivers/usb/gadget/u_ether.h" 2

# 1 "../../drivers/usb/gadget/gadget_chips.h" 1
# 172 "../../drivers/usb/gadget/gadget_chips.h"
static inline __attribute__((always_inline)) int usb_gadget_controller_number(struct usb_gadget *gadget)
{
 if (0)
  return 0x01;
 else if (0)
  ...
  return 0x27;
 else if (!strcmp("s3c-udc", (gadget)->name))
  return 0x28;
 return -2;
}
...
static inline __attribute__((always_inline)) bool gadget_supports_altsettings(struct usb_gadget *gadget)
{
...
# 32 "../../drivers/usb/gadget/u_ether.h" 2
# 45 "../../drivers/usb/gadget/u_ether.h"
struct gether {
...
# 83 "../../drivers/usb/gadget/u_ether.h"
...
static inline __attribute__((always_inline)) bool can_support_ecm(struct usb_gadget *gadget)
{
...
int geth_bind_config(struct usb_configuration *c, u8 ethaddr[6]);
...
# 36 "../../drivers/usb/gadget/f_rndis.c" 2
# 1 "../../drivers/usb/gadget/rndis.h" 1
# 18 "../../drivers/usb/gadget/rndis.h"
# 1 "../../drivers/usb/gadget/ndis.h" 1
# 29 "../../drivers/usb/gadget/ndis.h"
...
# 19 "../../drivers/usb/gadget/rndis.h" 2
# 70 "../../drivers/usb/gadget/rndis.h"
...
int __attribute__ ((__section__(".devinit.text"))) __attribute__((__cold__)) rndis_init (void);
void rndis_exit (void);
# 37 "../../drivers/usb/gadget/f_rndis.c" 2
# 115 "../../drivers/usb/gadget/f_rndis.c"
...
static inline __attribute__((always_inline)) struct f_rndis *func_to_rndis(struct usb_function *f)
{
 return ({ const typeof( ((struct f_rndis *)0)->port.func ) *__mptr = (f); (struct f_rndis *)( (char *)__mptr - __builtin_offsetof(struct f_rndis,port.func) );});
}
...
# 161 "../../drivers/usb/gadget/f_rndis.c"
...
static struct usb_endpoint_descriptor hs_in_desc = {
 ...
 .bEndpointAddress = 0x80,
 .bmAttributes = 2,
 .wMaxPacketSize = (( __le16)(__u16)(512)),
};
...
static void rndis_response_available(void *_rndis)
{
 ...
 if ((atomic_add_return(1, &rndis->notify_count)) != 1)
  return;
 ...
 data[0] = (( __le32)(__u32)(1));
 data[1] = (( __le32)(__u32)(0));

 status = usb_ep_queue(rndis->notify, req, ((( gfp_t)0x20u)));
 if (status) {
  atomic_sub(1, &rndis->notify_count);
  ({ if (0) printk("<7>" "%s %s: " "notify/0 --> %d\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev) , status); 0; });
 }
}
...
static void rndis_response_complete(struct usb_ep *ep, struct usb_request *req)
{
 ...
 case -108:
  ...
  (((&rndis->notify_count)->counter) = (0));
  break;
 default:
  ({ if (0) printk("<7>" "%s %s: " "RNDIS %s response error %d, %d/%d\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev) , ep->name, status, req->actual, req->length); 0; });
 ...
 case 0:
  ...
  if ((atomic_sub_return(1, &rndis->notify_count) == 0))
   break;
  status = usb_ep_queue(rndis->notify, req, ((( gfp_t)0x20u)));
  if (status) {
   atomic_sub(1, &rndis->notify_count);
   ({ if (0) printk("<7>" "%s %s: " "notify/1 --> %d\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev) , status); 0; });
  }
  break;
 }
}
...
static void rndis_command_complete(struct usb_ep *ep, struct usb_request *req)
{
 ...
 struct usb_composite_dev *cdev = rndis->port.func.config->cdev;
 int status;
# 473 "../../drivers/usb/gadget/f_rndis.c"
 status = rndis_msg_parser(rndis->config, (u8 *) req->buf);
 if (status < 0)
  printk("<3>" "%s %s: " "RNDIS command error %d, %d/%d\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev) , status, req->actual, req->length);
...
rndis_setup(struct usb_function *f, const struct usb_ctrlrequest *ctrl)
{
 ...
 int value = -95;
 u16 w_index = (( __u16)(__le16)(ctrl->wIndex));
 u16 w_value = (( __u16)(__le16)(ctrl->wValue));
 u16 w_length = (( __u16)(__le16)(ctrl->wLength));
# 501 "../../drivers/usb/gadget/f_rndis.c"
 switch ((ctrl->bRequestType << 8) | ctrl->bRequest) {




 case ((0 | (0x01 << 5) | 0x01) << 8)
   | 0x00:
  do { } while (0);
 ...
 default:
invalid:
  ({ if (0) printk("<7>" "%s %s: " "invalid control req%02x.%02x v%04x i%04x l%d\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev) , ctrl->bRequestType, ctrl->bRequest, w_value, w_index, w_length); 0; });
 ...
 if (value >= 0) {
  ({ if (0) printk("<7>" "%s %s: " "rndis req%02x.%02x v%04x i%04x l%d\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev) , ctrl->bRequestType, ctrl->bRequest, w_value, w_index, w_length); 0; });


  req->zero = (value < w_length);
  req->length = value;
  do { } while (0);
  value = usb_ep_queue(cdev->gadget->ep0, req, ((( gfp_t)0x20u)));
  if (value < 0)
   printk("<3>" "%s %s: " "rndis response on err %d\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev) , value);
 }
...
static int rndis_set_alt(struct usb_function *f, unsigned intf, unsigned alt)
{
 ...
 if (intf == rndis->ctrl_id) {
  if (rndis->notify->driver_data) {
   ({ if (0) printk("<7>" "%s %s: " "reset rndis control %d\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev) , intf); 0; });
   usb_ep_disable(rndis->notify);
  } else {
   ({ if (0) printk("<7>" "%s %s: " "init rndis ctrl %d\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev) , intf); 0; });
  }
  ...
  if (rndis->port.in_ep->driver_data) {
   ({ if (0) printk("<7>" "%s %s: " "reset rndis\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev)); 0; });
   gether_disconnect(&rndis->port);
  }

  if (!rndis->port.in) {
   ({ if (0) printk("<7>" "%s %s: " "init rndis\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev)); 0; });
  }
...
# 619 "../../drivers/usb/gadget/f_rndis.c"
  rndis->port.cdc_filter = 0;

  ({ if (0) printk("<7>" "%s %s: " "RNDIS RX/TX early activation ... \n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev)); 0; });
...
static void rndis_disable(struct usb_function *f)
{
 ...
 ({ if (0) printk("<7>" "%s %s: " "rndis deactivated\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev)); 0; });
...
# 663 "../../drivers/usb/gadget/f_rndis.c"
static void rndis_open(struct gether *geth)
{
 struct f_rndis *rndis = func_to_rndis(&geth->func);
 struct usb_composite_dev *cdev = geth->func.config->cdev;

 ({ if (0) printk("<7>" "%s %s: " "%s\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev) , __func__); 0; });

 rndis_set_param_medium(rndis->config, 0x00000000,
...
static void rndis_close(struct gether *geth)
{
 ...
 ({ if (0) printk("<7>" "%s %s: " "%s\n" , dev_driver_string(&(geth->func.config->cdev)->gadget->dev) , dev_name(&(geth->func.config->cdev)->gadget->dev) , __func__); 0; });

 rndis_set_param_medium(rndis->config, 0x00000000, 0);
...
rndis_bind(struct usb_configuration *c, struct usb_function *f)
{
 ...
 rndis->notify_req = usb_ep_alloc_request(ep, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!rndis->notify_req)
  goto fail;
 rndis->notify_req->buf = kmalloc(8, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!rndis->notify_req->buf)
  goto fail;
 rndis->notify_req->length = 8;
 do { } while (0);
 ...
 ({ if (0) printk("<7>" "%s %s: " "RNDIS: %s speed IN/%s OUT/%s NOTIFY/%s\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev) , gadget_is_dualspeed(c->cdev->gadget) ? "dual" : "full", rndis->port.in_ep->name, rndis->port.out_ep->name, rndis->notify->name); 0; });
...
fail:
 ...
 if (rndis->notify)
  rndis->notify->driver_data = ((void *)0);
 if (rndis->port.out)
  rndis->port.out_ep->driver_data = ((void *)0);
 if (rndis->port.in)
  rndis->port.in_ep->driver_data = ((void *)0);

 printk("<3>" "%s %s: " "%s: can't bind, err %d\n" , dev_driver_string(&(cdev)->gadget->dev) , dev_name(&(cdev)->gadget->dev) , f->name, status);
...
static inline __attribute__((always_inline)) bool can_support_rndis(struct usb_configuration *c)
{

 return true;
}
# 959 "../../drivers/usb/gadget/f_rndis.c"
int
rndis_bind_config(struct usb_configuration *c, u8 ethaddr[6])
{
 ...
 status = -12;
 rndis = kzalloc(sizeof *rndis, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!rndis)
  goto fail;

 memcpy(rndis->ethaddr, ethaddr, 6);
...
# 1 "../../drivers/usb/gadget/rndis.c" 1
# 64 "../../drivers/usb/gadget/rndis.c"
static rndis_params rndis_per_dev_params [1];


static const __le32 rndis_driver_version = (( __le32)(__u32)(1));
...
static const u32 oid_supported_list [] =
{
 ...
 0x00020104,
 0x00020105,
# 118 "../../drivers/usb/gadget/rndis.c"
 0x01010101,
 0x01010102,
 0x01010103,
 0x01010105,
 ...
 0x01020102,
 0x01020103,
# 160 "../../drivers/usb/gadget/rndis.c"
};
  ...
  rndis_resp_t *r)
{
 ...
 if (buf_len && 0 > 1) {
  ({ if (0) printk("<7>" "query OID %08x value, len %d:\n", OID, buf_len); 0; });
  for (i = 0; i < buf_len; i += 16) {
   ({ if (0) printk("<7>" "%03d: %08x %08x %08x %08x\n", i, get_unaligned_le32(&buf[i]), get_unaligned_le32(&buf[i + 4]), get_unaligned_le32(&buf[i + 8]), get_unaligned_le32(&buf[i + 12])); 0; });
 ...
 resp->InformationBufferOffset = (( __le32)(__u32)(16));
 ...
 case 0x00010101:
  ({ if (0) printk("<7>" "%s: OID_GEN_SUPPORTED_LIST\n", __func__); 0; });
  length = sizeof (oid_supported_list);
  count = length / sizeof (u32);
  for (i = 0; i < count; i++)
   outbuf[i] = (( __le32)(__u32)(oid_supported_list[i]));
  retval = 0;
  break;


 case 0x00010102:
  ({ if (0) printk("<7>" "%s: OID_GEN_HARDWARE_STATUS\n", __func__); 0; });
  ...
  *outbuf = (( __le32)(__u32)(0));
  retval = 0;
  break;


 case 0x00010103:
  ({ if (0) printk("<7>" "%s: OID_GEN_MEDIA_SUPPORTED\n", __func__); 0; });
  *outbuf = (( __le32)(__u32)(rndis_per_dev_params [configNr].medium));
  retval = 0;
  break;


 case 0x00010104:
  ({ if (0) printk("<7>" "%s: OID_GEN_MEDIA_IN_USE\n", __func__); 0; });
 ...
 case 0x00010106:
  ({ if (0) printk("<7>" "%s: OID_GEN_MAXIMUM_FRAME_SIZE\n", __func__); 0; });
  if (rndis_per_dev_params [configNr].dev) {
   *outbuf = (( __le32)(__u32)(rndis_per_dev_params [configNr].dev->mtu));
 ...
 case 0x00010107:
  if (0 > 1)
   ({ if (0) printk("<7>" "%s: OID_GEN_LINK_SPEED\n", __func__); 0; });
  if (rndis_per_dev_params [configNr].media_state
    == 0x00000001)
   *outbuf = (( __le32)(__u32)(0));
  else
   *outbuf = (( __le32)(__u32)(rndis_per_dev_params [configNr].speed));
 ...
 case 0x0001010A:
  ({ if (0) printk("<7>" "%s: OID_GEN_TRANSMIT_BLOCK_SIZE\n", __func__); 0; });
  if (rndis_per_dev_params [configNr].dev) {
   *outbuf = (( __le32)(__u32)(rndis_per_dev_params [configNr].dev->mtu));
 ...
 case 0x0001010B:
  ({ if (0) printk("<7>" "%s: OID_GEN_RECEIVE_BLOCK_SIZE\n", __func__); 0; });
  if (rndis_per_dev_params [configNr].dev) {
   *outbuf = (( __le32)(__u32)(rndis_per_dev_params [configNr].dev->mtu));
 ...
 case 0x0001010C:
  ({ if (0) printk("<7>" "%s: OID_GEN_VENDOR_ID\n", __func__); 0; });
  *outbuf = (( __le32)(__u32)(rndis_per_dev_params [configNr].vendorID));
 ...
 case 0x0001010D:
  ({ if (0) printk("<7>" "%s: OID_GEN_VENDOR_DESCRIPTION\n", __func__); 0; });
 ...
 case 0x00010116:
  ({ if (0) printk("<7>" "%s: OID_GEN_VENDOR_DRIVER_VERSION\n", __func__); 0; });
 ...
 case 0x0001010E:
  ({ if (0) printk("<7>" "%s: OID_GEN_CURRENT_PACKET_FILTER\n", __func__); 0; });
  *outbuf = (( __le32)(__u32)(*rndis_per_dev_params[configNr].filter));
  retval = 0;
  break;


 case 0x00010111:
  ({ if (0) printk("<7>" "%s: OID_GEN_MAXIMUM_TOTAL_SIZE\n", __func__); 0; });
  *outbuf = (( __le32)(__u32)(1558));
  retval = 0;
  break;
 ...
 case 0x00010114:
  if (0 > 1)
   ({ if (0) printk("<7>" "%s: OID_GEN_MEDIA_CONNECT_STATUS\n", __func__); 0; });
  *outbuf = (( __le32)(__u32)(rndis_per_dev_params [configNr] .media_state));

  retval = 0;
  break;

 case 0x00010202:
  ({ if (0) printk("<7>" "%s: OID_GEN_PHYSICAL_MEDIUM\n", __func__); 0; });
  *outbuf = (( __le32)(__u32)(0));
  retval = 0;
  break;
 ...
 case 0x00010113:
  ({ if (0) printk("<7>" "%s: OID_GEN_MAC_OPTIONS\n", __func__); 0; });
  *outbuf = (( __le32)(__u32)(0x00000002 | 0x00000010));
 ...
 case 0x00020101:
  if (0 > 1)
   ({ if (0) printk("<7>" "%s: OID_GEN_XMIT_OK\n", __func__); 0; });
  if (stats) {
   *outbuf = (( __le32)(__u32)(stats->tx_packets - stats->tx_errors - stats->tx_dropped));
 ...
 case 0x00020102:
  if (0 > 1)
   ({ if (0) printk("<7>" "%s: OID_GEN_RCV_OK\n", __func__); 0; });
  if (stats) {
   *outbuf = (( __le32)(__u32)(stats->rx_packets - stats->rx_errors - stats->rx_dropped));
 ...
 case 0x00020103:
  if (0 > 1)
   ({ if (0) printk("<7>" "%s: OID_GEN_XMIT_ERROR\n", __func__); 0; });
  if (stats) {
   *outbuf = (( __le32)(__u32)(stats->tx_errors));
   retval = 0;
  }
  break;
 ...
 case 0x00020104:
  if (0 > 1)
   ({ if (0) printk("<7>" "%s: OID_GEN_RCV_ERROR\n", __func__); 0; });
  if (stats) {
   *outbuf = (( __le32)(__u32)(stats->rx_errors));
   retval = 0;
  }
  break;
 ...
 case 0x00020105:
  ({ if (0) printk("<7>" "%s: OID_GEN_RCV_NO_BUFFER\n", __func__); 0; });
  if (stats) {
   *outbuf = (( __le32)(__u32)(stats->rx_dropped));
   retval = 0;
  }
  break;
 ...
 case 0x01010101:
  ({ if (0) printk("<7>" "%s: OID_802_3_PERMANENT_ADDRESS\n", __func__); 0; });
  if (rndis_per_dev_params [configNr].dev) {
   length = 6;
   memcpy (outbuf,
 ...
 case 0x01010102:
  ({ if (0) printk("<7>" "%s: OID_802_3_CURRENT_ADDRESS\n", __func__); 0; });
  if (rndis_per_dev_params [configNr].dev) {
   length = 6;
   memcpy (outbuf,
    rndis_per_dev_params [configNr].host_mac,
 ...
 case 0x01010103:
  ({ if (0) printk("<7>" "%s: OID_802_3_MULTICAST_LIST\n", __func__); 0; });

  *outbuf = (( __le32)(__u32)(0xE0000000));
  retval = 0;
  break;


 case 0x01010104:
  ({ if (0) printk("<7>" "%s: OID_802_3_MAXIMUM_LIST_SIZE\n", __func__); 0; });

  *outbuf = (( __le32)(__u32)(1));
  retval = 0;
  break;

 case 0x01010105:
  ({ if (0) printk("<7>" "%s: OID_802_3_MAC_OPTIONS\n", __func__); 0; });
  *outbuf = (( __le32)(__u32)(0));
  retval = 0;
  break;
 ...
 case 0x01020101:
  ({ if (0) printk("<7>" "%s: OID_802_3_RCV_ERROR_ALIGNMENT\n", __func__); 0; });
  if (stats) {
   *outbuf = (( __le32)(__u32)(stats->rx_frame_errors));
   retval = 0;
  }
  break;
 ...
 case 0x01020102:
  ({ if (0) printk("<7>" "%s: OID_802_3_XMIT_ONE_COLLISION\n", __func__); 0; });
  *outbuf = (( __le32)(__u32)(0));
  retval = 0;
  break;
 ...
 case 0x01020103:
  ({ if (0) printk("<7>" "%s: OID_802_3_XMIT_MORE_COLLISIONS\n", __func__); 0; });
  *outbuf = (( __le32)(__u32)(0));
  retval = 0;
  break;

 default:
  printk("<4>" "%s: query unknown OID 0x%08X\n", __func__, OID);

 }
 if (retval < 0)
  length = 0;

 resp->InformationBufferLength = (( __le32)(__u32)(length));
 r->length = length + sizeof *resp;
 resp->MessageLength = (( __le32)(__u32)(r->length));
 return retval;
}
   ...
   rndis_resp_t *r)
{
 ...
 if (buf_len && 0 > 1) {
  ({ if (0) printk("<7>" "set OID %08x value, len %d:\n", OID, buf_len); 0; });
  for (i = 0; i < buf_len; i += 16) {
   ({ if (0) printk("<7>" "%03d: %08x %08x %08x %08x\n", i, get_unaligned_le32(&buf[i]), get_unaligned_le32(&buf[i + 4]), get_unaligned_le32(&buf[i + 8]), get_unaligned_le32(&buf[i + 12])); 0; });
  ...
  *params->filter = (u16)get_unaligned_le32(buf);
  ({ if (0) printk("<7>" "%s: OID_GEN_CURRENT_PACKET_FILTER %08x\n", __func__, *params->filter); 0; });
 ...
 default:
  printk("<4>" "%s: set unknown OID 0x%08X, size %d\n", __func__, OID, buf_len);
...
static int rndis_init_response (int configNr, rndis_init_msg_type *buf)
{
 ...
 resp->MessageType = (( __le32)(__u32)(0x80000002U));

 resp->MessageLength = (( __le32)(__u32)(52));
 resp->RequestID = buf->RequestID;
 resp->Status = (( __le32)(__u32)(0x00000000U));
 resp->MajorVersion = (( __le32)(__u32)(1));
 resp->MinorVersion = (( __le32)(__u32)(0));
 resp->DeviceFlags = (( __le32)(__u32)(0x00000001U));
 resp->Medium = (( __le32)(__u32)(0x00000000U));
 resp->MaxPacketsPerTransfer = (( __le32)(__u32)(1));
 resp->MaxTransferSize = (( __le32)(__u32)(params->dev->mtu + sizeof (struct ethhdr) + sizeof (struct rndis_packet_msg_type) + 22));




 resp->PacketAlignmentFactor = (( __le32)(__u32)(0));
 resp->AFListOffset = (( __le32)(__u32)(0));
 resp->AFListSize = (( __le32)(__u32)(0));
...
static int rndis_query_response (int configNr, rndis_query_msg_type *buf)
{
 ...
 resp->MessageType = (( __le32)(__u32)(0x80000004U));
 resp->RequestID = buf->RequestID;

 if (gen_ndis_query_resp (configNr, (( __u32)(__le32)(buf->OID)),
   (( __u32)(__le32)(buf->InformationBufferOffset))
     + 8 + (u8 *) buf,
   (( __u32)(__le32)(buf->InformationBufferLength)),
   r)) {

  resp->Status = (( __le32)(__u32)(0xC00000BBU));

  resp->MessageLength = (( __le32)(__u32)(sizeof *resp));
  resp->InformationBufferLength = (( __le32)(__u32)(0));
  resp->InformationBufferOffset = (( __le32)(__u32)(0));
 } else
  resp->Status = (( __le32)(__u32)(0x00000000U));
...
static int rndis_set_response (int configNr, rndis_set_msg_type *buf)
{
 ...
 BufLength = (( __u32)(__le32)(buf->InformationBufferLength));
 BufOffset = (( __u32)(__le32)(buf->InformationBufferOffset));
# 672 "../../drivers/usb/gadget/rndis.c"
 resp->MessageType = (( __le32)(__u32)(0x80000005U));
 resp->MessageLength = (( __le32)(__u32)(16));
 resp->RequestID = buf->RequestID;
 if (gen_ndis_set_resp (configNr, (( __u32)(__le32)(buf->OID)),
...
static int rndis_reset_response (int configNr, rndis_reset_msg_type *buf)
{
 ...
 resp->MessageType = (( __le32)(__u32)(0x80000006U));
 resp->MessageLength = (( __le32)(__u32)(16));
 resp->Status = (( __le32)(__u32)(0x00000000U));

 resp->AddressingReset = (( __le32)(__u32)(1));
    ...
    rndis_keepalive_msg_type *buf)
{
 ...
 resp->MessageType = (( __le32)(__u32)(0x80000008U));
...
static int rndis_indicate_status_msg (int configNr, u32 status)
{
 ...
 resp->MessageType = (( __le32)(__u32)(0x00000007U));

 resp->MessageLength = (( __le32)(__u32)(20));
 resp->Status = (( __le32)(__u32)(status));
 resp->StatusBufferLength = (( __le32)(__u32)(0));
 resp->StatusBufferOffset = (( __le32)(__u32)(0));
...
int rndis_msg_parser (u8 configNr, u8 *buf)
{
 ...
 switch (MsgType) {
 case 0x00000002U:
  ({ if (0) printk("<7>" "%s: REMOTE_NDIS_INITIALIZE_MSG\n", __func__); 0; });
 ...
 case 0x00000003U:
  ({ if (0) printk("<7>" "%s: REMOTE_NDIS_HALT_MSG\n", __func__); 0; });
 ...
 case 0x00000006U:
  ({ if (0) printk("<7>" "%s: REMOTE_NDIS_RESET_MSG\n", __func__); 0; });
 ...
 case 0x00000008U:
  ...
  if (0 > 1)
   ({ if (0) printk("<7>" "%s: REMOTE_NDIS_KEEPALIVE_MSG\n", __func__); 0; });
 ...
 default:
  ...
  printk("<4>" "%s: unknown RNDIS message 0x%08X len %d\n", __func__ , MsgType, MsgLength);

  {
   unsigned i;
   for (i = 0; i < MsgLength; i += 16) {
    ({ if (0) printk("<7>" "%03d: " " %02x %02x %02x %02x" " %02x %02x %02x %02x" " %02x %02x %02x %02x" " %02x %02x %02x %02x" "\n", i, buf[i], buf [i+1], buf[i+2], buf[i+3], buf[i+4], buf [i+5], buf[i+6], buf[i+7], buf[i+8], buf [i+9], buf[i+10], buf[i+11], buf[i+12], buf [i+13], buf[i+14], buf[i+15]); 0; });
# 887 "../../drivers/usb/gadget/rndis.c"
   }
  }
  break;
 }
...
int rndis_register(void (*resp_avail)(void *v), void *v)
{
 ...
 for (i = 0; i < 1; i++) {
  if (!rndis_per_dev_params [i].used) {
   ...
   ({ if (0) printk("<7>" "%s: configNr = %d\n", __func__, i); 0; });
   return i;
  }
 }
 ({ if (0) printk("<7>" "failed\n"); 0; });
...
void rndis_add_hdr (struct sk_buff *skb)
{
 ...
 ({ void *__p = (header); size_t __n = sizeof *header; if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
 header->MessageType = (( __le32)(__u32)(0x00000001U));
 header->MessageLength = (( __le32)(__u32)(skb->len));
 header->DataOffset = (( __le32)(__u32)(36));
 header->DataLength = (( __le32)(__u32)(skb->len - sizeof *header));
}
...
void rndis_free_response (int configNr, u8 *buf)
{
 ...
 for (act = (&(rndis_per_dev_params [configNr].resp_queue))->next, tmp = act->next; act != (&(rndis_per_dev_params [configNr].resp_queue)); act = tmp, tmp = act->next)

 {
  r = ({ const typeof( ((rndis_resp_t *)0)->list ) *__mptr = (act); (rndis_resp_t *)( (char *)__mptr - __builtin_offsetof(rndis_resp_t,list) );});
  if (r && r->buf == buf) {
   list_del (&r->list);
   kfree (r);
  }
...
static rndis_resp_t *rndis_add_response (int configNr, u32 length)
{
 ...
 r = kmalloc (sizeof (rndis_resp_t) + length, ((( gfp_t)0x20u)));
 if (!r) return ((void *)0);
   ...
   struct sk_buff_head *list)
{
 ...
 if ((( __le32)(__u32)(0x00000001U))
   != (( typeof(*(tmp++)))({ __builtin_choose_expr(sizeof(*(tmp++)) == 1, *(tmp++), __builtin_choose_expr(sizeof(*(tmp++)) == 2, get_unaligned_le16((tmp++)), __builtin_choose_expr(sizeof(*(tmp++)) == 4, get_unaligned_le32((tmp++)), __builtin_choose_expr(sizeof(*(tmp++)) == 8, get_unaligned_le64((tmp++)), __bad_unaligned_access_size())))); }))) {
  dev_kfree_skb_any(skb);
  return -22;
 }
 tmp++;
...
# 1154 "../../drivers/usb/gadget/rndis.c"
int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) rndis_init (void)
{
 u8 i;

 for (i = 0; i < 1; i++) {
# 1177 "../../drivers/usb/gadget/rndis.c"
...
void rndis_exit (void)
{
# 1199 "../../drivers/usb/gadget/rndis.c"
}
# 1045 "../../drivers/usb/gadget/f_rndis.c" 2
...
int rndis_function_bind_config(struct usb_configuration *c)
{
 ...
 if (!rndis_pdata) {
  printk("<3>" "rndis_pdata null in rndis_function_bind_config\n");
  return -1;
 }
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) init(void)
{
 printk("<6>" "f_rndis init\n");
 platform_driver_register(&rndis_platform_driver);
 android_register_function(&rndis_function);
 return 0;
}
static initcall_t __initcall_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = init;;
