...
# 1 "<command-line>" 2
# 1 "../../net/ipv4/netfilter/arp_tables.c"
# 12 "../../net/ipv4/netfilter/arp_tables.c"
...
# 13 "../../net/ipv4/netfilter/arp_tables.c" 2
...
# 14 "../../net/ipv4/netfilter/arp_tables.c" 2
...
# 15 "../../net/ipv4/netfilter/arp_tables.c" 2
...
# 17 "../../net/ipv4/netfilter/arp_tables.c" 2
...
# 19 "../../net/ipv4/netfilter/arp_tables.c" 2
...
extern long compat_sys_recvmmsg(int, struct mmsghdr *,
        unsigned, unsigned,
        struct compat_timespec *);
...
extern int compat_mc_setsockopt(struct sock *, int, int, char *, unsigned int,
 int (*)(struct sock *, int, int, char *, unsigned int));
extern int compat_mc_getsockopt(struct sock *, int, int, char *,
 int *, int (*)(struct sock *, int, int, char *,
    int *));
# 25 "../../net/ipv4/netfilter/arp_tables.c" 2
...
# 26 "../../net/ipv4/netfilter/arp_tables.c" 2
...
# 29 "../../net/ipv4/netfilter/arp_tables.c" 2
# 1 "../../include/linux/netfilter_arp/arp_tables.h" 1
# 20 "../../include/linux/netfilter_arp/arp_tables.h"
# 1 "../../include/linux/netfilter_arp.h" 1
# 21 "../../include/linux/netfilter_arp/arp_tables.h" 2
...
# 90 "../../include/linux/netfilter_arp/arp_tables.h"
struct arpt_entry
{
 struct arpt_arp arp;
...
# 135 "../../include/linux/netfilter_arp/arp_tables.h"
struct arpt_getinfo {
...
static __inline__ __attribute__((always_inline)) struct xt_entry_target *arpt_get_target(struct arpt_entry *e)
{
 return (void *)e + e->target_offset;
}
# 226 "../../include/linux/netfilter_arp/arp_tables.h"
...
# 263 "../../include/linux/netfilter_arp/arp_tables.h"
...
# 30 "../../net/ipv4/netfilter/arp_tables.c" 2
# 1 "../../net/ipv4/netfilter/../../netfilter/xt_repldata.h" 1
# 31 "../../net/ipv4/netfilter/arp_tables.c" 2

;
;
;
# 57 "../../net/ipv4/netfilter/arp_tables.c"
void *arpt_alloc_initial_table(const struct xt_table *info)
{
 return ({ unsigned int hook_mask = info->valid_hooks; unsigned int nhooks = (__builtin_constant_p(hook_mask) ? ((( (!!((hook_mask) & (1ULL << 0))) + (!!((hook_mask) & (1ULL << 1))) + (!!((hook_mask) & (1ULL << 2))) + (!!((hook_mask) & (1ULL << 3))) + (!!((hook_mask) & (1ULL << 4))) + (!!((hook_mask) & (1ULL << 5))) + (!!((hook_mask) & (1ULL << 6))) + (!!((hook_mask) & (1ULL << 7))) ) + ( (!!(((hook_mask) >> 8) & (1ULL << 0))) + (!!(((hook_mask) >> 8) & (1ULL << 1))) + (!!(((hook_mask) >> 8) & (1ULL << 2))) + (!!(((hook_mask) >> 8) & (1ULL << 3))) + (!!(((hook_mask) >> 8) & (1ULL << 4))) + (!!(((hook_mask) >> 8) & (1ULL << 5))) + (!!(((hook_mask) >> 8) & (1ULL << 6))) + (!!(((hook_mask) >> 8) & (1ULL << 7))) )) + (( (!!(((hook_mask) >> 16) & (1ULL << 0))) + (!!(((hook_mask) >> 16) & (1ULL << 1))) + (!!(((hook_mask) >> 16) & (1ULL << 2))) + (!!(((hook_mask) >> 16) & (1ULL << 3))) + (!!(((hook_mask) >> 16) & (1ULL << 4))) + (!!(((hook_mask) >> 16) & (1ULL << 5))) + (!!(((hook_mask) >> 16) & (1ULL << 6))) + (!!(((hook_mask) >> 16) & (1ULL << 7))) ) + ( (!!((((hook_mask) >> 16) >> 8) & (1ULL << 0))) + (!!((((hook_mask) >> 16) >> 8) & (1ULL << 1))) + (!!((((hook_mask) >> 16) >> 8) & (1ULL << 2))) + (!!((((hook_mask) >> 16) >> 8) & (1ULL << 3))) + (!!((((hook_mask) >> 16) >> 8) & (1ULL << 4))) + (!!((((hook_mask) >> 16) >> 8) & (1ULL << 5))) + (!!((((hook_mask) >> 16) >> 8) & (1ULL << 6))) + (!!((((hook_mask) >> 16) >> 8) & (1ULL << 7))) ))) : __arch_hweight32(hook_mask)); unsigned int bytes = 0, hooknum = 0, i = 0; struct { struct arpt_replace repl; struct arpt_standard entries[nhooks]; struct arpt_error term; } *tbl = kzalloc(sizeof(*tbl), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u))); if (tbl == ((void *)0)) return ((void *)0); strncpy(tbl->repl.name, info->name, sizeof(tbl->repl.name)); tbl->term = (struct arpt_error){ .entry = { .target_offset = sizeof(struct arpt_entry), .next_offset = (sizeof(struct arpt_error)), }, .target = { .target.u.user = { .target_size = ((((sizeof(struct arpt_error_target))) + ((typeof((sizeof(struct arpt_error_target))))(__alignof__(struct _xt_align)) - 1)) & ~((typeof((sizeof(struct arpt_error_target))))(__alignof__(struct _xt_align)) - 1)), .name = "ERROR", }, }, .target.errorname = "ERROR", }; tbl->repl.valid_hooks = hook_mask; tbl->repl.num_entries = nhooks + 1; tbl->repl.size = nhooks * sizeof(struct arpt_standard) + sizeof(struct arpt_error); for (; hook_mask != 0; hook_mask >>= 1, ++hooknum) { if (!(hook_mask & 1)) continue; tbl->repl.hook_entry[hooknum] = bytes; tbl->repl.underflow[hooknum] = bytes; tbl->entries[i++] = (struct arpt_standard) { .entry = { .target_offset = sizeof(struct arpt_entry), .next_offset = (sizeof(struct arpt_standard)), }, .target = { .target.u.user = { .target_size = ((((sizeof(struct xt_standard_target))) + ((typeof((sizeof(struct xt_standard_target))))(__alignof__(struct _xt_align)) - 1)) & ~((typeof((sizeof(struct xt_standard_target))))(__alignof__(struct _xt_align)) - 1)), .name = "", }, }, .target.verdict = -(1) - 1, }; bytes += sizeof(struct arpt_standard); } tbl; });
}
extern typeof(arpt_alloc_initial_table) arpt_alloc_initial_table; static const char __kstrtab_arpt_alloc_initial_table[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "arpt_alloc_initial_table"; static const struct kernel_symbol __ksymtab_arpt_alloc_initial_table __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&arpt_alloc_initial_table, __kstrtab_arpt_alloc_initial_table };

static inline __attribute__((always_inline)) int arp_devaddr_compare(const struct arpt_devaddr_info *ap,
...
static inline __attribute__((always_inline)) int arp_packet_match(const struct arphdr *arphdr,
       struct net_device *dev,
       const char *indev,
       const char *outdev,
       const struct arpt_arp *arpinfo)
{
 ...
 if ((((arphdr->ar_op & arpinfo->arpop_mask) != arpinfo->arpop) ^ !!(arpinfo->invflags & (0x0040)))) {
 ...
 if ((((arphdr->ar_hrd & arpinfo->arhrd_mask) != arpinfo->arhrd) ^ !!(arpinfo->invflags & (0x0080)))) {
 ...
 if ((((arphdr->ar_pro & arpinfo->arpro_mask) != arpinfo->arpro) ^ !!(arpinfo->invflags & (0x0100)))) {
 ...
 if ((((arphdr->ar_hln & arpinfo->arhln_mask) != arpinfo->arhln) ^ !!(arpinfo->invflags & (0x0200)))) {
 ...
 if (((arp_devaddr_compare(&arpinfo->src_devaddr, src_devaddr, dev->addr_len)) ^ !!(arpinfo->invflags & (0x0010))) ||

     ((arp_devaddr_compare(&arpinfo->tgt_devaddr, tgt_devaddr, dev->addr_len)) ^ !!(arpinfo->invflags & (0x0020)))) {
 ...
 if ((((src_ipaddr & arpinfo->smsk.s_addr) != arpinfo->src.s_addr) ^ !!(arpinfo->invflags & (0x0004))) ||

     ((((tgt_ipaddr & arpinfo->tmsk.s_addr) != arpinfo->tgt.s_addr)) ^ !!(arpinfo->invflags & (0x0008)))) {
 ...
 if (((ret != 0) ^ !!(arpinfo->invflags & (0x0001)))) {
  ;
 ...
 if (((ret != 0) ^ !!(arpinfo->invflags & (0x0002)))) {
  ;
...
static inline __attribute__((always_inline)) int arp_checkentry(const struct arpt_arp *arp)
{
 if (arp->flags & ~0x00) {
  ;
...
{
 if (net_ratelimit())
  printk("<3>" "arp_tables" ": " "arp_tables: error: '%s'\n", (const char *)par->targinfo);


 return 0;
}

static inline __attribute__((always_inline)) const struct xt_entry_target *
arpt_get_target_c(const struct arpt_entry *e)
{
 return arpt_get_target((struct arpt_entry *)e);
}

static inline __attribute__((always_inline)) struct arpt_entry *
...
unsigned int arpt_do_table(struct sk_buff *skb,
      ...
      struct xt_table *table)
{
 static const char nulldevname[16] __attribute__((aligned(sizeof(long))));
 ...
 table_base = private->entries[(current_thread_info()->cpu)];
 ...
 do {
  ...
  hdr_len = sizeof(*arp) + (2 * sizeof(struct in_addr)) +
   (2 * skb->dev->addr_len);
  do { (e->counters).bcnt += (hdr_len); (e->counters).pcnt += (1); } while(0);
...
static inline __attribute__((always_inline)) bool unconditional(const struct arpt_arp *arp)
{
         ...
         unsigned int valid_hooks, void *entry0)
{
 ...
 for (hook = 0; hook < 3; hook++) {
  ...
  for (;;) {
   ...
   if (e->comefrom & (1 << 3)) {
    printk("<5>" "arp_tables" ": " "arptables: loop hook %u pos %u %08X.\n", hook, pos, e->comefrom);
...
static inline __attribute__((always_inline)) int check_entry(const struct arpt_entry *e, const char *name)
{
 const struct xt_entry_target *t;
...
static inline __attribute__((always_inline)) int check_target(struct arpt_entry *e, const char *name)
{
...
static inline __attribute__((always_inline)) int check_entry_size_and_hooks(struct arpt_entry *e,
          struct xt_table_info *newinfo,
 ...
 for (h = 0; h < 3; h++) {
  ...
  if ((unsigned char *)e - base == underflows[h]) {
   if (!check_underflow(e)) {
    printk("<3>" "arp_tables" ": " "Underflows must be unconditional and " "use the STANDARD target with " "ACCEPT/DROP\n");
...
static inline __attribute__((always_inline)) void cleanup_entry(struct arpt_entry *e)
{
                           ...
                           const struct arpt_replace *repl)
{
 ...
 for ((iter) = (typeof(iter))(entry0); (iter) < (typeof(iter))((char *)(entry0) + (newinfo->size)); (iter) = (typeof(iter))((char *)(iter) + (iter)->next_offset)) {
    ...
    struct xt_counters counters[])
{
 ...
 unsigned int i;
 unsigned int curcpu;
# 725 "../../net/ipv4/netfilter/arp_tables.c"
 local_bh_disable();
 curcpu = (current_thread_info()->cpu);

 i = 0;
 for ((iter) = (typeof(iter))(t->entries[curcpu]); (iter) < (typeof(iter))((char *)(t->entries[curcpu]) + (t->size)); (iter) = (typeof(iter))((char *)(iter) + (iter)->next_offset)) {
  do { (counters[i]).bcnt = (iter->counters.bcnt); (counters[i]).pcnt = (iter->counters.pcnt); } while(0);
 ...
 for (((cpu)) = -1; ((cpu)) = cpumask_next(((cpu)), (cpu_possible_mask)), ((cpu)) < nr_cpu_ids;) {
  ...
  i = 0;
  xt_info_wrlock(cpu);
  for ((iter) = (typeof(iter))(t->entries[cpu]); (iter) < (typeof(iter))((char *)(t->entries[cpu]) + (t->size)); (iter) = (typeof(iter))((char *)(iter) + (iter)->next_offset)) {
   do { (counters[i]).bcnt += (iter->counters.bcnt); (counters[i]).pcnt += (iter->counters.pcnt); } while(0);
    ...
    void *userptr)
{
 ...
 loc_cpu_entry = private->entries[(current_thread_info()->cpu)];
 ...
 for (off = 0, num = 0; off < total_size; off += e->next_offset, num++){
  ...
  if (copy_to_user(userptr + off
     + __builtin_offsetof(struct arpt_entry,counters),
     &counters[num],
  ...
  if (copy_to_user(userptr + off + e->target_offset
     + __builtin_offsetof(struct xt_entry_target,u.user.name),
...
# 894 "../../net/ipv4/netfilter/arp_tables.c"
static int get_info(struct net *net, void *user,
                    const int *len, int compat)
{
 ...
 t = ((xt_find_table_lock(net, NFPROTO_ARP, name)) ?: (__request_module(true, "arptable_%s", name), (xt_find_table_lock(net, NFPROTO_ARP, name))));

 if (t && !IS_ERR(t)) {
  struct arpt_getinfo info;
  const struct xt_table_info *private = t->private;
# 929 "../../net/ipv4/netfilter/arp_tables.c"
...
static int get_entries(struct net *net, struct arpt_get_entries *uptr,
         const int *len)
{
 int ret;
   ...
   void *counters_ptr)
{
 ...
 loc_cpu_old_entry = oldinfo->entries[(current_thread_info()->cpu)];
 for ((iter) = (typeof(iter))(loc_cpu_old_entry); (iter) < (typeof(iter))((char *)(loc_cpu_old_entry) + (oldinfo->size)); (iter) = (typeof(iter))((char *)(iter) + (iter)->next_offset))
  cleanup_entry(iter);
...
static int do_replace(struct net *net, const void *user,
                      unsigned int len)
{
 int ret;
 ...
 if (tmp.num_counters >= ((int)(~0U>>1)) / sizeof(struct xt_counters))
  return -12;
 ...
 loc_cpu_entry = newinfo->entries[(current_thread_info()->cpu)];
 ...
 for ((iter) = (typeof(iter))(loc_cpu_entry); (iter) < (typeof(iter))((char *)(loc_cpu_entry) + (newinfo->size)); (iter) = (typeof(iter))((char *)(iter) + (iter)->next_offset))
  cleanup_entry(iter);
 free_newinfo:
...
static int do_add_counters(struct net *net, const void *user,
      unsigned int len, int compat)
{
 ...
 void *loc_cpu_entry;
 struct arpt_entry *iter;
# 1140 "../../net/ipv4/netfilter/arp_tables.c"
 {
  ptmp = &tmp;
 ...
 for ((iter) = (typeof(iter))(loc_cpu_entry); (iter) < (typeof(iter))((char *)(loc_cpu_entry) + (private->size)); (iter) = (typeof(iter))((char *)(iter) + (iter)->next_offset)) {
  do { (iter->counters).bcnt += (paddc[i].bcnt); (iter->counters).pcnt += (paddc[i].pcnt); } while(0);
  ++i;
 }
...
# 1706 "../../net/ipv4/netfilter/arp_tables.c"
...
static int do_arpt_get_ctl(struct sock *sk, int cmd, void *user, int *len)
{
 ...
 case (96 + 3): {
  ...
  ((xt_find_revision(NFPROTO_ARP, rev.name, rev.revision, 1, &ret)) ?: (__request_module(true, "arpt_%s", rev.name), (xt_find_revision(NFPROTO_ARP, rev.name, rev.revision, 1, &ret))));
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) arp_tables_net_init(struct net *net)
{
 return xt_proto_init(net, NFPROTO_ARP);
}

static void __attribute__ ((__section__(".ref.text"))) __attribute__((noinline)) arp_tables_net_exit(struct net *net)
{
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) arp_tables_init(void)
{
 int ret;
 ...
 ret = xt_register_targets(arpt_builtin_tg, (sizeof(arpt_builtin_tg) / sizeof((arpt_builtin_tg)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(arpt_builtin_tg), typeof(&arpt_builtin_tg[0]))); }))));
 if (ret < 0)
  goto err2;
 ...
 printk("<6>" "arp_tables: (C) 2002 David S. Miller\n");
 return 0;

err4:
 xt_unregister_targets(arpt_builtin_tg, (sizeof(arpt_builtin_tg) / sizeof((arpt_builtin_tg)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(arpt_builtin_tg), typeof(&arpt_builtin_tg[0]))); }))));
err2:
...
static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) arp_tables_fini(void)
{
...
extern typeof(arpt_register_table) arpt_register_table; static const char __kstrtab_arpt_register_table[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "arpt_register_table"; static const struct kernel_symbol __ksymtab_arpt_register_table __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&arpt_register_table, __kstrtab_arpt_register_table };
extern typeof(arpt_unregister_table) arpt_unregister_table; static const char __kstrtab_arpt_unregister_table[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "arpt_unregister_table"; static const struct kernel_symbol __ksymtab_arpt_unregister_table __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&arpt_unregister_table, __kstrtab_arpt_unregister_table };
extern typeof(arpt_do_table) arpt_do_table; static const char __kstrtab_arpt_do_table[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "arpt_do_table"; static const struct kernel_symbol __ksymtab_arpt_do_table __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&arpt_do_table, __kstrtab_arpt_do_table };

static initcall_t __initcall_arp_tables_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = arp_tables_init;;
static exitcall_t __exitcall_arp_tables_fini __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = arp_tables_fini;;
