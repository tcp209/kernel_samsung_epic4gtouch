...
# 1 "../../include/linux/statfs.h" 1





# 1 "../../arch/arm/include/asm/statfs.h" 1
# 11 "../../arch/arm/include/asm/statfs.h"
# 1 "../../include/asm-generic/statfs.h" 1
...
# 25 "../../include/asm-generic/statfs.h"
struct statfs {
 __u32 f_type;
 __u32 f_bsize;
 __u32 f_blocks;
...
# 47 "../../include/asm-generic/statfs.h"
struct statfs64 {
 __u32 f_type;
 __u32 f_bsize;
 __u64 f_blocks;
...
# 69 "../../include/asm-generic/statfs.h"
...
# 12 "../../arch/arm/include/asm/statfs.h" 2
# 7 "../../include/linux/statfs.h" 2
...
# 12 "../../include/linux/posix_acl.h" 2
...
# 45 "../../mm/shmem.c" 2
# 1 "../../include/linux/generic_acl.h" 1
...
static inline __attribute__((always_inline)) struct shmem_inode_info *SHMEM_I(struct inode *inode)
{
 return ({ const typeof( ((struct shmem_inode_info *)0)->vfs_inode ) *__mptr = (inode); (struct shmem_inode_info *)( (char *)__mptr - __builtin_offsetof(struct shmem_inode_info,vfs_inode) );});
}
...
static inline __attribute__((always_inline)) void putback_lru_pages(struct list_head *l) {}
static inline __attribute__((always_inline)) int migrate_pages(struct list_head *l, new_page_t x,
  unsigned long private, int offlining) { return -38; }

static inline __attribute__((always_inline)) int migrate_prep(void) { return -38; }
static inline __attribute__((always_inline)) int migrate_prep_local(void) { return -38; }

static inline __attribute__((always_inline)) int migrate_vmas(struct mm_struct *mm,
...
{
 return ({ typeof(totalram_pages - totalhigh_pages) _min1 = (totalram_pages - totalhigh_pages); typeof(totalram_pages / 2) _min2 = (totalram_pages / 2); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });
}
...
static inline __attribute__((always_inline)) struct page *shmem_dir_alloc(gfp_t gfp_mask)
{
 ...
 return alloc_pages_node(numa_node_id(), (gfp_mask & ~((( gfp_t)0x80000u)|(( gfp_t)0x08u))) | (( gfp_t)0x8000u), 12 -12);

}

static inline __attribute__((always_inline)) void shmem_dir_free(struct page *page)
{
...
static inline __attribute__((always_inline)) void shmem_dir_unmap(struct page **dir)
{
...
static inline __attribute__((always_inline)) void shmem_swp_balance_unmap(void)
{
 ...
 (void) kmap_atomic((empty_zero_page), KM_USER1);
}

static inline __attribute__((always_inline)) void shmem_swp_unmap(swp_entry_t *entry)
{
 kunmap_atomic(entry, KM_USER1);
}

static inline __attribute__((always_inline)) struct shmem_sb_info *SHMEM_SB(struct super_block *sb)
{
 return sb->s_fs_info;
}
...
static inline __attribute__((always_inline)) int shmem_acct_size(unsigned long flags, loff_t size)
{
 return (flags & 0x00200000) ?
  0 : security_vm_enough_memory_kern(((((size)+((1UL) << 12)-1)&(~(((1UL) << 12)-1))) >> 12));
}

static inline __attribute__((always_inline)) void shmem_unacct_size(unsigned long flags, loff_t size)
{
 if (!(flags & 0x00200000))
...
static inline __attribute__((always_inline)) int shmem_acct_block(unsigned long flags)
{
 return (flags & 0x00200000) ?
  security_vm_enough_memory_kern(((((((1UL) << 12))+((1UL) << 12)-1)&(~(((1UL) << 12)-1))) >> 12)) : 0;
}

static inline __attribute__((always_inline)) void shmem_unacct_blocks(unsigned long flags, long pages)
{
 if (flags & 0x00200000)
...
static struct mutex shmem_swaplist_mutex = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } } , .wait_list = { &(shmem_swaplist_mutex.wait_list), &(shmem_swaplist_mutex.wait_list) } };
...
static swp_entry_t *shmem_swp_alloc(struct shmem_inode_info *info, unsigned long index, enum sgp_type sgp)
{
 ...
 while (!(entry = shmem_swp_entry(info, index, &page))) {
  if (sgp == SGP_READ)
   return shmem_swp_map((empty_zero_page));
      ...
      spinlock_t *punch_lock)
{
 ...
 for (ptr = dir; ptr < edir; ptr++) {
  if (ptr->val) {
   if (__builtin_expect(!!(punch_lock), 0)) {
  ...
  int limit, struct page ***dir, spinlock_t *punch_lock)
{
 ...
 for (; offset < limit; offset += 64) {
  ...
  if (need_resched()) {
   ...
   ({ __might_sleep("../../mm/shmem.c", 511, 0); _cond_resched(); });
   ptr = shmem_swp_map(subdir);
  }
 }
 shmem_swp_unmap(ptr);
...
static void shmem_free_pages(struct list_head *next)
{
 ...
 do {
  page = ({ const typeof( ((struct page *)0)->lru ) *__mptr = (next); (struct page *)( (char *)__mptr - __builtin_offsetof(struct page,lru) );});
  next = next->next;
  shmem_dir_free(page);
  freed++;
  if (freed >= 64) {
   ({ __might_sleep("../../mm/shmem.c", 530, 0); _cond_resched(); });
   freed = 0;
  }
 } while (next);
}
...
static void shmem_truncate_range(struct inode *inode, loff_t start, loff_t end)
{
 ...
 if (__builtin_expect(!!(end == (loff_t) -1), 1)) {
  limit = info->next_index;
  upper_limit = ((unsigned long)((({ unsigned long long __min1 = (((16 + (((unsigned long long)(((1UL) << 12)/sizeof(unsigned long))*(((1UL) << 12)/sizeof(unsigned long)))/2) * ((((1UL) << 12)/sizeof(unsigned long))+1)) << 12)); unsigned long long __min2 = ((((u64)((1UL) << 12) << (32 -1))-1)); __min1 < __min2 ? __min1: __min2; })+1) >> 12));
  info->next_index = idx;
  needs_lock = ((void *)0);
  punch_hole = 0;
 } else {
...
# 621 "../../mm/shmem.c"
 ...
 for (; idx < limit; idx += (((1UL) << 12)/sizeof(unsigned long)), diroff++) {
  if (__builtin_expect(!!(idx == stage), 0)) {
   shmem_dir_unmap(dir);
   dir = shmem_dir_map(topdir) +
   ...
   shmem_dir_unmap(dir);
   ({ __might_sleep("../../mm/shmem.c", 688, 0); _cond_resched(); });
   dir = shmem_dir_map(middir);
   diroff = 0;
  }
  ...
  if (subdir && ((subdir)->private) ) {
   ...
   if (offset || punch_lock) {
    ...
    do { if (__builtin_expect(!!(((subdir)->private) != freed), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  }
  offset = 0;
 }
done1:
...
static void shmem_delete_inode(struct inode *inode)
{
 ...
 do { if (__builtin_expect(!!(inode->i_blocks), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 shmem_free_inode(inode->i_sb);
 clear_inode(inode);
}

static inline __attribute__((always_inline)) int shmem_find_swp(swp_entry_t entry, swp_entry_t *dir, swp_entry_t *edir)
{
 swp_entry_t *ptr;
...
static int shmem_unuse_inode(struct shmem_inode_info *info, swp_entry_t entry, struct page *page)
{
 ...
 for (idx = 16; idx < limit; idx += (((1UL) << 12)/sizeof(unsigned long)), dir++) {
  if (__builtin_expect(!!(idx == stage), 0)) {
   ...
   if (({ __might_sleep("../../mm/shmem.c", 889, (1UL << 0)); __cond_resched_lock(&info->lock); })) {
...
# 941 "../../mm/shmem.c"
 ...
 error = mem_cgroup_cache_charge(page, (get_current())->mm, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (error)
  goto out;
 error = radix_tree_preload(((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (error) {
...
int shmem_unuse(swp_entry_t entry, struct page *page)
{
 ...
 for (p = (&shmem_swaplist)->next, next = p->next; p != (&shmem_swaplist); p = next, next = p->next) {
  info = ({ const typeof( ((struct shmem_inode_info *)0)->swaplist ) *__mptr = (p); (struct shmem_inode_info *)( (char *)__mptr - __builtin_offsetof(struct shmem_inode_info,swaplist) );});
  found = shmem_unuse_inode(info, entry, page);
  ({ __might_sleep("../../mm/shmem.c", 1017, 0); _cond_resched(); });
  if (found)
   goto out;
 }
 mutex_unlock(&shmem_swaplist_mutex);
...
# 1062 "../../mm/shmem.c"
 ...
 if (index >= info->next_index) {
  do { if (__builtin_expect(!!(!(info->flags & 0x00000002)), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  goto unlock;
 }
 ...
 if (swap.val && add_to_swap_cache(page, swap, ((( gfp_t)0x20u))) == 0) {
  ...
  do { if (__builtin_expect(!!(page_mapped(page)), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  put_page(page);
...
# 1186 "../../mm/shmem.c"
static inline __attribute__((always_inline)) void shmem_show_mpol(struct seq_file *seq, struct mempolicy *p)
{
}


static inline __attribute__((always_inline)) struct page *shmem_swapin(swp_entry_t entry, gfp_t gfp,
   struct shmem_inode_info *info, unsigned long idx)
{
 return swapin_readahead(entry, gfp, ((void *)0), 0);
}

static inline __attribute__((always_inline)) struct page *shmem_alloc_page(gfp_t gfp,
   struct shmem_inode_info *info, unsigned long idx)
{
 return alloc_pages_node(numa_node_id(), gfp, 0);
}
...
static inline __attribute__((always_inline)) struct mempolicy *shmem_get_sbmpol(struct shmem_sb_info *sbinfo)
{
 return ((void *)0);
}
# 1218 "../../mm/shmem.c"
   ...
   struct page **pagep, enum sgp_type sgp, int *type)
{
 ...
 if (idx >= ((unsigned long)((({ unsigned long long __min1 = (((16 + (((unsigned long long)(((1UL) << 12)/sizeof(unsigned long))*(((1UL) << 12)/sizeof(unsigned long)))/2) * ((((1UL) << 12)/sizeof(unsigned long))+1)) << 12)); unsigned long long __min2 = ((((u64)((1UL) << 12) << (32 -1))-1)); __min1 < __min2 ? __min1: __min2; })+1) >> 12)))
  return -27;
...
repeat:
 ...
 if (swap.val) {
  ...
  if (!filepage) {
   ...
   error = mem_cgroup_cache_charge(filepage, (get_current())->mm,
         ...
         int mode, dev_t dev, unsigned long flags)
{
 ...
 if (inode) {
  ...
  info = SHMEM_I(inode);
  ({ void *__p = (info); size_t __n = (char *)inode - (char *)info; if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
  do { spinlock_check(&info->lock); do { *(&(&info->lock)->rlock) = (raw_spinlock_t) { .raw_lock = { 0 }, }; } while (0); } while (0);
...
# 1737 "../../mm/shmem.c"
  ...
  ({ __might_sleep("../../mm/shmem.c", 1746, 0); _cond_resched(); });
 }
    ...
    int connectable)
{
 ...
 if (hlist_unhashed(&inode->i_hash)) {
  ...
  static spinlock_t lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } };
  spin_lock(&lock);
  if (hlist_unhashed(&inode->i_hash))
 ...
 while (options != ((void *)0)) {
  ...
  if (!strcmp(this_char,"size")) {
   ...
   if (*rest == '%') {
    size <<= 12;
    size *= totalram_pages;
    ({ unsigned int __r, __b = (100); if (!__builtin_constant_p(__b) || __b == 0 || (7 < 4 && (__b & (__b - 1)) != 0)) { __r = ({ register unsigned int __base asm("r4") = __b; register unsigned long long __n asm("r0") = size; register unsigned long long __res asm("r2"); register unsigned int __rem asm("r1"); asm( ".ifnc " "%0" "," "r1" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%3" "," "r4" " ; .err ; .endif\n\t" "bl	__do_div64" : "=r" (__rem), "=r" (__res) : "r" (__n), "r" (__base) : "ip", "lr", "cc"); size = __res; __rem; }); } else if ((__b & (__b - 1)) == 0) { __r = size; __r &= (__b - 1); size /= __b; } else { unsigned long long __res, __x, __t, __m, __n = size; unsigned int __c, __p, __z = 0; __r = __n; __p = 1 << ({ unsigned int __left = (__b), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); __m = (~0ULL / __b) * __p; __m += (((~0ULL % __b + 1) * __p) + __b - 1) / __b; __x = ~0ULL / __b * __b - 1; __res = (__m & 0xffffffff) * (__x & 0xffffffff); __res >>= 32; __res += (__m & 0xffffffff) * (__x >> 32); __t = __res; __res += (__x & 0xffffffff) * (__m >> 32); __t = (__res < __t) ? (1ULL << 32) : 0; __res = (__res >> 32) + __t; __res += (__m >> 32) * (__x >> 32); __res /= __p; if (~0ULL % (__b / (__b & -__b)) == 0) { __n /= (__b & -__b); __m = ~0ULL / (__b / (__b & -__b)); __p = 1; __c = 1; } else if (__res != __x / __b) { __c = 1; __m = (~0ULL / __b) * __p; __m += ((~0ULL % __b + 1) * __p) / __b; } else { unsigned int __bits = -(__m & -__m); __bits |= __m >> 32; __bits = (~__bits) << 1; if (!__bits) { __p /= (__m & -__m); __m /= (__m & -__m); } else { __p >>= ({ unsigned int __left = (__bits), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); __m >>= ({ unsigned int __left = (__bits), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); } __c = 0; } if (!__c) { asm ( "umull	%Q0, %R0, %1, %Q2\n\t" "mov	%Q0, #0" : "=&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else if (!(__m & ((1ULL << 63) | (1ULL << 31)))) { __res = __m; asm ( "umlal	%Q0, %R0, %Q1, %Q2\n\t" "mov	%Q0, #0" : "+&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else { asm ( "umull	%Q0, %R0, %Q1, %Q2\n\t" "cmn	%Q0, %Q1\n\t" "adcs	%R0, %R0, %R1\n\t" "adc	%Q0, %3, #0" : "=&r" (__res) : "r" (__m), "r" (__n), "r" (__z) : "cc" ); } if (!(__m & ((1ULL << 63) | (1ULL << 31)))) { asm ( "umlal	%R0, %Q0, %R1, %Q2\n\t" "umlal	%R0, %Q0, %Q1, %R2\n\t" "mov	%R0, #0\n\t" "umlal	%Q0, %R0, %R1, %R2" : "+&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else { asm ( "umlal	%R0, %Q0, %R2, %Q3\n\t" "umlal	%R0, %1, %Q2, %R3\n\t" "mov	%R0, #0\n\t" "adds	%Q0, %1, %Q0\n\t" "adc	%R0, %R0, #0\n\t" "umlal	%Q0, %R0, %R2, %R3" : "+&r" (__res), "+&r" (__z) : "r" (__m), "r" (__n) : "cc" ); } __res /= __p; { unsigned int __res0 = __res; unsigned int __b0 = __b; __r -= __res0 * __b0; } size = __res; } __r; });
    rest++;
   }
   if (*rest)
    goto bad_val;
...
int shmem_fill_super(struct super_block *sb, void *data, int silent)
{
 ...
 sbinfo = kzalloc(({ typeof((int)sizeof(struct shmem_sb_info)) _max1 = ((int)sizeof(struct shmem_sb_info)); typeof((1 << 5)) _max2 = ((1 << 5)); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; }), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 ...
 do { spinlock_check(&sbinfo->stat_lock); do { *(&(&sbinfo->stat_lock)->rlock) = (raw_spinlock_t) { .raw_lock = { 0 }, }; } while (0); } while (0);
 sbinfo->free_blocks = sbinfo->max_blocks;
 sbinfo->free_inodes = sbinfo->max_inodes;

 sb->s_maxbytes = ({ unsigned long long __min1 = (((16 + (((unsigned long long)(((1UL) << 12)/sizeof(unsigned long))*(((1UL) << 12)/sizeof(unsigned long)))/2) * ((((1UL) << 12)/sizeof(unsigned long))+1)) << 12)); unsigned long long __min2 = ((((u64)((1UL) << 12) << (32 -1))-1)); __min1 < __min2 ? __min1: __min2; });
...
static struct inode *shmem_alloc_inode(struct super_block *sb)
{
 ...
 p = (struct shmem_inode_info *)kmem_cache_alloc(shmem_inode_cachep, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!p)
  return ((void *)0);
 return &p->vfs_inode;
}
...
int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) init_tmpfs(void)
{
 int error;
...
struct file *shmem_file_setup(const char *name, loff_t size, unsigned long flags)
{
 ...
 if (size < 0 || size > ({ unsigned long long __min1 = (((16 + (((unsigned long long)(((1UL) << 12)/sizeof(unsigned long))*(((1UL) << 12)/sizeof(unsigned long)))/2) * ((((1UL) << 12)/sizeof(unsigned long))+1)) << 12)); unsigned long long __min2 = ((((u64)((1UL) << 12) << (32 -1))-1)); __min1 < __min2 ? __min1: __min2; }))
  return ERR_PTR(-22);
...
extern typeof(shmem_file_setup) shmem_file_setup; static const char __kstrtab_shmem_file_setup[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "shmem_file_setup"; static const struct kernel_symbol __ksymtab_shmem_file_setup __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&shmem_file_setup, __kstrtab_shmem_file_setup };
