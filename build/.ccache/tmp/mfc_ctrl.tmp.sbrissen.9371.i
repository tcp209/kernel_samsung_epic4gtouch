# 1 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c"
# 14 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c"
...
# 15 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c" 2
...
# 16 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c" 2
...
# 17 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c" 2
...
# 18 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c" 2


# 1 "../../arch/arm/mach-s5pv310/include/mach/regs-mfc.h" 1
# 21 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c" 2





# 1 "../../drivers/media/video/samsung/mfc5x/mfc.h" 1
# 27 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c" 2
# 1 "../../drivers/media/video/samsung/mfc5x/mfc_mem.h" 1
# 18 "../../drivers/media/video/samsung/mfc5x/mfc_mem.h"
# 1 "../../drivers/media/video/samsung/mfc5x/mfc_dev.h" 1
# 17 "../../drivers/media/video/samsung/mfc5x/mfc_dev.h"
...
# 18 "../../drivers/media/video/samsung/mfc5x/mfc_dev.h" 2
...
# 19 "../../drivers/media/video/samsung/mfc5x/mfc_dev.h" 2

# 1 "../../drivers/media/video/samsung/mfc5x/mfc_inst.h" 1
# 20 "../../drivers/media/video/samsung/mfc5x/mfc_inst.h"
# 1 "../../drivers/media/video/samsung/mfc5x/mfc_interface.h" 1
# 27 "../../drivers/media/video/samsung/mfc5x/mfc_interface.h"
# 1 "../../drivers/media/video/samsung/mfc5x/mfc_errno.h" 1
# 27 "../../drivers/media/video/samsung/mfc5x/mfc_errno.h"
enum mfc_ret_code {
 MFC_OK = 1,
 MFC_FAIL = -1000,
 MFC_OPEN_FAIL = -1001,
...
# 28 "../../drivers/media/video/samsung/mfc5x/mfc_interface.h" 2
# 1 "../../drivers/media/video/samsung/mfc5x/SsbSipMfcApi.h" 1
# 47 "../../drivers/media/video/samsung/mfc5x/SsbSipMfcApi.h"
typedef enum {
    H264_DEC,
    VC1_DEC,
    MPEG4_DEC,
...
typedef struct {
    ...
    unsigned int y_cookie;
    unsigned int c_cookie;
...
typedef struct {
    ...
    void *StrmPhyAddr;
    void *StrmVirAddr;
    void *encodedYPhyAddr;
    void *encodedCPhyAddr;


 unsigned int strm_cookie;
    unsigned int y_encoded_cookie;
    unsigned int c_encoded_cookie;
...
typedef struct {
    ...
    int NumberRefForPframes;
    int LoopFilterDisable;
    int LoopFilterAlphaC0Offset;
    int LoopFilterBetaOffset;
    int SymbolMode;
    int PictureInterlace;
...
typedef struct {
    ...
    int LevelIDC;
    int FrameQp_B;
    int TimeIncreamentRes;
    int VopTimeIncreament;
    int SliceArgument;
    int NumberBFrames;
    int DisableQpelME;
...
# 337 "../../drivers/media/video/samsung/mfc5x/SsbSipMfcApi.h"
...
# 29 "../../drivers/media/video/samsung/mfc5x/mfc_interface.h" 2
# 57 "../../drivers/media/video/samsung/mfc5x/mfc_interface.h"
enum inst_type {
    DECODER = 0x1,
    ENCODER = 0x2,
};
...
struct mfc_enc_init_common_arg {
 SSBSIP_MFC_CODEC_TYPE in_codec_type;
 ...
 int in_rc_qbound_min;
 int in_rc_qbound_max;
 int in_rc_rpara;
...
struct mfc_enc_init_mpeg4_arg {
 ...
 int in_TimeIncreamentRes;
 int in_VopTimeIncreament;
};
...
struct mfc_enc_init_h264_arg {
 ...
 int in_rc_mb_dark_dis;

 int in_rc_mb_smooth_dis;

 int in_rc_mb_static_dis;

 int in_rc_mb_activity_dis;
...
# 241 "../../drivers/media/video/samsung/mfc5x/mfc_interface.h"
};
...
struct mfc_dec_exe_arg {
 ...
 int out_y_offset;
 int out_c_offset;
# 306 "../../drivers/media/video/samsung/mfc5x/mfc_interface.h"
 int out_img_width;
 int out_img_height;
 int out_buf_width;
 int out_buf_height;
...
struct mfc_buf_alloc_arg {
 ...
 unsigned int addr;
# 353 "../../drivers/media/video/samsung/mfc5x/mfc_interface.h"
 unsigned int offset;
...
# 21 "../../drivers/media/video/samsung/mfc5x/mfc_inst.h" 2
...
struct mfc_dec_cfg {
 ...
 unsigned int postfilter;
 unsigned int dispdelay_en;
 unsigned int dispdelay_val;
 unsigned int width;
 unsigned int height;
};

struct mfc_enc_cfg {
# 90 "../../drivers/media/video/samsung/mfc5x/mfc_inst.h"
 unsigned int pixelcache;

 unsigned int frameskip;
 unsigned int frammode;
 unsigned int hier_p;
# 159 "../../drivers/media/video/samsung/mfc5x/mfc_inst.h"
};
...
# 21 "../../drivers/media/video/samsung/mfc5x/mfc_dev.h" 2
...
# 54 "../../drivers/media/video/samsung/mfc5x/mfc_dev.h"
struct mfc_mem {
 unsigned long base;
 size_t size;
 unsigned char *addr;
...
struct mfc_dev {
 ...
 atomic_t inst_cnt;
 struct mfc_inst_ctx *inst_ctx[(4)];
...
# 19 "../../drivers/media/video/samsung/mfc5x/mfc_mem.h" 2
# 45 "../../drivers/media/video/samsung/mfc5x/mfc_mem.h"
...
# 28 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c" 2
# 1 "../../drivers/media/video/samsung/mfc5x/mfc_reg.h" 1
# 17 "../../drivers/media/video/samsung/mfc5x/mfc_reg.h"
void init_reg(void *base);
void write_reg(unsigned int data, unsigned int offset);
unsigned int read_reg(unsigned int offset);
# 29 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c" 2
# 1 "../../drivers/media/video/samsung/mfc5x/mfc_log.h" 1
# 30 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c" 2
# 1 "../../drivers/media/video/samsung/mfc5x/mfc_cmd.h" 1
# 17 "../../drivers/media/video/samsung/mfc5x/mfc_cmd.h"
...
# 18 "../../drivers/media/video/samsung/mfc5x/mfc_cmd.h" 2
# 26 "../../drivers/media/video/samsung/mfc5x/mfc_cmd.h"
enum mfc_h2r_cmd {
 H2R_NOP = 0,
 OPEN_CH = 1,
 CLOSE_CH = 2,
...
# 31 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c" 2


# 1 "../../drivers/media/video/samsung/mfc5x/mfc_pm.h" 1
# 17 "../../drivers/media/video/samsung/mfc5x/mfc_pm.h"
...
# 34 "../../drivers/media/video/samsung/mfc5x/mfc_ctrl.c" 2
...
static bool mfc_reset(void)
{
 ...
 write_reg(0x3F6, (0x0000));
 write_reg(0x3E2, (0x0000));
 ( (__builtin_constant_p(10) && (10)<=2) ? (__builtin_constant_p((10)*1000) ? (((10)*1000) > (2 * 1000) ? __bad_udelay() : __const_udelay(((10)*1000) * ((2199023U*200)>>11))) : __udelay((10)*1000)) : ({unsigned long __ms=(10); while (__ms--) (__builtin_constant_p(1000) ? ((1000) > (2 * 1000) ? __bad_udelay() : __const_udelay((1000) * ((2199023U*200)>>11))) : __udelay(1000));}));


 do {
  mc_status = (read_reg((0x0510)) & 0x3);
 ...
 } while ((({ unsigned long __dummy; typeof(timeo) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ({ unsigned long __dummy; typeof(jiffies) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ((long)(jiffies) - (long)(timeo) < 0)));

 if (mc_status != 0)
  return false;

 write_reg(0x0, (0x0000));
 write_reg(0x3FE, (0x0000));
...
static void mfc_init_memctrl(void)
{
 ...
 write_reg(mfc_mem_base(0), (0x0508));





 write_reg(mfc_mem_base(1), (0x050c));
...
{
 write_reg(0xFFFFFFFF, (0x2040));
 write_reg(0xFFFFFFFF, (0x2080));

 write_reg(H2R_NOP, (0x0044));
 write_reg(R2H_NOP, (0x0030));
}
