# 1 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
# 39 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
...
# 40 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c" 2
...
extern int __blkdev_driver_ioctl(struct block_device *, fmode_t, unsigned int,
     unsigned long);
# 41 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c" 2
...
# 42 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c" 2
...
# 43 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c" 2
...
# 44 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c" 2
...
# 45 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c" 2
...
# 47 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c" 2
# 55 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
...
# 98 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
 ...
 struct request_queue *q, struct request *req)
{
 ...
 req->cmd_flags |= (1 << __REQ_DONTPREP);
...
static int cyasblkdev_queue_thread(void *d)
{
 ...
 do {
...

  {
   ...
   if (!test_bit(7, &(q)->queue_flags)) {

    bq->req = req = blk_fetch_request(q);
# 178 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
   } else {
...
# 224 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
  ...
  bq->issue_fn(bq, req);
# 259 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
 } while (1);
...
static void cyasblkdev_request(struct request_queue *q)
{
 ...
 struct request *req;
 ;
# 293 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
 if (!bq) {


  while( (req = blk_fetch_request(q)) != ((void *)0) )
  {
   req->cmd_flags |= (1 << __REQ_QUIET);
   __blk_end_request_all(req,-5);
  }
# 309 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
  return;
 }
 ...
 if (!bq->req) {
  ...
  __wake_up(&bq->thread_wq, (1 | 2), 1, ((void *)0));
 } else {
# 329 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
 }
}
# 347 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
int cyasblkdev_init_queue(struct cyasblkdev_queue *bq, spinlock_t *lock)
{
 ...
 blk_queue_bounce_limit(bq->queue, ((u64)blk_max_low_pfn << 12));

 blk_queue_max_hw_sectors(bq->queue, 128);
 ...
 blk_queue_max_segments(bq->queue, 16);
 ...
 blk_queue_max_segment_size(bq->queue, 512*128);
 ...
 do { static struct lock_class_key __key; __init_waitqueue_head((&bq->thread_wq), &__key); } while (0);
 sema_init(&bq->thread_sem, 1);

 ret = kernel_thread(cyasblkdev_queue_thread, bq, (0x00000200 | 0x00000400 | 0x00000800));
 if (ret >= 0) {
...
extern typeof(cyasblkdev_init_queue) cyasblkdev_init_queue; static const char __kstrtab_cyasblkdev_init_queue[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "cyasblkdev_init_queue"; static const struct kernel_symbol __ksymtab_cyasblkdev_init_queue __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&cyasblkdev_init_queue, __kstrtab_cyasblkdev_init_queue };
...
void cyasblkdev_cleanup_queue(struct cyasblkdev_queue *bq)
{
 ...
 do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = _raw_spin_lock_irqsave(spinlock_check(q->queue_lock)); } while (0); } while (0);
 q->queuedata = ((void *)0);
 blk_start_queue(q);
...
extern typeof(cyasblkdev_cleanup_queue) cyasblkdev_cleanup_queue; static const char __kstrtab_cyasblkdev_cleanup_queue[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "cyasblkdev_cleanup_queue"; static const struct kernel_symbol __ksymtab_cyasblkdev_cleanup_queue __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&cyasblkdev_cleanup_queue, __kstrtab_cyasblkdev_cleanup_queue };
# 440 "../../drivers/staging/westbridge/astoria/device/../block/cyasblkdev_queue.c"
...
extern typeof(cyasblkdev_queue_suspend) cyasblkdev_queue_suspend; static const char __kstrtab_cyasblkdev_queue_suspend[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "cyasblkdev_queue_suspend"; static const struct kernel_symbol __ksymtab_cyasblkdev_queue_suspend __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&cyasblkdev_queue_suspend, __kstrtab_cyasblkdev_queue_suspend };
...
extern typeof(cyasblkdev_queue_resume) cyasblkdev_queue_resume; static const char __kstrtab_cyasblkdev_queue_resume[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "cyasblkdev_queue_resume"; static const struct kernel_symbol __ksymtab_cyasblkdev_queue_resume __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&cyasblkdev_queue_resume, __kstrtab_cyasblkdev_queue_resume };
