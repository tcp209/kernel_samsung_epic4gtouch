...
# 1 "<command-line>" 2
# 1 "../../net/ipv4/netfilter/iptable_filter.c"
# 13 "../../net/ipv4/netfilter/iptable_filter.c"
...
# 14 "../../net/ipv4/netfilter/iptable_filter.c" 2
...
# 20 "../../include/linux/netfilter_ipv4/ip_tables.h" 2
...
# 21 "../../include/linux/netfilter_ipv4/ip_tables.h" 2
...
# 22 "../../include/linux/netfilter_ipv4/ip_tables.h" 2
...
# 9 "../../include/linux/netfilter_ipv4.h" 2
...
extern __sum16 nf_ip_checksum(struct sk_buff *skb, unsigned int hook,
       unsigned int dataoff, u_int8_t protocol);
# 27 "../../include/linux/netfilter_ipv4/ip_tables.h" 2
...
# 183 "../../include/linux/netfilter/x_tables.h"
...
# 184 "../../include/linux/netfilter/x_tables.h" 2
...
# 29 "../../include/linux/netfilter_ipv4/ip_tables.h" 2
...
# 79 "../../include/linux/netfilter_ipv4/ip_tables.h"
struct ipt_entry {
 struct ipt_ip ip;
...
# 122 "../../include/linux/netfilter_ipv4/ip_tables.h"
...
# 123 "../../include/linux/netfilter_ipv4/ip_tables.h" 2
# 137 "../../include/linux/netfilter_ipv4/ip_tables.h"
struct ipt_icmp {
 u_int8_t type;
 u_int8_t code[2];
 u_int8_t invflags;
...
extern void ipt_init(void) __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function));
...
# 16 "../../net/ipv4/netfilter/iptable_filter.c" 2
...
# 18 "../../net/ipv4/netfilter/iptable_filter.c" 2
...
static const struct xt_table packet_filter = {
 .name = "filter",
 .valid_hooks = ((1 << NF_INET_LOCAL_IN) | (1 << NF_INET_FORWARD) | (1 << NF_INET_LOCAL_OUT)),
 .me = ((struct module *)0),
 .af = NFPROTO_IPV4,
...
static inline __attribute__((always_inline)) void __check_forward(void) { ((void)(sizeof(struct { int:-!!(!__builtin_types_compatible_p(typeof(*(&(forward))), typeof(bool)) && !__builtin_types_compatible_p(typeof(*(&(forward))), typeof(unsigned int)) && !__builtin_types_compatible_p(typeof(*(&(forward))), typeof(int))); }))); }; static int __param_perm_check_forward __attribute__((unused)) = (sizeof(struct { int:-!!((0000) < 0 || (0000) > 0777 || ((0000) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""iptable_filter" ".") > (64 - sizeof(unsigned long))); })); static const char __param_str_forward[] = "iptable_filter" "." "forward"; static struct kernel_param const __param_forward __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_forward, 0000, __builtin_types_compatible_p(typeof(*(&forward)), typeof(bool)) ? 2 : 0, param_set_bool, param_get_bool, { &forward } }; ;

static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) iptable_filter_net_init(struct net *net)
{
...
static void __attribute__ ((__section__(".ref.text"))) __attribute__((noinline)) iptable_filter_net_exit(struct net *net)
{
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) iptable_filter_init(void)
{
 int ret;

 if (forward < 0 || forward > 5) {
  printk("<3>" "iptables forward must be 0 or 1\n");
  return -22;
 }
...
static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) iptable_filter_fini(void)
{
 xt_hook_unlink(&packet_filter, filter_ops);
 unregister_pernet_subsys(&iptable_filter_net_ops);
}

static initcall_t __initcall_iptable_filter_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = iptable_filter_init;;
static exitcall_t __exitcall_iptable_filter_fini __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = iptable_filter_fini;;
