...
static __attribute__((section(".data..percpu" ""))) __typeof__(struct pagevec[NR_LRU_LISTS]) lru_add_pvecs;
static __attribute__((section(".data..percpu" ""))) __typeof__(struct pagevec) lru_rotate_pvecs;
...
static void __page_cache_release(struct page *page)
{
 if (PageLRU(page)) {
  ...
  do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = _raw_spin_lock_irqsave(spinlock_check(&zone->lru_lock)); } while (0); } while (0);
  do { } while (0);
  __ClearPageLRU(page);
...
extern typeof(put_page) put_page; static const char __kstrtab_put_page[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "put_page"; static const struct kernel_symbol __ksymtab_put_page __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&put_page, __kstrtab_put_page };
# 89 "../../mm/swap.c"
void put_pages_list(struct list_head *pages)
{
 while (!list_empty(pages)) {
  ...
  victim = ({ const typeof( ((struct page *)0)->lru ) *__mptr = (pages->prev); (struct page *)( (char *)__mptr - __builtin_offsetof(struct page,lru) );});
  list_del(&victim->lru);
  put_page(victim);
 }
}
extern typeof(put_pages_list) put_pages_list; static const char __kstrtab_put_pages_list[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "put_pages_list"; static const struct kernel_symbol __ksymtab_put_pages_list __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&put_pages_list, __kstrtab_put_pages_list };
...
void rotate_reclaimable_page(struct page *page)
{
 if (!PageLocked(page) && !PageDirty(page) && !PageActive(page) &&
  ...
  get_page(page);
  do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); ({ __asm__ __volatile__( "mrs	%0, cpsr		@ local_irq_save\n" "cpsid	i" : "=r" (flags) : : "memory", "cc"); }); do { } while (0); } while (0);
  pvec = &(*({ do { const void *__vpp_verify = (typeof((&(lru_rotate_pvecs))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(lru_rotate_pvecs))) *)(&(lru_rotate_pvecs)))); (typeof((typeof(*(&(lru_rotate_pvecs))) *)(&(lru_rotate_pvecs)))) (__ptr + (((__per_cpu_offset[(current_thread_info()->cpu)])))); }); }));
...
extern typeof(mark_page_accessed) mark_page_accessed; static const char __kstrtab_mark_page_accessed[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "mark_page_accessed"; static const struct kernel_symbol __ksymtab_mark_page_accessed __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&mark_page_accessed, __kstrtab_mark_page_accessed };

void __lru_cache_add(struct page *page, enum lru_list lru)
{
 struct pagevec *pvec = &(*({ do { do { (current_thread_info()->preempt_count) += (1); } while (0); __asm__ __volatile__("": : :"memory"); } while (0); &(*({ do { const void *__vpp_verify = (typeof((&(lru_add_pvecs))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(lru_add_pvecs))) *)(&(lru_add_pvecs)))); (typeof((typeof(*(&(lru_add_pvecs))) *)(&(lru_add_pvecs)))) (__ptr + (((__per_cpu_offset[(current_thread_info()->cpu)])))); }); })); }))[lru];

 get_page(page);
 if (!pagevec_add(pvec, page))
  ____pagevec_lru_add(pvec, lru);
 do { (void)&(lru_add_pvecs); do { do { __asm__ __volatile__("": : :"memory"); do { (current_thread_info()->preempt_count) -= (1); } while (0); } while (0); __asm__ __volatile__("": : :"memory"); do { if (__builtin_expect(!!(test_ti_thread_flag(current_thread_info(), 1)), 0)) preempt_schedule(); } while (0); } while (0); } while (0);
}
extern typeof(__lru_cache_add) __lru_cache_add; static const char __kstrtab___lru_cache_add[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__lru_cache_add"; static const struct kernel_symbol __ksymtab___lru_cache_add __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__lru_cache_add, __kstrtab___lru_cache_add };
...
{
 struct pagevec *pvecs = (*({ do { const void *__vpp_verify = (typeof((&(lru_add_pvecs))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(lru_add_pvecs))) *)(&(lru_add_pvecs)))); (typeof((typeof(*(&(lru_add_pvecs))) *)(&(lru_add_pvecs)))) (__ptr + (((__per_cpu_offset[cpu])))); }); }));
 struct pagevec *pvec;
 int lru;
 ...
 pvec = &(*({ do { const void *__vpp_verify = (typeof((&(lru_rotate_pvecs))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(lru_rotate_pvecs))) *)(&(lru_rotate_pvecs)))); (typeof((typeof(*(&(lru_rotate_pvecs))) *)(&(lru_rotate_pvecs)))) (__ptr + (((__per_cpu_offset[cpu])))); }); }));
 if (pagevec_count(pvec)) {
  unsigned long flags;
...
{
 drain_cpu_pagevecs(({ do { do { (current_thread_info()->preempt_count) += (1); } while (0); __asm__ __volatile__("": : :"memory"); } while (0); (current_thread_info()->cpu); }));
 do { do { __asm__ __volatile__("": : :"memory"); do { (current_thread_info()->preempt_count) -= (1); } while (0); } while (0); __asm__ __volatile__("": : :"memory"); do { if (__builtin_expect(!!(test_ti_thread_flag(current_thread_info(), 1)), 0)) preempt_schedule(); } while (0); } while (0);
}
...
extern typeof(__pagevec_release) __pagevec_release; static const char __kstrtab___pagevec_release[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__pagevec_release"; static const struct kernel_symbol __ksymtab___pagevec_release __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__pagevec_release, __kstrtab___pagevec_release };
...
extern typeof(____pagevec_lru_add) ____pagevec_lru_add; static const char __kstrtab_____pagevec_lru_add[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "____pagevec_lru_add"; static const struct kernel_symbol __ksymtab_____pagevec_lru_add __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&____pagevec_lru_add, __kstrtab_____pagevec_lru_add };
...
extern typeof(pagevec_lookup) pagevec_lookup; static const char __kstrtab_pagevec_lookup[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "pagevec_lookup"; static const struct kernel_symbol __ksymtab_pagevec_lookup __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&pagevec_lookup, __kstrtab_pagevec_lookup };

unsigned pagevec_lookup_tag(struct pagevec *pvec, struct address_space *mapping,
  unsigned long *index, int tag, unsigned nr_pages)
{
...
extern typeof(pagevec_lookup_tag) pagevec_lookup_tag; static const char __kstrtab_pagevec_lookup_tag[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "pagevec_lookup_tag"; static const struct kernel_symbol __ksymtab_pagevec_lookup_tag __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&pagevec_lookup_tag, __kstrtab_pagevec_lookup_tag };




void __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) swap_setup(void)
{
 unsigned long megs = totalram_pages >> (20 - 12);
