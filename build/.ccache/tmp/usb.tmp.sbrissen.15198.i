# 1 "../../drivers/usb/storage/usb.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../drivers/usb/storage/usb.c"
# 52 "../../drivers/usb/storage/usb.c"
...
# 53 "../../drivers/usb/storage/usb.c" 2
...
# 55 "../../drivers/usb/storage/usb.c" 2
...
# 56 "../../drivers/usb/storage/usb.c" 2
...
# 58 "../../drivers/usb/storage/usb.c" 2
...
# 59 "../../drivers/usb/storage/usb.c" 2
...
# 61 "../../drivers/usb/storage/usb.c" 2
...
# 202 "../../include/scsi/scsi.h"
static inline __attribute__((always_inline)) int scsi_status_is_good(int status)
{
...
# 330 "../../include/scsi/scsi.h"
static inline __attribute__((always_inline)) int scsi_is_wlun(unsigned int lun)
{
 return (lun & 0xff00) == 0xc100;
}
# 516 "../../include/scsi/scsi.h"
static inline __attribute__((always_inline)) __u32 scsi_to_u32(__u8 *ptr)
{
 return (ptr[0]<<24) + (ptr[1]<<16) + (ptr[2]<<8) + ptr[3];
}
# 63 "../../drivers/usb/storage/usb.c" 2
...
static inline __attribute__((always_inline)) unsigned scsi_sg_count(struct scsi_cmnd *cmd)
{
 return cmd->sdb.table.nents;
}

static inline __attribute__((always_inline)) struct scatterlist *scsi_sglist(struct scsi_cmnd *cmd)
{
 return cmd->sdb.table.sgl;
}

static inline __attribute__((always_inline)) unsigned scsi_bufflen(struct scsi_cmnd *cmd)
{
 return cmd->sdb.length;
}

static inline __attribute__((always_inline)) void scsi_set_resid(struct scsi_cmnd *cmd, int resid)
{
 cmd->sdb.resid = resid;
}

static inline __attribute__((always_inline)) int scsi_get_resid(struct scsi_cmnd *cmd)
{
...
static inline __attribute__((always_inline)) int scsi_bidi_cmnd(struct scsi_cmnd *cmd)
{
 return ((cmd->request)->next_rq != ((void *)0)) &&
  (cmd->request->next_rq->special != ((void *)0));
}

static inline __attribute__((always_inline)) struct scsi_data_buffer *scsi_in(struct scsi_cmnd *cmd)
{
 return scsi_bidi_cmnd(cmd) ?
  cmd->request->next_rq->special : &cmd->sdb;
}

static inline __attribute__((always_inline)) struct scsi_data_buffer *scsi_out(struct scsi_cmnd *cmd)
{
 return &cmd->sdb;
}

static inline __attribute__((always_inline)) int scsi_sg_copy_from_buffer(struct scsi_cmnd *cmd,
        void *buf, int buflen)
{
...
static inline __attribute__((always_inline)) int scsi_sg_copy_to_buffer(struct scsi_cmnd *cmd,
      void *buf, int buflen)
{
...
static inline __attribute__((always_inline)) void scsi_set_prot_op(struct scsi_cmnd *scmd, unsigned char op)
{
 scmd->prot_op = op;
}

static inline __attribute__((always_inline)) unsigned char scsi_get_prot_op(struct scsi_cmnd *scmd)
{
 return scmd->prot_op;
}
...
static inline __attribute__((always_inline)) void scsi_set_prot_type(struct scsi_cmnd *scmd, unsigned char type)
{
 scmd->prot_type = type;
}

static inline __attribute__((always_inline)) unsigned char scsi_get_prot_type(struct scsi_cmnd *scmd)
{
 return scmd->prot_type;
}

static inline __attribute__((always_inline)) sector_t scsi_get_lba(struct scsi_cmnd *scmd)
{
 return blk_rq_pos(scmd->request);
}

static inline __attribute__((always_inline)) unsigned scsi_prot_sg_count(struct scsi_cmnd *cmd)
{
 return cmd->prot_sdb ? cmd->prot_sdb->table.nents : 0;
}

static inline __attribute__((always_inline)) struct scatterlist *scsi_prot_sglist(struct scsi_cmnd *cmd)
{
 return cmd->prot_sdb ? cmd->prot_sdb->table.sgl : ((void *)0);
}

static inline __attribute__((always_inline)) struct scsi_data_buffer *scsi_prot(struct scsi_cmnd *cmd)
{
 return cmd->prot_sdb;
}
...
static inline __attribute__((always_inline)) void set_msg_byte(struct scsi_cmnd *cmd, char status)
{
 cmd->result |= status << 8;
}

static inline __attribute__((always_inline)) void set_host_byte(struct scsi_cmnd *cmd, char status)
{
 cmd->result |= status << 16;
}

static inline __attribute__((always_inline)) void set_driver_byte(struct scsi_cmnd *cmd, char status)
{
 cmd->result |= status << 24;
}
# 64 "../../drivers/usb/storage/usb.c" 2
...
struct scsi_device {
 ...
 unsigned long supported_events[(((SDEV_EVT_MAXBITS) + (8 * sizeof(long)) - 1) / (8 * sizeof(long)))];
...
# 221 "../../include/scsi/scsi_device.h"
...
static inline __attribute__((always_inline)) struct scsi_target *scsi_target(struct scsi_device *sdev)
{
 return ({ const typeof( ((struct scsi_target *)0)->dev ) *__mptr = (sdev->sdev_gendev.parent); (struct scsi_target *)( (char *)__mptr - __builtin_offsetof(struct scsi_target,dev) );});
}
...
extern struct scsi_device *__scsi_iterate_devices(struct Scsi_Host *,
        struct scsi_device *);
# 335 "../../include/scsi/scsi_device.h"
...
static inline __attribute__((always_inline)) int __attribute__((warn_unused_result)) scsi_device_reprobe(struct scsi_device *sdev)
{
 return device_reprobe(&sdev->sdev_gendev);
}

static inline __attribute__((always_inline)) unsigned int sdev_channel(struct scsi_device *sdev)
{
 return sdev->channel;
}

static inline __attribute__((always_inline)) unsigned int sdev_id(struct scsi_device *sdev)
{
 return sdev->id;
}
...
static inline __attribute__((always_inline)) int scsi_device_online(struct scsi_device *sdev)
{
 return (sdev->sdev_state != SDEV_OFFLINE &&
  sdev->sdev_state != SDEV_DEL);
}
static inline __attribute__((always_inline)) int scsi_device_blocked(struct scsi_device *sdev)
{
 return sdev->sdev_state == SDEV_BLOCK ||
  sdev->sdev_state == SDEV_CREATED_BLOCK;
}
static inline __attribute__((always_inline)) int scsi_device_created(struct scsi_device *sdev)
{
...
static inline __attribute__((always_inline)) int scsi_device_sync(struct scsi_device *sdev)
{
 return sdev->sdtr;
}
static inline __attribute__((always_inline)) int scsi_device_wide(struct scsi_device *sdev)
{
 return sdev->wdtr;
}
static inline __attribute__((always_inline)) int scsi_device_dt(struct scsi_device *sdev)
{
 return sdev->ppr;
}
static inline __attribute__((always_inline)) int scsi_device_dt_only(struct scsi_device *sdev)
{
 if (sdev->inquiry_len < 57)
  return 0;
 return (sdev->inquiry[56] & 0x0c) == 0x04;
}
static inline __attribute__((always_inline)) int scsi_device_ius(struct scsi_device *sdev)
{
 if (sdev->inquiry_len < 57)
  return 0;
 return sdev->inquiry[56] & 0x01;
}
static inline __attribute__((always_inline)) int scsi_device_qas(struct scsi_device *sdev)
{
 if (sdev->inquiry_len < 57)
  return 0;
 return sdev->inquiry[56] & 0x02;
}
static inline __attribute__((always_inline)) int scsi_device_enclosure(struct scsi_device *sdev)
{
 return sdev->inquiry[6] & (1<<6);
}

static inline __attribute__((always_inline)) int scsi_device_protection(struct scsi_device *sdev)
{
 return sdev->scsi_level > 3 && sdev->inquiry[5] & (1<<0);
}
# 65 "../../drivers/usb/storage/usb.c" 2

# 1 "../../drivers/usb/storage/usb.h" 1
# 45 "../../drivers/usb/storage/usb.h"
...
# 46 "../../drivers/usb/storage/usb.h" 2
...
# 47 "../../drivers/usb/storage/usb.h" 2
...
# 235 "../../include/scsi/scsi_host.h"
 int (* slave_configure)(struct scsi_device *);
# 246 "../../include/scsi/scsi_host.h"
 void (* slave_destroy)(struct scsi_device *);
# 260 "../../include/scsi/scsi_host.h"
 int (* target_alloc)(struct scsi_target *);
# 270 "../../include/scsi/scsi_host.h"
 void (* target_destroy)(struct scsi_target *);
# 281 "../../include/scsi/scsi_host.h"
 int (* scan_finished)(struct Scsi_Host *, unsigned long);
# 290 "../../include/scsi/scsi_host.h"
 void (* scan_start)(struct Scsi_Host *);
# 303 "../../include/scsi/scsi_host.h"
 int (* change_queue_depth)(struct scsi_device *, int, int);
# 316 "../../include/scsi/scsi_host.h"
 int (* change_queue_type)(struct scsi_device *, int);
# 326 "../../include/scsi/scsi_host.h"
...
# 494 "../../include/scsi/scsi_host.h"
 struct list_head legacy_hosts;
# 503 "../../include/scsi/scsi_host.h"
 u64 vendor_id;
};
...
static inline __attribute__((always_inline)) void *shost_priv(struct Scsi_Host *shost)
{
...
static inline __attribute__((always_inline)) struct Scsi_Host *dev_to_shost(struct device *dev)
{
...
static inline __attribute__((always_inline)) int scsi_host_in_recovery(struct Scsi_Host *shost)
{
...
static inline __attribute__((always_inline)) int __attribute__((warn_unused_result)) scsi_add_host(struct Scsi_Host *host,
          struct device *dev)
{
 return scsi_add_host_with_dma(host, dev, dev);
}

static inline __attribute__((always_inline)) struct device *scsi_get_device(struct Scsi_Host *shost)
{
...
static inline __attribute__((always_inline)) int scsi_host_scan_allowed(struct Scsi_Host *shost)
{
...
static inline __attribute__((always_inline)) void scsi_host_set_prot(struct Scsi_Host *shost, unsigned int mask)
{
 shost->prot_capabilities = mask;
}

static inline __attribute__((always_inline)) unsigned int scsi_host_get_prot(struct Scsi_Host *shost)
{
 return shost->prot_capabilities;
}

static inline __attribute__((always_inline)) unsigned int scsi_host_dif_capable(struct Scsi_Host *shost, unsigned int target_type)
{
...
static inline __attribute__((always_inline)) unsigned int scsi_host_dix_capable(struct Scsi_Host *shost, unsigned int target_type)
{
# 849 "../../include/scsi/scsi_host.h"
 return 0;
}
# 861 "../../include/scsi/scsi_host.h"
enum scsi_host_guard_type {
 SHOST_DIX_GUARD_CRC = 1 << 0,
 SHOST_DIX_GUARD_IP = 1 << 1,
};

static inline __attribute__((always_inline)) void scsi_host_set_guard(struct Scsi_Host *shost, unsigned char type)
{
 shost->prot_guard_type = type;
}

static inline __attribute__((always_inline)) unsigned char scsi_host_get_guard(struct Scsi_Host *shost)
{
...
# 51 "../../drivers/usb/storage/usb.h" 2
...
static inline __attribute__((always_inline)) struct Scsi_Host *us_to_host(struct us_data *us) {
 return ({ const typeof( ((struct Scsi_Host *)0)->hostdata ) *__mptr = ((void *) us); (struct Scsi_Host *)( (char *)__mptr - __builtin_offsetof(struct Scsi_Host,hostdata) );});
}
static inline __attribute__((always_inline)) struct us_data *host_to_us(struct Scsi_Host *host) {
...
# 67 "../../drivers/usb/storage/usb.c" 2
# 1 "../../drivers/usb/storage/scsiglue.h" 1
# 42 "../../drivers/usb/storage/scsiglue.h"
extern void usb_stor_report_device_reset(struct us_data *us);
extern void usb_stor_report_bus_reset(struct us_data *us);

extern unsigned char usb_stor_sense_invalidCDB[18];
extern struct scsi_host_template usb_stor_host_template;
# 68 "../../drivers/usb/storage/usb.c" 2
# 1 "../../drivers/usb/storage/transport.h" 1
# 49 "../../drivers/usb/storage/transport.h"
struct bulk_cb_wrap {
 __le32 Signature;
 __u32 Tag;
...
# 116 "../../drivers/usb/storage/transport.h"
...
# 69 "../../drivers/usb/storage/usb.c" 2
# 1 "../../drivers/usb/storage/protocol.h" 1
# 43 "../../drivers/usb/storage/protocol.h"
...
# 70 "../../drivers/usb/storage/usb.c" 2
# 1 "../../drivers/usb/storage/debug.h" 1
# 71 "../../drivers/usb/storage/usb.c" 2
# 1 "../../drivers/usb/storage/initializers.h" 1
# 43 "../../drivers/usb/storage/initializers.h"
...
# 72 "../../drivers/usb/storage/usb.c" 2

# 1 "../../drivers/usb/storage/sierra_ms.h" 1


extern int sierra_ms_init(struct us_data *us);
# 74 "../../drivers/usb/storage/usb.c" 2
# 1 "../../drivers/usb/storage/option_ms.h" 1


extern int option_ms_init(struct us_data *us);
# 75 "../../drivers/usb/storage/usb.c" 2
...
static inline __attribute__((always_inline)) unsigned int *__check_delay_use(void) { return(&(delay_use)); }; static int __param_perm_check_delay_use __attribute__((unused)) = (sizeof(struct { int:-!!(((00400|00040|00004) | 00200) < 0 || ((00400|00040|00004) | 00200) > 0777 || (((00400|00040|00004) | 00200) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""usb_storage" ".") > (64 - sizeof(unsigned long))); })); static const char __param_str_delay_use[] = "usb_storage" "." "delay_use"; static struct kernel_param const __param_delay_use __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_delay_use, (00400|00040|00004) | 00200, __builtin_types_compatible_p(typeof(*(&delay_use)), typeof(bool)) ? 2 : 0, param_set_uint, param_get_uint, { &delay_use } }; ;
;

static char quirks[128];
static const struct kparam_string __param_string_quirks = { sizeof(quirks), quirks }; static int __param_perm_check_quirks __attribute__((unused)) = (sizeof(struct { int:-!!(((00400|00040|00004) | 00200) < 0 || ((00400|00040|00004) | 00200) > 0777 || (((00400|00040|00004) | 00200) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""usb_storage" ".") > (64 - sizeof(unsigned long))); })); static const char __param_str_quirks[] = "usb_storage" "." "quirks"; static struct kernel_param const __param_quirks __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_quirks, (00400|00040|00004) | 00200, 0 ? 2 : 0, param_set_copystring, param_get_string, { .str = &__param_string_quirks } }; ;
;
# 123 "../../drivers/usb/storage/usb.c"
static struct us_unusual_dev us_unusual_dev_list[] = {
# 1 "../../drivers/usb/storage/unusual_devs.h" 1
# 63 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "ATMEL", .productName = "SND1 Storage", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "VIA Technologies Inc.", .productName = "Mitsumi multi cardreader", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "HP", .productName = "CD-Writer+", .useProtocol = 0x05, .useTransport = 0x01, .initFunction = ((void *)0), },





{ .vendorName = "HP", .productName = "Personal Media Drive", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 91 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "HP", .productName = "PhotoSmart R707", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 100 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "NEC", .productName = "NEC USB UF000x", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "VIA Technologies Inc.", .productName = "USB 2.0 Card Reader", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 117 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Buffalo", .productName = "DUB-P40G HDD", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Samsung Info. Systems America, Inc.", .productName = "MP3 Player", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Samsung", .productName = "MP3 Player", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "TrekStor", .productName = "i.Beat 115 2.0", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "TrekStor", .productName = "i.Beat Joy 2.0", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "GENERIC", .productName = "MP3 PLAYER", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Nokia", .productName = "Nokia 6288", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Nokia", .productName = "Nokia 3250", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Nokia", .productName = "E70", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Nokia", .productName = "E60", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Nokia", .productName = "N91", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Nokia", .productName = "N80", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Nokia", .productName = "E61", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Nokia", .productName = "6131", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Nokia", .productName = "Nokia 6233", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Nokia", .productName = "6234", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Microtech", .productName = "CameraMate", .useProtocol = 0x06, .useTransport = 0x01, .initFunction = ((void *)0), },
# 239 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Neuros Audio", .productName = "USB 2.0 HD 2.5", .useProtocol = 0xff, .useTransport = 0x50, .initFunction = ((void *)0), },
# 250 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "USBest Technology", .productName = "USB Mass Storage Device", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 260 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "USB 2.0", .productName = "Flash Disk", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 272 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Mitac", .productName = "GPS", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 284 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "AMI", .productName = "Virtual Floppy", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Kyocera", .productName = "Finecam S3x", .useProtocol = 0x05, .useTransport = 0x01, .initFunction = ((void *)0), },





{ .vendorName = "Kyocera", .productName = "Finecam S4", .useProtocol = 0x05, .useTransport = 0x01, .initFunction = ((void *)0), },





{ .vendorName = "Kyocera", .productName = "Finecam S5", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Kyocera", .productName = "CONTAX SL300R T*", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Hitachi", .productName = "DVD-CAM DZ-MV100A Camcorder", .useProtocol = 0x06, .useTransport = 0x01, .initFunction = ((void *)0), },
...
{ .vendorName = "Tekom Technologies, Inc", .productName = "300_CAMERA", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "NIKON", .productName = "NIKON DSC E2000", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "IBM", .productName = "IBM RSA2", .useProtocol = 0xff, .useTransport = 0x01, .initFunction = ((void *)0), },
...
{ .vendorName = "Epson", .productName = "875DC Storage", .useProtocol = 0x06, .useTransport = 0x01, .initFunction = ((void *)0), },
...
{ .vendorName = "Epson", .productName = "785EPX Storage", .useProtocol = 0x06, .useTransport = 0x50, .initFunction = ((void *)0), },
...
{ .vendorName = "Fujifilm", .productName = "FinePix 1400Zoom", .useProtocol = 0x04, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "ScanLogic", .productName = "SL11R-IDE", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 382 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Panasonic", .productName = "LS-120 Camera", .useProtocol = 0x04, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sharp CE-CW05", .productName = "CD-R/RW Drive", .useProtocol = 0x05, .useTransport = 0x01, .initFunction = ((void *)0), },





{ .vendorName = "Panasonic", .productName = "DMC-LCx Camera", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "LEICA", .productName = "D-LUX Camera", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 411 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Matshita", .productName = "LS-120", .useProtocol = 0x02, .useTransport = 0x01, .initFunction = ((void *)0), },




{ .vendorName = "Shuttle", .productName = "eUSCSI Bridge", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = usb_stor_euscsi_init, },
...
{ .vendorName = "SCM Microsystems", .productName = "eUSB CompactFlash Adapter", .useProtocol = 0x06, .useTransport = 0x01, .initFunction = ((void *)0), },
...
{ .vendorName = "SCM Microsystems Inc.", .productName = "eUSB MMC Adapter", .useProtocol = 0x06, .useTransport = 0x01, .initFunction = ((void *)0), },
...
{ .vendorName = "Shuttle", .productName = "eUSB MMC Adapter", .useProtocol = 0x06, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Sony", .productName = "Hifd", .useProtocol = 0x06, .useTransport = 0x01, .initFunction = ((void *)0), },





{ .vendorName = "Shuttle", .productName = "eUSB ATA/ATAPI Adapter", .useProtocol = 0x02, .useTransport = 0x01, .initFunction = ((void *)0), },




{ .vendorName = "Shuttle", .productName = "eUSB CompactFlash Adapter", .useProtocol = 0x02, .useTransport = 0x01, .initFunction = ((void *)0), },




{ .vendorName = "Shuttle", .productName = "eUSCSI Bridge", .useProtocol = 0x06, .useTransport = 0x50, .initFunction = usb_stor_euscsi_init, },
...
{ .vendorName = "Shuttle", .productName = "CD-RW Device", .useProtocol = 0x02, .useTransport = 0x01, .initFunction = ((void *)0), },





{ .vendorName = "Samsung", .productName = "YP-U3", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 488 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Kobian Mercury", .productName = "Binocam DCB-132", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Belkin", .productName = "USB SCSI Adaptor", .useProtocol = 0x06, .useTransport = 0x50, .initFunction = usb_stor_euscsi_init, },
# 505 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Iomega", .productName = "USB Clik! 40", .useProtocol = 0x05, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Linux", .productName = "File-backed Storage Gadget", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Tekom Technologies, Inc", .productName = "400_CAMERA", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony", .productName = "DSC-S30/S70/S75/505V/F505/F707/F717/P8", .useProtocol = 0x06, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony", .productName = "DSC-T1/T5/H5", .useProtocol = 0x05, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony", .productName = "Memorystick NW-MS7", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony", .productName = "USB Floppy Drive", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Sony", .productName = "Memorystick MSAC-US1", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony", .productName = "Handycam", .useProtocol = 0x06, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony", .productName = "Handycam HC-85", .useProtocol = 0x04, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Sony", .productName = "Memorystick MSC-U01N", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony", .productName = "PEG N760c Memorystick", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Sony", .productName = "Memorystick MSC-U03", .useProtocol = 0x04, .useTransport = 0x01, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony", .productName = "PEG Mass Storage", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "SAMSUNG", .productName = "SFD-321U [FW 0C]", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Y-E Data", .productName = "Flashbuster-U", .useProtocol = 0xff, .useTransport = 0x01, .initFunction = ((void *)0), },
# 664 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Y-E Data", .productName = "Silicon Media R/W", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "JetFlash", .productName = "TS1GJF2A/120", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Fujifilm", .productName = "Digital Camera EX-20 DSC", .useProtocol = 0x05, .useTransport = 0xff, .initFunction = ((void *)0), },
# 688 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Iomega", .productName = "ZIP 100", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "LaCie", .productName = "DVD+-RW", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 705 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "In-System", .productName = "PyroGate External CD-ROM Enclosure (FCD-523)", .useProtocol = 0x06, .useTransport = 0x50, .initFunction = ((void *)0), },
# 717 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Apple", .productName = "iPod", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Option N.V.", .productName = "Mass Storage", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = option_ms_init, },
...
{ .vendorName = "Lexar", .productName = "USB CF Reader", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 782 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Genesys Logic", .productName = "USB to IDE Optical", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Genesys Logic", .productName = "USB to IDE Disk", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Genesys Logic", .productName = "USB to SATA", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Vivitar", .productName = "Vivicam 35Xx", .useProtocol = 0x06, .useTransport = 0x50, .initFunction = ((void *)0), },





{ .vendorName = "TEAC", .productName = "Floppy Drive", .useProtocol = 0x04, .useTransport = 0x01, .initFunction = ((void *)0), },





{ .vendorName = "SigmaTel", .productName = "USBMSC Audio Player", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Prolific Technology, Inc.", .productName = "Prolific Storage Gadget", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Prolific Technology, Inc.", .productName = "Mass Storage Device", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Prolific Technology Inc.", .productName = "ATAPI-6 Bridge Controller", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Minolta", .productName = "Dimage F300", .useProtocol = 0x06, .useTransport = 0x50, .initFunction = ((void *)0), },





{ .vendorName = "Minolta", .productName = "DIMAGE E223", .useProtocol = 0x06, .useTransport = 0xff, .initFunction = ((void *)0), },




{ .vendorName = "Hagiwara", .productName = "Flashgate", .useProtocol = 0x06, .useTransport = 0x50, .initFunction = ((void *)0), },





{ .vendorName = "Thomson Multimedia Inc.", .productName = "RCA RD1080 MP3 Player", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "RockChip", .productName = "MP3", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 886 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "RockChip", .productName = "MTP", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 902 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "RockChip", .productName = "ROCK MP3", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sandisk", .productName = "ImageMate SDDR-05a", .useProtocol = 0x06, .useTransport = 0x01, .initFunction = ((void *)0), },





{ .vendorName = "SanDisk Corporation", .productName = "ImageMate CompactFlash USB", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Sandisk", .productName = "ImageMate SDDR-12", .useProtocol = 0x06, .useTransport = 0x01, .initFunction = ((void *)0), },
...
{ .vendorName = "Freecom Technologies", .productName = "FHD-Classic", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Microtech", .productName = "USB-SCSI-DB25", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = usb_stor_euscsi_init, },





{ .vendorName = "Microtech", .productName = "USB-SCSI-HD50", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = usb_stor_euscsi_init, },
...
{ .vendorName = "Datafab", .productName = "KECF-USB", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 976 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Simple Tech/Datafab", .productName = "CF+SM Reader", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 993 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Casio", .productName = "QV DigitalCamera", .useProtocol = 0x05, .useTransport = 0x01, .initFunction = ((void *)0), },
...
{ .vendorName = "Samsung", .productName = "Digimax 410", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Argosy", .productName = "Storage", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Grandtech", .productName = "DC2MEGA", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1044 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "PanDigital", .productName = "Photo Frame", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "CITIZEN", .productName = "X1DE-USB", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1060 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "AIPTEK", .productName = "Aiptek USB Keychain MP3 Player", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1071 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Trumpion", .productName = "t33520 USB Flash Card Controller", .useProtocol = 0xff, .useTransport = 0x50, .initFunction = ((void *)0), },
# 1080 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Trumpion Microelectronics, Inc.", .productName = "33520 USB Digital Voice Recorder", .useProtocol = 0x04, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Trumpion", .productName = "MP3 player", .useProtocol = 0x01, .useTransport = 0x50, .initFunction = ((void *)0), },
...
{ .vendorName = "Feiya", .productName = "5-in-1 Card Reader", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1107 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Pentax", .productName = "Optio 2/3/400", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "ZyXEL", .productName = "G-220F USB-WLAN Install", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "SiteCom", .productName = "WL-117 USB-WLAN Install", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1133 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Option N.V.", .productName = "Mass Storage", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = option_ms_init, },
# 1143 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Option", .productName = "GI 0401 SD-Card", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1153 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Option", .productName = "GI 0431 SD-Card", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Option", .productName = "GI 0451 SD-Card", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Option", .productName = "GI 0452 SD-Card", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Option", .productName = "GI 0461 SD-Card", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Option", .productName = "GI 033x SD-Card", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Option", .productName = "GI 070x SD-Card", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Option", .productName = "GI 1505 SD-Card", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Option", .productName = "GI 1509 SD-Card", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Option", .productName = "GI 1515 SD-Card", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Option", .productName = "GI 1215 SD-Card", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Seagate", .productName = "FreeAgent Pro", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Maxtor", .productName = "USB to SATA", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1260 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Unknown", .productName = "Unknown", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Medion", .productName = "MD 7425", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1278 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Jenoptik", .productName = "JD 5200 z3", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "Macpower Technology Co.LTD.", .productName = "USB 2.0 3.5\" DEVICE", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1295 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Netac", .productName = "USB-CF-Card", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Netac", .productName = "USB Flash Disk", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1312 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "WINWARD", .productName = "Music Disk", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "PNP_MP3", .productName = "PNP_MP3 PLAYER", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Cowon Systems", .productName = "iAUDIO M5", .useProtocol = 0xff, .useTransport = 0x50, .initFunction = ((void *)0), },
...
{ .vendorName = "USB", .productName = "Solid state disk", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Ours Technology", .productName = "Flash Disk", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "USB", .productName = "Flash Disk", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Typhoon", .productName = "My DJ 1820", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1367 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Oracom Co., Ltd", .productName = "ORC-200M", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1377 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "C-MEX", .productName = "A-VOX", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony Ericsson", .productName = "V800-Vodafone 802", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony Ericsson", .productName = "MD400", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony Ericsson", .productName = "P990i", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony Ericsson", .productName = "M600i", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Sony Ericsson", .productName = "P1i", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1425 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Desknote", .productName = "UCR-61S2B", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = usb_stor_ucr61s2b_init, },





{ .vendorName = "Western Digital", .productName = "External HDD", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1440 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Actions Semiconductor", .productName = "Mtp device", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1449 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "D-Link", .productName = "USB Mass Storage", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = option_ms_init, },
# 1459 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Sierra Wireless", .productName = "USB MMC Storage", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = sierra_ms_init, },
# 1469 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Digitech HMG", .productName = "DigiTech Mass Storage", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1478 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "HUAWEI MOBILE", .productName = "Mass Storage", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = usb_stor_huawei_e220_init, },
...
{ .vendorName = "Minolta", .productName = "Dimage Z10", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "SWISSBIT", .productName = "Black Silver", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Super Top", .productName = "IDE DEVICE", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1833 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "JMicron", .productName = "USB to ATA/ATAPI Bridge", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "Teac", .productName = "HD-35PUK-B", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1851 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "BUILDWIN", .productName = "Photo Frame", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "ST", .productName = "2A", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1871 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Motorola", .productName = "RAZR V3x", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1882 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Motorola", .productName = "MSnc.", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "MPIO", .productName = "HS200", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1898 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Mitac", .productName = "Mio DigiWalker USB Sync", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "iRiver", .productName = "MP3 T10", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "iRiver", .productName = "P7K", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
# 1922 "../../drivers/usb/storage/unusual_devs.h"
{ .vendorName = "Iomega", .productName = "Micro Mini 1GB", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .vendorName = "DataStor", .productName = "USB4500 FW1.04", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },
...
{ .vendorName = "TGE", .productName = "Digital MP3 Audio Player", .useProtocol = 0xff, .useTransport = 0xff, .initFunction = ((void *)0), },





{ .useProtocol = 0x01, .useTransport = 0x01, },
{ .useProtocol = 0x02, .useTransport = 0x01, },
{ .useProtocol = 0x03, .useTransport = 0x01, },
{ .useProtocol = 0x04, .useTransport = 0x01, },
{ .useProtocol = 0x05, .useTransport = 0x01, },
{ .useProtocol = 0x06, .useTransport = 0x01, },


{ .useProtocol = 0x01, .useTransport = 0x00, },
{ .useProtocol = 0x02, .useTransport = 0x00, },
{ .useProtocol = 0x03, .useTransport = 0x00, },
{ .useProtocol = 0x04, .useTransport = 0x00, },
{ .useProtocol = 0x05, .useTransport = 0x00, },
{ .useProtocol = 0x06, .useTransport = 0x00, },


{ .useProtocol = 0x01, .useTransport = 0x50, },
{ .useProtocol = 0x02, .useTransport = 0x50, },
{ .useProtocol = 0x03, .useTransport = 0x50, },
{ .useProtocol = 0x04, .useTransport = 0x50, },
{ .useProtocol = 0x05, .useTransport = 0x50, },
{ .useProtocol = 0x06, .useTransport = 0x50, },
# 125 "../../drivers/usb/storage/usb.c" 2
 { }
};
# 135 "../../drivers/usb/storage/usb.c"
...
extern typeof(usb_stor_suspend) usb_stor_suspend; static const char __kstrtab_usb_stor_suspend[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_suspend"; static const struct kernel_symbol __ksymtab_usb_stor_suspend __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_suspend, __kstrtab_usb_stor_suspend };
...
extern typeof(usb_stor_resume) usb_stor_resume; static const char __kstrtab_usb_stor_resume[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_resume"; static const struct kernel_symbol __ksymtab_usb_stor_resume __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_resume, __kstrtab_usb_stor_resume };
...
extern typeof(usb_stor_reset_resume) usb_stor_reset_resume; static const char __kstrtab_usb_stor_reset_resume[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_reset_resume"; static const struct kernel_symbol __ksymtab_usb_stor_reset_resume __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_reset_resume, __kstrtab_usb_stor_reset_resume };
# 191 "../../drivers/usb/storage/usb.c"
...
extern typeof(usb_stor_pre_reset) usb_stor_pre_reset; static const char __kstrtab_usb_stor_pre_reset[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_pre_reset"; static const struct kernel_symbol __ksymtab_usb_stor_pre_reset __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_pre_reset, __kstrtab_usb_stor_pre_reset };
...
extern typeof(usb_stor_post_reset) usb_stor_post_reset; static const char __kstrtab_usb_stor_post_reset[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_post_reset"; static const struct kernel_symbol __ksymtab_usb_stor_post_reset __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_post_reset, __kstrtab_usb_stor_post_reset };
# 229 "../../drivers/usb/storage/usb.c"
  ...
  unsigned int data_len)
{
 ...
 ({ void *__p = (data+8); size_t __n = 28; if ((__n) != 0) { if (__builtin_constant_p((' ')) && (' ') == 0) __memzero((__p),(__n)); else memset((__p),(' '),(__n)); } (__p); });
 if(data[0]&0x20) {
# 245 "../../drivers/usb/storage/usb.c"
 } else {
  u16 bcdDevice = (( __u16)(__le16)(us->pusb_dev->descriptor.bcdDevice));
  int n;

  n = strlen(us->unusual_dev->vendorName);
  memcpy(data+8, us->unusual_dev->vendorName, ({ typeof(8) _min1 = (8); typeof(n) _min2 = (n); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; }));
  n = strlen(us->unusual_dev->productName);
  memcpy(data+16, us->unusual_dev->productName, ({ typeof(16) _min1 = (16); typeof(n) _min2 = (n); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; }));
...
extern typeof(fill_inquiry_response) fill_inquiry_response; static const char __kstrtab_fill_inquiry_response[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "fill_inquiry_response"; static const struct kernel_symbol __ksymtab_fill_inquiry_response __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&fill_inquiry_response, __kstrtab_fill_inquiry_response };
...
static int usb_stor_control_thread(void * __us)
{
 ...
 for(;;) {
  ...
  if (test_bit(5, &us->dflags)) {
   us->srb->result = 0x05 << 16;
   goto SkipForAbort;
  }
...
SkipForAbort:
  ...
  if (test_bit(5, &us->dflags)) {
   ...
   _clear_bit_le(2,&us->dflags);
   _clear_bit_le(5,&us->dflags);
  }
...
static int associate_dev(struct us_data *us, struct usb_interface *intf)
{
 ...
 us->cr = kmalloc(sizeof(*us->cr), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!us->cr) {
  ;
  return -12;
 }

 us->iobuf = usb_alloc_coherent(us->pusb_dev, 64,
   ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)), &us->iobuf_dma);
 if (!us->iobuf) {
  ;
  return -12;
 }
...
{
 char *p;
 u16 vid = (( __u16)(__le16)(us->pusb_dev->descriptor.idVendor));
 u16 pid = (( __u16)(__le16)(us->pusb_dev->descriptor.idProduct));
 unsigned f = 0;
  ...
  struct us_unusual_dev *unusual_dev)
{
 ...
 us->subclass = (unusual_dev->useProtocol == 0xff) ?
   idesc->bInterfaceSubClass :
   unusual_dev->useProtocol;
 us->protocol = (unusual_dev->useTransport == 0xff) ?
   idesc->bInterfaceProtocol :
   unusual_dev->useTransport;
 us->fflags = ((id->driver_info) & 0x00FFFFFF);
 adjust_quirks(us);

 if (us->fflags & US_FL_IGNORE_DEVICE) {
  printk("<6>" "%s %s: " "device ignored\n" , dev_driver_string(pdev) , dev_name(pdev));
  return -19;
 }
 ...
 if (us->fflags)
  printk("<6>" "%s %s: " "Quirks match for vid %04x pid %04x: %lx\n" , dev_driver_string(pdev) , dev_name(pdev) , (( __u16)(__le16)(dev->descriptor.idVendor)), (( __u16)(__le16)(dev->descriptor.idProduct)), us->fflags);
# 546 "../../drivers/usb/storage/usb.c"
 if (id->idVendor || id->idProduct) {
  ...
  if (unusual_dev->useProtocol != 0xff &&
   us->subclass == idesc->bInterfaceSubClass)
   msg += 1;
  if (unusual_dev->useTransport != 0xff &&
   us->protocol == idesc->bInterfaceProtocol)
   msg += 2;
  if (msg >= 0 && !(us->fflags & US_FL_NEED_OVERRIDE))
   printk("<5>" "%s %s: " "This device " "(%04x,%04x,%04x S %02x P %02x)" " has %s in unusual_devs.h (kernel" " %s)\n" "   Please send a copy of this message to " "<linux-usb@vger.kernel.org> and " "<usb-storage@lists.one-eyed-alien.net>\n" , dev_driver_string(pdev) , dev_name(pdev) , (( __u16)(__le16)(ddesc->idVendor)), (( __u16)(__le16)(ddesc->idProduct)), (( __u16)(__le16)(ddesc->bcdDevice)), idesc->bInterfaceSubClass, idesc->bInterfaceProtocol, msgs[msg], utsname()->release);
# 575 "../../drivers/usb/storage/usb.c"
 }
...
static int get_pipes(struct us_data *us)
{
 ...
 if (!ep_in || !ep_out || (us->protocol == 0x00 && !ep_int)) {
  ;
  return -5;
 }


 us->send_ctrl_pipe = ((2 << 30) | __create_pipe(us->pusb_dev, 0));
 us->recv_ctrl_pipe = ((2 << 30) | __create_pipe(us->pusb_dev, 0) | 0x80);
 us->send_bulk_pipe = ((3 << 30) | __create_pipe(us->pusb_dev, usb_endpoint_num(ep_out)));

 us->recv_bulk_pipe = ((3 << 30) | __create_pipe(us->pusb_dev, usb_endpoint_num(ep_in)) | 0x80);

 if (ep_int) {
  us->recv_intr_pipe = ((1 << 30) | __create_pipe(us->pusb_dev, usb_endpoint_num(ep_int)) | 0x80);
...
static int usb_stor_acquire_resources(struct us_data *us)
{
 ...
 us->current_urb = usb_alloc_urb(0, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!us->current_urb) {
  ;
  return -12;
 }
 ...
 th = ({ struct task_struct *__k = kthread_create(usb_stor_control_thread, us, "usb-storage"); if (!IS_ERR(__k)) wake_up_process(__k); __k; });
 if (IS_ERR(th)) {
  printk("<4>" "%s %s: " "Unable to start control thread\n" , dev_driver_string(&us->pusb_intf->dev) , dev_name(&us->pusb_intf->dev));
...
static void dissociate_dev(struct us_data *us)
{
 ...
 kfree(us->cr);
 usb_free_coherent(us->pusb_dev, 64, us->iobuf, us->iobuf_dma);
...
static void quiesce_and_remove_host(struct us_data *us)
{
 ...
 if (us->pusb_dev->state == USB_STATE_NOTATTACHED)
  _set_bit_le(3,&us->dflags);




 _set_bit_le(6,&us->dflags);
 __wake_up(&us->delay_wait, (1 | 2), 1, ((void *)0));
...
static int usb_stor_scan_thread(void * __us)
{
 ...
 ({ if (0) printk("<7>" "%s %s: " "device found\n" , dev_driver_string(dev) , dev_name(dev)); 0; });

 set_freezable();

 if (delay_use > 0) {
  ({ if (0) printk("<7>" "%s %s: " "waiting for device to settle " "before scanning\n" , dev_driver_string(dev) , dev_name(dev)); 0; });

  ({ long __retval = delay_use * 200; do { __retval = ({ long __ret = __retval; if (!((test_bit(6, &us->dflags)) || freezing((get_current())))) do { wait_queue_t __wait = { .private = (get_current()), .func = autoremove_wake_function, .task_list = { &((__wait).task_list), &((__wait).task_list) }, }; for (;;) { prepare_to_wait(&us->delay_wait, &__wait, 1); if ((test_bit(6, &us->dflags)) || freezing((get_current()))) break; if (!signal_pending((get_current()))) { __ret = schedule_timeout(__ret); if (!__ret) break; continue; } __ret = -512; break; } finish_wait(&us->delay_wait, &__wait); } while (0); __ret; }); } while (try_to_freeze()); __retval; });


 }


 if (!test_bit(6, &us->dflags)) {
  ...
  ({ if (0) printk("<7>" "%s %s: " "scan complete\n" , dev_driver_string(dev) , dev_name(dev)); 0; });
  ...
  struct us_unusual_dev *unusual_dev)
{
 ...
 if (!host) {
  printk("<4>" "%s %s: " "Unable to allocate the scsi host\n" , dev_driver_string(&intf->dev) , dev_name(&intf->dev));
 ...
 *pus = us = host_to_us(host);
 ({ void *__p = (us); size_t __n = sizeof(struct us_data); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
 do { static struct lock_class_key __key; __mutex_init((&(us->dev_mutex)), "&(us->dev_mutex)", &__key); } while (0);
 init_completion(&us->cmnd_ready);
 init_completion(&(us->notify));
 do { static struct lock_class_key __key; __init_waitqueue_head((&us->delay_wait), &__key); } while (0);
...
extern typeof(usb_stor_probe1) usb_stor_probe1; static const char __kstrtab_usb_stor_probe1[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_probe1"; static const struct kernel_symbol __ksymtab_usb_stor_probe1 __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_probe1, __kstrtab_usb_stor_probe1 };
...
int usb_stor_probe2(struct us_data *us)
{
 ...
 if (result) {
  printk("<4>" "%s %s: " "Unable to add the scsi host\n" , dev_driver_string(dev) , dev_name(dev));
 ...
 if (IS_ERR(th)) {
  printk("<4>" "%s %s: " "Unable to start the device-scanning thread\n" , dev_driver_string(dev) , dev_name(dev));
...
extern typeof(usb_stor_probe2) usb_stor_probe2; static const char __kstrtab_usb_stor_probe2[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_probe2"; static const struct kernel_symbol __ksymtab_usb_stor_probe2 __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_probe2, __kstrtab_usb_stor_probe2 };
...
extern typeof(usb_stor_disconnect) usb_stor_disconnect; static const char __kstrtab_usb_stor_disconnect[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_stor_disconnect"; static const struct kernel_symbol __ksymtab_usb_stor_disconnect __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_stor_disconnect, __kstrtab_usb_stor_disconnect };
    ...
    const struct usb_device_id *id)
{
 ...
 if ((0) ||
  ...
  return -6;
# 1018 "../../drivers/usb/storage/usb.c"
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) usb_stor_init(void)
{
 int retval;
...
static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) usb_stor_exit(void)
{
 ;
...
static initcall_t __initcall_usb_stor_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = usb_stor_init;;
static exitcall_t __exitcall_usb_stor_exit __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = usb_stor_exit;;
