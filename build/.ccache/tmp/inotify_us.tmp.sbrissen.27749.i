...
# 1 "<command-line>" 2
# 1 "../../fs/notify/inotify/inotify_user.c"
# 25 "../../fs/notify/inotify/inotify_user.c"
...
# 26 "../../fs/notify/inotify/inotify_user.c" 2
...
# 27 "../../fs/notify/inotify/inotify_user.c" 2
...
# 28 "../../fs/notify/inotify/inotify_user.c" 2
...
# 31 "../../fs/notify/inotify/inotify_user.c" 2
...
# 33 "../../fs/notify/inotify/inotify_user.c" 2
...
# 34 "../../fs/notify/inotify/inotify_user.c" 2
...
# 35 "../../fs/notify/inotify/inotify_user.c" 2
...
# 36 "../../fs/notify/inotify/inotify_user.c" 2
...
int anon_inode_getfd(const char *name, const struct file_operations *fops,
       void *priv, int flags);
# 38 "../../fs/notify/inotify/inotify_user.c" 2
...
# 39 "../../fs/notify/inotify/inotify_user.c" 2
...
# 40 "../../fs/notify/inotify/inotify_user.c" 2


# 1 "../../fs/notify/inotify/inotify.h" 1
...
# 43 "../../fs/notify/inotify/inotify_user.c" 2
...
# 45 "../../fs/notify/inotify/inotify_user.c" 2
...
static inline __attribute__((always_inline)) __u32 inotify_arg_to_mask(u32 arg)
{
 __u32 mask;
 ...
 mask = (0x00008000 | 0x08000000 | 0x00002000);


 mask |= (arg & ((0x00000001 | 0x00000002 | 0x00000004 | 0x00000008 | 0x00000010 | 0x00000020 | 0x00000040 | 0x00000080 | 0x00000200 | 0x00000100 | 0x00000400 | 0x00000800) | 0x80000000));

 return mask;
}

static inline __attribute__((always_inline)) u32 inotify_mask_to_arg(__u32 mask)
{
 return mask & ((0x00000001 | 0x00000002 | 0x00000004 | 0x00000008 | 0x00000010 | 0x00000020 | 0x00000040 | 0x00000080 | 0x00000200 | 0x00000100 | 0x00000400 | 0x00000800) | 0x40000000 | 0x00002000 | 0x00008000 |
         0x00004000);
}
...
# 139 "../../fs/notify/inotify/inotify_user.c"
         ...
         size_t count)
{
 ...
 if (event->name_len)
  event_size += ((((event->name_len + 1) + ((event_size) - 1)) / (event_size)) * (event_size));
      ...
      char *buf)
{
 ...
 if (!fsn_priv)
  ...
  priv = ({ const typeof( ((struct inotify_event_private_data *)0)->fsnotify_event_priv_data ) *__mptr = (fsn_priv); (struct inotify_event_private_data *)( (char *)__mptr - __builtin_offsetof(struct inotify_event_private_data,fsnotify_event_priv_data) );});
 ...
 if (event->name_len)
  name_len = ((((event->name_len + 1) + ((event_size) - 1)) / (event_size)) * (event_size));
       ...
       size_t count, loff_t *pos)
{
 ...
 while (1) {
  prepare_to_wait(&group->notification_waitq, &wait, 1);
...
static int inotify_fasync(int fd, struct file *file, int on)
{
 ...
 return fasync_helper(fd, file, on, &group->inotify_data.fa) >= 0 ? 0 : -5;
}
...
static int inotify_release(struct inode *ignored, struct file *file)
{
 ...
 atomic_sub(1, &user->inotify_devs);
     ...
     unsigned long arg)
{
 ...
 case 0x541B:
  mutex_lock(&group->notification_mutex);
  for (holder = ({ const typeof( ((typeof(*holder) *)0)->event_list ) *__mptr = ((&group->notification_list)->next); (typeof(*holder) *)( (char *)__mptr - __builtin_offsetof(typeof(*holder),event_list) );}); prefetch(holder->event_list.next), &holder->event_list != (&group->notification_list); holder = ({ const typeof( ((typeof(*holder) *)0)->event_list ) *__mptr = (holder->event_list.next); (typeof(*holder) *)( (char *)__mptr - __builtin_offsetof(typeof(*holder),event_list) );})) {
   event = holder->event;
   send_len += sizeof(struct inotify_event);
   if (event->name_len)
    send_len += ((((event->name_len + 1) + ((sizeof(struct inotify_event)) - 1)) / (sizeof(struct inotify_event))) * (sizeof(struct inotify_event)));

  }
  mutex_unlock(&group->notification_mutex);
  ret = ({ register const typeof(*((int *) p)) __r2 asm("r2") = (send_len); register const typeof(*((int *) p)) *__p asm("r0") = ((int *) p); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; });
  break;
 }
...
static int inotify_find_inode(const char *dirname, struct path *path, unsigned flags)
{
 int error;

 error = user_path_at(-100, dirname, flags, path);
 if (error)
  return error;

 error = inode_permission(path->dentry->d_inode, 4);
 if (error)
  path_put(path);
 return error;
}
        ...
        struct inotify_inode_mark_entry *ientry)
{
 ...
 found_ientry = ({ const typeof( ((struct inotify_inode_mark_entry *)0)->fsn_entry ) *__mptr = (entry); (struct inotify_inode_mark_entry *)( (char *)__mptr - __builtin_offsetof(struct inotify_inode_mark_entry,fsn_entry) );});
 if (__builtin_expect(!!(found_ientry != ientry), 0)) {



  ({ int __ret_warn_on = !!(1); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/notify/inotify/inotify_user.c", 391); __builtin_expect(!!(__ret_warn_on), 0); });
  ientry->wd = -1;
  goto out;
 }


 do { if (__builtin_expect(!!((*(volatile int *)&(&entry->refcnt)->counter) < 2), 0)) do { *(int *)0 = 0; } while (1); } while(0);
        ...
        struct fsnotify_group *group)
{
 ...
 ignored_event = fsnotify_create_event(((void *)0), 0x00008000, ((void *)0),
           0, ((void *)0), 0,
           ((( gfp_t)0x10u) | (( gfp_t)0x40u)));
 if (!ignored_event)
  return;

 ientry = ({ const typeof( ((struct inotify_inode_mark_entry *)0)->fsn_entry ) *__mptr = (entry); (struct inotify_inode_mark_entry *)( (char *)__mptr - __builtin_offsetof(struct inotify_inode_mark_entry,fsn_entry) );});

 event_priv = kmem_cache_alloc(event_priv_cachep, ((( gfp_t)0x10u) | (( gfp_t)0x40u)));
 if (__builtin_expect(!!(!event_priv), 0))
...
skip_send_ignore:
 ...
 atomic_sub(1, &group->inotify_data.user->inotify_watches);
}
        ...
        u32 arg)
{
 ...
 tmp_ientry = kmem_cache_alloc(inotify_inode_mark_cachep, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (__builtin_expect(!!(!tmp_ientry), 0))
  return -12;
 ...
 ret = -28;
 if ((*(volatile int *)&(&group->inotify_data.user->inotify_watches)->counter) >= inotify_max_user_watches)
  goto out_err;
retry:
 ret = -12;
 if (__builtin_expect(!!(!idr_pre_get(&group->inotify_data.idr, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)))), 0))
  goto out_err;
 ...
 atomic_add(1, &group->inotify_data.user->inotify_watches);
...
static struct fsnotify_group *inotify_new_group(struct user_struct *user, unsigned int max_events)
{
 ...
 grp_num = (((~0U)-1) - (atomic_add_return(1, &inotify_grp_num)));
 ...
 do { spinlock_check(&group->inotify_data.idr_lock); do { *(&(&group->inotify_data.idr_lock)->rlock) = (raw_spinlock_t) { .raw_lock = { 0 }, }; } while (0); } while (0);
 ...
 long sys_inotify_init1(int flags)
{
 ...
 ((void)(sizeof(struct { int:-!!(02000000 != 02000000); })));
 ((void)(sizeof(struct { int:-!!(00004000 != 00004000); })));

 if (flags & ~(02000000 | 00004000))
  return -22;

 user = ({ struct user_struct *__u; struct cred *__cred; __cred = (struct cred *) ((get_current())->cred); __u = get_uid(__cred->user); __u; });
 if (__builtin_expect(!!((*(volatile int *)&(&user->inotify_devs)->counter) >= inotify_max_user_instances), 0)) {
 ...
 atomic_add(1, &user->inotify_devs);
...

{
 ...
 if (__builtin_expect(!!(!filp), 0))
  return -9;


 if (__builtin_expect(!!(filp->f_op != &inotify_fops), 0)) {
  ret = -22;
  goto fput_and_out;
 }
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) inotify_user_setup(void)
{
 inotify_inode_mark_cachep = kmem_cache_create("inotify_inode_mark_entry", sizeof(struct inotify_inode_mark_entry), __alignof__(struct inotify_inode_mark_entry), (0x00040000UL), ((void *)0));
 event_priv_cachep = kmem_cache_create("inotify_event_private_data", sizeof(struct inotify_event_private_data), __alignof__(struct inotify_event_private_data), (0x00040000UL), ((void *)0));
...
static initcall_t __initcall_inotify_user_setup6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = inotify_user_setup;;
