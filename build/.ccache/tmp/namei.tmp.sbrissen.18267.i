...
static inline __attribute__((always_inline)) void nd_terminate_link(void *name, size_t len, size_t maxlen)
{
...
# 65 "../../include/linux/fsnotify_backend.h"
...
# 111 "../../include/linux/fsnotify_backend.h"
 __u32 mask;
# 121 "../../include/linux/fsnotify_backend.h"
 atomic_t refcnt;
...
# 168 "../../include/linux/fsnotify_backend.h"
...
# 205 "../../include/linux/fsnotify_backend.h"
 union {
  struct path path;
  struct inode *inode;
 };
...
# 235 "../../include/linux/fsnotify_backend.h"
struct fsnotify_mark_entry {
 __u32 mask;
...
static inline __attribute__((always_inline)) void fsnotify_d_instantiate(struct dentry *entry,
      struct inode *inode)
{
...
static inline __attribute__((always_inline)) void fsnotify_parent(struct dentry *dentry, __u32 mask)
{
...
static inline __attribute__((always_inline)) void fsnotify_d_move(struct dentry *entry)
{
...
{
 inotify_inode_queue_event(inode, 0x00000004, 0, ((void *)0), ((void *)0));
     ...
     int isdir, struct inode *target, struct dentry *moved)
{
 ...
 inotify_inode_queue_event(old_dir, 0x00000040|isdir, in_cookie, old_name,
      source);
 inotify_inode_queue_event(new_dir, 0x00000080|isdir, in_cookie, new_name,
      source);
 ...
 if (target) {
  inotify_inode_queue_event(target, 0x00000400, 0, ((void *)0), ((void *)0));
 ...
 if (source) {
  inotify_inode_queue_event(source, 0x00000800, 0, ((void *)0), ((void *)0));
...
{
 inotify_inode_queue_event(inode, 0x00000400, 0, ((void *)0), ((void *)0));
...
{
 inotify_inode_queue_event(inode, 0x00000100, 0, dentry->d_name.name,
      dentry->d_inode);
 do { ; } while (0);
...
{
 inotify_inode_queue_event(dir, 0x00000100, 0, new_dentry->d_name.name,
      inode);
...
static inline __attribute__((always_inline)) void fsnotify_access(struct dentry *dentry)
{
 ...
 inotify_inode_queue_event(inode, mask, 0, ((void *)0), ((void *)0));
...
static inline __attribute__((always_inline)) void fsnotify_modify(struct dentry *dentry)
{
 struct inode *inode = dentry->d_inode;
...
static inline __attribute__((always_inline)) void fsnotify_open(struct dentry *dentry)
{
 struct inode *inode = dentry->d_inode;
...
static inline __attribute__((always_inline)) void fsnotify_close(struct file *file)
{
 ...
 fsnotify_parent(dentry, mask);
 fsnotify(inode, mask, file, 3, ((void *)0), 0);
}
...
static inline __attribute__((always_inline)) const char *fsnotify_oldname_init(const char *name)
{
...
static inline __attribute__((always_inline)) void fsnotify_oldname_free(const char *old_name)
{
 kfree(old_name);
}
# 24 "../../fs/namei.c" 2
...
{ }
# 26 "../../fs/namei.c" 2
# 1 "../../include/linux/ima.h" 1
# 14 "../../include/linux/ima.h"
struct linux_binprm;
# 26 "../../include/linux/ima.h"
static inline __attribute__((always_inline)) int ima_bprm_check(struct linux_binprm *bprm)
{
 return 0;
}

static inline __attribute__((always_inline)) int ima_inode_alloc(struct inode *inode)
{
 return 0;
}

static inline __attribute__((always_inline)) void ima_inode_free(struct inode *inode)
{
 return;
}

static inline __attribute__((always_inline)) int ima_file_check(struct file *file, int mask)
{
 return 0;
}

static inline __attribute__((always_inline)) void ima_file_free(struct file *file)
{
 return;
}

static inline __attribute__((always_inline)) int ima_file_mmap(struct file *file, unsigned long prot)
{
 return 0;
}

static inline __attribute__((always_inline)) void ima_counts_get(struct file *file)
{
 return;
}
# 27 "../../fs/namei.c" 2
...
# 5 "../../include/linux/ftrace_event.h" 2
...
static inline __attribute__((always_inline)) int trace_seq_printf(struct trace_seq *s, const char *fmt, ...)
{
 return 0;
}
static inline __attribute__((always_inline)) int
...
static inline __attribute__((always_inline)) int trace_print_seq(struct seq_file *m, struct trace_seq *s)
{
 return 0;
}
static inline __attribute__((always_inline)) ssize_t trace_seq_to_user(struct trace_seq *s, char *ubuf,
     size_t cnt)
{
 return 0;
}
static inline __attribute__((always_inline)) int trace_seq_puts(struct trace_seq *s, const char *str)
{
 return 0;
}
static inline __attribute__((always_inline)) int trace_seq_putc(struct trace_seq *s, unsigned char c)
{
 return 0;
}
static inline __attribute__((always_inline)) int
...
static inline __attribute__((always_inline)) int trace_seq_putmem_hex(struct trace_seq *s, const void *mem,
           size_t len)
{
 return 0;
}
static inline __attribute__((always_inline)) void *trace_seq_reserve(struct trace_seq *s, size_t len)
{
 return ((void *)0);
}
static inline __attribute__((always_inline)) int trace_seq_path(struct trace_seq *s, struct path *path)
{
 return 0;
}
# 6 "../../include/linux/ftrace_event.h" 2
...
# 22 "../../arch/arm/include/asm/perf_event.h"
static inline __attribute__((always_inline)) void
...
# 6 "../../include/linux/ftrace.h" 2
# 15 "../../include/linux/ftrace.h"
# 1 "../../arch/arm/include/asm/ftrace.h" 1
# 44 "../../arch/arm/include/asm/ftrace.h"
void *return_address(unsigned int);
# 16 "../../include/linux/ftrace.h" 2
# 91 "../../include/linux/ftrace.h"
static inline __attribute__((always_inline)) void clear_ftrace_function(void) { }
...
# 244 "../../include/linux/ftrace.h"
static inline __attribute__((always_inline)) int skip_trace(unsigned long ip) { return 0; }
static inline __attribute__((always_inline)) int ftrace_force_update(void) { return 0; }
static inline __attribute__((always_inline)) void ftrace_set_filter(unsigned char *buf, int len, int reset)
{
}
static inline __attribute__((always_inline)) void ftrace_disable_daemon(void) { }
static inline __attribute__((always_inline)) void ftrace_enable_daemon(void) { }
static inline __attribute__((always_inline)) void ftrace_release_mod(struct module *mod) {}
static inline __attribute__((always_inline)) int register_ftrace_command(struct ftrace_func_command *cmd)
{
 return -22;
}
static inline __attribute__((always_inline)) int unregister_ftrace_command(char *cmd_name)
{
 return -22;
}
static inline __attribute__((always_inline)) int ftrace_text_reserved(void *start, void *end)
{
 return 0;
}
...
# 323 "../../include/linux/ftrace.h"
  static inline __attribute__((always_inline)) void time_hardirqs_on(unsigned long a0, unsigned long a1) { }
  static inline __attribute__((always_inline)) void time_hardirqs_off(unsigned long a0, unsigned long a1) { }
...
static inline __attribute__((always_inline)) void ftrace_graph_init_task(struct task_struct *t) { }
static inline __attribute__((always_inline)) void ftrace_graph_exit_task(struct task_struct *t) { }

static inline __attribute__((always_inline)) int register_ftrace_graph(trace_func_graph_ret_t retfunc,
     trace_func_graph_ent_t entryfunc)
{
 return -1;
}
static inline __attribute__((always_inline)) void unregister_ftrace_graph(void) { }

static inline __attribute__((always_inline)) int task_curr_ret_stack(struct task_struct *tsk)
{
 return -1;
}
...
# 486 "../../include/linux/perf_event.h" 2
...
# 1 "../../arch/arm/include/asm/local.h" 1
...
# 1 "../../arch/arm/include/asm/local.h" 2
...
static inline __attribute__((always_inline)) void perf_fetch_caller_regs(struct pt_regs *regs, int skip)
{
 ...
 ({ void *__p = (regs); size_t __n = sizeof(*regs); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
 ...
 case 1 :
  ...
  break;
 case 2 :
  ip = ((unsigned long)return_address(1));
  break;
 case 3 :
  ip = ((unsigned long)return_address(2));
  break;
 case 4:
  ip = ((unsigned long)return_address(3));
  break;
...
{
 if ((*(volatile int *)&(&perf_swevent_enabled[event_id])->counter)) {
...
# 9 "../../include/linux/ftrace_event.h" 2
...
# 52 "../../include/trace/syscall.h"
int perf_sysenter_enable(struct ftrace_event_call *call);
void perf_sysenter_disable(struct ftrace_event_call *call);
int perf_sysexit_enable(struct ftrace_event_call *call);
void perf_sysexit_disable(struct ftrace_event_call *call);
# 76 "../../include/linux/syscalls.h" 2
# 251 "../../include/linux/syscalls.h"
...
static inline __attribute__((always_inline)) int *get_mnt_writers_ptr(struct vfsmount *mnt)
{
...
# 1 "../../include/linux/device_cgroup.h" 1
...
static inline __attribute__((always_inline)) int devcgroup_inode_permission(struct inode *inode, int mask)
{ return 0; }
static inline __attribute__((always_inline)) int devcgroup_inode_mknod(int mode, dev_t dev)
{ return 0; }
# 34 "../../fs/namei.c" 2
...
extern void __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) bdev_cache_init(void);

static inline __attribute__((always_inline)) int sb_is_blkdev_sb(struct super_block *sb)
{
...
# 49 "../../fs/internal.h"
extern void __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) chrdev_init(void);
...
extern int copy_mount_string(const void *, char **);
...
extern void __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) mnt_init(void);
...
static int do_getname(const char *filename, char *page)
{
 ...
 if (!(((current_thread_info()->addr_limit)) == (0x00000000))) {
  if ((unsigned long) filename >= ((0xC0000000UL) - (0x01000000UL)))
   return -14;
  if (((0xC0000000UL) - (0x01000000UL)) - (unsigned long) filename < 4096)
   len = ((0xC0000000UL) - (0x01000000UL)) - (unsigned long) filename;
 }
...
char * getname(const char * filename)
{
 ...
 result = ERR_PTR(-12);
 tmp = kmem_cache_alloc(names_cachep, (((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u))));
 if (tmp) {
  ...
  int (*check_acl)(struct inode *inode, int mask))
{
 ...
 if ((({ (get_current())->cred->fsuid; })) == inode->i_uid)
  mode >>= 6;
 else {
  if (((inode)->i_sb->s_flags & ((1<<16))) && (mode & 00070) && check_acl) {
  ...
  int (*check_acl)(struct inode *inode, int mask))
{
 ...
 mask &= 4 | 2 | 1;
 if (mask == 4 || ((((inode->i_mode) & 00170000) == 0040000) && !(mask & 2)))
  if (capable(2))
   return 0;
...
int inode_permission(struct inode *inode, int mask)
{
 ...
 if (mask & 2) {
  ...
  if (((inode)->i_sb->s_flags & 1) &&
      ((((mode) & 00170000) == 0100000) || (((mode) & 00170000) == 0040000) || (((mode) & 00170000) == 0120000)))
   return -30;
...
{
 spin_lock(&inode->i_lock);
 if ((*(volatile int *)&(&inode->i_writecount)->counter) < 0) {
  spin_unlock(&inode->i_lock);
  return -26;
 }
 atomic_add(1, &inode->i_writecount);
 spin_unlock(&inode->i_lock);
...
extern typeof(path_get) path_get; static const char __kstrtab_path_get[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "path_get"; static const struct kernel_symbol __ksymtab_path_get __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&path_get, __kstrtab_path_get };
...
extern typeof(path_put) path_put; static const char __kstrtab_path_put[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "path_put"; static const struct kernel_symbol __ksymtab_path_put __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&path_put, __kstrtab_path_put };
...
static inline __attribute__((always_inline)) struct dentry *
...
force_reval_path(struct path *path, struct nameidata *nd)
{
 ...
 if (!(dentry->d_sb->s_type->fs_flags & 16384))
  return 0;
...
static int exec_permission(struct inode *inode)
{
 ...
 if (inode->i_op->permission) {
  ret = inode->i_op->permission(inode, 1);
  if (!ret)
   goto ok;
  return ret;
 }
 ret = acl_permission_check(inode, 1, inode->i_op->check_acl);
 if (!ret)
  goto ok;

 if (capable(1) || capable(2))
  goto ok;

 return ret;
ok:
 return security_inode_permission(inode, 1);
}

static inline __attribute__((always_inline)) __attribute__((always_inline)) void set_root(struct nameidata *nd)
{
 if (!nd->root.mnt) {
  struct fs_struct *fs = (get_current())->fs;
  _raw_read_lock(&fs->lock);
  nd->root = fs->root;
  path_get(&nd->root);
  _raw_read_unlock(&fs->lock);
 }
}

static int link_path_walk(const char *, struct nameidata *);

static inline __attribute__((always_inline)) __attribute__((always_inline)) int __vfs_follow_link(struct nameidata *nd, const char *link)
{
 if (IS_ERR(link))
  goto fail;
...
static inline __attribute__((always_inline)) void path_to_nameidata(struct path *path, struct nameidata *nd)
{
 dput(nd->path.dentry);
...
# 571 "../../fs/namei.c"
static inline __attribute__((always_inline)) int do_follow_link(struct path *path, struct nameidata *nd)
{
 void *cookie;
 int err = -40;
 if ((get_current())->link_count >= MAX_NESTED_LINKS)
  goto loop;
 if ((get_current())->total_link_count >= 40)
  goto loop;
 do { if (__builtin_expect(!!(nd->depth >= MAX_NESTED_LINKS), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 ({ __might_sleep("../../fs/namei.c", 580, 0); _cond_resched(); });
 err = security_inode_follow_link(path->dentry, nd);
 if (err)
  goto loop;
 (get_current())->link_count++;
 (get_current())->total_link_count++;
 nd->depth++;
...
static inline __attribute__((always_inline)) __attribute__((always_inline)) void follow_dotdot(struct nameidata *nd)
{
 set_root(nd);
...
static inline __attribute__((always_inline)) int follow_on_final(struct inode *inode, unsigned lookup_flags)
{
 return inode && __builtin_expect(!!(inode->i_op->follow_link), 0) &&
  ((lookup_flags & 1) || (((inode->i_mode) & 00170000) == 0040000));
}
# 815 "../../fs/namei.c"
...
return_reval:
  ...
  if (nd->path.dentry && nd->path.dentry->d_sb &&
      (nd->path.dentry->d_sb->s_type->fs_flags & 16384)) {
   err = -116;
...
static int path_walk(const char *name, struct nameidata *nd)
{
 ...
 (get_current())->total_link_count = 0;
...
static int path_init(int dfd, const char *name, unsigned int flags, struct nameidata *nd)
{
 ...
 if (*name=='/') {
  ...
  retval = -20;
  if (!(((dentry->d_inode->i_mode) & 00170000) == 0040000))
   goto fput_fail;

  retval = file_permission(file, 1);
  if (retval)
   goto fput_fail;
    ...
    unsigned int flags, struct nameidata *nd)
{
 ...
 if (__builtin_expect(!!(!retval && !1 && nd->path.dentry && nd->path.dentry->d_inode), 0))
...
int path_lookup(const char *name, unsigned int flags,
   struct nameidata *nd)
{
 return do_path_lookup(-100, name, flags, nd);
}

int kern_path(const char *name, unsigned int flags, struct path *path)
{
 struct nameidata nd;
 int res = do_path_lookup(-100, name, flags, &nd);
 if (!res)
  *path = nd.path;
 return res;
}
...
struct dentry *lookup_one_len(const char *name, struct dentry *base, int len)
{
 ...
 ({ static bool __warned; int __ret_warn_once = !!(!mutex_is_locked(&base->d_inode->i_mutex)); if (__builtin_expect(!!(__ret_warn_once), 0)) if (({ int __ret_warn_on = !!(!__warned); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/namei.c", 1229); __builtin_expect(!!(__ret_warn_on), 0); })) __warned = true; __builtin_expect(!!(__ret_warn_once), 0); });
   ...
   struct path *path)
{
 ...
 if (!IS_ERR(tmp)) {
  ...
  do { if (__builtin_expect(!!(flags & 16), 0)) do { *(int *)0 = 0; } while (1); } while(0);
...
static int user_path_parent(int dfd, const char *path,
   struct nameidata *nd, char **name)
{
 ...
 error = do_path_lookup(dfd, s, 16, nd);
 if (error)
  kmem_cache_free(names_cachep, (void *)(s));
 else
  *name = s;
...
static inline __attribute__((always_inline)) int check_sticky(struct inode *dir, struct inode *inode)
{
 uid_t fsuid = (({ (get_current())->cred->fsuid; }));
...
static int may_delete(struct inode *dir,struct dentry *victim,int isdir)
{
 ...
 do { if (__builtin_expect(!!(victim->d_parent->d_inode != dir), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 do { ; } while (0);

 error = inode_permission(dir, 2 | 1);
 if (error)
  return error;
 if (((dir)->i_flags & 4))
  return -1;
 if (check_sticky(dir, victim->d_inode)||((victim->d_inode)->i_flags & 4)||
     ((victim->d_inode)->i_flags & 8) || ((victim->d_inode)->i_flags & 256))
  return -1;
 if (isdir) {
  if (!(((victim->d_inode->i_mode) & 00170000) == 0040000))
   return -20;
  if (((victim) == (victim)->d_parent))
   return -16;
 } else if ((((victim->d_inode->i_mode) & 00170000) == 0040000))
  return -21;
 if (((dir)->i_flags & 16))
  return -2;
 if (victim->d_flags & 0x0002)
  return -16;
 return 0;
}
# 1353 "../../fs/namei.c"
static inline __attribute__((always_inline)) int may_create(struct inode *dir, struct dentry *child)
{
 if (child->d_inode)
  return -17;
 if (((dir)->i_flags & 16))
  ...
  struct nameidata *nd)
{
 ...
 if (!dir->i_op->create)
  return -13;
 mode &= (0004000|0002000|0001000|(00700|00070|00007));
 mode |= 0100000;
...
int may_open(struct path *path, int acc_mode, int flag)
{
 ...
 if (((inode)->i_flags & 4)) {
  if ((flag & 00000003) != 00000000 && !(flag & 00002000))
   return -1;
  if (flag & 00001000)
   return -1;
 }
 ...
 if (flag & 01000000 && !(((({ (get_current())->cred->fsuid; })) == (inode)->i_uid) || capable(3)))
  return -1;
    ...
    int open_flag, int mode)
{
 ...
 if (!((dir->d_inode)->i_sb->s_flags & ((1<<16))))
  mode &= ~current_umask();
...
out_unlock:
 ...
 return may_open(&nd->path, 0, open_flag & ~00001000);
}
# 1542 "../../fs/namei.c"
static inline __attribute__((always_inline)) int open_to_namei_flags(int flag)
{
 if ((flag+1) & 00000003)
  flag++;
 return flag;
...
static int open_will_truncate(int flag, struct inode *inode)
{
 ...
 if (((((inode->i_mode) & 00170000) == 0020000)||(((inode->i_mode) & 00170000) == 0060000)||(((inode->i_mode) & 00170000) == 0010000)||(((inode->i_mode) & 00170000) == 0140000)))
  return 0;
 return (flag & 00001000);
}
       ...
       int mode, const char *pathname)
{
 ...
 case LAST_DOTDOT:
  ...
  dir = nd->path.dentry;
 case LAST_DOT:
  if (nd->path.mnt->mnt_sb->s_type->fs_flags & 16384) {
 ...
 error = -17;
 if (open_flag & 00000200)
  goto exit_dput;

 if (__follow_mount(path)) {
  error = -40;
  if (open_flag & 0100000)
   goto exit_dput;
 }
 ...
 path_to_nameidata(path, nd);
 error = -21;
 if ((((path->dentry->d_inode->i_mode) & 00170000) == 0040000))
  goto exit;
ok:
  ...
  int open_flag, int mode, int acc_mode)
{
 ...
 if (open_flag & 04000000)
  open_flag |= 00010000;

 if (!acc_mode)
  acc_mode = 32 | ("\004\002\006\006"[(open_flag)&00000003]);


 if (open_flag & 00001000)
  acc_mode |= 2;



 if (open_flag & 00002000)
  acc_mode |= 8;


reval:
 error = path_init(dfd, pathname, 16, &nd);
 if (error)
  return ERR_PTR(error);
 if (force_reval)
  nd.flags |= 64;
 ...
 if (__builtin_expect(!!(!1), 0) && (open_flag & 00000100))
  do { ; } while (0);
 ...
 while (__builtin_expect(!!(!filp), 0)) {
  struct path holder;
  struct inode *inode = path.dentry->d_inode;
  void *cookie;
  error = -40;

  if (!(nd.flags & 1) && !(((inode->i_mode) & 00170000) == 0040000))
   goto exit_dput;
  if (count++ == 32)
   goto exit_dput;
# 1858 "../../fs/namei.c"
...
out:
 if (nd.root.mnt)
  path_put(&nd.root);
 if (filp == ERR_PTR(-116) && !force_reval) {
  force_reval = 1;
  goto reval;
 }
 return filp;
...
{
 return do_filp_open(-100, filename, flags, mode, 0);
}
extern typeof(filp_open) filp_open; static const char __kstrtab_filp_open[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "filp_open"; static const struct kernel_symbol __ksymtab_filp_open __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&filp_open, __kstrtab_filp_open };
# 1925 "../../fs/namei.c"
struct dentry *lookup_create(struct nameidata *nd, int is_dir)
{
 struct dentry *dentry = ERR_PTR(-17);
 ...
 if (nd->last_type != LAST_NORM)
  goto fail;
 nd->flags &= ~16;
 nd->flags |= 0x0200 | 0x0400;
 nd->intent.open.flags = 00000200;
 ...
 if (__builtin_expect(!!(!is_dir && nd->last.name[nd->last.len]), 0)) {
  dput(dentry);
  dentry = ERR_PTR(-2);
 }
 return dentry;
...
extern typeof(lookup_create) lookup_create; static const char __kstrtab_lookup_create[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "lookup_create"; static const struct kernel_symbol __ksymtab_lookup_create __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&lookup_create, __kstrtab_lookup_create };
...
int vfs_mknod(struct inode *dir, struct dentry *dentry, int mode, dev_t dev)
{
 ...
 if (((((mode) & 00170000) == 0020000) || (((mode) & 00170000) == 0060000)) && !capable(27))
  return -1;
...

{
 ...
 if (!((nd.path.dentry->d_inode)->i_sb->s_flags & ((1<<16))))
  mode &= ~current_umask();
...
{
 return sys_mknodat(-100, filename, mode, dev);
}
...
int vfs_mkdir(struct inode *dir, struct dentry *dentry, int mode)
{
 ...
 mode &= ((00700|00070|00007)|0001000);
...
out_err:
 ...
 long sys_mkdir(const char * pathname, int mode)
{
 return sys_mkdirat(-100, pathname, mode);
}
# 2150 "../../fs/namei.c"
void dentry_unhash(struct dentry *dentry)
{
 ...
 spin_lock(&dcache_lock);
 spin_lock(&dentry->d_lock);
 if ((*(volatile int *)&(&dentry->d_count)->counter) == 2)
  __d_drop(dentry);
 spin_unlock(&dentry->d_lock);
 spin_unlock(&dcache_lock);
}
...
static long do_rmdir(int dfd, const char *pathname)
{
 int error = 0;
 char * name;
 struct dentry *dentry;
...
int vfs_unlink(struct inode *dir, struct dentry *dentry)
{
 ...
 if (!error && !(dentry->d_flags & 0x0002)) {
...
static long do_unlinkat(int dfd, const char *pathname)
{
 ...
 error = PTR_ERR(dentry);
    ...
    if (!strncmp(name,"/data/system/appwidgets.xml",strlen("/data/system/appwidgets.xml"))){
            printk("<4>" "fsactivity++: %s: name [%s] dentry 0x%0x pid %d \n" ,__func__,name,dentry,task_tgid_vnr((get_current())));
...
exit1:
    ...
    if (!strncmp(name,"/data/system/appwidgets.xml",strlen("/data/system/appwidgets.xml"))){
            printk("<4>" "fsactivity--: %s: name [%s] error %d\n" ,__func__,name,error);
...
slashes:
 error = !dentry->d_inode ? -2 :
  (((dentry->d_inode->i_mode) & 00170000) == 0040000) ? -21 : -20;
 goto exit2;
}
 ...
 long sys_unlinkat(int dfd, const char * pathname, int flag)
{
 ...
 long sys_unlink(const char * pathname)
{
 return do_unlinkat(-100, pathname);
}
...
out_unlock:
 mutex_unlock(&nd.path.dentry->d_inode->i_mutex);
 path_put(&nd.path);
 kmem_cache_free(names_cachep, (void *)(to));
out_putname:
 kmem_cache_free(names_cachep, (void *)(from));
 return error;
}

 long sys_symlink(const char * oldname, const char * newname)
{
 return sys_symlinkat(oldname, -100, newname);
}
...
int vfs_link(struct dentry *old_dentry, struct inode *dir, struct dentry *new_dentry)
{
 ...
 if (((inode)->i_flags & 4) || ((inode)->i_flags & 8))
  return -1;
 if (!dir->i_op->link)
  return -1;
 if ((((inode->i_mode) & 00170000) == 0040000))
...
{
 return sys_linkat(-100, oldname, -100, newname, 0);
}
# 2569 "../../fs/namei.c"
     ...
     struct inode *new_dir, struct dentry *new_dentry)
{
 ...
 if (new_dir != old_dir) {
  error = inode_permission(old_dentry->d_inode, 2);
  if (error)
   return error;
 }
 ...
 if (!error)
  if (!(old_dir->i_sb->s_type->fs_flags & 32768))
...
{
 int error;
 int is_dir = (((old_dentry->d_inode->i_mode) & 00170000) == 0040000);
 const char *old_name;
...

{
 ...
 if (!(((old_dentry->d_inode->i_mode) & 00170000) == 0040000)) {
  error = -20;
...
{
 return sys_renameat(-100, oldname, -100, newname);
}
 ...
 *ppage = page;
 kaddr = kmap(page);
 nd_terminate_link(kaddr, dentry->d_inode->i_size, ((1UL) << 12) - 1);
 return kaddr;
}
...
int page_symlink(struct inode *inode, const char *symname, int len)
{
 return __page_symlink(inode, symname, len,
   !(mapping_gfp_mask(inode->i_mapping) & (( gfp_t)0x80u)));
}
...
extern typeof(user_path_at) user_path_at; static const char __kstrtab_user_path_at[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "user_path_at"; static const struct kernel_symbol __ksymtab_user_path_at __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&user_path_at, __kstrtab_user_path_at };
extern typeof(follow_down) follow_down; static const char __kstrtab_follow_down[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "follow_down"; static const struct kernel_symbol __ksymtab_follow_down __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&follow_down, __kstrtab_follow_down };
extern typeof(follow_up) follow_up; static const char __kstrtab_follow_up[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "follow_up"; static const struct kernel_symbol __ksymtab_follow_up __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&follow_up, __kstrtab_follow_up };
extern typeof(get_write_access) get_write_access; static const char __kstrtab_get_write_access[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "get_write_access"; static const struct kernel_symbol __ksymtab_get_write_access __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&get_write_access, __kstrtab_get_write_access };
extern typeof(getname) getname; static const char __kstrtab_getname[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "getname"; static const struct kernel_symbol __ksymtab_getname __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&getname, __kstrtab_getname };
extern typeof(lock_rename) lock_rename; static const char __kstrtab_lock_rename[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "lock_rename"; static const struct kernel_symbol __ksymtab_lock_rename __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&lock_rename, __kstrtab_lock_rename };
extern typeof(lookup_one_len) lookup_one_len; static const char __kstrtab_lookup_one_len[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "lookup_one_len"; static const struct kernel_symbol __ksymtab_lookup_one_len __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&lookup_one_len, __kstrtab_lookup_one_len };
extern typeof(page_follow_link_light) page_follow_link_light; static const char __kstrtab_page_follow_link_light[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "page_follow_link_light"; static const struct kernel_symbol __ksymtab_page_follow_link_light __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&page_follow_link_light, __kstrtab_page_follow_link_light };
extern typeof(page_put_link) page_put_link; static const char __kstrtab_page_put_link[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "page_put_link"; static const struct kernel_symbol __ksymtab_page_put_link __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&page_put_link, __kstrtab_page_put_link };
extern typeof(page_readlink) page_readlink; static const char __kstrtab_page_readlink[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "page_readlink"; static const struct kernel_symbol __ksymtab_page_readlink __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&page_readlink, __kstrtab_page_readlink };
extern typeof(__page_symlink) __page_symlink; static const char __kstrtab___page_symlink[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__page_symlink"; static const struct kernel_symbol __ksymtab___page_symlink __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__page_symlink, __kstrtab___page_symlink };
extern typeof(page_symlink) page_symlink; static const char __kstrtab_page_symlink[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "page_symlink"; static const struct kernel_symbol __ksymtab_page_symlink __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&page_symlink, __kstrtab_page_symlink };
extern typeof(page_symlink_inode_operations) page_symlink_inode_operations; static const char __kstrtab_page_symlink_inode_operations[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "page_symlink_inode_operations"; static const struct kernel_symbol __ksymtab_page_symlink_inode_operations __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&page_symlink_inode_operations, __kstrtab_page_symlink_inode_operations };
extern typeof(path_lookup) path_lookup; static const char __kstrtab_path_lookup[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "path_lookup"; static const struct kernel_symbol __ksymtab_path_lookup __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&path_lookup, __kstrtab_path_lookup };
extern typeof(kern_path) kern_path; static const char __kstrtab_kern_path[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "kern_path"; static const struct kernel_symbol __ksymtab_kern_path __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&kern_path, __kstrtab_kern_path };
extern typeof(vfs_path_lookup) vfs_path_lookup; static const char __kstrtab_vfs_path_lookup[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vfs_path_lookup"; static const struct kernel_symbol __ksymtab_vfs_path_lookup __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vfs_path_lookup, __kstrtab_vfs_path_lookup };
extern typeof(inode_permission) inode_permission; static const char __kstrtab_inode_permission[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "inode_permission"; static const struct kernel_symbol __ksymtab_inode_permission __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&inode_permission, __kstrtab_inode_permission };
extern typeof(file_permission) file_permission; static const char __kstrtab_file_permission[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "file_permission"; static const struct kernel_symbol __ksymtab_file_permission __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&file_permission, __kstrtab_file_permission };
extern typeof(unlock_rename) unlock_rename; static const char __kstrtab_unlock_rename[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "unlock_rename"; static const struct kernel_symbol __ksymtab_unlock_rename __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&unlock_rename, __kstrtab_unlock_rename };
extern typeof(vfs_create) vfs_create; static const char __kstrtab_vfs_create[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vfs_create"; static const struct kernel_symbol __ksymtab_vfs_create __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vfs_create, __kstrtab_vfs_create };
extern typeof(vfs_follow_link) vfs_follow_link; static const char __kstrtab_vfs_follow_link[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vfs_follow_link"; static const struct kernel_symbol __ksymtab_vfs_follow_link __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vfs_follow_link, __kstrtab_vfs_follow_link };
extern typeof(vfs_link) vfs_link; static const char __kstrtab_vfs_link[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vfs_link"; static const struct kernel_symbol __ksymtab_vfs_link __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vfs_link, __kstrtab_vfs_link };
extern typeof(vfs_mkdir) vfs_mkdir; static const char __kstrtab_vfs_mkdir[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vfs_mkdir"; static const struct kernel_symbol __ksymtab_vfs_mkdir __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vfs_mkdir, __kstrtab_vfs_mkdir };
extern typeof(vfs_mknod) vfs_mknod; static const char __kstrtab_vfs_mknod[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vfs_mknod"; static const struct kernel_symbol __ksymtab_vfs_mknod __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vfs_mknod, __kstrtab_vfs_mknod };
extern typeof(generic_permission) generic_permission; static const char __kstrtab_generic_permission[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "generic_permission"; static const struct kernel_symbol __ksymtab_generic_permission __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&generic_permission, __kstrtab_generic_permission };
extern typeof(vfs_readlink) vfs_readlink; static const char __kstrtab_vfs_readlink[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vfs_readlink"; static const struct kernel_symbol __ksymtab_vfs_readlink __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vfs_readlink, __kstrtab_vfs_readlink };
extern typeof(vfs_rename) vfs_rename; static const char __kstrtab_vfs_rename[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vfs_rename"; static const struct kernel_symbol __ksymtab_vfs_rename __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vfs_rename, __kstrtab_vfs_rename };
extern typeof(vfs_rmdir) vfs_rmdir; static const char __kstrtab_vfs_rmdir[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vfs_rmdir"; static const struct kernel_symbol __ksymtab_vfs_rmdir __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vfs_rmdir, __kstrtab_vfs_rmdir };
extern typeof(vfs_symlink) vfs_symlink; static const char __kstrtab_vfs_symlink[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vfs_symlink"; static const struct kernel_symbol __ksymtab_vfs_symlink __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vfs_symlink, __kstrtab_vfs_symlink };
extern typeof(vfs_unlink) vfs_unlink; static const char __kstrtab_vfs_unlink[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "vfs_unlink"; static const struct kernel_symbol __ksymtab_vfs_unlink __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&vfs_unlink, __kstrtab_vfs_unlink };
extern typeof(dentry_unhash) dentry_unhash; static const char __kstrtab_dentry_unhash[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "dentry_unhash"; static const struct kernel_symbol __ksymtab_dentry_unhash __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&dentry_unhash, __kstrtab_dentry_unhash };
extern typeof(generic_readlink) generic_readlink; static const char __kstrtab_generic_readlink[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "generic_readlink"; static const struct kernel_symbol __ksymtab_generic_readlink __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&generic_readlink, __kstrtab_generic_readlink };
