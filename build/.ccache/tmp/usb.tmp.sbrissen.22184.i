# 1 "../../drivers/usb/core/usb.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../drivers/usb/core/usb.c"
# 24 "../../drivers/usb/core/usb.c"
...
usb_maxpacket(struct usb_device *udev, int pipe, int is_out)
{
 ...
 if (is_out) {
  ({ int __ret_warn_on = !!(((pipe) & 0x80)); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../include/linux/usb.h", 1563); __builtin_expect(!!(__ret_warn_on), 0); });
  ep = udev->ep_out[epnum];
 } else {
  ({ int __ret_warn_on = !!((!((pipe) & 0x80))); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../include/linux/usb.h", 1566); __builtin_expect(!!(__ret_warn_on), 0); });
  ep = udev->ep_in[epnum];
 }
 if (!ep)
  return 0;
...
# 1583 "../../include/linux/usb.h"
extern void usb_register_notify(struct notifier_block *nb);
extern void usb_unregister_notify(struct notifier_block *nb);
# 1601 "../../include/linux/usb.h"
extern struct dentry *usb_debug_root;
# 35 "../../drivers/usb/core/usb.c" 2
# 1 "../../include/linux/usb/hcd.h" 1
# 25 "../../include/linux/usb/hcd.h"
# 1 "../../include/linux/host_notify.h" 1
# 12 "../../include/linux/host_notify.h"
...
# 100 "../../include/linux/usb/ch11.h"
struct usb_port_status {
 __le16 wPortStatus;
 __le16 wPortChange;
} __attribute__ ((packed));
# 146 "../../include/linux/usb/ch11.h"
struct usb_hub_status {
 __le16 wHubStatus;
 __le16 wHubChange;
} __attribute__ ((packed));
# 171 "../../include/linux/usb/ch11.h"
...
# 403 "../../include/linux/usb/hcd.h" 2
# 415 "../../include/linux/usb/hcd.h"
struct usb_device;
...
# 552 "../../include/linux/usb/hcd.h"
extern void usbfs_update_special(void);
extern int usbfs_init(void);
extern void usbfs_cleanup(void);
# 602 "../../include/linux/usb/hcd.h"
...
static inline __attribute__((always_inline)) int *__check_autosuspend(void) { return(&(usb_autosuspend_delay)); }; static int __param_perm_check_autosuspend __attribute__((unused)) = (sizeof(struct { int:-!!((0644) < 0 || (0644) > 0777 || ((0644) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""usbcore" ".") > (64 - sizeof(unsigned long))); })); static const char __param_str_autosuspend[] = "usbcore" "." "autosuspend"; static struct kernel_param const __param_autosuspend __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_autosuspend, 0644, __builtin_types_compatible_p(typeof(*(&usb_autosuspend_delay)), typeof(bool)) ? 2 : 0, param_set_int, param_get_int, { &usb_autosuspend_delay } }; ;
;
# 72 "../../drivers/usb/core/usb.c"
struct usb_host_interface *usb_find_alt_setting(
  struct usb_host_config *config,
  unsigned int iface_num,
  unsigned int alt_num)
{
 struct usb_interface_cache *intf_cache = ((void *)0);
 int i;
 ...
 printk("<7>" "Did not find alt setting %u for intf %u, "
   "config %u\n", alt_num, iface_num,
   config->desc.bConfigurationValue);
 return ((void *)0);
}
extern typeof(usb_find_alt_setting) usb_find_alt_setting; static const char __kstrtab_usb_find_alt_setting[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_find_alt_setting"; static const struct kernel_symbol __ksymtab_usb_find_alt_setting __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_find_alt_setting, __kstrtab_usb_find_alt_setting };
# 119 "../../drivers/usb/core/usb.c"
...
extern typeof(usb_ifnum_to_if) usb_ifnum_to_if; static const char __kstrtab_usb_ifnum_to_if[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_ifnum_to_if"; static const struct kernel_symbol __ksymtab_usb_ifnum_to_if __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_ifnum_to_if, __kstrtab_usb_ifnum_to_if };
# 153 "../../drivers/usb/core/usb.c"
...
extern typeof(usb_altnum_to_altsetting) usb_altnum_to_altsetting; static const char __kstrtab_usb_altnum_to_altsetting[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_altnum_to_altsetting"; static const struct kernel_symbol __ksymtab_usb_altnum_to_altsetting __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_altnum_to_altsetting, __kstrtab_usb_altnum_to_altsetting };
...
static int __find_interface(struct device *dev, void *data)
{
 ...
 if (dev->driver != arg->drv)
  return 0;
 intf = ({ const typeof( ((struct usb_interface *)0)->dev ) *__mptr = (dev); (struct usb_interface *)( (char *)__mptr - __builtin_offsetof(struct usb_interface,dev) );});
 return intf->minor == arg->minor;
}
# 195 "../../drivers/usb/core/usb.c"
struct usb_interface *usb_find_interface(struct usb_driver *drv, int minor)
{
 ...
 return dev ? ({ const typeof( ((struct usb_interface *)0)->dev ) *__mptr = (dev); (struct usb_interface *)( (char *)__mptr - __builtin_offsetof(struct usb_interface,dev) );}) : ((void *)0);
}
extern typeof(usb_find_interface) usb_find_interface; static const char __kstrtab_usb_find_interface[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_find_interface"; static const struct kernel_symbol __ksymtab_usb_find_interface __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_find_interface, __kstrtab_usb_find_interface };
# 219 "../../drivers/usb/core/usb.c"
static void usb_release_dev(struct device *dev)
{
 struct usb_device *udev;
 struct usb_hcd *hcd;

 udev = ({ const typeof( ((struct usb_device *)0)->dev ) *__mptr = (dev); (struct usb_device *)( (char *)__mptr - __builtin_offsetof(struct usb_device,dev) );});
...
static int usb_dev_uevent(struct device *dev, struct kobj_uevent_env *env)
{
 ...
 usb_dev = ({ const typeof( ((struct usb_device *)0)->dev ) *__mptr = (dev); (struct usb_device *)( (char *)__mptr - __builtin_offsetof(struct usb_device,dev) );});
...
static void usb_dev_complete(struct device *dev)
{
 ...
 usb_resume(dev, ((struct pm_message){ .event = 0x0000, }));
}

static int usb_dev_suspend(struct device *dev)
{
 return usb_suspend(dev, ((struct pm_message){ .event = 0x0002, }));
}

static int usb_dev_resume(struct device *dev)
{
 return usb_resume(dev, ((struct pm_message){ .event = 0x0010, }));
}

static int usb_dev_freeze(struct device *dev)
{
 return usb_suspend(dev, ((struct pm_message){ .event = 0x0001, }));
}

static int usb_dev_thaw(struct device *dev)
{
 return usb_resume(dev, ((struct pm_message){ .event = 0x0020, }));
}

static int usb_dev_poweroff(struct device *dev)
{
 return usb_suspend(dev, ((struct pm_message){ .event = 0x0004, }));
}

static int usb_dev_restore(struct device *dev)
{
 return usb_resume(dev, ((struct pm_message){ .event = 0x0040, }));
}
...
# 327 "../../drivers/usb/core/usb.c"
static char *usb_devnode(struct device *dev, mode_t *mode)
{
 struct usb_device *usb_dev;

 usb_dev = ({ const typeof( ((struct usb_device *)0)->dev ) *__mptr = (dev); (struct usb_device *)( (char *)__mptr - __builtin_offsetof(struct usb_device,dev) );});
 return kasprintf(((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)), "bus/usb/%03d/%03d",
...
{
 struct usb_hcd *hcd = ({ const typeof( ((struct usb_hcd *)0)->self ) *__mptr = (bus); (struct usb_hcd *)( (char *)__mptr - __builtin_offsetof(struct usb_hcd,self) );});
 return hcd->wireless;
}
# 365 "../../drivers/usb/core/usb.c"
struct usb_device *usb_alloc_dev(struct usb_device *parent,
     struct usb_bus *bus, unsigned port1)
{
 struct usb_device *dev;
 struct usb_hcd *usb_hcd = ({ const typeof( ((struct usb_hcd *)0)->self ) *__mptr = (bus); (struct usb_hcd *)( (char *)__mptr - __builtin_offsetof(struct usb_hcd,self) );});
 unsigned root_hub = 0;
 ...
 (((&dev->urbnum)->counter) = (0));

 INIT_LIST_HEAD(&dev->ep0.urb_list);
 dev->ep0.desc.bLength = 7;
 dev->ep0.desc.bDescriptorType = 0x05;

 usb_enable_endpoint(dev, &dev->ep0, false);
 dev->can_submit = 1;
# 412 "../../drivers/usb/core/usb.c"
...
extern typeof(usb_get_dev) usb_get_dev; static const char __kstrtab_usb_get_dev[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_get_dev"; static const struct kernel_symbol __ksymtab_usb_get_dev __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_get_dev, __kstrtab_usb_get_dev };
# 491 "../../drivers/usb/core/usb.c"
void usb_put_dev(struct usb_device *dev)
{
 if (dev)
  put_device(&dev->dev);
}
extern typeof(usb_put_dev) usb_put_dev; static const char __kstrtab_usb_put_dev[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_put_dev"; static const struct kernel_symbol __ksymtab_usb_put_dev __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_put_dev, __kstrtab_usb_put_dev };
# 511 "../../drivers/usb/core/usb.c"
struct usb_interface *usb_get_intf(struct usb_interface *intf)
{
 if (intf)
  get_device(&intf->dev);
...
extern typeof(usb_get_intf) usb_get_intf; static const char __kstrtab_usb_get_intf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_get_intf"; static const struct kernel_symbol __ksymtab_usb_get_intf __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_get_intf, __kstrtab_usb_get_intf };
# 527 "../../drivers/usb/core/usb.c"
void usb_put_intf(struct usb_interface *intf)
{
 if (intf)
  put_device(&intf->dev);
}
extern typeof(usb_put_intf) usb_put_intf; static const char __kstrtab_usb_put_intf[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_put_intf"; static const struct kernel_symbol __ksymtab_usb_put_intf __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_put_intf, __kstrtab_usb_put_intf };
# 564 "../../drivers/usb/core/usb.c"
int usb_lock_device_for_reset(struct usb_device *udev,
         const struct usb_interface *iface)
{
 unsigned long jiffies_expire = jiffies + 200;
 ...
 while (!device_trylock(&(udev)->dev)) {



  if ((({ unsigned long __dummy; typeof(jiffies) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ({ unsigned long __dummy; typeof(jiffies_expire) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ((long)(jiffies_expire) - (long)(jiffies) < 0)))
   return -16;
...
extern typeof(usb_lock_device_for_reset) usb_lock_device_for_reset; static const char __kstrtab_usb_lock_device_for_reset[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_lock_device_for_reset"; static const struct kernel_symbol __ksymtab_usb_lock_device_for_reset __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_lock_device_for_reset, __kstrtab_usb_lock_device_for_reset };
# 610 "../../drivers/usb/core/usb.c"
int usb_get_current_frame_number(struct usb_device *dev)
{
 return usb_hcd_get_frame_number(dev);
}
extern typeof(usb_get_current_frame_number) usb_get_current_frame_number; static const char __kstrtab_usb_get_current_frame_number[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_get_current_frame_number"; static const struct kernel_symbol __ksymtab_usb_get_current_frame_number __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_get_current_frame_number, __kstrtab_usb_get_current_frame_number };
...
extern typeof(__usb_get_extra_descriptor) __usb_get_extra_descriptor; static const char __kstrtab___usb_get_extra_descriptor[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__usb_get_extra_descriptor"; static const struct kernel_symbol __ksymtab___usb_get_extra_descriptor __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&__usb_get_extra_descriptor, __kstrtab___usb_get_extra_descriptor };
# 673 "../../drivers/usb/core/usb.c"
...
extern typeof(usb_alloc_coherent) usb_alloc_coherent; static const char __kstrtab_usb_alloc_coherent[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_alloc_coherent"; static const struct kernel_symbol __ksymtab_usb_alloc_coherent __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_alloc_coherent, __kstrtab_usb_alloc_coherent };
# 693 "../../drivers/usb/core/usb.c"
...
extern typeof(usb_free_coherent) usb_free_coherent; static const char __kstrtab_usb_free_coherent[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_free_coherent"; static const struct kernel_symbol __ksymtab_usb_free_coherent __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_free_coherent, __kstrtab_usb_free_coherent };
# 928 "../../drivers/usb/core/usb.c"
static inline __attribute__((always_inline)) void __check_nousb(void) { ((void)(sizeof(struct { int:-!!(!__builtin_types_compatible_p(typeof(*(&(nousb))), typeof(bool)) && !__builtin_types_compatible_p(typeof(*(&(nousb))), typeof(unsigned int)) && !__builtin_types_compatible_p(typeof(*(&(nousb))), typeof(int))); }))); }; static int __param_perm_check_nousb __attribute__((unused)) = (sizeof(struct { int:-!!((0444) < 0 || (0444) > 0777 || ((0444) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""") > (64 - sizeof(unsigned long))); })); static const char __param_str_nousb[] = "" "nousb"; static struct kernel_param const __param_nousb __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_nousb, 0444, __builtin_types_compatible_p(typeof(nousb), typeof(bool)) ? 2 : 0, param_set_bool, param_get_bool, { &nousb } };
...
extern typeof(usb_disabled) usb_disabled; static const char __kstrtab_usb_disabled[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_disabled"; static const struct kernel_symbol __ksymtab_usb_disabled __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_disabled, __kstrtab_usb_disabled };
  ...
  void *data)
{
 ...
 case 0x00000001:
  if (dev->type == &usb_device_type)
   (void) usb_create_sysfs_dev_files(({ const typeof( ((struct usb_device *)0)->dev ) *__mptr = (dev); (struct usb_device *)( (char *)__mptr - __builtin_offsetof(struct usb_device,dev) );}));
  else if (dev->type == &usb_if_device_type)
   (void) usb_create_sysfs_intf_files(
     ({ const typeof( ((struct usb_interface *)0)->dev ) *__mptr = (dev); (struct usb_interface *)( (char *)__mptr - __builtin_offsetof(struct usb_interface,dev) );}));
  break;

 case 0x00000002:
  if (dev->type == &usb_device_type)
   usb_remove_sysfs_dev_files(({ const typeof( ((struct usb_device *)0)->dev ) *__mptr = (dev); (struct usb_device *)( (char *)__mptr - __builtin_offsetof(struct usb_device,dev) );}));
  else if (dev->type == &usb_if_device_type)
   usb_remove_sysfs_intf_files(({ const typeof( ((struct usb_interface *)0)->dev ) *__mptr = (dev); (struct usb_interface *)( (char *)__mptr - __builtin_offsetof(struct usb_interface,dev) );}));
  break;
 }
 return 0;
}
...
extern typeof(usb_debug_root) usb_debug_root; static const char __kstrtab_usb_debug_root[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "usb_debug_root"; static const struct kernel_symbol __ksymtab_usb_debug_root __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&usb_debug_root, __kstrtab_usb_debug_root };
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) usb_init(void)
{
 int retval;
 if (nousb) {
...
static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) usb_exit(void)
{
...
static initcall_t __initcall_usb_init4 __attribute__((__used__)) __attribute__((__section__(".initcall" "4" ".init"))) = usb_init;
static exitcall_t __exitcall_usb_exit __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = usb_exit;;
;
