...
# 5 "../../include/linux/debug_locks.h" 2
...
# 1 "../../arch/arm/include/asm/emergency-restart.h" 1
...
static inline __attribute__((always_inline)) void machine_emergency_restart(void)
{
 machine_restart(((void *)0));
}
# 5 "../../arch/arm/include/asm/emergency-restart.h" 2
# 81 "../../include/linux/reboot.h" 2
# 19 "../../kernel/panic.c" 2
...
# 20 "../../kernel/panic.c" 2
# 1 "../../include/linux/kexec.h" 1
# 213 "../../include/linux/kexec.h"
struct pt_regs;
struct task_struct;
static inline __attribute__((always_inline)) void crash_kexec(struct pt_regs *regs) { }
static inline __attribute__((always_inline)) int kexec_should_crash(struct task_struct *p) { return 0; }
# 21 "../../kernel/panic.c" 2
...
static inline __attribute__((always_inline)) void touch_nmi_watchdog(void)
{
 touch_softlockup_watchdog();
}
static inline __attribute__((always_inline)) void acpi_nmi_disable(void) { }
static inline __attribute__((always_inline)) void acpi_nmi_enable(void) { }
# 44 "../../include/linux/nmi.h"
static inline __attribute__((always_inline)) bool trigger_all_cpu_backtrace(void)
{
 return false;
}
# 25 "../../kernel/panic.c" 2
...
static inline __attribute__((always_inline)) int dmi_check_system(const struct dmi_system_id *list) { return 0; }
static inline __attribute__((always_inline)) const char * dmi_get_system_info(int field) { return ((void *)0); }
static inline __attribute__((always_inline)) const struct dmi_device * dmi_find_device(int type, const char *name,
 const struct dmi_device *from) { return ((void *)0); }
static inline __attribute__((always_inline)) void dmi_scan_machine(void) { return; }
static inline __attribute__((always_inline)) bool dmi_get_date(int field, int *yearp, int *monthp, int *dayp)
{
 if (yearp)
  *yearp = 0;
 if (monthp)
...
static inline __attribute__((always_inline)) int dmi_name_in_vendors(const char *s) { return 0; }
static inline __attribute__((always_inline)) int dmi_name_in_serial(const char *s) { return 0; }

static inline __attribute__((always_inline)) int dmi_walk(void (*decode)(const struct dmi_header *, void *),
 void *private_data) { return -1; }
static inline __attribute__((always_inline)) bool dmi_match(enum dmi_field f, const char *str)
 { return false; }
static inline __attribute__((always_inline)) const struct dmi_system_id *
...
static spinlock_t pause_on_oops_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } };
...
struct atomic_notifier_head panic_notifier_list = { .lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } }, .head = ((void *)0) };

extern typeof(panic_notifier_list) panic_notifier_list; static const char __kstrtab_panic_notifier_list[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "panic_notifier_list"; static const struct kernel_symbol __ksymtab_panic_notifier_list __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&panic_notifier_list, __kstrtab_panic_notifier_list };


long (*panic_blink)(long time);
extern typeof(panic_blink) panic_blink; static const char __kstrtab_panic_blink[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "panic_blink"; static const struct kernel_symbol __ksymtab_panic_blink __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&panic_blink, __kstrtab_panic_blink };
...
# 68 "../../kernel/panic.c"
  ( (__builtin_constant_p(1000L) && (1000L)<=2) ? (__builtin_constant_p((1000L)*1000) ? (((1000L)*1000) > (2 * 1000) ? __bad_udelay() : __const_udelay(((1000L)*1000) * ((2199023U*200)>>11))) : __udelay((1000L)*1000)) : ({unsigned long __ms=(1000L); while (__ms--) (__builtin_constant_p(1000) ? ((1000) > (2 * 1000) ? __bad_udelay() : __const_udelay((1000) * ((2199023U*200)>>11))) : __udelay(1000));}));
 }
}
# 80 "../../kernel/panic.c"
 void panic(const char * fmt, ...)
{
 ...
 printk("<0>" "Kernel panic(CPU:%d) - not syncing: %s\n", (current_thread_info()->cpu),buf);
# 108 "../../kernel/panic.c"
 crash_kexec(((void *)0));
...
extern typeof(panic) panic; static const char __kstrtab_panic[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "panic"; static const struct kernel_symbol __ksymtab_panic __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&panic, __kstrtab_panic };
...
{
 static char buf[(sizeof(tnts) / sizeof((tnts)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(tnts), typeof(&tnts[0]))); }))) + sizeof("Tainted: ") + 1];
 ...
 if (tainted_mask) {
  ...
  for (i = 0; i < (sizeof(tnts) / sizeof((tnts)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(tnts), typeof(&tnts[0]))); }))); i++) {
...
extern typeof(test_taint) test_taint; static const char __kstrtab_test_taint[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "test_taint"; static const struct kernel_symbol __ksymtab_test_taint __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&test_taint, __kstrtab_test_taint };
...
void add_taint(unsigned flag)
{
 ...
 if (flag != 10 && flag != 9 && __debug_locks_off())
  printk("<4>" "Disabling lock debugging due to kernel taint\n");

 _set_bit_le(flag,&tainted_mask);
}
extern typeof(add_taint) add_taint; static const char __kstrtab_add_taint[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "add_taint"; static const struct kernel_symbol __ksymtab_add_taint __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&add_taint, __kstrtab_add_taint };
...
static void do_oops_enter_exit(void)
{
 ...
 do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = _raw_spin_lock_irqsave(spinlock_check(&pause_on_oops_lock)); } while (0); } while (0);
...
static initcall_t __initcall_init_oops_id7 __attribute__((__used__)) __attribute__((__section__(".initcall" "7" ".init"))) = init_oops_id;

static void print_oops_end_marker(void)
{
 init_oops_id();
 printk("<4>" "---[ end trace %016llx ]---\n",
     ...
     unsigned taint, struct slowpath_args *args)
{
 ...
 printk("<4>" "------------[ cut here ]------------\n");
 printk("<4>" "WARNING: at %s:%d %pS()\n", file, line, caller);
 board = dmi_get_system_info(DMI_PRODUCT_NAME);
 if (board)
  printk("<4>" "Hardware name: %s\n", board);
...
void warn_slowpath_fmt(const char *file, int line, const char *fmt, ...)
{
 ...
 args.fmt = fmt;
 __builtin_va_start(args.args,fmt);
 warn_slowpath_common(file, line, __builtin_return_address(0),
        9, &args);
 __builtin_va_end(args.args);
}
extern typeof(warn_slowpath_fmt) warn_slowpath_fmt; static const char __kstrtab_warn_slowpath_fmt[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "warn_slowpath_fmt"; static const struct kernel_symbol __ksymtab_warn_slowpath_fmt __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&warn_slowpath_fmt, __kstrtab_warn_slowpath_fmt };
...
extern typeof(warn_slowpath_fmt_taint) warn_slowpath_fmt_taint; static const char __kstrtab_warn_slowpath_fmt_taint[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "warn_slowpath_fmt_taint"; static const struct kernel_symbol __ksymtab_warn_slowpath_fmt_taint __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&warn_slowpath_fmt_taint, __kstrtab_warn_slowpath_fmt_taint };
...
extern typeof(warn_slowpath_null) warn_slowpath_null; static const char __kstrtab_warn_slowpath_null[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "warn_slowpath_null"; static const struct kernel_symbol __ksymtab_warn_slowpath_null __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&warn_slowpath_null, __kstrtab_warn_slowpath_null };
# 442 "../../kernel/panic.c"
static inline __attribute__((always_inline)) int *__check_panic(void) { return(&(panic_timeout)); }; static int __param_perm_check_panic __attribute__((unused)) = (sizeof(struct { int:-!!((0644) < 0 || (0644) > 0777 || ((0644) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""") > (64 - sizeof(unsigned long))); })); static const char __param_str_panic[] = "" "panic"; static struct kernel_param const __param_panic __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_panic, 0644, __builtin_types_compatible_p(typeof(panic_timeout), typeof(bool)) ? 2 : 0, param_set_int, param_get_int, { &panic_timeout } };
static inline __attribute__((always_inline)) int *__check_pause_on_oops(void) { return(&(pause_on_oops)); }; static int __param_perm_check_pause_on_oops __attribute__((unused)) = (sizeof(struct { int:-!!((0644) < 0 || (0644) > 0777 || ((0644) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""") > (64 - sizeof(unsigned long))); })); static const char __param_str_pause_on_oops[] = "" "pause_on_oops"; static struct kernel_param const __param_pause_on_oops __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_pause_on_oops, 0644, __builtin_types_compatible_p(typeof(pause_on_oops), typeof(bool)) ? 2 : 0, param_set_int, param_get_int, { &pause_on_oops } };
