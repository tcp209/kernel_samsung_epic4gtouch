...
# 11 "../../net/netfilter/nf_queue.c" 2
# 1 "../../include/net/netfilter/nf_queue.h" 1
...
# 12 "../../net/netfilter/nf_queue.c" 2


# 1 "../../net/netfilter/nf_internals.h" 1
# 16 "../../net/netfilter/nf_internals.h"
...
extern int nf_queue(struct sk_buff *skb,
      ...
      int (*okfn)(struct sk_buff *),
      unsigned int queuenum);
extern int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) netfilter_queue_init(void);


extern int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) netfilter_log_init(void);
# 15 "../../net/netfilter/nf_queue.c" 2
...
static struct mutex queue_handler_mutex = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } } , .wait_list = { &(queue_handler_mutex.wait_list), &(queue_handler_mutex.wait_list) } };
...
int nf_register_queue_handler(u_int8_t pf, const struct nf_queue_handler *qh)
{
 ...
 if (pf >= (sizeof(queue_handler) / sizeof((queue_handler)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(queue_handler), typeof(&queue_handler[0]))); }))))
  return -22;
 ...
 if (queue_handler[pf] == qh)
  ...
  ({ if (!__builtin_constant_p(qh) || ((qh) != ((void *)0))) __asm__ __volatile__ ("dmb" : : : "memory"); (queue_handler[pf]) = (qh); });
  ret = 0;
 }
...
extern typeof(nf_register_queue_handler) nf_register_queue_handler; static const char __kstrtab_nf_register_queue_handler[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "nf_register_queue_handler"; static const struct kernel_symbol __ksymtab_nf_register_queue_handler __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&nf_register_queue_handler, __kstrtab_nf_register_queue_handler };
...
int nf_unregister_queue_handler(u_int8_t pf, const struct nf_queue_handler *qh)
{
 ...
 ({ if (!__builtin_constant_p(((void *)0)) || ((((void *)0)) != ((void *)0))) __asm__ __volatile__ ("dmb" : : : "memory"); (queue_handler[pf]) = (((void *)0)); });
 mutex_unlock(&queue_handler_mutex);
...
extern typeof(nf_unregister_queue_handler) nf_unregister_queue_handler; static const char __kstrtab_nf_unregister_queue_handler[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "nf_unregister_queue_handler"; static const struct kernel_symbol __ksymtab_nf_unregister_queue_handler __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&nf_unregister_queue_handler, __kstrtab_nf_unregister_queue_handler };
...
void nf_unregister_queue_handlers(const struct nf_queue_handler *qh)
{
 ...
 mutex_lock(&queue_handler_mutex);
 for (pf = 0; pf < (sizeof(queue_handler) / sizeof((queue_handler)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(queue_handler), typeof(&queue_handler[0]))); }))); pf++) {
  if (queue_handler[pf] == qh)
   ({ if (!__builtin_constant_p(((void *)0)) || ((((void *)0)) != ((void *)0))) __asm__ __volatile__ ("dmb" : : : "memory"); (queue_handler[pf]) = (((void *)0)); });
 }
 mutex_unlock(&queue_handler_mutex);
...
extern typeof(nf_unregister_queue_handlers) nf_unregister_queue_handlers; static const char __kstrtab_nf_unregister_queue_handlers[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "nf_unregister_queue_handlers"; static const struct kernel_symbol __ksymtab_nf_unregister_queue_handlers __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&nf_unregister_queue_handlers, __kstrtab_nf_unregister_queue_handlers };
...
{
 int status;
 struct nf_queue_entry *entry = ((void *)0);
 ...
 qh = ({ typeof(queue_handler[pf]) _________p1 = (*(volatile typeof(queue_handler[pf]) *)&(queue_handler[pf])); do { } while(0); (_________p1); });
 if (!qh)
  goto err_unlock;
 ...
 entry = kmalloc(sizeof(*entry) + afinfo->route_key_size, ((( gfp_t)0x20u)));
 if (!entry)
  goto err_unlock;

 *entry = (struct nf_queue_entry) {
  .skb = skb,
  .elem = ({ const typeof( ((struct nf_hook_ops *)0)->list ) *__mptr = (elem); (struct nf_hook_ops *)( (char *)__mptr - __builtin_offsetof(struct nf_hook_ops,list) );}),
  .pf = pf,
  .hook = hook,
  .indev = indev,
  .outdev = outdev,
      ...
      unsigned int queuenum)
{
 ...
 switch (pf) {
 case NFPROTO_IPV4:
  skb->protocol = (( __be16)(__builtin_constant_p((__u16)((0x0800))) ? ((__u16)( (((__u16)((0x0800)) & (__u16)0x00ffU) << 8) | (((__u16)((0x0800)) & (__u16)0xff00U) >> 8))) : __fswab16((0x0800))));
  break;
 case NFPROTO_IPV6:
  skb->protocol = (( __be16)(__builtin_constant_p((__u16)((0x86DD))) ? ((__u16)( (((__u16)((0x86DD)) & (__u16)0x00ffU) << 8) | (((__u16)((0x86DD)) & (__u16)0xff00U) >> 8))) : __fswab16((0x86DD))));
  break;
 }
...
void nf_reinject(struct nf_queue_entry *entry, unsigned int verdict)
{
 ...
 next_hook:
  verdict = nf_iterate(&nf_hooks[entry->pf][entry->hook],
         ...
         entry->okfn, (-((int)(~0U>>1)) - 1));
 }

 switch (verdict & 0x0000ffff) {
 case 1:
 case 5:
  local_bh_disable();
  entry->okfn(skb);
...
extern typeof(nf_reinject) nf_reinject; static const char __kstrtab_nf_reinject[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "nf_reinject"; static const struct kernel_symbol __ksymtab_nf_reinject __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&nf_reinject, __kstrtab_nf_reinject };


static void *seq_start(struct seq_file *seq, loff_t *pos)
{
 if (*pos >= (sizeof(queue_handler) / sizeof((queue_handler)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(queue_handler), typeof(&queue_handler[0]))); }))))
  return ((void *)0);
...
static int seq_show(struct seq_file *s, void *v)
{
 ...
 rcu_read_lock();
 qh = ({ typeof(queue_handler[*pos]) _________p1 = (*(volatile typeof(queue_handler[*pos]) *)&(queue_handler[*pos])); do { } while(0); (_________p1); });
 if (!qh)
...
int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) netfilter_queue_init(void)
{

 if (!proc_create("nf_queue", (00400|00040|00004),
