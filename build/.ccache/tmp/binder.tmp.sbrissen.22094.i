...
# 1 "<command-line>" 2
# 1 "../../drivers/staging/android/binder.c"
# 18 "../../drivers/staging/android/binder.c"
# 1 "../../arch/arm/include/asm/cacheflush.h" 1
# 13 "../../arch/arm/include/asm/cacheflush.h"
...
# 14 "../../arch/arm/include/asm/cacheflush.h" 2
...
# 19 "../../drivers/staging/android/binder.c" 2
...
struct files_struct {
 ...
 spinlock_t file_lock __attribute__((__aligned__((1 << 5))));
 int next_fd;
 struct embedded_fd_set close_on_exec_init;
 struct embedded_fd_set open_fds_init;
 struct file * fd_array[32];
};
# 70 "../../include/linux/fdtable.h"
...
extern void __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) files_defer_init(void);

static inline __attribute__((always_inline)) void free_fdtable(struct fdtable *fdt)
{
...
static inline __attribute__((always_inline)) struct file * fcheck_files(struct files_struct *files, unsigned int fd)
{
 ...
 struct fdtable *fdt = ((({ typeof(((files)->fdt)) _________p1 = (*(volatile typeof(((files)->fdt)) *)&(((files)->fdt))); do { } while(0); (_________p1); })));

 if (fd < fdt->max_fds)
  file = (({ typeof((fdt->fd[fd])) _________p1 = (*(volatile typeof((fdt->fd[fd])) *)&((fdt->fd[fd]))); do { } while(0); (_________p1); }));
 return file;
}
...
# 20 "../../drivers/staging/android/binder.c" 2
...
# 21 "../../drivers/staging/android/binder.c" 2
...
# 22 "../../drivers/staging/android/binder.c" 2
...
# 24 "../../drivers/staging/android/binder.c" 2
...
# 28 "../../drivers/staging/android/binder.c" 2
...
# 29 "../../drivers/staging/android/binder.c" 2
...
# 30 "../../drivers/staging/android/binder.c" 2
...
extern struct hlist_node *seq_hlist_next_rcu(void *v,
         ...
         loff_t *ppos);
# 33 "../../drivers/staging/android/binder.c" 2
...
# 34 "../../drivers/staging/android/binder.c" 2
...
# 35 "../../drivers/staging/android/binder.c" 2
...
# 36 "../../drivers/staging/android/binder.c" 2

# 1 "../../drivers/staging/android/binder.h" 1
# 29 "../../drivers/staging/android/binder.h"
enum {
...
# 49 "../../drivers/staging/android/binder.h"
...
# 110 "../../drivers/staging/android/binder.h"
...
enum BinderDriverReturnProtocol {
 BR_ERROR = (((2U) << (((0 +8)+8)+14)) | ((('r')) << (0 +8)) | (((0)) << 0) | (((((sizeof(int) == sizeof(int[1]) && sizeof(int) < (1 << 14)) ? sizeof(int) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 ...
 BR_TRANSACTION = (((2U) << (((0 +8)+8)+14)) | ((('r')) << (0 +8)) | (((2)) << 0) | (((((sizeof(struct binder_transaction_data) == sizeof(struct binder_transaction_data[1]) && sizeof(struct binder_transaction_data) < (1 << 14)) ? sizeof(struct binder_transaction_data) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 BR_REPLY = (((2U) << (((0 +8)+8)+14)) | ((('r')) << (0 +8)) | (((3)) << 0) | (((((sizeof(struct binder_transaction_data) == sizeof(struct binder_transaction_data[1]) && sizeof(struct binder_transaction_data) < (1 << 14)) ? sizeof(struct binder_transaction_data) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),




 BR_ACQUIRE_RESULT = (((2U) << (((0 +8)+8)+14)) | ((('r')) << (0 +8)) | (((4)) << 0) | (((((sizeof(int) == sizeof(int[1]) && sizeof(int) < (1 << 14)) ? sizeof(int) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 ...
 BR_INCREFS = (((2U) << (((0 +8)+8)+14)) | ((('r')) << (0 +8)) | (((7)) << 0) | (((((sizeof(struct binder_ptr_cookie) == sizeof(struct binder_ptr_cookie[1]) && sizeof(struct binder_ptr_cookie) < (1 << 14)) ? sizeof(struct binder_ptr_cookie) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 BR_ACQUIRE = (((2U) << (((0 +8)+8)+14)) | ((('r')) << (0 +8)) | (((8)) << 0) | (((((sizeof(struct binder_ptr_cookie) == sizeof(struct binder_ptr_cookie[1]) && sizeof(struct binder_ptr_cookie) < (1 << 14)) ? sizeof(struct binder_ptr_cookie) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 BR_RELEASE = (((2U) << (((0 +8)+8)+14)) | ((('r')) << (0 +8)) | (((9)) << 0) | (((((sizeof(struct binder_ptr_cookie) == sizeof(struct binder_ptr_cookie[1]) && sizeof(struct binder_ptr_cookie) < (1 << 14)) ? sizeof(struct binder_ptr_cookie) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 BR_DECREFS = (((2U) << (((0 +8)+8)+14)) | ((('r')) << (0 +8)) | (((10)) << 0) | (((((sizeof(struct binder_ptr_cookie) == sizeof(struct binder_ptr_cookie[1]) && sizeof(struct binder_ptr_cookie) < (1 << 14)) ? sizeof(struct binder_ptr_cookie) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),





 BR_ATTEMPT_ACQUIRE = (((2U) << (((0 +8)+8)+14)) | ((('r')) << (0 +8)) | (((11)) << 0) | (((((sizeof(struct binder_pri_ptr_cookie) == sizeof(struct binder_pri_ptr_cookie[1]) && sizeof(struct binder_pri_ptr_cookie) < (1 << 14)) ? sizeof(struct binder_pri_ptr_cookie) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 ...
 BR_DEAD_BINDER = (((2U) << (((0 +8)+8)+14)) | ((('r')) << (0 +8)) | (((15)) << 0) | (((((sizeof(void *) == sizeof(void *[1]) && sizeof(void *) < (1 << 14)) ? sizeof(void *) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),



 BR_CLEAR_DEATH_NOTIFICATION_DONE = (((2U) << (((0 +8)+8)+14)) | ((('r')) << (0 +8)) | (((16)) << 0) | (((((sizeof(void *) == sizeof(void *[1]) && sizeof(void *) < (1 << 14)) ? sizeof(void *) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
...
enum BinderDriverCommandProtocol {
 BC_TRANSACTION = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((0)) << 0) | (((((sizeof(struct binder_transaction_data) == sizeof(struct binder_transaction_data[1]) && sizeof(struct binder_transaction_data) < (1 << 14)) ? sizeof(struct binder_transaction_data) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 BC_REPLY = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((1)) << 0) | (((((sizeof(struct binder_transaction_data) == sizeof(struct binder_transaction_data[1]) && sizeof(struct binder_transaction_data) < (1 << 14)) ? sizeof(struct binder_transaction_data) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),




 BC_ACQUIRE_RESULT = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((2)) << 0) | (((((sizeof(int) == sizeof(int[1]) && sizeof(int) < (1 << 14)) ? sizeof(int) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 ...
 BC_FREE_BUFFER = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((3)) << 0) | (((((sizeof(int) == sizeof(int[1]) && sizeof(int) < (1 << 14)) ? sizeof(int) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),




 BC_INCREFS = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((4)) << 0) | (((((sizeof(int) == sizeof(int[1]) && sizeof(int) < (1 << 14)) ? sizeof(int) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 BC_ACQUIRE = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((5)) << 0) | (((((sizeof(int) == sizeof(int[1]) && sizeof(int) < (1 << 14)) ? sizeof(int) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 BC_RELEASE = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((6)) << 0) | (((((sizeof(int) == sizeof(int[1]) && sizeof(int) < (1 << 14)) ? sizeof(int) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 BC_DECREFS = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((7)) << 0) | (((((sizeof(int) == sizeof(int[1]) && sizeof(int) < (1 << 14)) ? sizeof(int) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),




 BC_INCREFS_DONE = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((8)) << 0) | (((((sizeof(struct binder_ptr_cookie) == sizeof(struct binder_ptr_cookie[1]) && sizeof(struct binder_ptr_cookie) < (1 << 14)) ? sizeof(struct binder_ptr_cookie) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
 BC_ACQUIRE_DONE = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((9)) << 0) | (((((sizeof(struct binder_ptr_cookie) == sizeof(struct binder_ptr_cookie[1]) && sizeof(struct binder_ptr_cookie) < (1 << 14)) ? sizeof(struct binder_ptr_cookie) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),





 BC_ATTEMPT_ACQUIRE = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((10)) << 0) | (((((sizeof(struct binder_pri_desc) == sizeof(struct binder_pri_desc[1]) && sizeof(struct binder_pri_desc) < (1 << 14)) ? sizeof(struct binder_pri_desc) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),
...
# 311 "../../drivers/staging/android/binder.h"
 BC_REQUEST_DEATH_NOTIFICATION = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((14)) << 0) | (((((sizeof(struct binder_ptr_cookie) == sizeof(struct binder_ptr_cookie[1]) && sizeof(struct binder_ptr_cookie) < (1 << 14)) ? sizeof(struct binder_ptr_cookie) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),





 BC_CLEAR_DEATH_NOTIFICATION = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((15)) << 0) | (((((sizeof(struct binder_ptr_cookie) == sizeof(struct binder_ptr_cookie[1]) && sizeof(struct binder_ptr_cookie) < (1 << 14)) ? sizeof(struct binder_ptr_cookie) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),





 BC_DEAD_BINDER_DONE = (((1U) << (((0 +8)+8)+14)) | ((('c')) << (0 +8)) | (((16)) << 0) | (((((sizeof(void *) == sizeof(void *[1]) && sizeof(void *) < (1 << 14)) ? sizeof(void *) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))),



};
# 38 "../../drivers/staging/android/binder.c" 2

static struct mutex binder_lock = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } } , .wait_list = { &(binder_lock.wait_list), &(binder_lock.wait_list) } };
static struct mutex binder_deferred_lock = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } } , .wait_list = { &(binder_deferred_lock.wait_list), &(binder_deferred_lock.wait_list) } };

static struct hlist_head binder_procs = { .first = ((void *)0) };
static struct hlist_head binder_deferred_list = { .first = ((void *)0) };
static struct hlist_head binder_dead_nodes = { .first = ((void *)0) };
...
# 67 "../../drivers/staging/android/binder.c"
static int binder_proc_show(struct seq_file *m, void *unused);
static int binder_proc_open(struct inode *inode, struct file *file) { return single_open(file, binder_proc_show, inode->i_private); } static const struct file_operations binder_proc_fops = { .owner = ((struct module *)0), .open = binder_proc_open, .read = seq_read, .llseek = seq_lseek, .release = single_release, };
# 83 "../../drivers/staging/android/binder.c"
enum {
...
static inline __attribute__((always_inline)) unsigned int *__check_debug_mask(void) { return(&(binder_debug_mask)); }; static int __param_perm_check_debug_mask __attribute__((unused)) = (sizeof(struct { int:-!!((00200 | (00400|00040|00004)) < 0 || (00200 | (00400|00040|00004)) > 0777 || ((00200 | (00400|00040|00004)) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""binder" ".") > (64 - sizeof(unsigned long))); })); static const char __param_str_debug_mask[] = "binder" "." "debug_mask"; static struct kernel_param const __param_debug_mask __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_debug_mask, 00200 | (00400|00040|00004), __builtin_types_compatible_p(typeof(*(&binder_debug_mask)), typeof(bool)) ? 2 : 0, param_set_uint, param_get_uint, { &binder_debug_mask } }; ;

static int binder_debug_no_lock;
static inline __attribute__((always_inline)) void __check_proc_no_lock(void) { ((void)(sizeof(struct { int:-!!(!__builtin_types_compatible_p(typeof(*(&(binder_debug_no_lock))), typeof(bool)) && !__builtin_types_compatible_p(typeof(*(&(binder_debug_no_lock))), typeof(unsigned int)) && !__builtin_types_compatible_p(typeof(*(&(binder_debug_no_lock))), typeof(int))); }))); }; static int __param_perm_check_proc_no_lock __attribute__((unused)) = (sizeof(struct { int:-!!((00200 | (00400|00040|00004)) < 0 || (00200 | (00400|00040|00004)) > 0777 || ((00200 | (00400|00040|00004)) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""binder" ".") > (64 - sizeof(unsigned long))); })); static const char __param_str_proc_no_lock[] = "binder" "." "proc_no_lock"; static struct kernel_param const __param_proc_no_lock __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_proc_no_lock, 00200 | (00400|00040|00004), __builtin_types_compatible_p(typeof(*(&binder_debug_no_lock)), typeof(bool)) ? 2 : 0, param_set_bool, param_get_bool, { &binder_debug_no_lock } }; ;

static wait_queue_head_t binder_user_error_wait = { .lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } }, .task_list = { &(binder_user_error_wait).task_list, &(binder_user_error_wait).task_list } };
      ...
      struct kernel_param *kp)
{
 ...
 if (binder_stop_on_user_error < 2)
  __wake_up(&binder_user_error_wait, (1 | 2), 1, ((void *)0));
 return ret;
}
static int __param_perm_check_stop_on_user_error __attribute__((unused)) = (sizeof(struct { int:-!!((00200 | (00400|00040|00004)) < 0 || (00200 | (00400|00040|00004)) > 0777 || ((00200 | (00400|00040|00004)) & 2)); })) + (sizeof(struct { int:-!!(sizeof("""binder" ".") > (64 - sizeof(unsigned long))); })); static const char __param_str_stop_on_user_error[] = "binder" "." "stop_on_user_error"; static struct kernel_param const __param_stop_on_user_error __attribute__((__used__)) __attribute__ ((unused,__section__ ("__param"),aligned(sizeof(void *)))) = { __param_str_stop_on_user_error, 00200 | (00400|00040|00004), __builtin_types_compatible_p(typeof(*(&binder_stop_on_user_error)), typeof(bool)) ? 2 : 0, binder_set_stop_on_user_error, param_get_int, { &binder_stop_on_user_error } };
# 137 "../../drivers/staging/android/binder.c"
...
struct binder_stats {
 int br[(((BR_FAILED_REPLY) >> 0) & ((1 << 8)-1)) + 1];
 int bc[(((BC_DEAD_BINDER_DONE) >> 0) & ((1 << 8)-1)) + 1];
...
static inline __attribute__((always_inline)) void binder_stats_deleted(enum binder_stat_types type)
{
 binder_stats.obj_deleted[type]++;
}

static inline __attribute__((always_inline)) void binder_stats_created(enum binder_stat_types type)
{
 ...
 struct binder_transaction_log *log)
{
 ...
 ({ void *__p = (e); size_t __n = sizeof(*e); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
 log->next++;
 if (log->next == (sizeof(log->entry) / sizeof((log->entry)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(log->entry), typeof(&log->entry[0]))); })))) {
  log->next = 0;
  log->full = 1;
 }
 return e;
...
repeat:
 fdt = ((({ typeof(((files)->fdt)) _________p1 = (*(volatile typeof(((files)->fdt)) *)&(((files)->fdt))); do { } while(0); (_________p1); })));
 fd = _find_next_zero_bit_le(fdt->open_fds->fds_bits,fdt->max_fds,files->next_fd);
 ...
 if (lock_task_sighand(proc->tsk, &irqs)) {
  rlim_cur = proc->tsk->signal->rlim[7].rlim_cur;
 ...
 (((fd_set *)(fdt->open_fds))->fds_bits[(fd) >> 5] |= (1<<((fd) & 31)));
 if (flags & 02000000)
  (((fd_set *)(fdt->close_on_exec))->fds_bits[(fd) >> 5] |= (1<<((fd) & 31)));
 else
  (((fd_set *)(fdt->close_on_exec))->fds_bits[(fd) >> 5] &= ~(1<<((fd) & 31)));
 files->next_fd = fd + 1;
 ...
 if (fdt->fd[fd] != ((void *)0)) {
  printk("<4>" "get_unused_fd: slot %d not NULL!\n", fd);
  fdt->fd[fd] = ((void *)0);
 }
 ...
 struct binder_proc *proc, unsigned int fd, struct file *file)
{
 ...
 spin_lock(&files->file_lock);
 fdt = ((({ typeof(((files)->fdt)) _________p1 = (*(volatile typeof(((files)->fdt)) *)&(((files)->fdt))); do { } while(0); (_________p1); })));
 do { if (__builtin_expect(!!(fdt->fd[fd] != ((void *)0)), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 ({ if (!__builtin_constant_p(file) || ((file) != ((void *)0))) __asm__ __volatile__ ("dmb" : : : "memory"); (fdt->fd[fd]) = (file); });
 spin_unlock(&files->file_lock);
}
...
static long task_close_fd(struct binder_proc *proc, unsigned int fd)
{
 ...
 if (!filp)
  goto out_unlock;
 ({ if (!__builtin_constant_p(((void *)0)) || ((((void *)0)) != ((void *)0))) __asm__ __volatile__ ("dmb" : : : "memory"); (fdt->fd[fd]) = (((void *)0)); });
 (((fd_set *)(fdt->close_on_exec))->fds_bits[(fd) >> 5] &= ~(1<<((fd) & 31)));
 ...
 if (__builtin_expect(!!(retval == -512 || retval == -513 || retval == -514 || retval == -516), 0))
...
{
 long min_nice;
 if (can_nice((get_current()), nice)) {
  set_user_nice((get_current()), nice);
  return;
 }
 min_nice = 20 - (get_current())->signal->rlim[13].rlim_cur;
 do { if (binder_debug_mask & BINDER_DEBUG_PRIORITY_CAP) printk("<6>" "binder: %d: nice value %ld not allowed use " "%ld instead\n", (get_current())->pid, nice, min_nice); } while (0);


 set_user_nice((get_current()), min_nice);
 if (min_nice < 20)
  return;
 do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d RLIMIT_NICE not set\n", (get_current())->pid); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
}
     ...
     struct binder_buffer *buffer)
{
 if (list_is_last(&buffer->entry, &proc->buffers))
  ...
  return (size_t)({ const typeof( ((struct binder_buffer *)0)->entry ) *__mptr = (buffer->entry.next); (struct binder_buffer *)( (char *)__mptr - __builtin_offsetof(struct binder_buffer,entry) );}) - (size_t)buffer->data;
          ...
          struct binder_buffer *new_buffer)
{
 ...
 do { if (__builtin_expect(!!(!new_buffer->free), 0)) do { *(int *)0 = 0; } while (1); } while(0);

 new_buffer_size = binder_buffer_size(proc, new_buffer);

 do { if (binder_debug_mask & BINDER_DEBUG_BUFFER_ALLOC) printk("<6>" "binder: %d: add free buffer, size %zd, " "at %p\n", proc->pid, new_buffer_size, new_buffer); } while (0);



 while (*p) {
  parent = *p;
  buffer = ({ const typeof( ((struct binder_buffer *)0)->rb_node ) *__mptr = (parent); (struct binder_buffer *)( (char *)__mptr - __builtin_offsetof(struct binder_buffer,rb_node) );});
  do { if (__builtin_expect(!!(!buffer->free), 0)) do { *(int *)0 = 0; } while (1); } while(0);
        ...
        void *user_ptr)
{
 ...
 kern_ptr = user_ptr - proc->user_buffer_offset
  - __builtin_offsetof(struct binder_buffer,data);

 while (n) {
  buffer = ({ const typeof( ((struct binder_buffer *)0)->rb_node ) *__mptr = (n); (struct binder_buffer *)( (char *)__mptr - __builtin_offsetof(struct binder_buffer,rb_node) );});
  do { if (__builtin_expect(!!(buffer->free), 0)) do { *(int *)0 = 0; } while (1); } while(0);
        ...
        struct vm_area_struct *vma)
{
 ...
 do { if (binder_debug_mask & BINDER_DEBUG_BUFFER_ALLOC) printk("<6>" "binder: %d: %s pages %p-%p\n", proc->pid, allocate ? "allocate" : "free", start, end); } while (0);
 ...
 if (vma == ((void *)0)) {
  printk("<3>" "binder: %d: binder_alloc_buf failed to "
         "map pages in userspace, no vma\n", proc->pid);
  goto err_no_vma;
 }

 for (page_addr = start; page_addr < end; page_addr += ((1UL) << 12)) {
  int ret;
  struct page **page_array_ptr;
  page = &proc->pages[(page_addr - proc->buffer) / ((1UL) << 12)];

  do { if (__builtin_expect(!!(*page), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  *page = alloc_pages_node(numa_node_id(), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)) | (( gfp_t)0x8000u), 0);
  if (*page == ((void *)0)) {
   printk("<3>" "binder: %d: binder_alloc_buf failed "
          "for page at %p\n", proc->pid, page_addr);
   goto err_alloc_page_failed;
  }
  tmp_area.addr = page_addr;
  tmp_area.size = ((1UL) << 12) + ((1UL) << 12) ;
  page_array_ptr = page;
  ret = map_vm_area(&tmp_area, pgprot_kernel, &page_array_ptr);
  if (ret) {
   printk("<3>" "binder: %d: binder_alloc_buf failed "
...
free_range:
 for (page_addr = end - ((1UL) << 12); page_addr >= start;
      page_addr -= ((1UL) << 12)) {
  page = &proc->pages[(page_addr - proc->buffer) / ((1UL) << 12)];
  if (vma)
   zap_page_range(vma, (uintptr_t)page_addr +
    proc->user_buffer_offset, ((1UL) << 12), ((void *)0));
err_vm_insert_page_failed:
  unmap_kernel_range((unsigned long)page_addr, ((1UL) << 12));
           ...
           size_t offsets_size, int is_async)
{
 ...
 struct binder_buffer *buffer;
 size_t buffer_size;
 struct rb_node *best_fit = ((void *)0);
 void *has_page_addr;
 void *end_page_addr;
 size_t size;

 if (proc->vma == ((void *)0)) {
  printk("<3>" "binder: %d: binder_alloc_buf, no vma\n",
         proc->pid);
  return ((void *)0);
 }

 size = ((((data_size)) + ((typeof((data_size)))((sizeof(void *))) - 1)) & ~((typeof((data_size)))((sizeof(void *))) - 1)) +
  ((((offsets_size)) + ((typeof((offsets_size)))((sizeof(void *))) - 1)) & ~((typeof((offsets_size)))((sizeof(void *))) - 1));

 if (size < data_size || size < offsets_size) {
  do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d: got transaction with invalid " "size %zd-%zd\n", proc->pid, data_size, offsets_size); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
 ...
 if (is_async &&
  ...
  do { if (binder_debug_mask & BINDER_DEBUG_BUFFER_ALLOC) printk("<6>" "binder: %d: binder_alloc_buf size %zd" "failed, no async space left\n", proc->pid, size); } while (0);
 ...
 if (best_fit == ((void *)0)) {
  printk("<3>" "binder: %d: binder_alloc_buf size %zd failed, "
         "no address space\n", proc->pid, size);
  return ((void *)0);
 }
 if (n == ((void *)0)) {
  buffer = ({ const typeof( ((struct binder_buffer *)0)->rb_node ) *__mptr = (best_fit); (struct binder_buffer *)( (char *)__mptr - __builtin_offsetof(struct binder_buffer,rb_node) );});
  buffer_size = binder_buffer_size(proc, buffer);
 }

 do { if (binder_debug_mask & BINDER_DEBUG_BUFFER_ALLOC) printk("<6>" "binder: %d: binder_alloc_buf size %zd got buff" "er %p size %zd\n", proc->pid, size, buffer, buffer_size); } while (0);



 has_page_addr =
  (void *)(((uintptr_t)buffer->data + buffer_size) & (~(((1UL) << 12)-1)));
 if (n == ((void *)0)) {
 ...
 end_page_addr =
  (void *)(((((uintptr_t)buffer->data + buffer_size)) + ((typeof(((uintptr_t)buffer->data + buffer_size)))((((1UL) << 12))) - 1)) & ~((typeof(((uintptr_t)buffer->data + buffer_size)))((((1UL) << 12))) - 1));
 if (end_page_addr > has_page_addr)
  end_page_addr = has_page_addr;
 if (binder_update_page_range(proc, 1,
     (void *)(((((uintptr_t)buffer->data)) + ((typeof(((uintptr_t)buffer->data)))((((1UL) << 12))) - 1)) & ~((typeof(((uintptr_t)buffer->data)))((((1UL) << 12))) - 1)), end_page_addr, ((void *)0)))
  return ((void *)0);
 ...
 do { if (binder_debug_mask & BINDER_DEBUG_BUFFER_ALLOC) printk("<6>" "binder: %d: binder_alloc_buf size %zd got " "%p\n", proc->pid, size, buffer); } while (0);
 ...
 if (is_async) {
  proc->free_async_space -= size + sizeof(struct binder_buffer);
  do { if (binder_debug_mask & BINDER_DEBUG_BUFFER_ALLOC_ASYNC) printk("<6>" "binder: %d: binder_alloc_buf size %zd " "async free %zd\n", proc->pid, size, proc->free_async_space); } while (0);
...
{
 return (void *)((uintptr_t)buffer & (~(((1UL) << 12)-1)));
}

static void *buffer_end_page(struct binder_buffer *buffer)
{
 return (void *)(((uintptr_t)(buffer + 1) - 1) & (~(((1UL) << 12)-1)));
}

static void binder_delete_free_buffer(struct binder_proc *proc,
          struct binder_buffer *buffer)
{
 struct binder_buffer *prev, *next = ((void *)0);
 int free_page_end = 1;
 int free_page_start = 1;

 do { if (__builtin_expect(!!(proc->buffers.next == &buffer->entry), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 prev = ({ const typeof( ((struct binder_buffer *)0)->entry ) *__mptr = (buffer->entry.prev); (struct binder_buffer *)( (char *)__mptr - __builtin_offsetof(struct binder_buffer,entry) );});
 do { if (__builtin_expect(!!(!prev->free), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 if (buffer_end_page(prev) == buffer_start_page(buffer)) {
  free_page_start = 0;
  if (buffer_end_page(prev) == buffer_end_page(buffer))
   free_page_end = 0;
  do { if (binder_debug_mask & BINDER_DEBUG_BUFFER_ALLOC) printk("<6>" "binder: %d: merge free, buffer %p " "share page with %p\n", proc->pid, buffer, prev); } while (0);


 }

 if (!list_is_last(&buffer->entry, &proc->buffers)) {
  next = ({ const typeof( ((struct binder_buffer *)0)->entry ) *__mptr = (buffer->entry.next); (struct binder_buffer *)( (char *)__mptr - __builtin_offsetof(struct binder_buffer,entry) );});
 ...
 if (free_page_start || free_page_end) {
  do { if (binder_debug_mask & BINDER_DEBUG_BUFFER_ALLOC) printk("<6>" "binder: %d: merge free, buffer %p do " "not share page%s%s with with %p or %p\n", proc->pid, buffer, free_page_start ? "" : " end", free_page_end ? "" : " start", prev, next); } while (0);
  ...
  binder_update_page_range(proc, 0, free_page_start ?
   ...
   buffer_start_page(buffer)) + ((1UL) << 12), ((void *)0));
 }
}
       ...
       struct binder_buffer *buffer)
{
 ...
 size = ((((buffer->data_size)) + ((typeof((buffer->data_size)))((sizeof(void *))) - 1)) & ~((typeof((buffer->data_size)))((sizeof(void *))) - 1)) +
  ((((buffer->offsets_size)) + ((typeof((buffer->offsets_size)))((sizeof(void *))) - 1)) & ~((typeof((buffer->offsets_size)))((sizeof(void *))) - 1));

 do { if (binder_debug_mask & BINDER_DEBUG_BUFFER_ALLOC) printk("<6>" "binder: %d: binder_free_buf %p size %zd buffer" "_size %zd\n", proc->pid, buffer, size, buffer_size); } while (0);



 do { if (__builtin_expect(!!(buffer->free), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 do { if (__builtin_expect(!!(size > buffer_size), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 do { if (__builtin_expect(!!(buffer->transaction != ((void *)0)), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 do { if (__builtin_expect(!!((void *)buffer < proc->buffer), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 do { if (__builtin_expect(!!((void *)buffer > proc->buffer + proc->buffer_size), 0)) do { *(int *)0 = 0; } while (1); } while(0);

 if (buffer->async_transaction) {
  proc->free_async_space += size + sizeof(struct binder_buffer);

  do { if (binder_debug_mask & BINDER_DEBUG_BUFFER_ALLOC_ASYNC) printk("<6>" "binder: %d: binder_free_buf size %zd " "async free %zd\n", proc->pid, size, proc->free_async_space); } while (0);
 ...
 binder_update_page_range(proc, 0,
  (void *)(((((uintptr_t)buffer->data)) + ((typeof(((uintptr_t)buffer->data)))((((1UL) << 12))) - 1)) & ~((typeof(((uintptr_t)buffer->data)))((((1UL) << 12))) - 1)),
  (void *)(((uintptr_t)buffer->data + buffer_size) & (~(((1UL) << 12)-1))),
  ((void *)0));
 rb_erase(&buffer->rb_node, &proc->allocated_buffers);
 buffer->free = 1;
 if (!list_is_last(&buffer->entry, &proc->buffers)) {
  struct binder_buffer *next = ({ const typeof( ((struct binder_buffer *)0)->entry ) *__mptr = (buffer->entry.next); (struct binder_buffer *)( (char *)__mptr - __builtin_offsetof(struct binder_buffer,entry) );});
 ...
 if (proc->buffers.next != &buffer->entry) {
  struct binder_buffer *prev = ({ const typeof( ((struct binder_buffer *)0)->entry ) *__mptr = (buffer->entry.prev); (struct binder_buffer *)( (char *)__mptr - __builtin_offsetof(struct binder_buffer,entry) );});
        ...
        void *ptr)
{
 ...
 while (n) {
  node = ({ const typeof( ((struct binder_node *)0)->rb_node ) *__mptr = (n); (struct binder_node *)( (char *)__mptr - __builtin_offsetof(struct binder_node,rb_node) );});
        ...
        void *cookie)
{
 ...
 while (*p) {
  parent = *p;
  node = ({ const typeof( ((struct binder_node *)0)->rb_node ) *__mptr = (parent); (struct binder_node *)( (char *)__mptr - __builtin_offsetof(struct binder_node,rb_node) );});
 ...
 node = kzalloc(sizeof(*node), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (node == ((void *)0))
  return ((void *)0);
 ...
 do { if (binder_debug_mask & BINDER_DEBUG_INTERNAL_REFS) printk("<6>" "binder: %d:%d node %d u%p c%p created\n", proc->pid, (get_current())->pid, node->debug_id, node->ptr, node->cookie); } while (0);
      ...
      struct list_head *target_list)
{
 if (strong) {
  if (internal) {
   if (target_list == ((void *)0) &&
       node->internal_strong_refs == 0 &&
       !(node == binder_context_mgr_node &&
       node->has_strong_ref)) {
    printk("<3>" "binder: invalid inc strong "
     "node for %d\n", node->debug_id);
    return -22;
   }
  ...
  if (!node->has_weak_ref && list_empty(&node->work.entry)) {
   if (target_list == ((void *)0)) {
    printk("<3>" "binder: invalid inc weak node "
     "for %d\n", node->debug_id);
    return -22;
   }
   list_add_tail(&node->work.entry, target_list);
...
static int binder_dec_node(struct binder_node *node, int strong, int internal)
{
 ...
 if (node->proc && (node->has_strong_ref || node->has_weak_ref)) {
  if (list_empty(&node->work.entry)) {
   ...
   __wake_up(&node->proc->wait, 1, 1, ((void *)0));
  }
 } else {
  if (hlist_empty(&node->refs) && !node->local_strong_refs &&
   ...
   if (node->proc) {
    ...
    do { if (binder_debug_mask & BINDER_DEBUG_INTERNAL_REFS) printk("<6>" "binder: refless node %d deleted\n", node->debug_id); } while (0);


   } else {
    hlist_del(&node->dead_node);
    do { if (binder_debug_mask & BINDER_DEBUG_INTERNAL_REFS) printk("<6>" "binder: dead node %d deleted\n", node->debug_id); } while (0);
      ...
      uint32_t desc)
{
 ...
 while (n) {
  ref = ({ const typeof( ((struct binder_ref *)0)->rb_node_desc ) *__mptr = (n); (struct binder_ref *)( (char *)__mptr - __builtin_offsetof(struct binder_ref,rb_node_desc) );});
        ...
        struct binder_node *node)
{
 ...
 while (*p) {
  parent = *p;
  ref = ({ const typeof( ((struct binder_ref *)0)->rb_node_node ) *__mptr = (parent); (struct binder_ref *)( (char *)__mptr - __builtin_offsetof(struct binder_ref,rb_node_node) );});
 ...
 new_ref = kzalloc(sizeof(*ref), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (new_ref == ((void *)0))
  return ((void *)0);
 ...
 for (n = rb_first(&proc->refs_by_desc); n != ((void *)0); n = rb_next(n)) {
  ref = ({ const typeof( ((struct binder_ref *)0)->rb_node_desc ) *__mptr = (n); (struct binder_ref *)( (char *)__mptr - __builtin_offsetof(struct binder_ref,rb_node_desc) );});
 ...
 while (*p) {
  parent = *p;
  ref = ({ const typeof( ((struct binder_ref *)0)->rb_node_desc ) *__mptr = (parent); (struct binder_ref *)( (char *)__mptr - __builtin_offsetof(struct binder_ref,rb_node_desc) );});
 ...
 if (node) {
  ...
  do { if (binder_debug_mask & BINDER_DEBUG_INTERNAL_REFS) printk("<6>" "binder: %d new ref %d desc %d for " "node %d\n", proc->pid, new_ref->debug_id, new_ref->desc, node->debug_id); } while (0);



 } else {
  do { if (binder_debug_mask & BINDER_DEBUG_INTERNAL_REFS) printk("<6>" "binder: %d new ref %d desc %d for " "dead node\n", proc->pid, new_ref->debug_id, new_ref->desc); } while (0);
...
{
 do { if (binder_debug_mask & BINDER_DEBUG_INTERNAL_REFS) printk("<6>" "binder: %d delete ref %d desc %d for " "node %d\n", ref->proc->pid, ref->debug_id, ref->desc, ref->node->debug_id); } while (0);
 ...
 if (ref->death) {
  do { if (binder_debug_mask & BINDER_DEBUG_DEAD_BINDER) printk("<6>" "binder: %d delete ref %d desc %d " "has death notification\n", ref->proc->pid, ref->debug_id, ref->desc); } while (0);
...
static int binder_dec_ref(struct binder_ref *ref, int strong)
{
 if (strong) {
  if (ref->strong == 0) {
   do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d invalid dec strong, " "ref %d desc %d s %d w %d\n", ref->proc->pid, ref->debug_id, ref->desc, ref->strong, ref->weak); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
  ...
  if (ref->weak == 0) {
   do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d invalid dec weak, " "ref %d desc %d s %d w %d\n", ref->proc->pid, ref->debug_id, ref->desc, ref->strong, ref->weak); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
...
{
 if (target_thread) {
  do { if (__builtin_expect(!!(target_thread->transaction_stack != t), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  do { if (__builtin_expect(!!(target_thread->transaction_stack->from != target_thread), 0)) do { *(int *)0 = 0; } while (1); } while(0);
         ...
         uint32_t error_code)
{
 ...
 do { if (__builtin_expect(!!(t->flags & TF_ONE_WAY), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 while (1) {
  ...
  if (target_thread) {
   ...
   if (target_thread->return_error == BR_OK) {
    do { if (binder_debug_mask & BINDER_DEBUG_FAILED_TRANSACTION) printk("<6>" "binder: send failed reply for " "transaction %d to %d:%d\n", t->debug_id, target_thread->proc->pid, target_thread->pid); } while (0);
    ...
    __wake_up(&target_thread->wait, 1, 1, ((void *)0));
   } else {
    printk("<3>" "binder: reply failed, target "
   ...
   do { if (binder_debug_mask & BINDER_DEBUG_FAILED_TRANSACTION) printk("<6>" "binder: send failed reply " "for transaction %d, target dead\n", t->debug_id); } while (0);
   ...
   binder_pop_transaction(target_thread, t);
   if (next == ((void *)0)) {
    do { if (binder_debug_mask & BINDER_DEBUG_DEAD_BINDER) printk("<6>" "binder: reply failed," " no target thread at root\n"); } while (0);


    return;
   }
   t = next;
   do { if (binder_debug_mask & BINDER_DEBUG_DEAD_BINDER) printk("<6>" "binder: reply failed, no target " "thread -- retry %d\n", t->debug_id); } while (0);
           ...
           size_t *failed_at)
{
 ...
 do { if (binder_debug_mask & BINDER_DEBUG_TRANSACTION) printk("<6>" "binder: %d buffer release %d, size %zd-%zd, failed at %p\n", proc->pid, buffer->debug_id, buffer->data_size, buffer->offsets_size, failed_at); } while (0);
 ...
 offp = (size_t *)(buffer->data + ((((buffer->data_size)) + ((typeof((buffer->data_size)))((sizeof(void *))) - 1)) & ~((typeof((buffer->data_size)))((sizeof(void *))) - 1)));
 if (failed_at)
  off_end = failed_at;
 else
 ...
 for (; offp < off_end; offp++) {
  ...
  if (*offp > buffer->data_size - sizeof(*fp) ||
      ...
      !(((*offp) & ((typeof(*offp))(sizeof(void *)) - 1)) == 0)) {
   printk("<3>" "binder: transaction release %d bad"
     "offset %zd, size %zd\n", debug_id,
  ...
  case BINDER_TYPE_WEAK_BINDER: {
   ...
   if (node == ((void *)0)) {
    printk("<3>" "binder: transaction release %d"
           " bad node %p\n", debug_id, fp->binder);
    break;
   }
   do { if (binder_debug_mask & BINDER_DEBUG_TRANSACTION) printk("<6>" "        node %d u%p\n", node->debug_id, node->ptr); } while (0);
  ...
  case BINDER_TYPE_WEAK_HANDLE: {
   ...
   do { if (binder_debug_mask & BINDER_DEBUG_TRANSACTION) printk("<6>" "        ref %d desc %d (node %d)\n", ref->debug_id, ref->desc, ref->node->debug_id); } while (0);
  ...
  case BINDER_TYPE_FD:
   do { if (binder_debug_mask & BINDER_DEBUG_TRANSACTION) printk("<6>" "        fd %ld\n", fp->handle); } while (0);
          ...
          struct binder_transaction_data *tr, int reply)
{
 ...
 struct binder_thread *target_thread = ((void *)0);
 struct binder_node *target_node = ((void *)0);
 struct list_head *target_list;
 wait_queue_head_t *target_wait;
 struct binder_transaction *in_reply_to = ((void *)0);
 struct binder_transaction_log_entry *e;
 ...
 if (reply) {
  ...
  if (in_reply_to == ((void *)0)) {
   do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got reply transaction " "with no transaction stack\n", proc->pid, thread->pid); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
  ...
  if (in_reply_to->to_thread != thread) {
   do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got reply transaction " "with bad transaction stack," " transaction %d has target %d:%d\n", proc->pid, thread->pid, in_reply_to->debug_id, in_reply_to->to_proc ? in_reply_to->to_proc->pid : 0, in_reply_to->to_thread ? in_reply_to->to_thread->pid : 0); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
  ...
  if (target_thread == ((void *)0)) {
   return_error = BR_DEAD_REPLY;
   goto err_dead_binder;
  }
  if (target_thread->transaction_stack != in_reply_to) {
   do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got reply transaction " "with bad target transaction stack %d, " "expected %d\n", proc->pid, thread->pid, target_thread->transaction_stack ? target_thread->transaction_stack->debug_id : 0, in_reply_to->debug_id); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
  ...
  if (tr->target.handle) {
   ...
   if (ref == ((void *)0)) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got " "transaction to invalid handle\n", proc->pid, thread->pid); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
  ...
  if (!(tr->flags & TF_ONE_WAY) && thread->transaction_stack) {
   ...
   if (tmp->to_thread != thread) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got new " "transaction with bad transaction stack" ", transaction %d has target %d:%d\n", proc->pid, thread->pid, tmp->debug_id, tmp->to_proc ? tmp->to_proc->pid : 0, tmp->to_thread ? tmp->to_thread->pid : 0); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
 ...
 t = kzalloc(sizeof(*t), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (t == ((void *)0)) {
  return_error = BR_FAILED_REPLY;
 ...
 tcomplete = kzalloc(sizeof(*tcomplete), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (tcomplete == ((void *)0)) {
  return_error = BR_FAILED_REPLY;
 ...
 if (reply)
  do { if (binder_debug_mask & BINDER_DEBUG_TRANSACTION) printk("<6>" "binder: %d:%d BC_REPLY %d -> %d:%d, " "data %p-%p size %zd-%zd\n", proc->pid, thread->pid, t->debug_id, target_proc->pid, target_thread->pid, tr->data.ptr.buffer, tr->data.ptr.offsets, tr->data_size, tr->offsets_size); } while (0);
  ...
  do { if (binder_debug_mask & BINDER_DEBUG_TRANSACTION) printk("<6>" "binder: %d:%d BC_TRANSACTION %d -> " "%d - node %d, data %p-%p size %zd-%zd\n", proc->pid, thread->pid, t->debug_id, target_proc->pid, target_node->debug_id, tr->data.ptr.buffer, tr->data.ptr.offsets, tr->data_size, tr->offsets_size); } while (0);
 ...
 t->code = tr->code;
 t->flags = tr->flags;
 t->priority = task_nice((get_current()));
 ...
 if (target_node)
  binder_inc_node(target_node, 1, 0, ((void *)0));

 offp = (size_t *)(t->buffer->data + ((((tr->data_size)) + ((typeof((tr->data_size)))((sizeof(void *))) - 1)) & ~((typeof((tr->data_size)))((sizeof(void *))) - 1)));

 if (copy_from_user(t->buffer->data, tr->data.ptr.buffer, tr->data_size)) {
  do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got transaction with invalid " "data ptr\n", proc->pid, thread->pid); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);

  return_error = BR_FAILED_REPLY;
  goto err_copy_data_failed;
 }
 if (copy_from_user(offp, tr->data.ptr.offsets, tr->offsets_size)) {
  do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got transaction with invalid " "offsets ptr\n", proc->pid, thread->pid); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);

  return_error = BR_FAILED_REPLY;
  goto err_copy_data_failed;
 }
 if (!(((tr->offsets_size) & ((typeof(tr->offsets_size))(sizeof(size_t)) - 1)) == 0)) {
  do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got transaction with " "invalid offsets size, %zd\n", proc->pid, thread->pid, tr->offsets_size); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
 ...
 for (; offp < off_end; offp++) {
  ...
  if (*offp > t->buffer->data_size - sizeof(*fp) ||
      ...
      !(((*offp) & ((typeof(*offp))(sizeof(void *)) - 1)) == 0)) {
   do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got transaction with " "invalid offset, %zd\n", proc->pid, thread->pid, *offp); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
  ...
  case BINDER_TYPE_WEAK_BINDER: {
   ...
   if (fp->cookie != node->cookie) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d sending u%p " "node %d, cookie mismatch %p != %p\n", proc->pid, thread->pid, fp->binder, node->debug_id, fp->cookie, node->cookie); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
   ...
   do { if (binder_debug_mask & BINDER_DEBUG_TRANSACTION) printk("<6>" "        node %d u%p -> ref %d desc %d\n", node->debug_id, node->ptr, ref->debug_id, ref->desc); } while (0);
  ...
  case BINDER_TYPE_WEAK_HANDLE: {
   struct binder_ref *ref = binder_get_ref(proc, fp->handle);
   if (ref == ((void *)0)) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got " "transaction with invalid " "handle, %ld\n", proc->pid, thread->pid, fp->handle); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
   ...
   if (ref->node->proc == target_proc) {
    ...
    binder_inc_node(ref->node, fp->type == BINDER_TYPE_BINDER, 0, ((void *)0));
    do { if (binder_debug_mask & BINDER_DEBUG_TRANSACTION) printk("<6>" "        ref %d desc %d -> node %d u%p\n", ref->debug_id, ref->desc, ref->node->debug_id, ref->node->ptr); } while (0);
    ...
    binder_inc_ref(new_ref, fp->type == BINDER_TYPE_HANDLE, ((void *)0));
    do { if (binder_debug_mask & BINDER_DEBUG_TRANSACTION) printk("<6>" "        ref %d desc %d -> ref %d desc %d (node %d)\n", ref->debug_id, ref->desc, new_ref->debug_id, new_ref->desc, ref->node->debug_id); } while (0);
  ...
  case BINDER_TYPE_FD: {
   ...
   if (reply) {
    if (!(in_reply_to->flags & TF_ACCEPT_FDS)) {
     do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got reply with fd, %ld, but target does not allow fds\n", proc->pid, thread->pid, fp->handle); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);

     return_error = BR_FAILED_REPLY;
     goto err_fd_not_allowed;
    }
   } else if (!target_node->accept_fds) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got transaction with fd, %ld, but target does not allow fds\n", proc->pid, thread->pid, fp->handle); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
   ...
   file = fget(fp->handle);
   if (file == ((void *)0)) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got transaction with invalid fd, %ld\n", proc->pid, thread->pid, fp->handle); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);

    return_error = BR_FAILED_REPLY;
    goto err_fget_failed;
   }
   target_fd = task_get_unused_fd_flags(target_proc, 02000000);
   if (target_fd < 0) {
    fput(file);
    return_error = BR_FAILED_REPLY;
   ...
   do { if (binder_debug_mask & BINDER_DEBUG_TRANSACTION) printk("<6>" "        fd %ld -> %d\n", fp->handle, target_fd); } while (0);
  ...
  default:
   do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d got transactio" "n with invalid object type, %lx\n", proc->pid, thread->pid, fp->type); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
 ...
 if (reply) {
  do { if (__builtin_expect(!!(t->buffer->async_transaction != 0), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  ...
  do { if (__builtin_expect(!!(target_node == ((void *)0)), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  do { if (__builtin_expect(!!(t->buffer->async_transaction != 1), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 ...
 if (target_wait)
  __wake_up(target_wait, 1, 1, ((void *)0));
 return;
...
err_no_context_mgr_node:
 do { if (binder_debug_mask & BINDER_DEBUG_FAILED_TRANSACTION) printk("<6>" "binder: %d:%d transaction failed %d, size %zd-%zd\n", proc->pid, thread->pid, return_error, tr->data_size, tr->offsets_size); } while (0);
 ...
 do { if (__builtin_expect(!!(thread->return_error != BR_OK), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 if (in_reply_to) {
...
int binder_thread_write(struct binder_proc *proc, struct binder_thread *thread,
   void *buffer, int size, signed long *consumed)
{
 uint32_t cmd;
 void *ptr = buffer + *consumed;
 void *end = buffer + size;

 while (ptr < end && thread->return_error == BR_OK) {
  if (({ register const typeof(*((uint32_t *)ptr)) *__p asm("r0") = ((uint32_t *)ptr); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } cmd = (typeof(*((uint32_t *)ptr))) __r2; __e; }))
   return -14;
  ptr += sizeof(uint32_t);
  if ((((cmd) >> 0) & ((1 << 8)-1)) < (sizeof(binder_stats.bc) / sizeof((binder_stats.bc)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(binder_stats.bc), typeof(&binder_stats.bc[0]))); })))) {
   binder_stats.bc[(((cmd) >> 0) & ((1 << 8)-1))]++;
   proc->stats.bc[(((cmd) >> 0) & ((1 << 8)-1))]++;
   thread->stats.bc[(((cmd) >> 0) & ((1 << 8)-1))]++;
  }
  switch (cmd) {
  case BC_INCREFS:
  case BC_ACQUIRE:
  ...
  case BC_DECREFS: {
   ...
   if (({ register const typeof(*((uint32_t *)ptr)) *__p asm("r0") = ((uint32_t *)ptr); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } target = (typeof(*((uint32_t *)ptr))) __r2; __e; }))
    return -14;
   ptr += sizeof(uint32_t);
   if (target == 0 && binder_context_mgr_node &&
    ...
    if (ref->desc != target) {
     do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:" "%d tried to acquire " "reference to desc 0, " "got %d instead\n", proc->pid, thread->pid, ref->desc); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
   ...
   if (ref == ((void *)0)) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d refcou" "nt change on invalid ref %d\n", proc->pid, thread->pid, target); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
   ...
   case BC_INCREFS:
    ...
    binder_inc_ref(ref, 0, ((void *)0));
    break;
   case BC_ACQUIRE:
    debug_string = "Acquire";
    binder_inc_ref(ref, 1, ((void *)0));
    break;
   case BC_RELEASE:
   ...
   do { if (binder_debug_mask & BINDER_DEBUG_USER_REFS) printk("<6>" "binder: %d:%d %s ref %d desc %d s %d w %d for node %d\n", proc->pid, thread->pid, debug_string, ref->debug_id, ref->desc, ref->strong, ref->weak, ref->node->debug_id); } while (0);
  ...
  case BC_ACQUIRE_DONE: {
   ...
   if (({ register const typeof(*((void * *)ptr)) *__p asm("r0") = ((void * *)ptr); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } node_ptr = (typeof(*((void * *)ptr))) __r2; __e; }))
    return -14;
   ptr += sizeof(void *);
   if (({ register const typeof(*((void * *)ptr)) *__p asm("r0") = ((void * *)ptr); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } cookie = (typeof(*((void * *)ptr))) __r2; __e; }))
    return -14;
   ptr += sizeof(void *);
   node = binder_get_node(proc, node_ptr);
   if (node == ((void *)0)) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d " "%s u%p no match\n", proc->pid, thread->pid, cmd == BC_INCREFS_DONE ? "BC_INCREFS_DONE" : "BC_ACQUIRE_DONE", node_ptr); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
   ...
   if (cookie != node->cookie) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d %s u%p node %d" " cookie mismatch %p != %p\n", proc->pid, thread->pid, cmd == BC_INCREFS_DONE ? "BC_INCREFS_DONE" : "BC_ACQUIRE_DONE", node_ptr, node->debug_id, cookie, node->cookie); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
   ...
   if (cmd == BC_ACQUIRE_DONE) {
    if (node->pending_strong_ref == 0) {
     do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d " "BC_ACQUIRE_DONE node %d has " "no pending acquire request\n", proc->pid, thread->pid, node->debug_id); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
    ...
    if (node->pending_weak_ref == 0) {
     do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d " "BC_INCREFS_DONE node %d has " "no pending increfs request\n", proc->pid, thread->pid, node->debug_id); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
   ...
   do { if (binder_debug_mask & BINDER_DEBUG_USER_REFS) printk("<6>" "binder: %d:%d %s node %d ls %d lw %d\n", proc->pid, thread->pid, cmd == BC_INCREFS_DONE ? "BC_INCREFS_DONE" : "BC_ACQUIRE_DONE", node->debug_id, node->local_strong_refs, node->local_weak_refs); } while (0);
  ...
  case BC_ATTEMPT_ACQUIRE:
   printk("<3>" "binder: BC_ATTEMPT_ACQUIRE not supported\n");
   return -22;
  case BC_ACQUIRE_RESULT:
   printk("<3>" "binder: BC_ACQUIRE_RESULT not supported\n");
   return -22;
  ...
  case BC_FREE_BUFFER: {
   ...
   if (({ register const typeof(*((void * *)ptr)) *__p asm("r0") = ((void * *)ptr); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } data_ptr = (typeof(*((void * *)ptr))) __r2; __e; }))
    return -14;
   ptr += sizeof(void *);

   buffer = binder_buffer_lookup(proc, data_ptr);
   if (buffer == ((void *)0)) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d " "BC_FREE_BUFFER u%p no match\n", proc->pid, thread->pid, data_ptr); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);


    break;
   }
   if (!buffer->allow_user_free) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d " "BC_FREE_BUFFER u%p matched " "unreturned buffer\n", proc->pid, thread->pid, data_ptr); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);



    break;
   }
   do { if (binder_debug_mask & BINDER_DEBUG_FREE_BUFFER) printk("<6>" "binder: %d:%d BC_FREE_BUFFER u%p found buffer %d for %s transaction\n", proc->pid, thread->pid, data_ptr, buffer->debug_id, buffer->transaction ? "active" : "finished"); } while (0);
   ...
   if (buffer->async_transaction && buffer->target_node) {
    do { if (__builtin_expect(!!(!buffer->target_node->has_async_transaction), 0)) do { *(int *)0 = 0; } while (1); } while(0);
    if (list_empty(&buffer->target_node->async_todo))
     buffer->target_node->has_async_transaction = 0;
    else
     list_move_tail(buffer->target_node->async_todo.next, &thread->todo);
   }
   binder_transaction_buffer_release(proc, buffer, ((void *)0));
  ...
  case BC_REGISTER_LOOPER:
   do { if (binder_debug_mask & BINDER_DEBUG_THREADS) printk("<6>" "binder: %d:%d BC_REGISTER_LOOPER\n", proc->pid, thread->pid); } while (0);


   if (thread->looper & BINDER_LOOPER_STATE_ENTERED) {
    thread->looper |= BINDER_LOOPER_STATE_INVALID;
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d ERROR:" " BC_REGISTER_LOOPER called " "after BC_ENTER_LOOPER\n", proc->pid, thread->pid); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);



   } else if (proc->requested_threads == 0) {
    thread->looper |= BINDER_LOOPER_STATE_INVALID;
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d ERROR:" " BC_REGISTER_LOOPER called " "without request\n", proc->pid, thread->pid); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
  ...
  case BC_ENTER_LOOPER:
   do { if (binder_debug_mask & BINDER_DEBUG_THREADS) printk("<6>" "binder: %d:%d BC_ENTER_LOOPER\n", proc->pid, thread->pid); } while (0);


   if (thread->looper & BINDER_LOOPER_STATE_REGISTERED) {
    thread->looper |= BINDER_LOOPER_STATE_INVALID;
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d ERROR:" " BC_ENTER_LOOPER called after " "BC_REGISTER_LOOPER\n", proc->pid, thread->pid); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
   ...
   break;
  case BC_EXIT_LOOPER:
   do { if (binder_debug_mask & BINDER_DEBUG_THREADS) printk("<6>" "binder: %d:%d BC_EXIT_LOOPER\n", proc->pid, thread->pid); } while (0);
  ...
  case BC_CLEAR_DEATH_NOTIFICATION: {
   ...
   ref = binder_get_ref(proc, target);
   if (ref == ((void *)0)) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d %s " "invalid ref %d\n", proc->pid, thread->pid, cmd == BC_REQUEST_DEATH_NOTIFICATION ? "BC_REQUEST_DEATH_NOTIFICATION" : "BC_CLEAR_DEATH_NOTIFICATION", target); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
   ...
   do { if (binder_debug_mask & BINDER_DEBUG_DEATH_NOTIFICATION) printk("<6>" "binder: %d:%d %s %p ref %d desc %d s %d w %d for node %d\n", proc->pid, thread->pid, cmd == BC_REQUEST_DEATH_NOTIFICATION ? "BC_REQUEST_DEATH_NOTIFICATION" : "BC_CLEAR_DEATH_NOTIFICATION", cookie, ref->debug_id, ref->desc, ref->strong, ref->weak, ref->node->debug_id); } while (0);
# 2058 "../../drivers/staging/android/binder.c"
   if (cmd == BC_REQUEST_DEATH_NOTIFICATION) {
    if (ref->death) {
     do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%" "d BC_REQUEST_DEATH_NOTI" "FICATION death notific" "ation already set\n", proc->pid, thread->pid); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
    ...
    death = kzalloc(sizeof(*death), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
    if (death == ((void *)0)) {
     thread->return_error = BR_ERROR;
     do { if (binder_debug_mask & BINDER_DEBUG_FAILED_TRANSACTION) printk("<6>" "binder: %d:%d " "BC_REQUEST_DEATH_NOTIFICATION failed\n", proc->pid, thread->pid); } while (0);
    ...
    death->cookie = cookie;
    ref->death = death;
    if (ref->node->proc == ((void *)0)) {
     ref->death->work.type = BINDER_WORK_DEAD_BINDER;
     if (thread->looper & (BINDER_LOOPER_STATE_REGISTERED | BINDER_LOOPER_STATE_ENTERED)) {
      list_add_tail(&ref->death->work.entry, &thread->todo);
     } else {
      list_add_tail(&ref->death->work.entry, &proc->todo);
      __wake_up(&proc->wait, 1, 1, ((void *)0));
     }
    }
   } else {
    if (ref->death == ((void *)0)) {
     do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%" "d BC_CLEAR_DEATH_NOTIFI" "CATION death notificat" "ion not active\n", proc->pid, thread->pid); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
    ...
    if (death->cookie != cookie) {
     do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%" "d BC_CLEAR_DEATH_NOTIFI" "CATION death notificat" "ion cookie mismatch " "%p != %p\n", proc->pid, thread->pid, death->cookie, cookie); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
    ...
    if (list_empty(&death->work.entry)) {
     ...
     do { if (__builtin_expect(!!(death->work.type != BINDER_WORK_DEAD_BINDER), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  ...
  case BC_DEAD_BINDER_DONE: {
   ...
   void *cookie;
   struct binder_ref_death *death = ((void *)0);
   if (({ register const typeof(*((void * *)ptr)) *__p asm("r0") = ((void * *)ptr); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } cookie = (typeof(*((void * *)ptr))) __r2; __e; }))
    return -14;

   ptr += sizeof(void *);
   for (w = ({ const typeof( ((typeof(*w) *)0)->entry ) *__mptr = ((&proc->delivered_death)->next); (typeof(*w) *)( (char *)__mptr - __builtin_offsetof(typeof(*w),entry) );}); prefetch(w->entry.next), &w->entry != (&proc->delivered_death); w = ({ const typeof( ((typeof(*w) *)0)->entry ) *__mptr = (w->entry.next); (typeof(*w) *)( (char *)__mptr - __builtin_offsetof(typeof(*w),entry) );})) {
    struct binder_ref_death *tmp_death = ({ const typeof( ((struct binder_ref_death *)0)->work ) *__mptr = (w); (struct binder_ref_death *)( (char *)__mptr - __builtin_offsetof(struct binder_ref_death,work) );});
    if (tmp_death->cookie == cookie) {
     death = tmp_death;
     break;
    }
   }
   do { if (binder_debug_mask & BINDER_DEBUG_DEAD_BINDER) printk("<6>" "binder: %d:%d BC_DEAD_BINDER_DONE %p found %p\n", proc->pid, thread->pid, cookie, death); } while (0);


   if (death == ((void *)0)) {
    do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d BC_DEAD" "_BINDER_DONE %p not found\n", proc->pid, thread->pid, cookie); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);
  ...
  default:
   printk("<3>" "binder: %d:%d unknown command %d\n",
...
void binder_stat_br(struct binder_proc *proc, struct binder_thread *thread,
      uint32_t cmd)
{
 if ((((cmd) >> 0) & ((1 << 8)-1)) < (sizeof(binder_stats.br) / sizeof((binder_stats.br)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(binder_stats.br), typeof(&binder_stats.br[0]))); })))) {
  binder_stats.br[(((cmd) >> 0) & ((1 << 8)-1))]++;
  proc->stats.br[(((cmd) >> 0) & ((1 << 8)-1))]++;
  thread->stats.br[(((cmd) >> 0) & ((1 << 8)-1))]++;
 }
}
...
retry:
 ...
 if (thread->return_error != BR_OK && ptr < end) {
  if (thread->return_error2 != BR_OK) {
   if (({ register const typeof(*((uint32_t *)ptr)) __r2 asm("r2") = (thread->return_error2); register const typeof(*((uint32_t *)ptr)) *__p asm("r0") = ((uint32_t *)ptr); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; }))
    return -14;
   ptr += sizeof(uint32_t);
   if (ptr == end)
    goto done;
  ...
  if (({ register const typeof(*((uint32_t *)ptr)) __r2 asm("r2") = (thread->return_error); register const typeof(*((uint32_t *)ptr)) *__p asm("r0") = ((uint32_t *)ptr); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; }))
   return -14;
  ptr += sizeof(uint32_t);
 ...
 if (wait_for_proc_work) {
  if (!(thread->looper & (BINDER_LOOPER_STATE_REGISTERED |
   ...
   do { if (binder_debug_mask & BINDER_DEBUG_USER_ERROR) printk("<6>" "binder: %d:%d ERROR: Thread waiting " "for process work before calling BC_REGISTER_" "LOOPER or BC_ENTER_LOOPER (state %x)\n", proc->pid, thread->pid, thread->looper); if (binder_stop_on_user_error) binder_stop_on_user_error = 2; } while (0);



   ({ int __ret = 0; if (!(binder_stop_on_user_error < 2)) do { wait_queue_t __wait = { .private = (get_current()), .func = autoremove_wake_function, .task_list = { &((__wait).task_list), &((__wait).task_list) }, }; for (;;) { prepare_to_wait(&binder_user_error_wait, &__wait, 1); if (binder_stop_on_user_error < 2) break; if (!signal_pending((get_current()))) { schedule(); continue; } __ret = -512; break; } finish_wait(&binder_user_error_wait, &__wait); } while (0); __ret; });
  ...
  if (non_block) {
   ...
   ret = ({ int __ret = 0; if (!(binder_has_proc_work(proc, thread))) do { wait_queue_t __wait = { .private = (get_current()), .func = autoremove_wake_function, .task_list = { &((__wait).task_list), &((__wait).task_list) }, }; for (;;) { prepare_to_wait_exclusive(&proc->wait, &__wait, 1); if (binder_has_proc_work(proc, thread)) { finish_wait(&proc->wait, &__wait); break; } if (!signal_pending((get_current()))) { schedule(); continue; } __ret = -512; abort_exclusive_wait(&proc->wait, &__wait, 1, ((void *)0)); break; } } while (0); __ret; });
 } else {
  if (non_block) {
   if (!binder_has_thread_work(thread))
    ret = -11;
  } else
   ret = ({ int __ret = 0; if (!(binder_has_thread_work(thread))) do { wait_queue_t __wait = { .private = (get_current()), .func = autoremove_wake_function, .task_list = { &((__wait).task_list), &((__wait).task_list) }, }; for (;;) { prepare_to_wait(&thread->wait, &__wait, 1); if (binder_has_thread_work(thread)) break; if (!signal_pending((get_current()))) { schedule(); continue; } __ret = -512; break; } finish_wait(&thread->wait, &__wait); } while (0); __ret; });
 }
 ...
 while (1) {
  ...
  struct binder_transaction_data tr;
  struct binder_work *w;
  struct binder_transaction *t = ((void *)0);

  if (!list_empty(&thread->todo))
   w = ({ const typeof( ((struct binder_work *)0)->entry ) *__mptr = ((&thread->todo)->next); (struct binder_work *)( (char *)__mptr - __builtin_offsetof(struct binder_work,entry) );});
  else if (!list_empty(&proc->todo) && wait_for_proc_work)
   w = ({ const typeof( ((struct binder_work *)0)->entry ) *__mptr = ((&proc->todo)->next); (struct binder_work *)( (char *)__mptr - __builtin_offsetof(struct binder_work,entry) );});
  else {
  ...
  case BINDER_WORK_TRANSACTION: {
   t = ({ const typeof( ((struct binder_transaction *)0)->work ) *__mptr = (w); (struct binder_transaction *)( (char *)__mptr - __builtin_offsetof(struct binder_transaction,work) );});
  } break;
  case BINDER_WORK_TRANSACTION_COMPLETE: {
   cmd = BR_TRANSACTION_COMPLETE;
   if (({ register const typeof(*((uint32_t *)ptr)) __r2 asm("r2") = (cmd); register const typeof(*((uint32_t *)ptr)) *__p asm("r0") = ((uint32_t *)ptr); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; }))
    return -14;
   ptr += sizeof(uint32_t);

   binder_stat_br(proc, thread, cmd);
   do { if (binder_debug_mask & BINDER_DEBUG_TRANSACTION_COMPLETE) printk("<6>" "binder: %d:%d BR_TRANSACTION_COMPLETE\n", proc->pid, thread->pid); } while (0);
  ...
  case BINDER_WORK_NODE: {
   struct binder_node *node = ({ const typeof( ((struct binder_node *)0)->work ) *__mptr = (w); (struct binder_node *)( (char *)__mptr - __builtin_offsetof(struct binder_node,work) );});
   ...
   if (cmd != BR_NOOP) {
    if (({ register const typeof(*((uint32_t *)ptr)) __r2 asm("r2") = (cmd); register const typeof(*((uint32_t *)ptr)) *__p asm("r0") = ((uint32_t *)ptr); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; }))
     return -14;
    ptr += sizeof(uint32_t);
    if (({ register const typeof(*((void * *)ptr)) __r2 asm("r2") = (node->ptr); register const typeof(*((void * *)ptr)) *__p asm("r0") = ((void * *)ptr); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; }))
     return -14;
    ptr += sizeof(void *);
    if (({ register const typeof(*((void * *)ptr)) __r2 asm("r2") = (node->cookie); register const typeof(*((void * *)ptr)) *__p asm("r0") = ((void * *)ptr); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; }))
     return -14;
    ptr += sizeof(void *);

    binder_stat_br(proc, thread, cmd);
    do { if (binder_debug_mask & BINDER_DEBUG_USER_REFS) printk("<6>" "binder: %d:%d %s %d u%p c%p\n", proc->pid, thread->pid, cmd_name, node->debug_id, node->ptr, node->cookie); } while (0);


   } else {
    list_del_init(&w->entry);
    if (!weak && !strong) {
     do { if (binder_debug_mask & BINDER_DEBUG_INTERNAL_REFS) printk("<6>" "binder: %d:%d node %d u%p c%p deleted\n", proc->pid, thread->pid, node->debug_id, node->ptr, node->cookie); } while (0);
     ...
     do { if (binder_debug_mask & BINDER_DEBUG_INTERNAL_REFS) printk("<6>" "binder: %d:%d node %d u%p c%p state unchanged\n", proc->pid, thread->pid, node->debug_id, node->ptr, node->cookie); } while (0);
  ...
  case BINDER_WORK_CLEAR_DEATH_NOTIFICATION: {
   ...
   death = ({ const typeof( ((struct binder_ref_death *)0)->work ) *__mptr = (w); (struct binder_ref_death *)( (char *)__mptr - __builtin_offsetof(struct binder_ref_death,work) );});
   ...
   if (({ register const typeof(*((uint32_t *)ptr)) __r2 asm("r2") = (cmd); register const typeof(*((uint32_t *)ptr)) *__p asm("r0") = ((uint32_t *)ptr); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; }))
    return -14;
   ptr += sizeof(uint32_t);
   if (({ register const typeof(*((void * *)ptr)) __r2 asm("r2") = (death->cookie); register const typeof(*((void * *)ptr)) *__p asm("r0") = ((void * *)ptr); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; }))
    return -14;
   ptr += sizeof(void *);
   do { if (binder_debug_mask & BINDER_DEBUG_DEATH_NOTIFICATION) printk("<6>" "binder: %d:%d %s %p\n", proc->pid, thread->pid, cmd == BR_DEAD_BINDER ? "BR_DEAD_BINDER" : "BR_CLEAR_DEATH_NOTIFICATION_DONE", death->cookie); } while (0);
  ...
  do { if (__builtin_expect(!!(t->buffer == ((void *)0)), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  if (t->buffer->target_node) {
   struct binder_node *target_node = t->buffer->target_node;
   tr.target.ptr = target_node->ptr;
   tr.cookie = target_node->cookie;
   t->saved_priority = task_nice((get_current()));
  ...
  tr.data.ptr.offsets = tr.data.ptr.buffer +
     ((((t->buffer->data_size)) + ((typeof((t->buffer->data_size)))((sizeof(void *))) - 1)) & ~((typeof((t->buffer->data_size)))((sizeof(void *))) - 1));
  ...
  binder_stat_br(proc, thread, cmd);
  do { if (binder_debug_mask & BINDER_DEBUG_TRANSACTION) printk("<6>" "binder: %d:%d %s %d %d:%d, cmd %d" "size %zd-%zd ptr %p-%p\n", proc->pid, thread->pid, (cmd == BR_TRANSACTION) ? "BR_TRANSACTION" : "BR_REPLY", t->debug_id, t->from ? t->from->proc->pid : 0, t->from ? t->from->pid : 0, cmd, t->buffer->data_size, t->buffer->offsets_size, tr.data.ptr.buffer, tr.data.ptr.offsets); } while (0);
# 2461 "../../drivers/staging/android/binder.c"
 ...
 *consumed = ptr - buffer;
 if (proc->requested_threads + proc->ready_threads == 0 &&
  ...
  proc->requested_threads++;
  do { if (binder_debug_mask & BINDER_DEBUG_THREADS) printk("<6>" "binder: %d:%d BR_SPAWN_LOOPER\n", proc->pid, thread->pid); } while (0);


  if (({ register const typeof(*((uint32_t *)buffer)) __r2 asm("r2") = (BR_SPAWN_LOOPER); register const typeof(*((uint32_t *)buffer)) *__p asm("r0") = ((uint32_t *)buffer); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; }))
   return -14;
 }
 return 0;
}
...
static void binder_release_work(struct list_head *list)
{
 ...
 while (!list_empty(list)) {
  w = ({ const typeof( ((struct binder_work *)0)->entry ) *__mptr = ((list)->next); (struct binder_work *)( (char *)__mptr - __builtin_offsetof(struct binder_work,entry) );});
  list_del_init(&w->entry);
  switch (w->type) {
  case BINDER_WORK_TRANSACTION: {
   struct binder_transaction *t;
...
static struct binder_thread *binder_get_thread(struct binder_proc *proc)
{
 ...
 while (*p) {
  parent = *p;
  thread = ({ const typeof( ((struct binder_thread *)0)->rb_node ) *__mptr = (parent); (struct binder_thread *)( (char *)__mptr - __builtin_offsetof(struct binder_thread,rb_node) );});

  if ((get_current())->pid < thread->pid)
   p = &(*p)->rb_left;
  else if ((get_current())->pid > thread->pid)
   p = &(*p)->rb_right;
  else
   break;
 }
 if (*p == ((void *)0)) {
  thread = kzalloc(sizeof(*thread), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
  if (thread == ((void *)0))
   return ((void *)0);
  binder_stats_created(BINDER_STAT_THREAD);
  thread->proc = proc;
  thread->pid = (get_current())->pid;
  do { static struct lock_class_key __key; __init_waitqueue_head((&thread->wait), &__key); } while (0);
         ...
         struct binder_thread *thread)
{
 ...
 while (t) {
  active_transactions++;
  do { if (binder_debug_mask & BINDER_DEBUG_DEAD_TRANSACTION) printk("<6>" "binder: release %d:%d transaction %d " "%s, still active\n", proc->pid, thread->pid, t->debug_id, (t->to_thread == thread) ? "in" : "out"); } while (0);
...
static long binder_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
 ...
 struct binder_proc *proc = filp->private_data;
 struct binder_thread *thread;
 unsigned int size = (((cmd) >> ((0 +8)+8)) & ((1 << 14)-1));
 void *ubuf = (void *)arg;



 ret = ({ int __ret = 0; if (!(binder_stop_on_user_error < 2)) do { wait_queue_t __wait = { .private = (get_current()), .func = autoremove_wake_function, .task_list = { &((__wait).task_list), &((__wait).task_list) }, }; for (;;) { prepare_to_wait(&binder_user_error_wait, &__wait, 1); if (binder_stop_on_user_error < 2) break; if (!signal_pending((get_current()))) { schedule(); continue; } __ret = -512; break; } finish_wait(&binder_user_error_wait, &__wait); } while (0); __ret; });
 if (ret)
  return ret;
 ...
 switch (cmd) {
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('b')) << (0 +8)) | (((1)) << 0) | (((((sizeof(struct binder_write_read) == sizeof(struct binder_write_read[1]) && sizeof(struct binder_write_read) < (1 << 14)) ? sizeof(struct binder_write_read) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))): {
  ...
  do { if (binder_debug_mask & BINDER_DEBUG_READ_WRITE) printk("<6>" "binder: %d:%d write %ld at %08lx, read %ld at %08lx\n", proc->pid, thread->pid, bwr.write_size, bwr.write_buffer, bwr.read_size, bwr.read_buffer); } while (0);




  if (bwr.write_size > 0) {
   ret = binder_thread_write(proc, thread, (void *)bwr.write_buffer, bwr.write_size, &bwr.write_consumed);
   if (ret < 0) {
    bwr.read_consumed = 0;
  ...
  if (bwr.read_size > 0) {
   ret = binder_thread_read(proc, thread, (void *)bwr.read_buffer, bwr.read_size, &bwr.read_consumed, filp->f_flags & 00004000);
  ...
  do { if (binder_debug_mask & BINDER_DEBUG_READ_WRITE) printk("<6>" "binder: %d:%d wrote %ld of %ld, read return %ld of %ld\n", proc->pid, thread->pid, bwr.write_consumed, bwr.write_size, bwr.read_consumed, bwr.read_size); } while (0);
 ...
 case (((1U) << (((0 +8)+8)+14)) | ((('b')) << (0 +8)) | (((5)) << 0) | (((((sizeof(size_t) == sizeof(size_t[1]) && sizeof(size_t) < (1 << 14)) ? sizeof(size_t) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
  if (copy_from_user(&proc->max_threads, ubuf, sizeof(proc->max_threads))) {
   ret = -22;
   goto err;
  }
  break;
 case (((1U) << (((0 +8)+8)+14)) | ((('b')) << (0 +8)) | (((7)) << 0) | (((((sizeof(int) == sizeof(int[1]) && sizeof(int) < (1 << 14)) ? sizeof(int) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
  if (binder_context_mgr_node != ((void *)0)) {
   printk("<3>" "binder: BINDER_SET_CONTEXT_MGR already set\n");
   ret = -16;
   goto err;
  }
  if (binder_context_mgr_uid != -1) {
   if (binder_context_mgr_uid != (get_current())->cred->euid) {
    printk("<3>" "binder: BINDER_SET_"
           "CONTEXT_MGR bad uid %d != %d\n",
           (get_current())->cred->euid,
           binder_context_mgr_uid);
    ret = -1;
    goto err;
   }
  } else
   binder_context_mgr_uid = (get_current())->cred->euid;
  binder_context_mgr_node = binder_new_node(proc, ((void *)0), ((void *)0));
  if (binder_context_mgr_node == ((void *)0)) {
   ret = -12;
   goto err;
  }
  ...
  break;
 case (((1U) << (((0 +8)+8)+14)) | ((('b')) << (0 +8)) | (((8)) << 0) | (((((sizeof(int) == sizeof(int[1]) && sizeof(int) < (1 << 14)) ? sizeof(int) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
  do { if (binder_debug_mask & BINDER_DEBUG_THREADS) printk("<6>" "binder: %d:%d exit\n", proc->pid, thread->pid); } while (0);

  binder_free_thread(proc, thread);
  thread = ((void *)0);
  break;
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('b')) << (0 +8)) | (((9)) << 0) | (((((sizeof(struct binder_version) == sizeof(struct binder_version[1]) && sizeof(struct binder_version) < (1 << 14)) ? sizeof(struct binder_version) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
  if (size != sizeof(struct binder_version)) {
   ret = -22;
   goto err;
  }
  if (({ register const typeof(*(&((struct binder_version *)ubuf)->protocol_version)) __r2 asm("r2") = (7); register const typeof(*(&((struct binder_version *)ubuf)->protocol_version)) *__p asm("r0") = (&((struct binder_version *)ubuf)->protocol_version); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; })) {
   ret = -22;
   goto err;
  }
  break;
...
err:
 ...
 ({ int __ret = 0; if (!(binder_stop_on_user_error < 2)) do { wait_queue_t __wait = { .private = (get_current()), .func = autoremove_wake_function, .task_list = { &((__wait).task_list), &((__wait).task_list) }, }; for (;;) { prepare_to_wait(&binder_user_error_wait, &__wait, 1); if (binder_stop_on_user_error < 2) break; if (!signal_pending((get_current()))) { schedule(); continue; } __ret = -512; break; } finish_wait(&binder_user_error_wait, &__wait); } while (0); __ret; });
 if (ret && ret != -512)
  printk("<6>" "binder: %d:%d ioctl %x %lx returned %d\n", proc->pid, (get_current())->pid, cmd, arg, ret);
 return ret;
}
...
static void binder_vma_open(struct vm_area_struct *vma)
{
 ...
 do { if (binder_debug_mask & BINDER_DEBUG_OPEN_CLOSE) printk("<6>" "binder: %d open vm area %lx-%lx (%ld K) vma %lx pagep %lx\n", proc->pid, vma->vm_start, vma->vm_end, (vma->vm_end - vma->vm_start) / 0x00000400, vma->vm_flags, (unsigned long)(vma->vm_page_prot)); } while (0);
...
{
 struct binder_proc *proc = vma->vm_private_data;
 do { if (binder_debug_mask & BINDER_DEBUG_OPEN_CLOSE) printk("<6>" "binder: %d close vm area %lx-%lx (%ld K) vma %lx pagep %lx\n", proc->pid, vma->vm_start, vma->vm_end, (vma->vm_end - vma->vm_start) / 0x00000400, vma->vm_flags, (unsigned long)(vma->vm_page_prot)); } while (0);
...
static int binder_mmap(struct file *filp, struct vm_area_struct *vma)
{
 ...
 if ((vma->vm_end - vma->vm_start) > 0x00400000)
  vma->vm_end = vma->vm_start + 0x00400000;

 do { if (binder_debug_mask & BINDER_DEBUG_OPEN_CLOSE) printk("<6>" "binder_mmap: %d %lx-%lx (%ld K) vma %lx pagep %lx\n", proc->pid, vma->vm_start, vma->vm_end, (vma->vm_end - vma->vm_start) / 0x00000400, vma->vm_flags, (unsigned long)(vma->vm_page_prot)); } while (0);
 ...
 vma->vm_flags = (vma->vm_flags | 0x00020000) & ~0x00000020;
 ...
 area = get_vm_area(vma->vm_end - vma->vm_start, 0x00000001);
 if (area == ((void *)0)) {
  ret = -12;
 ...
 if (cacheid_is((1 << 2))) {
  while ((((vma->vm_start ^ (uint32_t)proc->buffer) & ((4 * ((1UL) << 12)) - 1)) >> 12)) {
   printk("<6>" "binder_mmap: %d %lx-%lx maps %p bad alignment\n", proc->pid, vma->vm_start, vma->vm_end, proc->buffer);
   vma->vm_start += ((1UL) << 12);
  }
 }

 proc->pages = kzalloc(sizeof(proc->pages[0]) * ((vma->vm_end - vma->vm_start) / ((1UL) << 12)), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (proc->pages == ((void *)0)) {
  ret = -12;
 ...
 if (binder_update_page_range(proc, 1, proc->buffer, proc->buffer + ((1UL) << 12), vma)) {
  ret = -12;
 ...
 __asm__ __volatile__("": : :"memory");
 proc->files = get_files_struct((get_current()));
 proc->vma = vma;
...
err_already_mapped:
err_bad_arg:
 printk("<3>" "binder_mmap: %d %lx-%lx %s failed %d\n",
...
static int binder_open(struct inode *nodp, struct file *filp)
{
 ...
 do { if (binder_debug_mask & BINDER_DEBUG_OPEN_CLOSE) printk("<6>" "binder_open: %d:%d\n", (get_current())->group_leader->pid, (get_current())->pid); } while (0);


 proc = kzalloc(sizeof(*proc), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (proc == ((void *)0))
  return -12;
 do { atomic_add(1, &((get_current()))->usage); } while(0);
 proc->tsk = (get_current());
 INIT_LIST_HEAD(&proc->todo);
 do { static struct lock_class_key __key; __init_waitqueue_head((&proc->wait), &__key); } while (0);
 proc->default_priority = task_nice((get_current()));
 mutex_lock(&binder_lock);
 binder_stats_created(BINDER_STAT_PROC);
 hlist_add_head(&proc->proc_node, &binder_procs);
 proc->pid = (get_current())->group_leader->pid;
 ...
 if (binder_debugfs_dir_entry_proc) {
  ...
  proc->debugfs_entry = debugfs_create_file(strbuf, (00400|00040|00004),
...
static void binder_deferred_flush(struct binder_proc *proc)
{
 struct rb_node *n;
 int wake_count = 0;
 for (n = rb_first(&proc->threads); n != ((void *)0); n = rb_next(n)) {
  struct binder_thread *thread = ({ const typeof( ((struct binder_thread *)0)->rb_node ) *__mptr = (n); (struct binder_thread *)( (char *)__mptr - __builtin_offsetof(struct binder_thread,rb_node) );});
  thread->looper |= BINDER_LOOPER_STATE_NEED_RETURN;
  if (thread->looper & BINDER_LOOPER_STATE_WAITING) {
   __wake_up(&thread->wait, 1, 1, ((void *)0));
   wake_count++;
  }
 }
 __wake_up(&proc->wait, 1, 0, ((void *)0));

 do { if (binder_debug_mask & BINDER_DEBUG_OPEN_CLOSE) printk("<6>" "binder_flush: %d woke %d threads\n", proc->pid, wake_count); } while (0);
...
static void binder_deferred_release(struct binder_proc *proc)
{
 ...
 do { if (__builtin_expect(!!(proc->vma), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 do { if (__builtin_expect(!!(proc->files), 0)) do { *(int *)0 = 0; } while (1); } while(0);

 hlist_del(&proc->proc_node);
 if (binder_context_mgr_node && binder_context_mgr_node->proc == proc) {
  do { if (binder_debug_mask & BINDER_DEBUG_DEAD_BINDER) printk("<6>" "binder_release: %d context_mgr_node gone\n", proc->pid); } while (0);


  binder_context_mgr_node = ((void *)0);
 }
 ...
 while ((n = rb_first(&proc->nodes))) {
  struct binder_node *node = ({ const typeof( ((struct binder_node *)0)->rb_node ) *__mptr = (n); (struct binder_node *)( (char *)__mptr - __builtin_offsetof(struct binder_node,rb_node) );});
  ...
  if (hlist_empty(&node->refs)) {
   ...
   for (pos = (&node->refs)->first; pos && ({ prefetch(pos->next); 1;}) && ({ ref = ({ const typeof( ((typeof(*ref) *)0)->node_entry ) *__mptr = (pos); (typeof(*ref) *)( (char *)__mptr - __builtin_offsetof(typeof(*ref),node_entry) );}); 1;}); pos = pos->next) {
    incoming_refs++;
    if (ref->death) {
     death++;
     if (list_empty(&ref->death->work.entry)) {
      ...
      __wake_up(&ref->proc->wait, 1, 1, ((void *)0));
     } else
      do { *(int *)0 = 0; } while (1);
    }
   }
   do { if (binder_debug_mask & BINDER_DEBUG_DEAD_BINDER) printk("<6>" "binder: node %d now dead, " "refs %d, death %d\n", node->debug_id, incoming_refs, death); } while (0);
 ...
 while ((n = rb_first(&proc->refs_by_desc))) {
  struct binder_ref *ref = ({ const typeof( ((struct binder_ref *)0)->rb_node_desc ) *__mptr = (n); (struct binder_ref *)( (char *)__mptr - __builtin_offsetof(struct binder_ref,rb_node_desc) );});
 ...
 while ((n = rb_first(&proc->allocated_buffers))) {
  struct binder_buffer *buffer = ({ const typeof( ((struct binder_buffer *)0)->rb_node ) *__mptr = (n); (struct binder_buffer *)( (char *)__mptr - __builtin_offsetof(struct binder_buffer,rb_node) );});

  t = buffer->transaction;
  if (t) {
   t->buffer = ((void *)0);
   buffer->transaction = ((void *)0);
   printk("<3>" "binder: release proc %d, "
 ...
 if (proc->pages) {
  int i;
  for (i = 0; i < proc->buffer_size / ((1UL) << 12); i++) {
   if (proc->pages[i]) {
    void *page_addr = proc->buffer + i * ((1UL) << 12);
    do { if (binder_debug_mask & BINDER_DEBUG_BUFFER_ALLOC) printk("<6>" "binder_release: %d: " "page %d at %p not freed\n", proc->pid, i, page_addr); } while (0);
 ...
 do { if (binder_debug_mask & BINDER_DEBUG_OPEN_CLOSE) printk("<6>" "binder_release: %d threads %d, nodes %d (ref %d), " "refs %d, active transactions %d, buffers %d, " "pages %d\n", proc->pid, threads, nodes, incoming_refs, outgoing_refs, active_transactions, buffers, page_count); } while (0);
...
static void binder_deferred_func(struct work_struct *work)
{
 ...
 do {
  ...
  if (!hlist_empty(&binder_deferred_list)) {
   proc = ({ const typeof( ((struct binder_proc *)0)->deferred_work_node ) *__mptr = (binder_deferred_list.first); (struct binder_proc *)( (char *)__mptr - __builtin_offsetof(struct binder_proc,deferred_work_node) );});
...
static struct work_struct binder_deferred_work = { .data = { (2) }, .entry = { &(binder_deferred_work).entry, &(binder_deferred_work).entry }, .func = (binder_deferred_func), };
         ...
         struct binder_work *w)
{
 ...
 case BINDER_WORK_TRANSACTION_COMPLETE:
  ...
  break;
 case BINDER_WORK_NODE:
  node = ({ const typeof( ((struct binder_node *)0)->work ) *__mptr = (w); (struct binder_node *)( (char *)__mptr - __builtin_offsetof(struct binder_node,work) );});
    ...
    int print_always)
{
 ...
 for (w = ({ const typeof( ((typeof(*w) *)0)->entry ) *__mptr = ((&thread->todo)->next); (typeof(*w) *)( (char *)__mptr - __builtin_offsetof(typeof(*w),entry) );}); prefetch(w->entry.next), &w->entry != (&thread->todo); w = ({ const typeof( ((typeof(*w) *)0)->entry ) *__mptr = (w->entry.next); (typeof(*w) *)( (char *)__mptr - __builtin_offsetof(typeof(*w),entry) );})) {
...
static void print_binder_node(struct seq_file *m, struct binder_node *node)
{
 ...
 seq_puts(m, "\n");
 for (w = ({ const typeof( ((typeof(*w) *)0)->entry ) *__mptr = ((&node->async_todo)->next); (typeof(*w) *)( (char *)__mptr - __builtin_offsetof(typeof(*w),entry) );}); prefetch(w->entry.next), &w->entry != (&node->async_todo); w = ({ const typeof( ((typeof(*w) *)0)->entry ) *__mptr = (w->entry.next); (typeof(*w) *)( (char *)__mptr - __builtin_offsetof(typeof(*w),entry) );}))
  print_binder_work(m, "    ",
         ...
         struct binder_proc *proc, int print_all)
{
 ...
 for (n = rb_first(&proc->threads); n != ((void *)0); n = rb_next(n))
  print_binder_thread(m, ({ const typeof( ((struct binder_thread *)0)->rb_node ) *__mptr = (n); (struct binder_thread *)( (char *)__mptr - __builtin_offsetof(struct binder_thread,rb_node) );}), print_all);

 for (n = rb_first(&proc->nodes); n != ((void *)0); n = rb_next(n)) {
  struct binder_node *node = ({ const typeof( ((struct binder_node *)0)->rb_node ) *__mptr = (n); (struct binder_node *)( (char *)__mptr - __builtin_offsetof(struct binder_node,rb_node) );});
 ...
 if (print_all) {
  for (n = rb_first(&proc->refs_by_desc);
       n != ((void *)0);
       n = rb_next(n))
   print_binder_ref(m, ({ const typeof( ((struct binder_ref *)0)->rb_node_desc ) *__mptr = (n); (struct binder_ref *)( (char *)__mptr - __builtin_offsetof(struct binder_ref,rb_node_desc) );}));

 }
 for (n = rb_first(&proc->allocated_buffers); n != ((void *)0); n = rb_next(n))
  print_binder_buffer(m, "  buffer",
        ({ const typeof( ((struct binder_buffer *)0)->rb_node ) *__mptr = (n); (struct binder_buffer *)( (char *)__mptr - __builtin_offsetof(struct binder_buffer,rb_node) );}));
 for (w = ({ const typeof( ((typeof(*w) *)0)->entry ) *__mptr = ((&proc->todo)->next); (typeof(*w) *)( (char *)__mptr - __builtin_offsetof(typeof(*w),entry) );}); prefetch(w->entry.next), &w->entry != (&proc->todo); w = ({ const typeof( ((typeof(*w) *)0)->entry ) *__mptr = (w->entry.next); (typeof(*w) *)( (char *)__mptr - __builtin_offsetof(typeof(*w),entry) );}))
  print_binder_work(m, "  ", "  pending transaction", w);
 for (w = ({ const typeof( ((typeof(*w) *)0)->entry ) *__mptr = ((&proc->delivered_death)->next); (typeof(*w) *)( (char *)__mptr - __builtin_offsetof(typeof(*w),entry) );}); prefetch(w->entry.next), &w->entry != (&proc->delivered_death); w = ({ const typeof( ((typeof(*w) *)0)->entry ) *__mptr = (w->entry.next); (typeof(*w) *)( (char *)__mptr - __builtin_offsetof(typeof(*w),entry) );})) {
          ...
          struct binder_stats *stats)
{
 ...
 ((void)(sizeof(struct { int:-!!((sizeof(stats->bc) / sizeof((stats->bc)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(stats->bc), typeof(&stats->bc[0]))); }))) != (sizeof(binder_command_strings) / sizeof((binder_command_strings)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(binder_command_strings), typeof(&binder_command_strings[0]))); })))); })));

 for (i = 0; i < (sizeof(stats->bc) / sizeof((stats->bc)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(stats->bc), typeof(&stats->bc[0]))); }))); i++) {
  if (stats->bc[i])
   seq_printf(m, "%s%s: %d\n", prefix,
       binder_command_strings[i], stats->bc[i]);
 }

 ((void)(sizeof(struct { int:-!!((sizeof(stats->br) / sizeof((stats->br)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(stats->br), typeof(&stats->br[0]))); }))) != (sizeof(binder_return_strings) / sizeof((binder_return_strings)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(binder_return_strings), typeof(&binder_return_strings[0]))); })))); })));

 for (i = 0; i < (sizeof(stats->br) / sizeof((stats->br)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(stats->br), typeof(&stats->br[0]))); }))); i++) {
  if (stats->br[i])
   seq_printf(m, "%s%s: %d\n", prefix,
       binder_return_strings[i], stats->br[i]);
 }

 ((void)(sizeof(struct { int:-!!((sizeof(stats->obj_created) / sizeof((stats->obj_created)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(stats->obj_created), typeof(&stats->obj_created[0]))); }))) != (sizeof(binder_objstat_strings) / sizeof((binder_objstat_strings)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(binder_objstat_strings), typeof(&binder_objstat_strings[0]))); })))); })));

 ((void)(sizeof(struct { int:-!!((sizeof(stats->obj_created) / sizeof((stats->obj_created)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(stats->obj_created), typeof(&stats->obj_created[0]))); }))) != (sizeof(stats->obj_deleted) / sizeof((stats->obj_deleted)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(stats->obj_deleted), typeof(&stats->obj_deleted[0]))); })))); })));

 for (i = 0; i < (sizeof(stats->obj_created) / sizeof((stats->obj_created)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(stats->obj_created), typeof(&stats->obj_created[0]))); }))); i++) {
...
static int binder_state_show(struct seq_file *m, void *unused)
{
 ...
 for (pos = (&binder_dead_nodes)->first; pos && ({ prefetch(pos->next); 1;}) && ({ node = ({ const typeof( ((typeof(*node) *)0)->dead_node ) *__mptr = (pos); (typeof(*node) *)( (char *)__mptr - __builtin_offsetof(typeof(*node),dead_node) );}); 1;}); pos = pos->next)
  print_binder_node(m, node);

 for (pos = (&binder_procs)->first; pos && ({ prefetch(pos->next); 1;}) && ({ proc = ({ const typeof( ((typeof(*proc) *)0)->proc_node ) *__mptr = (pos); (typeof(*proc) *)( (char *)__mptr - __builtin_offsetof(typeof(*proc),proc_node) );}); 1;}); pos = pos->next)
...
static int binder_transaction_log_show(struct seq_file *m, void *unused)
{
 ...
 if (log->full) {
  for (i = log->next; i < (sizeof(log->entry) / sizeof((log->entry)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(log->entry), typeof(&log->entry[0]))); }))); i++)
...
static int binder_state_open(struct inode *inode, struct file *file) { return single_open(file, binder_state_show, inode->i_private); } static const struct file_operations binder_state_fops = { .owner = ((struct module *)0), .open = binder_state_open, .read = seq_read, .llseek = seq_lseek, .release = single_release, };
static int binder_stats_open(struct inode *inode, struct file *file) { return single_open(file, binder_stats_show, inode->i_private); } static const struct file_operations binder_stats_fops = { .owner = ((struct module *)0), .open = binder_stats_open, .read = seq_read, .llseek = seq_lseek, .release = single_release, };
static int binder_transactions_open(struct inode *inode, struct file *file) { return single_open(file, binder_transactions_show, inode->i_private); } static const struct file_operations binder_transactions_fops = { .owner = ((struct module *)0), .open = binder_transactions_open, .read = seq_read, .llseek = seq_lseek, .release = single_release, };
static int binder_transaction_log_open(struct inode *inode, struct file *file) { return single_open(file, binder_transaction_log_show, inode->i_private); } static const struct file_operations binder_transaction_log_fops = { .owner = ((struct module *)0), .open = binder_transaction_log_open, .read = seq_read, .llseek = seq_lseek, .release = single_release, };

static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) binder_init(void)
{
 int ret;

 binder_deferred_workqueue = __create_workqueue_key((("binder")), (1), (0), (0), ((void *)0), ((void *)0));
 if (!binder_deferred_workqueue)
  return -12;

 binder_debugfs_dir_entry_root = debugfs_create_dir("binder", ((void *)0));
...
static initcall_t __initcall_binder_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = binder_init;
