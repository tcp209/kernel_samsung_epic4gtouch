...
static int ext4_release_file(struct inode *inode, struct file *filp)
{
 ...
 if ((filp->f_mode & (( fmode_t)0x2)) &&
   ((*(volatile int *)&(&inode->i_writecount)->counter) == 1) &&
 ...
 if ((((EXT4_SB(inode->i_sb)->s_es->s_feature_compat & (( __le32)(__u32)(0x0020))) != 0) && ext4_test_inode_flag((inode), EXT4_INODE_INDEX)) && filp->private_data)
...
static int ext4_file_open(struct inode * inode, struct file * filp)
{
 ...
 if (__builtin_expect(!!(!(sbi->s_mount_flags & 0x0001) && !(sb->s_flags & 1)), 0)) {

  sbi->s_mount_flags |= 0x0001;
  ...
  ({ void *__p = (buf); size_t __n = sizeof(buf); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
  path.mnt = mnt;
