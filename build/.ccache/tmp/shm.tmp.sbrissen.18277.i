...
# 5 "../../include/linux/hugetlb.h" 2

struct ctl_table;
struct user_struct;
# 75 "../../include/linux/hugetlb.h"
static inline __attribute__((always_inline)) int PageHuge(struct page *page)
{
 return 0;
}
...
static inline __attribute__((always_inline)) void reset_vma_resv_huge_pages(struct vm_area_struct *vma)
{
}
...
static inline __attribute__((always_inline)) void hugetlb_report_meminfo(struct seq_file *m)
{
}
# 123 "../../include/linux/hugetlb.h"
enum {
...
# 196 "../../include/linux/hugetlb.h"
static inline __attribute__((always_inline)) struct file *hugetlb_file_setup(const char *name, size_t size,
  int acctflag, struct user_struct **user, int creat_flags)
{
 return ERR_PTR(-38);
}
# 311 "../../include/linux/hugetlb.h"
struct hstate {};
# 322 "../../include/linux/hugetlb.h"
static inline __attribute__((always_inline)) unsigned int pages_per_huge_page(struct hstate *h)
{
 return 1;
}
# 27 "../../ipc/shm.c" 2
...
static inline __attribute__((always_inline)) int security_path_rmdir(struct path *dir, struct dentry *de