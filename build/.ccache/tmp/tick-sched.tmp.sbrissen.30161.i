...
# 14 "../../include/linux/clockchips.h" 2
...
# 111 "../../include/linux/clockchips.h"
static inline __attribute__((always_inline)) unsigned long div_sc(unsigned long ticks, unsigned long nsec,
       int shift)
{
 uint64_t tmp = ((uint64_t)ticks) << shift;

 ({ unsigned int __r, __b = (nsec); if (!__builtin_constant_p(__b) || __b == 0 || (7 < 4 && (__b & (__b - 1)) != 0)) { __r = ({ register unsigned int __base asm("r4") = __b; register unsigned long long __n asm("r0") = tmp; register unsigned long long __res asm("r2"); register unsigned int __rem asm("r1"); asm( ".ifnc " "%0" "," "r1" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%3" "," "r4" " ; .err ; .endif\n\t" "bl	__do_div64" : "=r" (__rem), "=r" (__res) : "r" (__n), "r" (__base) : "ip", "lr", "cc"); tmp = __res; __rem; }); } else if ((__b & (__b - 1)) == 0) { __r = tmp; __r &= (__b - 1); tmp /= __b; } else { unsigned long long __res, __x, __t, __m, __n = tmp; unsigned int __c, __p, __z = 0; __r = __n; __p = 1 << ({ unsigned int __left = (__b), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); __m = (~0ULL / __b) * __p; __m += (((~0ULL % __b + 1) * __p) + __b - 1) / __b; __x = ~0ULL / __b * __b - 1; __res = (__m & 0xffffffff) * (__x & 0xffffffff); __res >>= 32; __res += (__m & 0xffffffff) * (__x >> 32); __t = __res; __res += (__x & 0xffffffff) * (__m >> 32); __t = (__res < __t) ? (1ULL << 32) : 0; __res = (__res >> 32) + __t; __res += (__m >> 32) * (__x >> 32); __res /= __p; if (~0ULL % (__b / (__b & -__b)) == 0) { __n /= (__b & -__b); __m = ~0ULL / (__b / (__b & -__b)); __p = 1; __c = 1; } else if (__res != __x / __b) { __c = 1; __m = (~0ULL / __b) * __p; __m += ((~0ULL % __b + 1) * __p) / __b; } else { unsigned int __bits = -(__m & -__m); __bits |= __m >> 32; __bits = (~__bits) << 1; if (!__bits) { __p /= (__m & -__m); __m /= (__m & -__m); } else { __p >>= ({ unsigned int __left = (__bits), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); __m >>= ({ unsigned int __left = (__bits), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); } __c = 0; } if (!__c) { asm ( "umull	%Q0, %R0, %1, %Q2\n\t" "mov	%Q0, #0" : "=&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else if (!(__m & ((1ULL << 63) | (1ULL << 31)))) { __res = __m; asm ( "umlal	%Q0, %R0, %Q1, %Q2\n\t" "mov	%Q0, #0" : "+&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else { asm ( "umull	%Q0, %R0, %Q1, %Q2\n\t" "cmn	%Q0, %Q1\n\t" "adcs	%R0, %R0, %R1\n\t" "adc	%Q0, %3, #0" : "=&r" (__res) : "r" (__m), "r" (__n), "r" (__z) : "cc" ); } if (!(__m & ((1ULL << 63) | (1ULL << 31)))) { asm ( "umlal	%R0, %Q0, %R1, %Q2\n\t" "umlal	%R0, %Q0, %Q1, %R2\n\t" "mov	%R0, #0\n\t" "umlal	%Q0, %R0, %R1, %R2" : "+&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else { asm ( "umlal	%R0, %Q0, %R2, %Q3\n\t" "umlal	%R0, %1, %Q2, %R3\n\t" "mov	%R0, #0\n\t" "adds	%Q0, %1, %Q0\n\t" "adc	%R0, %R0, #0\n\t" "umlal	%Q0, %R0, %R2, %R3" : "+&r" (__res), "+&r" (__z) : "r" (__m), "r" (__n) : "cc" ); } __res /= __p; { unsigned int __res0 = __res; unsigned int __b0 = __b; __r -= __res0 * __b0; } tmp = __res; } __r; });
...
# 124 "../../include/linux/tick.h"
extern void tick_nohz_stop_sched_tick(int inidle);
extern void tick_nohz_restart_sched_tick(void);
extern ktime_t tick_nohz_get_sleep_length(void);
extern u64 get_cpu_idle_time_us(int cpu, u64 *last_update_time);
extern u64 get_cpu_iowait_time_us(int cpu, u64 *last_update_time);
# 23 "../../kernel/time/tick-sched.c" 2


# 1 "../../arch/arm/include/asm/irq_regs.h" 1
# 26 "../../kernel/time/tick-sched.c" 2

# 1 "../../kernel/time/tick-internal.h" 1
...
# 40 "../../kernel/time/tick-internal.h"
static inline __attribute__((always_inline)) void tick_broadcast_setup_oneshot(struct clock_event_device *bc)
{
 do { *(int *)0 = 0; } while (1);
}
static inline __attribute__((always_inline)) void tick_broadcast_oneshot_control(unsigned long reason) { }
static inline __attribute__((always_inline)) void tick_broadcast_switch_to_oneshot(void) { }
static inline __attribute__((always_inline)) void tick_shutdown_broadcast_oneshot(unsigned int *cpup) { }
static inline __attribute__((always_inline)) int tick_broadcast_oneshot_active(void) { return 0; }
static inline __attribute__((always_inline)) void tick_check_oneshot_broadcast(int cpu) { }
# 98 "../../kernel/time/tick-internal.h"
static inline __attribute__((always_inline)) int tick_check_broadcast_device(struct clock_event_device *dev)
{
 return 0;
}

static inline __attribute__((always_inline)) int tick_is_broadcast_device(struct clock_event_device *dev)
{
 return 0;
}
static inline __attribute__((always_inline)) int tick_device_uses_broadcast(struct clock_event_device *dev,
          int cpu)
{
 return 0;
}
static inline __attribute__((always_inline)) void tick_do_periodic_broadcast(struct clock_event_device *d) { }
static inline __attribute__((always_inline)) void tick_broadcast_on_off(unsigned long reason, int *oncpu) { }
static inline __attribute__((always_inline)) void tick_shutdown_broadcast(unsigned int *cpup) { }
static inline __attribute__((always_inline)) void tick_suspend_broadcast(void) { }
static inline __attribute__((always_inline)) int tick_resume_broadcast(void) { return 0; }




static inline __attribute__((always_inline)) void tick_set_periodic_handler(struct clock_event_device *dev,
          int broadcast)
{
...
static inline __attribute__((always_inline)) int tick_device_is_functional(struct clock_event_device *dev)
{
 return !(dev->features & 0x000008);
}
# 28 "../../kernel/time/tick-sched.c" 2




static __attribute__((section(".data..percpu" ""))) __typeof__(struct tick_sched) tick_cpu_sched;
...
{
 return &(*({ do { const void *__vpp_verify = (typeof((&(tick_cpu_sched))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))); (typeof((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))) (__ptr + (((__per_cpu_offset[cpu])))); }); }));
}
...
static void tick_do_update_jiffies64(ktime_t now)
{
 ...
 if (delta.tv64 >= tick_period.tv64) {
  ...
  if (__builtin_expect(!!(delta.tv64 >= tick_period.tv64), 0)) {
...
# 109 "../../kernel/time/tick-sched.c"
static int tick_nohz_enabled = 1;




static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) setup_tick_nohz(char *str)
{
 if (!strcmp(str, "off"))
  tick_nohz_enabled = 0;
...
static const char __setup_str_setup_tick_nohz[] __attribute__ ((__section__(".init.rodata"))) __attribute__((aligned(1))) = "nohz="; static struct obs_kernel_param __setup_setup_tick_nohz __attribute__((__used__)) __attribute__ ((__section__(".init.setup"))) __attribute__((aligned((sizeof(long))))) = { __setup_str_setup_tick_nohz, setup_tick_nohz, 0 };
# 137 "../../kernel/time/tick-sched.c"
static void tick_nohz_update_jiffies(ktime_t now)
{
 int cpu = (current_thread_info()->cpu);
 struct tick_sched *ts = &(*({ do { const void *__vpp_verify = (typeof((&(tick_cpu_sched))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))); (typeof((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))) (__ptr + (((__per_cpu_offset[cpu])))); }); }));
 unsigned long flags;
...
static void tick_nohz_stop_idle(int cpu, ktime_t now)
{
 ...
 update_ts_time_stats(cpu, ts, now, ((void *)0));
 ts->idle_active = 0;
...
extern typeof(get_cpu_idle_time_us) get_cpu_idle_time_us; static const char __kstrtab_get_cpu_idle_time_us[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "get_cpu_idle_time_us"; static const struct kernel_symbol __ksymtab_get_cpu_idle_time_us __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&get_cpu_idle_time_us, __kstrtab_get_cpu_idle_time_us };
# 238 "../../kernel/time/tick-sched.c"
...
extern typeof(get_cpu_iowait_time_us) get_cpu_iowait_time_us; static const char __kstrtab_get_cpu_iowait_time_us[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "get_cpu_iowait_time_us"; static const struct kernel_symbol __ksymtab_get_cpu_iowait_time_us __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&get_cpu_iowait_time_us, __kstrtab_get_cpu_iowait_time_us };
# 258 "../../kernel/time/tick-sched.c"
void tick_nohz_stop_sched_tick(int inidle)
{
 unsigned long seq, last_jiffies, next_jiffies, delta_jiffies, flags;
 struct tick_sched *ts;
 ktime_t last_update, expires, now;
 struct clock_event_device *dev = (*({ do { const void *__vpp_verify = (typeof((&(tick_cpu_device))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(tick_cpu_device))) *)(&(tick_cpu_device)))); (typeof((typeof(*(&(tick_cpu_device))) *)(&(tick_cpu_device)))) (__ptr + (((__per_cpu_offset[(current_thread_info()->cpu)])))); }); })).evtdev;
 u64 time_delta;
 int cpu;
 ...
 ts = &(*({ do { const void *__vpp_verify = (typeof((&(tick_cpu_sched))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))); (typeof((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))) (__ptr + (((__per_cpu_offset[cpu])))); }); }));
...
# 296 "../../kernel/time/tick-sched.c"
 if (__builtin_expect(!!(!test_bit(cpumask_check((cpu)), (((cpu_online_mask))->bits))), 0)) {
  if (cpu == tick_do_timer_cpu)
   tick_do_timer_cpu = -1;
 }

 if (__builtin_expect(!!(ts->nohz_mode == NOHZ_MODE_INACTIVE), 0))
  goto end;

 if (need_resched())
  goto end;

 if (__builtin_expect(!!((irq_stat[(current_thread_info()->cpu)].__softirq_pending) && test_bit(cpumask_check((cpu)), (((cpu_online_mask))->bits))), 0)) {
  static int ratelimit;

  if (ratelimit < 10) {
   printk("<3>" "NOHZ: local_softirq_pending %02x\n",
          (unsigned int) (irq_stat[(current_thread_info()->cpu)].__softirq_pending));
   ratelimit++;
  }
  goto end;
 }
...
# 359 "../../kernel/time/tick-sched.c"
  if (cpu == tick_do_timer_cpu) {
   tick_do_timer_cpu = -1;
   ts->do_timer_last = 1;
  } else if (tick_do_timer_cpu != -1) {
   time_delta = ((s64)~((u64)1 << 63));
   ts->do_timer_last = 0;
  } else if (!ts->do_timer_last) {
   time_delta = ((s64)~((u64)1 << 63));
  }
# 376 "../../kernel/time/tick-sched.c"
  if (__builtin_expect(!!(delta_jiffies < ((1UL << 30) - 1)), 1)) {
   ...
   time_delta = ({ u64 __min1 = (time_delta); u64 __min2 = (tick_period.tv64 * delta_jiffies); __min1 < __min2 ? __min1: __min2; });

  }

  if (time_delta < ((s64)~((u64)1 << 63)))
   expires = ktime_add_ns(last_update, time_delta);
  else
   expires.tv64 = ((s64)~((u64)1 << 63));
...
# 407 "../../kernel/time/tick-sched.c"
  ...
  ts->idle_expires = expires;
   ...
   if (__builtin_expect(!!(expires.tv64 == ((s64)~((u64)1 << 63))), 0)) {
...
{
 struct tick_sched *ts = &(*({ do { const void *__vpp_verify = (typeof((&(tick_cpu_sched))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))); (typeof((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))) (__ptr + (((__per_cpu_offset[(current_thread_info()->cpu)])))); }); }));
...
static void tick_nohz_handler(struct clock_event_device *dev)
{
 ...
 dev->next_event.tv64 = ((s64)~((u64)1 << 63));
# 581 "../../kernel/time/tick-sched.c"
 if (__builtin_expect(!!(tick_do_timer_cpu == -1), 0))
  tick_do_timer_cpu = cpu;


 if (tick_do_timer_cpu == cpu)
  tick_do_update_jiffies64(now);
# 596 "../../kernel/time/tick-sched.c"
 if (ts->tick_stopped) {
  touch_softlockup_watchdog();
  ts->idle_jiffies++;
 }

 update_process_times((((regs)->uregs[16] & 0xf) == 0));
 profile_tick(1);
...
static void tick_nohz_switch_to_nohz(void)
{
 ...
 hrtimer_init(&ts->sched_timer, 1, HRTIMER_MODE_ABS);
 ...
 printk("<6>" "Switched to NOHz mode on CPU #%d\n",
        (current_thread_info()->cpu));
}
# 660 "../../kernel/time/tick-sched.c"
static void tick_nohz_kick_tick(int cpu, ktime_t now)
{
# 678 "../../kernel/time/tick-sched.c"
}

static inline __attribute__((always_inline)) void tick_check_nohz(int cpu)
{
 struct tick_sched *ts = &(*({ do { const void *__vpp_verify = (typeof((&(tick_cpu_sched))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))); (typeof((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))) (__ptr + (((__per_cpu_offset[cpu])))); }); }));
 ktime_t now;
...
# 706 "../../kernel/time/tick-sched.c"
void tick_check_idle(int cpu)
{
 tick_check_oneshot_broadcast(cpu);
 tick_check_nohz(cpu);
}
# 720 "../../kernel/time/tick-sched.c"
static enum hrtimer_restart tick_sched_timer(struct hrtimer *timer)
{
 struct tick_sched *ts =
  ({ const typeof( ((struct tick_sched *)0)->sched_timer ) *__mptr = (timer); (struct tick_sched *)( (char *)__mptr - __builtin_offsetof(struct tick_sched,sched_timer) );});
 struct pt_regs *regs = get_irq_regs();
 ktime_t now = ktime_get();
 int cpu = (current_thread_info()->cpu);
# 736 "../../kernel/time/tick-sched.c"
 if (__builtin_expect(!!(tick_do_timer_cpu == -1), 0))
  tick_do_timer_cpu = cpu;
...
void tick_setup_sched_timer(void)
{
 ...
 ({ unsigned int __r, __b = (cpumask_weight(cpu_possible_mask)); if (!__builtin_constant_p(__b) || __b == 0 || (7 < 4 && (__b & (__b - 1)) != 0)) { __r = ({ register unsigned int __base asm("r4") = __b; register unsigned long long __n asm("r0") = offset; register unsigned long long __res asm("r2"); register unsigned int __rem asm("r1"); asm( ".ifnc " "%0" "," "r1" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%3" "," "r4" " ; .err ; .endif\n\t" "bl	__do_div64" : "=r" (__rem), "=r" (__res) : "r" (__n), "r" (__base) : "ip", "lr", "cc"); offset = __res; __rem; }); } else if ((__b & (__b - 1)) == 0) { __r = offset; __r &= (__b - 1); offset /= __b; } else { unsigned long long __res, __x, __t, __m, __n = offset; unsigned int __c, __p, __z = 0; __r = __n; __p = 1 << ({ unsigned int __left = (__b), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); __m = (~0ULL / __b) * __p; __m += (((~0ULL % __b + 1) * __p) + __b - 1) / __b; __x = ~0ULL / __b * __b - 1; __res = (__m & 0xffffffff) * (__x & 0xffffffff); __res >>= 32; __res += (__m & 0xffffffff) * (__x >> 32); __t = __res; __res += (__x & 0xffffffff) * (__m >> 32); __t = (__res < __t) ? (1ULL << 32) : 0; __res = (__res >> 32) + __t; __res += (__m >> 32) * (__x >> 32); __res /= __p; if (~0ULL % (__b / (__b & -__b)) == 0) { __n /= (__b & -__b); __m = ~0ULL / (__b / (__b & -__b)); __p = 1; __c = 1; } else if (__res != __x / __b) { __c = 1; __m = (~0ULL / __b) * __p; __m += ((~0ULL % __b + 1) * __p) / __b; } else { unsigned int __bits = -(__m & -__m); __bits |= __m >> 32; __bits = (~__bits) << 1; if (!__bits) { __p /= (__m & -__m); __m /= (__m & -__m); } else { __p >>= ({ unsigned int __left = (__bits), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); __m >>= ({ unsigned int __left = (__bits), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); } __c = 0; } if (!__c) { asm ( "umull	%Q0, %R0, %1, %Q2\n\t" "mov	%Q0, #0" : "=&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else if (!(__m & ((1ULL << 63) | (1ULL << 31)))) { __res = __m; asm ( "umlal	%Q0, %R0, %Q1, %Q2\n\t" "mov	%Q0, #0" : "+&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else { asm ( "umull	%Q0, %R0, %Q1, %Q2\n\t" "cmn	%Q0, %Q1\n\t" "adcs	%R0, %R0, %R1\n\t" "adc	%Q0, %3, #0" : "=&r" (__res) : "r" (__m), "r" (__n), "r" (__z) : "cc" ); } if (!(__m & ((1ULL << 63) | (1ULL << 31)))) { asm ( "umlal	%R0, %Q0, %R1, %Q2\n\t" "umlal	%R0, %Q0, %Q1, %R2\n\t" "mov	%R0, #0\n\t" "umlal	%Q0, %R0, %R1, %R2" : "+&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else { asm ( "umlal	%R0, %Q0, %R2, %Q3\n\t" "umlal	%R0, %1, %Q2, %R3\n\t" "mov	%R0, #0\n\t" "adds	%Q0, %1, %Q0\n\t" "adc	%R0, %R0, #0\n\t" "umlal	%Q0, %R0, %R2, %R3" : "+&r" (__res), "+&r" (__z) : "r" (__m), "r" (__n) : "cc" ); } __res /= __p; { unsigned int __res0 = __res; unsigned int __b0 = __b; __r -= __res0 * __b0; } offset = __res; } __r; });
 offset *= (current_thread_info()->cpu);
...
void tick_clock_notify(void)
{
 ...
 for (((cpu)) = -1; ((cpu)) = cpumask_next(((cpu)), (cpu_possible_mask)), ((cpu)) < nr_cpu_ids;)
  _set_bit_le(0,&(*({ do { const void *__vpp_verify = (typeof((&(tick_cpu_sched))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))); (typeof((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))) (__ptr + (((__per_cpu_offset[cpu])))); }); })).check_clocks);
}
...
void tick_oneshot_notify(void)
{
 ...
 _set_bit_le(0,&ts->check_clocks);
}
# 852 "../../kernel/time/tick-sched.c"
int tick_check_oneshot_change(int allow_nohz)
{
 struct tick_sched *ts = &(*({ do { const void *__vpp_verify = (typeof((&(tick_cpu_sched))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))); (typeof((typeof(*(&(tick_cpu_sched))) *)(&(tick_cpu_sched)))) (__ptr + (((__per_cpu_offset[(current_thread_info()->cpu)])))); }); }));

 if (!_test_and_clear_bit_le(0,&ts->check_clocks))
  return 0;
