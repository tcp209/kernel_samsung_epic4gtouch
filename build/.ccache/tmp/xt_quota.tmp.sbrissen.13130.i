...
# 11 "../../net/netfilter/xt_quota.c" 2
# 1 "../../include/linux/netfilter/xt_quota.h" 1
...
struct xt_quota_info {
 ...
 __u64 __attribute__((aligned(8))) quota;
 struct xt_quota_priv *master;
};
# 12 "../../net/netfilter/xt_quota.c" 2
...
static spinlock_t quota_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } };
...
static int quota_mt_check(const struct xt_mtchk_param *par)
{
 ...
 q->master = kmalloc(sizeof(*q->master), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (q->master == ((void *)0))
  return -12;
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) quota_mt_init(void)
{
 return xt_register_match(&quota_mt_reg);
}

static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) quota_mt_exit(void)
{
 xt_unregister_match(&quota_mt_reg);
}

static initcall_t __initcall_quota_mt_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = quota_mt_init;;
static exitcall_t __exitcall_quota_mt_exit __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = quota_mt_exit;;
