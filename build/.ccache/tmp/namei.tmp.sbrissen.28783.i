...
static inline __attribute__((always_inline)) void bit_spin_lock(int bitnum, unsigned long *addr)
{
 ...
 while (__builtin_expect(!!(_test_and_set_bit_le(bitnum,addr)), 0)) {
...
static inline __attribute__((always_inline)) int bit_spin_trylock(int bitnum, unsigned long *addr)
{
 ...
 if (__builtin_expect(!!(_test_and_set_bit_le(bitnum,addr)), 0)) {
  do { do { __asm__ __volatile__("": : :"memory"); do { (current_thread_info()->preempt_count) -= (1); } while (0); } while (0); __asm__ __volatile__("": : :"memory"); do { if (__builtin_expect(!!(test_ti_thread_flag(current_thread_info(), 1)), 0)) preempt_schedule(); } while (0); } while (0);
  return 0;
 }
...
static inline __attribute__((always_inline)) void bit_spin_unlock(int bitnum, unsigned long *addr)
{
 ...
 do { do { __asm__ __volatile__ ("dsb" : : : "memory"); outer_sync(); } while (0); _clear_bit_le(bitnum,addr); } while (0);
...
# 34 "../../include/linux/jbd2.h" 2
# 73 "../../include/linux/jbd2.h"
extern void *jbd2_alloc(size_t size, gfp_t flags);
extern void jbd2_free(void *ptr, size_t size);
# 97 "../../include/linux/jbd2.h"
typedef struct handle_s handle_t;
# 111 "../../include/linux/jbd2.h"
...
# 189 "../../include/linux/jbd2.h"
typedef struct jbd2_journal_revoke_header_s
{
 journal_header_t r_header;
 __be32 r_count;
} jbd2_journal_revoke_header_t;
# 206 "../../include/linux/jbd2.h"
...
static inline __attribute__((always_inline)) void set_buffer_jbd(struct buffer_head *bh) { _set_bit_le(BH_JBD,&(bh)->b_state); } static inline __attribute__((always_inline)) void clear_buffer_jbd(struct buffer_head *bh) { _clear_bit_le(BH_JBD,&(bh)->b_state); } static inline __attribute__((always_inline)) int buffer_jbd(const struct buffer_head *bh) { return test_bit(BH_JBD, &(bh)->b_state); }
static inline __attribute__((always_inline)) void set_buffer_jwrite(struct buffer_head *bh) { _set_bit_le(BH_JWrite,&(bh)->b_state); } static inline __attribute__((always_inline)) void clear_buffer_jwrite(struct buffer_head *bh) { _clear_bit_le(BH_JWrite,&(bh)->b_state); } static inline __attribute__((always_inline)) int buffer_jwrite(const struct buffer_head *bh) { return test_bit(BH_JWrite, &(bh)->b_state); }
static inline __attribute__((always_inline)) void set_buffer_jbddirty(struct buffer_head *bh) { _set_bit_le(BH_JBDDirty,&(bh)->b_state); } static inline __attribute__((always_inline)) void clear_buffer_jbddirty(struct buffer_head *bh) { _clear_bit_le(BH_JBDDirty,&(bh)->b_state); } static inline __attribute__((always_inline)) int buffer_jbddirty(const struct buffer_head *bh) { return test_bit(BH_JBDDirty, &(bh)->b_state); }
static inline __attribute__((always_inline)) int test_set_buffer_jbddirty(struct buffer_head *bh) { return _test_and_set_bit_le(BH_JBDDirty,&(bh)->b_state); } static inline __attribute__((always_inline)) int test_clear_buffer_jbddirty(struct buffer_head *bh) { return _test_and_clear_bit_le(BH_JBDDirty,&(bh)->b_state); }
static inline __attribute__((always_inline)) void set_buffer_revoked(struct buffer_head *bh) { _set_bit_le(BH_Revoked,&(bh)->b_state); } static inline __attribute__((always_inline)) void clear_buffer_revoked(struct buffer_head *bh) { _clear_bit_le(BH_Revoked,&(bh)->b_state); } static inline __attribute__((always_inline)) int buffer_revoked(const struct buffer_head *bh) { return test_bit(BH_Revoked, &(bh)->b_state); }
static inline __attribute__((always_inline)) int test_set_buffer_revoked(struct buffer_head *bh) { return _test_and_set_bit_le(BH_Revoked,&(bh)->b_state); } static inline __attribute__((always_inline)) int test_clear_buffer_revoked(struct buffer_head *bh) { return _test_and_clear_bit_le(BH_Revoked,&(bh)->b_state); }
static inline __attribute__((always_inline)) void set_buffer_revokevalid(struct buffer_head *bh) { _set_bit_le(BH_RevokeValid,&(bh)->b_state); } static inline __attribute__((always_inline)) void clear_buffer_revokevalid(struct buffer_head *bh) { _clear_bit_le(BH_RevokeValid,&(bh)->b_state); } static inline __attribute__((always_inline)) int buffer_revokevalid(const struct buffer_head *bh) { return test_bit(BH_RevokeValid, &(bh)->b_state); }
static inline __attribute__((always_inline)) int test_set_buffer_revokevalid(struct buffer_head *bh) { return _test_and_set_bit_le(BH_RevokeValid,&(bh)->b_state); } static inline __attribute__((always_inline)) int test_clear_buffer_revokevalid(struct buffer_head *bh) { return _test_and_clear_bit_le(BH_RevokeValid,&(bh)->b_state); }
static inline __attribute__((always_inline)) void set_buffer_freed(struct buffer_head *bh) { _set_bit_le(BH_Freed,&(bh)->b_state); } static inline __attribute__((always_inline)) void clear_buffer_freed(struct buffer_head *bh) { _clear_bit_le(BH_Freed,&(bh)->b_state); } static inline __attribute__((always_inline)) int buffer_freed(const struct buffer_head *bh) { return test_bit(BH_Freed, &(bh)->b_state); }

static inline __attribute__((always_inline)) struct buffer_head *jh2bh(struct journal_head *jh)
{
 return jh->b_bh;
}

static inline __attribute__((always_inline)) struct journal_head *bh2jh(struct buffer_head *bh)
{
 return bh->b_private;
}

static inline __attribute__((always_inline)) void jbd_lock_bh_state(struct buffer_head *bh)
{
 bit_spin_lock(BH_State, &bh->b_state);
}

static inline __attribute__((always_inline)) int jbd_trylock_bh_state(struct buffer_head *bh)
{
 return bit_spin_trylock(BH_State, &bh->b_state);
}

static inline __attribute__((always_inline)) int jbd_is_locked_bh_state(struct buffer_head *bh)
{
 return bit_spin_is_locked(BH_State, &bh->b_state);
}

static inline __attribute__((always_inline)) void jbd_unlock_bh_state(struct buffer_head *bh)
{
 bit_spin_unlock(BH_State, &bh->b_state);
}

static inline __attribute__((always_inline)) void jbd_lock_bh_journal_head(struct buffer_head *bh)
{
 bit_spin_lock(BH_JournalHead, &bh->b_state);
}

static inline __attribute__((always_inline)) void jbd_unlock_bh_journal_head(struct buffer_head *bh)
{
 bit_spin_unlock(BH_JournalHead, &bh->b_state);
}
# 381 "../../include/linux/jbd2.h"
struct jbd2_inode {
...
# 1076 "../../include/linux/jbd2.h"
static inline __attribute__((always_inline)) handle_t *journal_current_handle(void)
{
...
static inline __attribute__((always_inline)) handle_t *jbd2_alloc_handle(gfp_t gfp_flags)
{
 return kmem_cache_alloc(jbd2_handle_cache, gfp_flags);
}

static inline __attribute__((always_inline)) void jbd2_free_handle(handle_t *handle)
{
...
# 1219 "../../include/linux/jbd2.h"
static inline __attribute__((always_inline)) int is_journal_aborted(journal_t *journal)
{
 return journal->j_flags & 0x002;
}

static inline __attribute__((always_inline)) int is_handle_aborted(handle_t *handle)
{
 if (handle->h_aborted)
  return 1;
...
static inline __attribute__((always_inline)) void jbd2_journal_abort_handle(handle_t *handle)
{
 handle->h_aborted = 1;
}
...
static inline __attribute__((always_inline)) int tid_gt(tid_t x, tid_t y)
{
 int difference = (x - y);
 return (difference > 0);
}

static inline __attribute__((always_inline)) int tid_geq(tid_t x, tid_t y)
{
 int difference = (x - y);
 return (difference >= 0);
}
...
static inline __attribute__((always_inline)) int jbd_space_needed(journal_t *journal)
{
...
# 1283 "../../include/linux/jbd2.h"
extern int jbd_blocks_per_page(struct inode *inode);
# 1298 "../../include/linux/jbd2.h"
extern const char *jbd2_dev_to_name(dev_t device);
# 30 "../../fs/ext4/namei.c" 2




# 1 "../../include/linux/quotaops.h" 1
# 16 "../../include/linux/quotaops.h"
static inline __attribute__((always_inline)) struct quota_info *sb_dqopt(struct super_block *sb)
{
 return &sb->s_dquot;
}


static inline __attribute__((always_inline)) bool is_quota_modification(struct inode *inode, struct iattr *ia)
{
 return (ia->ia_valid & (1 << 3) && ia->ia_size != inode->i_size) ||
  (ia->ia_valid & (1 << 1) && ia->ia_uid != inode->i_uid) ||
  (ia->ia_valid & (1 << 2) && ia->ia_gid != inode->i_gid);
}
# 161 "../../include/linux/quotaops.h"
static inline __attribute__((always_inline)) int sb_has_quota_usage_enabled(struct super_block *sb, int type)
{
 return 0;
}

static inline __attribute__((always_inline)) int sb_has_quota_limits_enabled(struct super_block *sb, int type)
{
 return 0;
}

static inline __attribute__((always_inline)) int sb_has_quota_suspended(struct super_block *sb, int type)
{
 return 0;
}

static inline __attribute__((always_inline)) int sb_any_quota_suspended(struct super_block *sb)
{
 return 0;
}


static inline __attribute__((always_inline)) int sb_has_quota_loaded(struct super_block *sb, int type)
{
 return 0;
}

static inline __attribute__((always_inline)) int sb_any_quota_loaded(struct super_block *sb)
{
 return 0;
}

static inline __attribute__((always_inline)) int sb_has_quota_active(struct super_block *sb, int type)
{
 return 0;
}

static inline __attribute__((always_inline)) int sb_any_quota_active(struct super_block *sb)
{
 return 0;
}

static inline __attribute__((always_inline)) void dquot_initialize(struct inode *inode)
{
}

static inline __attribute__((always_inline)) void dquot_drop(struct inode *inode)
{
}

static inline __attribute__((always_inline)) int dquot_alloc_inode(const struct inode *inode)
{
 return 0;
}

static inline __attribute__((always_inline)) void dquot_free_inode(const struct inode *inode)
{
}

static inline __attribute__((always_inline)) int dquot_transfer(struct inode *inode, struct iattr *iattr)
{
 return 0;
}

static inline __attribute__((always_inline)) int __dquot_alloc_space(struct inode *inode, qsize_t number,
  int flags)
{
 if (!(flags & 0x2))
...
static inline __attribute__((always_inline)) void __dquot_free_space(struct inode *inode, qsize_t number,
  int flags)
{
 if (!(flags & 0x2))
...
static inline __attribute__((always_inline)) int dquot_claim_space_nodirty(struct inode *inode, qsize_t number)
{
 inode_add_bytes(inode, number);
 return 0;
}

static inline __attribute__((always_inline)) int dquot_disable(struct super_block *sb, int type,
  unsigned int flags)
{
 return 0;
}

static inline __attribute__((always_inline)) int dquot_suspend(struct super_block *sb, int type)
{
 return 0;
}

static inline __attribute__((always_inline)) int dquot_resume(struct super_block *sb, int type)
{
 return 0;
}
...
static inline __attribute__((always_inline)) int dquot_alloc_space_nodirty(struct inode *inode, qsize_t nr)
{
 return __dquot_alloc_space(inode, nr, 0x1);
}

static inline __attribute__((always_inline)) void dquot_alloc_space_nofail(struct inode *inode, qsize_t nr)
{
 __dquot_alloc_space(inode, nr, 0x1|0x4);
 mark_inode_dirty(inode);
}

static inline __attribute__((always_inline)) int dquot_alloc_space(struct inode *inode, qsize_t nr)
{
 int ret;
...
static inline __attribute__((always_inline)) int dquot_alloc_block_nodirty(struct inode *inode, qsize_t nr)
{
 return dquot_alloc_space_nodirty(inode, nr << inode->i_blkbits);
}

static inline __attribute__((always_inline)) void dquot_alloc_block_nofail(struct inode *inode, qsize_t nr)
{
 dquot_alloc_space_nofail(inode, nr << inode->i_blkbits);
}

static inline __attribute__((always_inline)) int dquot_alloc_block(struct inode *inode, qsize_t nr)
{
 return dquot_alloc_space(inode, nr << inode->i_blkbits);
}

static inline __attribute__((always_inline)) int dquot_prealloc_block_nodirty(struct inode *inode, qsize_t nr)
{
 return __dquot_alloc_space(inode, nr << inode->i_blkbits, 0);
}

static inline __attribute__((always_inline)) int dquot_prealloc_block(struct inode *inode, qsize_t nr)
{
 int ret;
...
static inline __attribute__((always_inline)) int dquot_reserve_block(struct inode *inode, qsize_t nr)
{
 return __dquot_alloc_space(inode, nr << inode->i_blkbits,
    0x1|0x2);
}

static inline __attribute__((always_inline)) int dquot_claim_block(struct inode *inode, qsize_t nr)
{
 int ret;
...
static inline __attribute__((always_inline)) void dquot_free_space_nodirty(struct inode *inode, qsize_t nr)
{
 __dquot_free_space(inode, nr, 0);
}

static inline __attribute__((always_inline)) void dquot_free_space(struct inode *inode, qsize_t nr)
{
 dquot_free_space_nodirty(inode, nr);
 mark_inode_dirty(inode);
}

static inline __attribute__((always_inline)) void dquot_free_block_nodirty(struct inode *inode, qsize_t nr)
{
 dquot_free_space_nodirty(inode, nr << inode->i_blkbits);
}

static inline __attribute__((always_inline)) void dquot_free_block(struct inode *inode, qsize_t nr)
{
 dquot_free_space(inode, nr << inode->i_blkbits);
}

static inline __attribute__((always_inline)) void dquot_release_reservation_block(struct inode *inode,
  qsize_t nr)
{
 __dquot_free_space(inode, nr << inode->i_blkbits, 0x2);
}
# 35 "../../fs/ext4/namei.c" 2
...
# 22 "../../fs/ext4/ext4.h" 2
# 30 "../../fs/ext4/ext4.h"
# 1 "../../include/linux/blockgroup_lock.h" 1
# 36 "../../include/linux/blockgroup_lock.h"
struct bgl_lock {
 spinlock_t lock;
} __attribute__((__aligned__((1 << 5))));
...
static inline __attribute__((always_inline)) void bgl_lock_init(struct blockgroup_lock *bgl)
{
 int i;

 for (i = 0; i < 8; i++)
  do { spinlock_check(&bgl->locks[i].lock); do { *(&(&bgl->locks[i].lock)->rlock) = (raw_spinlock_t) { .raw_lock = { 0 }, }; } while (0); } while (0);
}
...
static inline __attribute__((always_inline)) spinlock_t *
bgl_lock_ptr(struct blockgroup_lock *bgl, unsigned int block_group)
{
 return &bgl->locks[(block_group) & (8 -1)].lock;
}
# 31 "../../fs/ext4/ext4.h" 2
...
# 342 "../../fs/ext4/ext4.h"
static inline __attribute__((always_inline)) __u32 ext4_mask_flags(umode_t mode, __u32 flags)
{
 if ((((mode) & 00170000) == 0040000))
  return flags;
 else if ((((mode) & 00170000) == 0100000))
  return flags & (~(0x00010000 | 0x00020000));
 else
  return flags & (0x00000040 | 0x00000080);
}
...
# 402 "../../fs/ext4/ext4.h"
static inline __attribute__((always_inline)) void ext4_check_flag_values(void)
{
 if (!(0x00000001 == (1 << EXT4_INODE_SECRM))) { printk("<0>" "EXT4 flag fail: " "SECRM" ": %d %d\n", 0x00000001, EXT4_INODE_SECRM); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00000002 == (1 << EXT4_INODE_UNRM))) { printk("<0>" "EXT4 flag fail: " "UNRM" ": %d %d\n", 0x00000002, EXT4_INODE_UNRM); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00000004 == (1 << EXT4_INODE_COMPR))) { printk("<0>" "EXT4 flag fail: " "COMPR" ": %d %d\n", 0x00000004, EXT4_INODE_COMPR); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00000008 == (1 << EXT4_INODE_SYNC))) { printk("<0>" "EXT4 flag fail: " "SYNC" ": %d %d\n", 0x00000008, EXT4_INODE_SYNC); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00000010 == (1 << EXT4_INODE_IMMUTABLE))) { printk("<0>" "EXT4 flag fail: " "IMMUTABLE" ": %d %d\n", 0x00000010, EXT4_INODE_IMMUTABLE); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00000020 == (1 << EXT4_INODE_APPEND))) { printk("<0>" "EXT4 flag fail: " "APPEND" ": %d %d\n", 0x00000020, EXT4_INODE_APPEND); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00000040 == (1 << EXT4_INODE_NODUMP))) { printk("<0>" "EXT4 flag fail: " "NODUMP" ": %d %d\n", 0x00000040, EXT4_INODE_NODUMP); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00000080 == (1 << EXT4_INODE_NOATIME))) { printk("<0>" "EXT4 flag fail: " "NOATIME" ": %d %d\n", 0x00000080, EXT4_INODE_NOATIME); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00000100 == (1 << EXT4_INODE_DIRTY))) { printk("<0>" "EXT4 flag fail: " "DIRTY" ": %d %d\n", 0x00000100, EXT4_INODE_DIRTY); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00000200 == (1 << EXT4_INODE_COMPRBLK))) { printk("<0>" "EXT4 flag fail: " "COMPRBLK" ": %d %d\n", 0x00000200, EXT4_INODE_COMPRBLK); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00000400 == (1 << EXT4_INODE_NOCOMPR))) { printk("<0>" "EXT4 flag fail: " "NOCOMPR" ": %d %d\n", 0x00000400, EXT4_INODE_NOCOMPR); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00000800 == (1 << EXT4_INODE_ECOMPR))) { printk("<0>" "EXT4 flag fail: " "ECOMPR" ": %d %d\n", 0x00000800, EXT4_INODE_ECOMPR); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00001000 == (1 << EXT4_INODE_INDEX))) { printk("<0>" "EXT4 flag fail: " "INDEX" ": %d %d\n", 0x00001000, EXT4_INODE_INDEX); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00002000 == (1 << EXT4_INODE_IMAGIC))) { printk("<0>" "EXT4 flag fail: " "IMAGIC" ": %d %d\n", 0x00002000, EXT4_INODE_IMAGIC); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00004000 == (1 << EXT4_INODE_JOURNAL_DATA))) { printk("<0>" "EXT4 flag fail: " "JOURNAL_DATA" ": %d %d\n", 0x00004000, EXT4_INODE_JOURNAL_DATA); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00008000 == (1 << EXT4_INODE_NOTAIL))) { printk("<0>" "EXT4 flag fail: " "NOTAIL" ": %d %d\n", 0x00008000, EXT4_INODE_NOTAIL); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00010000 == (1 << EXT4_INODE_DIRSYNC))) { printk("<0>" "EXT4 flag fail: " "DIRSYNC" ": %d %d\n", 0x00010000, EXT4_INODE_DIRSYNC); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00020000 == (1 << EXT4_INODE_TOPDIR))) { printk("<0>" "EXT4 flag fail: " "TOPDIR" ": %d %d\n", 0x00020000, EXT4_INODE_TOPDIR); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00040000 == (1 << EXT4_INODE_HUGE_FILE))) { printk("<0>" "EXT4 flag fail: " "HUGE_FILE" ": %d %d\n", 0x00040000, EXT4_INODE_HUGE_FILE); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00080000 == (1 << EXT4_INODE_EXTENTS))) { printk("<0>" "EXT4 flag fail: " "EXTENTS" ": %d %d\n", 0x00080000, EXT4_INODE_EXTENTS); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00200000 == (1 << EXT4_INODE_EA_INODE))) { printk("<0>" "EXT4 flag fail: " "EA_INODE" ": %d %d\n", 0x00200000, EXT4_INODE_EA_INODE); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x00400000 == (1 << EXT4_INODE_EOFBLOCKS))) { printk("<0>" "EXT4 flag fail: " "EOFBLOCKS" ": %d %d\n", 0x00400000, EXT4_INODE_EOFBLOCKS); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
 if (!(0x80000000 == (1 << EXT4_INODE_RESERVED))) { printk("<0>" "EXT4 flag fail: " "RESERVED" ": %d %d\n", 0x80000000, EXT4_INODE_RESERVED); do { if (__builtin_expect(!!(1), 0)) do { *(int *)0 = 0; } while (1); } while(0); };
}
...
# 647 "../../fs/ext4/ext4.h"
static inline __attribute__((always_inline)) __le32 ext4_encode_extra_time(struct timespec *time)
{
       return (( __le32)(__u32)((sizeof(time->tv_sec) > 4 ? (time->tv_sec >> 32) & ((1 << 2) - 1) : 0) | ((time->tv_nsec << 2) & (~0UL << 2))));


}

static inline __attribute__((always_inline)) void ext4_decode_extra_time(struct timespec *time, __le32 extra)
{
       if (sizeof(time->tv_sec) > 4)
        time->tv_sec |= (__u64)((( __u32)(__le32)(extra)) & ((1 << 2) - 1))
          << 32;
       time->tv_nsec = ((( __u32)(__le32)(extra)) & (~0UL << 2)) >> 2;
}
# 727 "../../fs/ext4/ext4.h"
...
static inline __attribute__((always_inline)) struct ext4_sb_info *EXT4_SB(struct super_block *sb)
{
 return sb->s_fs_info;
}
static inline __attribute__((always_inline)) struct ext4_inode_info *EXT4_I(struct inode *inode)
{
 return ({ const typeof( ((struct ext4_inode_info *)0)->vfs_inode ) *__mptr = (inode); (struct ext4_inode_info *)( (char *)__mptr - __builtin_offsetof(struct ext4_inode_info,vfs_inode) );});
}

static inline __attribute__((always_inline)) struct timespec ext4_current_time(struct inode *inode)
{
 return (inode->i_sb->s_time_gran < 1000000000L) ?
  current_fs_time(inode->i_sb) : ((struct timespec) { get_seconds(), 0 });
}

static inline __attribute__((always_inline)) int ext4_valid_inum(struct super_block *sb, unsigned long ino)
{
 return ino == 2 ||
  ino == 8 ||
  ino == 7 ||
  (ino >= (EXT4_SB(sb)->s_first_ino) &&
   ino <= (( __u32)(__le32)(EXT4_SB(sb)->s_es->s_inodes_count)));
}
...
# 1202 "../../fs/ext4/ext4.h"
static inline __attribute__((always_inline)) int ext4_test_inode_flag(struct inode *inode, int bit) { return test_bit(bit, &EXT4_I(inode)->i_flags); } static inline __attribute__((always_inline)) void ext4_set_inode_flag(struct inode *inode, int bit) { _set_bit_le(bit,&EXT4_I(inode)->i_flags); } static inline __attribute__((always_inline)) void ext4_clear_inode_flag(struct inode *inode, int bit) { _clear_bit_le(bit,&EXT4_I(inode)->i_flags); }
static inline __attribute__((always_inline)) int ext4_test_inode_state(struct inode *inode, int bit) { return test_bit(bit, &EXT4_I(inode)->i_state_flags); } static inline __attribute__((always_inline)) void ext4_set_inode_state(struct inode *inode, int bit) { _set_bit_le(bit,&EXT4_I(inode)->i_state_flags); } static inline __attribute__((always_inline)) void ext4_clear_inode_state(struct inode *inode, int bit) { _clear_bit_le(bit,&EXT4_I(inode)->i_state_flags); }
# 1336 "../../fs/ext4/ext4.h"
...
static inline __attribute__((always_inline)) struct ext4_inode *ext4_raw_inode(struct ext4_iloc *iloc)
{
...
static inline __attribute__((always_inline)) ext4_fsblk_t
ext4_group_first_block_no(struct super_block *sb, ext4_group_t group_no)
{
 return group_no * (ext4_fsblk_t)(EXT4_SB(sb)->s_blocks_per_group) +
  (( __u32)(__le32)(EXT4_SB(sb)->s_es->s_first_data_block));
}
...
extern int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) init_ext4_mballoc(void);
...
static inline __attribute__((always_inline)) ext4_fsblk_t ext4_blocks_count(struct ext4_super_block *es)
{
 return ((ext4_fsblk_t)(( __u32)(__le32)(es->s_blocks_count_hi)) << 32) |
  (( __u32)(__le32)(es->s_blocks_count_lo));
}

static inline __attribute__((always_inline)) ext4_fsblk_t ext4_r_blocks_count(struct ext4_super_block *es)
{
 return ((ext4_fsblk_t)(( __u32)(__le32)(es->s_r_blocks_count_hi)) << 32) |
  (( __u32)(__le32)(es->s_r_blocks_count_lo));
}

static inline __attribute__((always_inline)) ext4_fsblk_t ext4_free_blocks_count(struct ext4_super_block *es)
{
 return ((ext4_fsblk_t)(( __u32)(__le32)(es->s_free_blocks_count_hi)) << 32) |
  (( __u32)(__le32)(es->s_free_blocks_count_lo));
}

static inline __attribute__((always_inline)) void ext4_blocks_count_set(struct ext4_super_block *es,
      ext4_fsblk_t blk)
{
 es->s_blocks_count_lo = (( __le32)(__u32)((u32)blk));
 es->s_blocks_count_hi = (( __le32)(__u32)(blk >> 32));
}

static inline __attribute__((always_inline)) void ext4_free_blocks_count_set(struct ext4_super_block *es,
           ext4_fsblk_t blk)
{
 es->s_free_blocks_count_lo = (( __le32)(__u32)((u32)blk));
 es->s_free_blocks_count_hi = (( __le32)(__u32)(blk >> 32));
}

static inline __attribute__((always_inline)) void ext4_r_blocks_count_set(struct ext4_super_block *es,
        ext4_fsblk_t blk)
{
 es->s_r_blocks_count_lo = (( __le32)(__u32)((u32)blk));
 es->s_r_blocks_count_hi = (( __le32)(__u32)(blk >> 32));
}

static inline __attribute__((always_inline)) loff_t ext4_isize(struct ext4_inode *raw_inode)
{
 if (((((( __u16)(__le16)(raw_inode->i_mode))) & 00170000) == 0100000))
  return ((loff_t)(( __u32)(__le32)(raw_inode->i_size_high)) << 32) |
   (( __u32)(__le32)(raw_inode->i_size_lo));
 else
  return (loff_t) (( __u32)(__le32)(raw_inode->i_size_lo));
}

static inline __attribute__((always_inline)) void ext4_isize_set(struct ext4_inode *raw_inode, loff_t i_size)
{
 raw_inode->i_size_lo = (( __le32)(__u32)(i_size));
 raw_inode->i_size_high = (( __le32)(__u32)(i_size >> 32));
}
         ...
         ext4_group_t group)
{
  ...
  indexv = group >> ((EXT4_SB(sb)->s_desc_per_block_bits));
  indexh = group & (((EXT4_SB(sb)->s_desc_per_block)) - 1);
...
static inline __attribute__((always_inline)) ext4_group_t ext4_get_groups_count(struct super_block *sb)
{
...
static inline __attribute__((always_inline)) ext4_group_t ext4_flex_group(struct ext4_sb_info *sbi,
          ext4_group_t block_group)
{
 return block_group >> sbi->s_log_groups_per_flex;
}

static inline __attribute__((always_inline)) unsigned int ext4_flex_bg_size(struct ext4_sb_info *sbi)
{
 return 1 << sbi->s_log_groups_per_flex;
}
# 1786 "../../fs/ext4/ext4.h"
static inline __attribute__((always_inline)) void ext4_update_i_disksize(struct inode *inode, loff_t newsize)
{
...
# 1824 "../../fs/ext4/ext4.h"
static inline __attribute__((always_inline)) spinlock_t *ext4_group_lock_ptr(struct super_block *sb,
           ext4_group_t group)
{
...
static inline __attribute__((always_inline)) int ext4_fs_is_busy(struct ext4_sb_info *sbi)
{
 return ((*(volatile int *)&(&sbi->s_lock_busy)->counter) > 2);
}

static inline __attribute__((always_inline)) void ext4_lock_group(struct super_block *sb, ext4_group_t group)
{
...
static inline __attribute__((always_inline)) void ext4_unlock_group(struct super_block *sb,
     ext4_group_t group)
{
...
extern int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) init_ext4_system_zone(void);
...
static inline __attribute__((always_inline)) void set_buffer_uninit(struct buffer_head *bh) { _set_bit_le(BH_Uninit,&(bh)->b_state); } static inline __attribute__((always_inline)) void clear_buffer_uninit(struct buffer_head *bh) { _clear_bit_le(BH_Uninit,&(bh)->b_state); } static inline __attribute__((always_inline)) int buffer_uninit(const struct buffer_head *bh) { return test_bit(BH_Uninit, &(bh)->b_state); }
static inline __attribute__((always_inline)) int test_set_buffer_uninit(struct buffer_head *bh) { return _test_and_set_bit_le(BH_Uninit,&(bh)->b_state); } static inline __attribute__((always_inline)) int test_clear_buffer_uninit(struct buffer_head *bh) { return _test_and_clear_bit_le(BH_Uninit,&(bh)->b_state); }
# 1937 "../../fs/ext4/ext4.h"
static inline __attribute__((always_inline)) int bitmap_uptodate(struct buffer_head *bh)
{
 return (buffer_uptodate(bh) &&
   test_bit(BH_JBDPrivateStart, &(bh)->b_state));
}
static inline __attribute__((always_inline)) void set_bitmap_uptodate(struct buffer_head *bh)
{
 _set_bit_le(BH_JBDPrivateStart,&(bh)->b_state);
}
# 38 "../../fs/ext4/namei.c" 2
# 1 "../../fs/ext4/ext4_jbd2.h" 1
# 107 "../../fs/ext4/ext4_jbd2.h"
int
...
static inline __attribute__((always_inline)) int ext4_handle_valid(handle_t *handle)
{
 if ((unsigned long)handle < ((unsigned long) 4096))
  return 0;
 return 1;
}

static inline __attribute__((always_inline)) void ext4_handle_sync(handle_t *handle)
{
 if (ext4_handle_valid(handle))
  handle->h_sync = 1;
}

static inline __attribute__((always_inline)) void ext4_handle_release_buffer(handle_t *handle,
      struct buffer_head *bh)
{
 if (ext4_handle_valid(handle))
...
static inline __attribute__((always_inline)) int ext4_handle_is_aborted(handle_t *handle)
{
 if (ext4_handle_valid(handle))
...
static inline __attribute__((always_inline)) int ext4_handle_has_enough_credits(handle_t *handle, int needed)
{
...
static inline __attribute__((always_inline)) void ext4_journal_release_buffer(handle_t *handle,
      struct buffer_head *bh)
{
 if (ext4_handle_valid(handle))
  jbd2_journal_release_buffer(handle, bh);
...
static inline __attribute__((always_inline)) handle_t *ext4_journal_start(struct inode *inode, int nblocks)
{
...
static inline __attribute__((always_inline)) handle_t *ext4_journal_current_handle(void)
{
 return journal_current_handle();
}

static inline __attribute__((always_inline)) int ext4_journal_extend(handle_t *handle, int nblocks)
{
 if (ext4_handle_valid(handle))
...
static inline __attribute__((always_inline)) int ext4_journal_restart(handle_t *handle, int nblocks)
{
 if (ext4_handle_valid(handle))
...
static inline __attribute__((always_inline)) int ext4_journal_blocks_per_page(struct inode *inode)
{
 if ((EXT4_SB((inode)->i_sb)->s_journal) != ((void *)0))
  return jbd2_journal_blocks_per_page(inode);
 return 0;
}

static inline __attribute__((always_inline)) int ext4_journal_force_commit(journal_t *journal)
{
 if (journal)
...
static inline __attribute__((always_inline)) int ext4_jbd2_file_inode(handle_t *handle, struct inode *inode)
{
 if (ext4_handle_valid(handle))
...
static inline __attribute__((always_inline)) void ext4_update_inode_fsync_trans(handle_t *handle,
       struct inode *inode,
       int datasync)
{
...
static inline __attribute__((always_inline)) int ext4_should_journal_data(struct inode *inode)
{
 if ((EXT4_SB((inode)->i_sb)->s_journal) == ((void *)0))
  return 0;
 if (!(((inode->i_mode) & 00170000) == 0100000))
  return 1;
 if ((EXT4_SB(inode->i_sb)->s_mount_opt & 0x00C00) == 0x00400)
  return 1;
...
static inline __attribute__((always_inline)) int ext4_should_order_data(struct inode *inode)
{
 if ((EXT4_SB((inode)->i_sb)->s_journal) == ((void *)0))
  return 0;
 if (!(((inode->i_mode) & 00170000) == 0100000))
 ...
 if (ext4_test_inode_flag(inode, EXT4_INODE_JOURNAL_DATA))
  return 0;
 if ((EXT4_SB(inode->i_sb)->s_mount_opt & 0x00C00) == 0x00800)
  return 1;
 return 0;
}

static inline __attribute__((always_inline)) int ext4_should_writeback_data(struct inode *inode)
{
 if (!(((inode->i_mode) & 00170000) == 0100000))
  return 0;
 if ((EXT4_SB((inode)->i_sb)->s_journal) == ((void *)0))
 ...
 if (ext4_test_inode_flag(inode, EXT4_INODE_JOURNAL_DATA))
  return 0;
 if ((EXT4_SB(inode->i_sb)->s_mount_opt & 0x00C00) == 0x00C00)
  return 1;
 return 0;
}
# 316 "../../fs/ext4/ext4_jbd2.h"
static inline __attribute__((always_inline)) int ext4_should_dioread_nolock(struct inode *inode)
{
 if (!(EXT4_SB(inode->i_sb)->s_mount_opt & 0x400000))
  return 0;
 if ((EXT4_SB(inode->i_sb)->s_mount_opt & 0x40000))
  return 0;
 if (!(((inode->i_mode) & 00170000) == 0100000))
  return 0;
...
# 150 "../../fs/ext4/xattr.h"
static inline __attribute__((always_inline)) int ext4_init_security(handle_t *handle, struct inode *inode,
    struct inode *dir)
{
 return 0;
}
# 41 "../../fs/ext4/namei.c" 2
# 1 "../../fs/ext4/acl.h" 1
...
# 1 "../../include/linux/posix_acl_xattr.h" 1
...
{
 if (acl && (atomic_sub_return(1, &acl->a_refcount) == 0))
  kfree(acl);
}
...
static inline __attribute__((always_inline)) struct posix_acl *get_cached_acl(struct inode *inode, int type)
{
...
static inline __attribute__((always_inline)) void set_cached_acl(struct inode *inode,
      int type,
...
static inline __attribute__((always_inline)) void forget_cached_acl(struct inode *inode, int type)
{
 struct posix_acl *old = ((void *)0);
 spin_lock(&inode->i_lock);
 switch (type) {
...
static inline __attribute__((always_inline)) void forget_all_cached_acls(struct inode *inode)
{
...
static inline __attribute__((always_inline)) void cache_no_acl(struct inode *inode)
{
...
# 13 "../../include/linux/posix_acl_xattr.h" 2
...
static inline __attribute__((always_inline)) size_t ext4_acl_size(int count)
{
 if (count <= 4) {
...
static inline __attribute__((always_inline)) int ext4_acl_count(size_t size)
{
 ssize_t s;
 ...
 *block = inode->i_size >> inode->i_sb->s_blocksize_bits;
  ...
  *err = __ext4_journal_get_write_access(__func__, (handle), (bh));
  if (*err) {
   brelse(bh);
   bh = ((void *)0);
  }
...
static inline __attribute__((always_inline)) ext4_lblk_t dx_get_block(struct dx_entry *entry);
static void dx_set_block(struct dx_entry *entry, ext4_lblk_t value);
static inline __attribute__((always_inline)) unsigned dx_get_hash(struct dx_entry *entry);
...
__le16 ext4_rec_len_to_disk(unsigned len, unsigned blocksize)
{
 ...
 if (len == blocksize) {
  if (blocksize == 65536)
   ...
   return (( __le16)(__u16)(0));
 }
 return (( __le16)(__u16)((len & 65532) | ((len >> 16) & 3)));
}




static inline __attribute__((always_inline)) struct ext4_dir_entry_2 *
...
static inline __attribute__((always_inline)) ext4_lblk_t dx_get_block(struct dx_entry *entry)
{
 return (( __u32)(__le32)(entry->block)) & 0x00ffffff;
}

static inline __attribute__((always_inline)) void dx_set_block(struct dx_entry *entry, ext4_lblk_t value)
{
 entry->block = (( __le32)(__u32)(value));
}

static inline __attribute__((always_inline)) unsigned dx_get_hash(struct dx_entry *entry)
{
 return (( __u32)(__le32)(entry->hash));
}

static inline __attribute__((always_inline)) void dx_set_hash(struct dx_entry *entry, unsigned value)
{
 entry->hash = (( __le32)(__u32)(value));
}

static inline __attribute__((always_inline)) unsigned dx_get_count(struct dx_entry *entries)
{
 return (( __u16)(__le16)(((struct dx_countlimit *) entries)->count));
}

static inline __attribute__((always_inline)) unsigned dx_get_limit(struct dx_entry *entries)
{
 return (( __u16)(__le16)(((struct dx_countlimit *) entries)->limit));
}

static inline __attribute__((always_inline)) void dx_set_count(struct dx_entry *entries, unsigned value)
{
 ((struct dx_countlimit *) entries)->count = (( __le16)(__u16)(value));
}

static inline __attribute__((always_inline)) void dx_set_limit(struct dx_entry *entries, unsigned value)
{
 ((struct dx_countlimit *) entries)->limit = (( __le16)(__u16)(value));
}

static inline __attribute__((always_inline)) unsigned dx_root_limit(struct inode *dir, unsigned infosize)
{
 unsigned entry_space = dir->i_sb->s_blocksize - (((1) + 8 + (4 - 1)) & ~(4 - 1)) -
  (((2) + 8 + (4 - 1)) & ~(4 - 1)) - infosize;
 return entry_space / sizeof(struct dx_entry);
}

static inline __attribute__((always_inline)) unsigned dx_node_limit(struct inode *dir)
{
 unsigned entry_space = dir->i_sb->s_blocksize - (((0) + 8 + (4 - 1)) & ~(4 - 1));
 return entry_space / sizeof(struct dx_entry);
}
# 368 "../../fs/ext4/namei.c"
  ...
  struct dx_hash_info *hinfo, struct dx_frame *frame_in, int *err)
{
 ...
 if (root->info.hash_version != 2 &&
     root->info.hash_version != 1 &&
     root->info.hash_version != 0) {
  __ext4_warning(dir->i_sb, __func__, "Unrecognised inode hash code %d", root->info.hash_version);
 ...
 if (root->info.unused_flags & 1) {
  __ext4_warning(dir->i_sb, __func__, "Unimplemented inode hash flags: %#06x", root->info.unused_flags);
 ...
 if ((indirect = root->info.indirect_levels) > 1) {
  __ext4_warning(dir->i_sb, __func__, "Unimplemented inode hash depth: %#06x", root->info.indirect_levels);
 ...
 if (dx_get_limit(entries) != dx_root_limit(dir,
         root->info.info_length)) {
  __ext4_warning(dir->i_sb, __func__, "dx entry: limit != root limit");
  brelse(bh);
  *err = -75000;
  goto fail;
 }
 ...
 while (1)
 {
  ...
  if (!count || count > dx_get_limit(entries)) {
   __ext4_warning(dir->i_sb, __func__, "dx entry: no count or count > limit");
  ...
  if (0)
  {
   ...
   do { if (__builtin_expect(!!(!(at == p - 1)), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  }
  ...
  if (dx_get_limit(entries) != dx_node_limit (dir)) {
   __ext4_warning(dir->i_sb, __func__, "dx entry: limit != node limit");
...
fail:
 if (*err == -75000)
  __ext4_warning(dir->i_sb, __func__, "Corrupt dir inode %ld, running e2fsck is " "recommended.", dir->i_ino);
      ...
      __u32 start_hash, __u32 start_minor_hash)
{
 ...
 if (!(bh = ext4_bread (((void *)0), dir, block, 0, &err)))
  return err;
 ...
 for (; de < top; de = ext4_next_entry(de, dir->i_sb->s_blocksize)) {
  if (!ext4_check_dir_entry("htree_dirblock_to_tree", dir, de, bh,
     (block<<((dir->i_sb)->s_blocksize_bits))
      +((char *)de - bh->b_data))) {
    ...
    __u32 start_minor_hash, __u32 *next_hash)
{
 ...
 hinfo.hash = start_hash;
 hinfo.minor_hash = 0;
 frame = dx_probe(((void *)0), dir, &hinfo, frames, &err);
 if (!frame)
  return err;
 ...
 while (1) {
  ...
  count += ret;
  hashval = ~0;
  ret = ext4_htree_next_block(dir, 1,
         ...
         struct dx_map_entry *map_tail)
{
 ...
 while ((char *) de < base + blocksize) {
  if (de->name_len && de->inode) {
   ...
   map_tail->size = (( __u16)(__le16)(de->rec_len));
   count++;
   ({ __might_sleep("../../fs/ext4/namei.c", 751, 0); _cond_resched(); });
  }
...
static void dx_sort_map (struct dx_map_entry *map, unsigned count)
{
 ...
 while (count > 2) {
  ...
  for (p = top, q = p - count; q >= map; p--, q--)
   if (p->hash < q->hash)
    do { typeof(*p) __tmp = (*p); (*p) = (*q); (*q) = __tmp; } while (0);
 }
 ...
 do {
  ...
  while (q-- > map) {
   if (q[1].hash >= q[0].hash)
    continue;
   do { typeof(*(q+1)) __tmp = (*(q+1)); (*(q+1)) = (*q); (*q) = __tmp; } while (0);
   more = 1;
  }
 } while(more);
}
...
static void dx_insert_block(struct dx_frame *frame, u32 hash, ext4_lblk_t block)
{
 ...
 do { if (__builtin_expect(!!(!(count < dx_get_limit(entries))), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 do { if (__builtin_expect(!!(!(old < entries + count)), 0)) do { *(int *)0 = 0; } while (1); } while(0);
...
{
 if (!((EXT4_SB(inode->i_sb)->s_es->s_feature_compat & (( __le32)(__u32)(0x0020))) != 0))
...
static inline __attribute__((always_inline)) int ext4_match (int len, const char * const name,
         struct ext4_dir_entry_2 * de)
{
 if (len != de->name_len)
  return 0;
...
static inline __attribute__((always_inline)) int search_dirblock(struct buffer_head *bh,
      struct inode *dir,
      const struct qstr *d_name,
      unsigned int offset,
      struct ext4_dir_entry_2 ** res_dir)
 ...
 *res_dir = ((void *)0);
 ...
 if (namelen > 255)
  return ((void *)0);
 if ((((EXT4_SB(dir->i_sb)->s_es->s_feature_compat & (( __le32)(__u32)(0x0020))) != 0) && ext4_test_inode_flag((dir), EXT4_INODE_INDEX))) {
...
restart:
 do {
  ...
  if (ra_ptr >= ra_max) {
   ...
   ra_ptr = 0;
   b = block;
   for (ra_max = 0; ra_max < (2 * 4); ra_max++) {
    ...
    num++;
    bh = ext4_getblk(((void *)0), dir, b++, 0, &err);
    bh_use[ra_max] = bh;
    if (bh)
     ll_rw_block((0 | (1 << BIO_RW_META)), 1, &bh);
   }
  }
  ...
  if (!buffer_uptodate(bh)) {
   ...
   ext4_error_inode(__func__, (dir), ("reading directory lblock %lu"), (unsigned long) block);
         ...
         struct ext4_dir_entry_2 **res_dir, int *err)
{
 ...
 do {
  ...
  for (; de < top; de = ext4_next_entry(de, sb->s_blocksize)) {
   int off = (block << ((sb)->s_blocksize_bits))
      + ((char *) de - bh->b_data);
  ...
  retval = ext4_htree_next_block(dir, hash, frame,
            frames, ((void *)0));
  if (retval < 0) {
   __ext4_warning(sb, __func__, "error reading index page in directory #%lu", dir->i_ino);
...
static struct dentry *ext4_lookup(struct inode *dir, struct dentry *dentry, struct nameidata *nd)
{
 ...
 inode = ((void *)0);
 if (bh) {
  __u32 ino = (( __u32)(__le32)(de->inode));
  brelse(bh);
  if (!ext4_valid_inum(dir->i_sb, ino)) {
   ext4_error_inode(__func__, (dir), ("bad inode number: %u"), ino);
   return ERR_PTR(-5);
  }
  inode = ext4_iget(dir->i_sb, ino);
  if (__builtin_expect(!!(IS_ERR(inode)), 0)) {
   if (PTR_ERR(inode) == -116) {
    ext4_error_inode(__func__, (dir), ("deleted inode referenced: %u"), ino);
...
struct dentry *ext4_get_parent(struct dentry *child)
{
 ...
 if (!bh)
  return ERR_PTR(-2);
 ino = (( __u32)(__le32)(de->inode));
 brelse(bh);

 if (!ext4_valid_inum(child->d_inode->i_sb, ino)) {
  ext4_error_inode(__func__, (child->d_inode), ("bad parent inode number: %u"), ino);
...
static unsigned char ext4_type_by_mode[00170000 >> 12] = {
 [0100000 >> 12] = 1,
 [0040000 >> 12] = 2,
 [0020000 >> 12] = 3,
 [0060000 >> 12] = 4,
...
static inline __attribute__((always_inline)) void ext4_set_de_type(struct super_block *sb,
    struct ext4_dir_entry_2 *de,
    umode_t mode) {
 if (((EXT4_SB(sb)->s_es->s_feature_incompat & (( __le32)(__u32)(0x0002))) != 0))
  de->file_type = ext4_type_by_mode[(mode & 00170000)>>12];
}
   ...
   struct dx_hash_info *hinfo, int *error)
{
 ...
 struct ext4_dir_entry_2 *de = ((void *)0), *de2;
 int err = 0, i;
 ...
 do {} while (0);
 err = __ext4_journal_get_write_access(__func__, (handle), (frame->bh));
 if (err)
  goto journal_error;
 ...
 if (hinfo->hash >= hash2)
 {
  do { typeof(*bh) __tmp = (*bh); (*bh) = (bh2); (bh2) = __tmp; } while (0);
  de = de2;
 }
 dx_insert_block(frame, hash2 + continued, newblock);
 err = __ext4_handle_dirty_metadata(__func__, (handle), (dir), (bh2));
 if (err)
  goto journal_error;
 err = __ext4_handle_dirty_metadata(__func__, (handle), (dir), (frame->bh));
 if (err)
  goto journal_error;
 brelse(bh2);
 ;
...
journal_error:
 ...
 brelse(bh2);
 *bh = ((void *)0);
 do { if ((err)) __ext4_std_error((dir->i_sb), __func__, (err)); } while (0);
errout:
 *error = err;
 return ((void *)0);
}
# 1290 "../../fs/ext4/namei.c"
        ...
        struct buffer_head *bh)
{
 ...
 de->file_type = 0;
 if (inode) {
  de->inode = (( __le32)(__u32)(inode->i_ino));
  ext4_set_de_type(dir->i_sb, de, inode->i_mode);
 } else
  de->inode = 0;
 de->name_len = namelen;
 memcpy(de->name, name, namelen);
# 1358 "../../fs/ext4/namei.c"
 dir->i_mtime = dir->i_ctime = ext4_current_time(dir);
 ext4_update_dx_flag(dir);
 dir->i_version++;
 ext4_mark_inode_dirty(handle, dir);
 do {} while (0);
 err = __ext4_handle_dirty_metadata(__func__, (handle), (dir), (bh));
 if (err)
  do { if ((err)) __ext4_std_error((dir->i_sb), __func__, (err)); } while (0);
 return 0;
}
       ...
       struct inode *inode, struct buffer_head *bh)
{
 ...
 ;
 retval = __ext4_journal_get_write_access(__func__, (handle), (bh));
 if (retval) {
  do { if ((retval)) __ext4_std_error((dir->i_sb), __func__, (retval)); } while (0);
  brelse(bh);
  return retval;
 }
 root = (struct dx_root *) bh->b_data;
 ...
 if ((char *) de >= (((char *) root) + blocksize)) {
  ext4_error_inode(__func__, (dir), ("invalid rec_len for '..'"));
  brelse(bh);
  return -5;
 }
 ...
 de->rec_len = ext4_rec_len_to_disk(blocksize - (((2) + 8 + (4 - 1)) & ~(4 - 1)),
        blocksize);
 ({ void *__p = (&root->info); size_t __n = sizeof(root->info); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
     ...
     struct inode *inode)
{
 ...
 for (block = 0; block < blocks; block++) {
  ...
  if (blocks == 1 && !dx_fallback &&
      ((EXT4_SB(sb)->s_es->s_feature_compat & (( __le32)(__u32)(0x0020))) != 0))
        ...
        struct inode *inode)
{
 ...
 err = add_dirent_to_buf(handle, dentry, inode, ((void *)0), bh);
 if (err != -28)
  goto cleanup;
 ...
 if (dx_get_count(entries) == dx_get_limit(entries)) {
  ...
  if (levels && (dx_get_count(frames->entries) ==
   ...
   __ext4_warning(sb, __func__, "Directory index full!");
   err = -28;
   goto cleanup;
  }
  bh2 = ext4_append (handle, dir, &newblock, &err);
  ...
  ({ void *__p = (&node2->fake); size_t __n = sizeof(struct fake_dirent); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
  ...
  if (levels) {
   ...
   do {} while (0);
   err = __ext4_journal_get_write_access(__func__, (handle), (frames[0].bh));
   ...
   if (at - entries >= icount1) {
    ...
    do { typeof(frame->bh) __tmp = (frame->bh); (frame->bh) = (bh2); (bh2) = __tmp; } while (0);
   }
   dx_insert_block(frames + 0, hash2, newblock);
   ;
   ;

   err = __ext4_handle_dirty_metadata(__func__, (handle), (inode), (bh2));
   if (err)
    goto journal_error;
   brelse (bh2);
  } else {
  ...
  __ext4_handle_dirty_metadata(__func__, (handle), (inode), (frames[0].bh));
 }
        ...
        struct buffer_head *bh)
{
 ...
 while (i < bh->b_size) {
  ...
  if (de == de_del) {
   ...
   dir->i_version++;
   do {} while (0);
   __ext4_handle_dirty_metadata(__func__, (handle), (dir), (bh));
   return 0;
  }
...
{
 inc_nlink(inode);
 if ((((EXT4_SB(inode->i_sb)->s_es->s_feature_compat & (( __le32)(__u32)(0x0020))) != 0) && ext4_test_inode_flag((inode), EXT4_INODE_INDEX)) && inode->i_nlink > 1) {

  if (inode->i_nlink >= 65000 || inode->i_nlink == 2) {
   inode->i_nlink = 1;
   EXT4_SB(inode->i_sb)->s_es->s_feature_ro_compat |= (( __le32)(__u32)(0x0020));
...
{
 drop_nlink(inode);
 if ((((inode->i_mode) & 00170000) == 0040000) && inode->i_nlink == 0)
  inc_nlink(inode);
}
...
retry:
 handle = ext4_journal_start(dir, ((((EXT4_SB(dir->i_sb)->s_es->s_feature_incompat & (( __le32)(__u32)(0x0040))) != 0) ? 27U : 8U) + 6U - 2 + (2*0)) +
     8 + 3 +
     (2*0));
 if (IS_ERR(handle))
  return PTR_ERR(handle);

 if ((((dir)->i_sb->s_flags & (16|128)) || ((dir)->i_flags & (1|64))))
 ...
 if (err == -28 && ext4_should_retry_alloc(dir->i_sb, &retries))
  goto retry;
 return err;
}
...
static int ext4_mkdir(struct inode *dir, struct dentry *dentry, int mode)
{
 ...
 if ((!(((EXT4_SB(dir->i_sb)->s_es->s_feature_compat & (( __le32)(__u32)(0x0020))) != 0) && ext4_test_inode_flag((dir), EXT4_INODE_INDEX)) && (dir)->i_nlink >= 65000))
  return -31;
...
retry:
 ...
 inode = ext4_new_inode(handle, dir, 0040000 | mode,
          &dentry->d_name, 0);
 err = PTR_ERR(inode);
 if (IS_ERR(inode))
  goto out_stop;
 ...
 do {} while (0);
 __ext4_journal_get_write_access(__func__, (handle), (dir_block));
 de = (struct ext4_dir_entry_2 *) dir_block->b_data;
 de->inode = (( __le32)(__u32)(inode->i_ino));
 de->name_len = 1;
 de->rec_len = ext4_rec_len_to_disk((((de->name_len) + 8 + (4 - 1)) & ~(4 - 1)),
        blocksize);
 strcpy(de->name, ".");
 ext4_set_de_type(dir->i_sb, de, 0040000);
 de = ext4_next_entry(de, blocksize);
 de->inode = (( __le32)(__u32)(dir->i_ino));
 de->rec_len = ext4_rec_len_to_disk(blocksize - (((1) + 8 + (4 - 1)) & ~(4 - 1)),
        blocksize);
 de->name_len = 2;
 strcpy(de->name, "..");
 ext4_set_de_type(dir->i_sb, de, 0040000);
 inode->i_nlink = 2;
 do {} while (0);
 __ext4_handle_dirty_metadata(__func__, (handle), (dir), (dir_block));
 brelse(dir_block);
 ext4_mark_inode_dirty(handle, inode);
...
static int empty_dir(struct inode *inode)
{
 ...
 sb = inode->i_sb;
 if (inode->i_size < (((1) + 8 + (4 - 1)) & ~(4 - 1)) + (((2) + 8 + (4 - 1)) & ~(4 - 1)) ||
     !(bh = ext4_bread(((void *)0), inode, 0, 0, &err))) {
  if (err)
   ext4_error_inode(__func__, (inode), ("error %d reading directory lblock 0"), err);

  else
   __ext4_warning(inode->i_sb, __func__, "bad directory (dir #%lu) - no data block", inode->i_ino);
 ...
 if ((( __u32)(__le32)(de->inode)) != inode->i_ino ||
   !(( __u32)(__le32)(de1->inode)) ||
   strcmp(".", de->name) ||
   strcmp("..", de1->name)) {
  __ext4_warning(inode->i_sb, __func__, "bad directory (dir #%lu) - no `.' or `..'", inode->i_ino);
 ...
 while (offset < inode->i_size) {
  if (!bh ||
   ...
   err = 0;
   brelse(bh);
   lblock = offset >> ((sb)->s_blocksize_bits);
   bh = ext4_bread(((void *)0), inode, lblock, 0, &err);
   if (!bh) {
    if (err)
     ext4_error_inode(__func__, (inode), ("error %d reading directory " "lblock %u"), err, lblock);
...
int ext4_orphan_add(handle_t *handle, struct inode *inode)
{
 ...
 if (!list_empty(&EXT4_I(inode)->i_orphan))
  goto out_unlock;
# 2010 "../../fs/ext4/namei.c"
 do { if (__builtin_expect(!!(!(((((inode->i_mode) & 00170000) == 0100000) || (((inode->i_mode) & 00170000) == 0040000) || (((inode->i_mode) & 00170000) == 0120000)) || inode->i_nlink == 0)), 0)) do { *(int *)0 = 0; } while (1); } while(0);


 do {} while (0);
 err = __ext4_journal_get_write_access(__func__, (handle), (EXT4_SB(sb)->s_sbh));
 if (err)
  goto out_unlock;
 ...
 if (EXT4_I(inode)->i_dtime && EXT4_I(inode)->i_dtime <=
  ((( __u32)(__le32)(EXT4_SB(sb)->s_es->s_inodes_count))))
   goto mem_insert;


 EXT4_I(inode)->i_dtime = (( __u32)(__le32)(EXT4_SB(sb)->s_es->s_last_orphan));
 EXT4_SB(sb)->s_es->s_last_orphan = (( __le32)(__u32)(inode->i_ino));
 err = __ext4_handle_dirty_metadata(__func__, (handle), (((void *)0)), (EXT4_SB(sb)->s_sbh));
 rc = ext4_mark_iloc_dirty(handle, inode, &iloc);
 if (!err)
  err = rc;
# 2045 "../../fs/ext4/namei.c"
mem_insert:
 if (!err)
...
out_unlock:
 ...
 do { if ((err)) __ext4_std_error((inode->i_sb), __func__, (err)); } while (0);
 return err;
}
...
int ext4_orphan_del(handle_t *handle, struct inode *inode)
{
 ...
 if (prev == &sbi->s_orphan) {
  ;
  do {} while (0);
  err = __ext4_journal_get_write_access(__func__, (handle), (sbi->s_sbh));
  if (err)
   goto out_brelse;
  sbi->s_es->s_last_orphan = (( __le32)(__u32)(ino_next));
  err = __ext4_handle_dirty_metadata(__func__, (handle), (((void *)0)), (sbi->s_sbh));
 } else {
  struct ext4_iloc iloc2;
  struct inode *i_prev =
   &({ const typeof( ((struct ext4_inode_info *)0)->i_orphan ) *__mptr = (prev); (struct ext4_inode_info *)( (char *)__mptr - __builtin_offsetof(struct ext4_inode_info,i_orphan) );})->vfs_inode;
  ...
  if (err)
   goto out_brelse;
  EXT4_I(i_prev)->i_dtime = ino_next;
...
static int ext4_rmdir(struct inode *dir, struct dentry *dentry)
{
 ...
 handle = ext4_journal_start(dir, (2 * ((((EXT4_SB(dir->i_sb)->s_es->s_feature_incompat & (( __le32)(__u32)(0x0040))) != 0) ? 27U : 8U) + 6U - 2 + (2*0)) + 64));
 if (IS_ERR(handle))
  return PTR_ERR(handle);
 ...
 if (!((inode)->i_nlink == 2 || (inode)->i_nlink == 1))
  __ext4_warning(inode->i_sb, __func__, "empty directory has too many links (%d)", inode->i_nlink);
...
static int ext4_unlink(struct inode *dir, struct dentry *dentry)
{
 ...
 if (!inode->i_nlink) {
  __ext4_warning(inode->i_sb, __func__, "Deleting nonexistent file (%lu), %d", inode->i_ino, inode->i_nlink);
...
retry:
 ...
 inode = ext4_new_inode(handle, dir, 0120000|(00700|00070|00007),
          &dentry->d_name, 0);
 err = PTR_ERR(inode);
 if (IS_ERR(inode))
  goto out_stop;
         ...
         struct inode *new_dir, struct dentry *new_dentry)
{
 ...
 handle = ext4_journal_start(old_dir, 2 *
     ((((EXT4_SB(old_dir->i_sb)->s_es->s_feature_incompat & (( __le32)(__u32)(0x0040))) != 0) ? 27U : 8U) + 6U - 2 + (2*0)) +
     8 + 2);
 if (IS_ERR(handle))
  return PTR_ERR(handle);

 if ((((old_dir)->i_sb->s_flags & (16|128)) || ((old_dir)->i_flags & (1|64))) || (((new_dir)->i_sb->s_flags & (16|128)) || ((new_dir)->i_flags & (1|64))))
  ext4_handle_sync(handle);
 ...
 retval = -2;
 if (!old_bh || (( __u32)(__le32)(old_de->inode)) != old_inode->i_ino)
  goto end_rename;
 ...
 if ((((old_inode->i_mode) & 00170000) == 0040000)) {
  if (new_inode) {
   retval = -39;
  ...
  if (!dir_bh)
   goto end_rename;
  if ((( __u32)(__le32)((ext4_next_entry((struct ext4_dir_entry_2 *)(dir_bh->b_data), old_dir->i_sb->s_blocksize)->inode))) != old_dir->i_ino)

   goto end_rename;
  retval = -31;
  if (!new_inode && new_dir != old_dir &&
      (!(((EXT4_SB(new_dir->i_sb)->s_es->s_feature_compat & (( __le32)(__u32)(0x0020))) != 0) && ext4_test_inode_flag((new_dir), EXT4_INODE_INDEX)) && (new_dir)->i_nlink >= 65000))
   goto end_rename;
 }
 if (!new_bh) {
  ...
  do {} while (0);
  __ext4_journal_get_write_access(__func__, (handle), (new_bh));
  new_de->inode = (( __le32)(__u32)(old_inode->i_ino));
  if (((EXT4_SB(new_dir->i_sb)->s_es->s_feature_incompat & (( __le32)(__u32)(0x0002))) != 0))
  ...
  do {} while (0);
  __ext4_handle_dirty_metadata(__func__, (handle), (new_dir), (new_bh));
  brelse(new_bh);
  new_bh = ((void *)0);
 }
 ...
 if ((( __u32)(__le32)(old_de->inode)) != old_inode->i_ino ||
 ...
 if (retval) {
  __ext4_warning(old_dir->i_sb, __func__, "Deleting old file (%lu), %d, error=%d", old_dir->i_ino, old_dir->i_nlink, retval);
 ...
 if (dir_bh) {
  do {} while (0);
  __ext4_journal_get_write_access(__func__, (handle), (dir_bh));
  (ext4_next_entry((struct ext4_dir_entry_2 *)(dir_bh->b_data), new_dir->i_sb->s_blocksize)->inode) =
      (( __le32)(__u32)(new_dir->i_ino));
  do {} while (0);
  __ext4_handle_dirty_metadata(__func__, (handle), (old_dir), (dir_bh));
 ...
 if (new_inode) {
  ...
  if (!(EXT4_SB(new_dir->i_sb)->s_mount_opt & 0x10000))
   force_da_alloc = 1;
 }
 retval = 0;
