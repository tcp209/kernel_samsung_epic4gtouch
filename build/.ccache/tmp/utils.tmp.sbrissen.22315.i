...
int net_msg_warn = 1;
extern typeof(net_msg_warn) net_msg_warn; static const char __kstrtab_net_msg_warn[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "net_msg_warn"; static const struct kernel_symbol __ksymtab_net_msg_warn __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&net_msg_warn, __kstrtab_net_msg_warn };

struct ratelimit_state net_ratelimit_state = { .lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } }, .interval = 5 * 200, .burst = 10, };



int net_ratelimit(void)
{
 return ___ratelimit(&net_ratelimit_state, __func__);
}
extern typeof(net_ratelimit) net_ratelimit; static const char __kstrtab_net_ratelimit[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "net_ratelimit"; static const struct kernel_symbol __ksymtab_net_ratelimit __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&net_ratelimit, __kstrtab_net_ratelimit };
...
__be32 in_aton(const char *str)
{
 ...
 return((( __be32)(__builtin_constant_p((__u32)((l))) ? ((__u32)( (((__u32)((l)) & (__u32)0x000000ffUL) << 24) | (((__u32)((l)) & (__u32)0x0000ff00UL) << 8) | (((__u32)((l)) & (__u32)0x00ff0000UL) >> 8) | (((__u32)((l)) & (__u32)0xff000000UL) >> 24))) : __fswab32((l)))));
}

extern typeof(in_aton) in_aton; static const char __kstrtab_in_aton[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "in_aton"; static const struct kernel_symbol __ksymtab_in_aton __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&in_aton, __kstrtab_in_aton };
# 94 "../../net/core/utils.c"
...
extern typeof(in4_pton) in4_pton; static const char __kstrtab_in4_pton[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "in4_pton"; static const struct kernel_symbol __ksymtab_in4_pton __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&in4_pton, __kstrtab_in4_pton };
      ...
      int delim, const char **end)
{
 ...
 ({ void *__p = (dbuf); size_t __n = sizeof(dbuf); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
...
extern typeof(in6_pton) in6_pton; static const char __kstrtab_in6_pton[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "in6_pton"; static const struct kernel_symbol __ksymtab_in6_pton __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&in6_pton, __kstrtab_in6_pton };
...
extern typeof(inet_proto_csum_replace4) inet_proto_csum_replace4; static const char __kstrtab_inet_proto_csum_replace4[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "inet_proto_csum_replace4"; static const struct kernel_symbol __ksymtab_inet_proto_csum_replace4 __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&inet_proto_csum_replace4, __kstrtab_inet_proto_csum_replace4 };
