...
# 36 "../../drivers/serial/samsung.c" 2

# 1 "../../include/linux/sysrq.h" 1
...
static inline __attribute__((always_inline)) int register_sysrq_key(int key, struct sysrq_key_op *op)
{
 return -22;
}

static inline __attribute__((always_inline)) int unregister_sysrq_key(int key, struct sysrq_key_op *op)
{
 return -22;
}
# 38 "../../drivers/serial/samsung.c" 2
...
# 231 "../../include/linux/tty_driver.h"
...
# 232 "../../include/linux/tty_driver.h" 2
...
static inline __attribute__((always_inline)) struct tty_port *tty_port_get(struct tty_port *port)
{
 if (port)
  kref_get(&port->kref);
 return port;
...
extern int tty_port_open(struct tty_port *port,
    struct tty_struct *tty, struct file *filp);
static inline __attribute__((always_inline)) int tty_port_users(struct tty_port *port)
{
...
extern int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) tty_init(void);
...
static inline __attribute__((always_inline)) int tty_insert_flip_char(struct tty_struct *tty,
...
static inline __attribute__((always_inline)) int tty_insert_flip_string(struct tty_struct *tty, const unsigned char *chars, size_t size)
{
 return tty_insert_flip_string_fixed_flag(tty, chars, 0, size);
}
# 41 "../../drivers/serial/samsung.c" 2
...
# 24 "../../include/linux/serial_core.h" 2
# 192 "../../include/linux/serial_core.h"
...
# 193 "../../include/linux/serial_core.h" 2
...
# 194 "../../include/linux/serial_core.h" 2
...
# 298 "../../include/linux/serial_core.h"
 ...
 upf_t flags;
# 337 "../../include/linux/serial_core.h"
 unsigned int mctrl;
...
# 440 "../../include/linux/serial_core.h"
static inline __attribute__((always_inline)) int uart_tx_stopped(struct uart_port *port)
{
...
{
# 464 "../../include/linux/serial_core.h"
 return 0;
}
...
# 485 "../../include/linux/serial_core.h"
 if (port->flags & (( upf_t) (1 << 2)))
...
uart_handle_dcd_change(struct uart_port *uport, unsigned int status)
{
 ...
 if (port->flags & (1U << 25)) {
  if (status)
   __wake_up(&port->open_wait, 1, 1, ((void *)0));
  else if (port->tty)
   tty_hangup(port->tty);
 }
...
int clk_add_alias(const char *alias, const char *alias_dev_name, char *id,
   struct device *dev);
# 45 "../../drivers/serial/samsung.c" 2
# 1 "../../include/linux/cpufreq.h" 1
...
static inline __attribute__((always_inline)) unsigned long cpufreq_scale(unsigned long old, u_int div, u_int mult)
{


 u64 result = ((u64) old) * ((u64) mult);
 ({ unsigned int __r, __b = (div); if (!__builtin_constant_p(__b) || __b == 0 || (7 < 4 && (__b & (__b - 1)) != 0)) { __r = ({ register unsigned int __base asm("r4") = __b; register unsigned long long __n asm("r0") = result; register unsigned long long __res asm("r2"); register unsigned int __rem asm("r1"); asm( ".ifnc " "%0" "," "r1" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%3" "," "r4" " ; .err ; .endif\n\t" "bl	__do_div64" : "=r" (__rem), "=r" (__res) : "r" (__n), "r" (__base) : "ip", "lr", "cc"); result = __res; __rem; }); } else if ((__b & (__b - 1)) == 0) { __r = result; __r &= (__b - 1); result /= __b; } else { unsigned long long __res, __x, __t, __m, __n = result; unsigned int __c, __p, __z = 0; __r = __n; __p = 1 << ({ unsigned int __left = (__b), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); __m = (~0ULL / __b) * __p; __m += (((~0ULL % __b + 1) * __p) + __b - 1) / __b; __x = ~0ULL / __b * __b - 1; __res = (__m & 0xffffffff) * (__x & 0xffffffff); __res >>= 32; __res += (__m & 0xffffffff) * (__x >> 32); __t = __res; __res += (__x & 0xffffffff) * (__m >> 32); __t = (__res < __t) ? (1ULL << 32) : 0; __res = (__res >> 32) + __t; __res += (__m >> 32) * (__x >> 32); __res /= __p; if (~0ULL % (__b / (__b & -__b)) == 0) { __n /= (__b & -__b); __m = ~0ULL / (__b / (__b & -__b)); __p = 1; __c = 1; } else if (__res != __x / __b) { __c = 1; __m = (~0ULL / __b) * __p; __m += ((~0ULL % __b + 1) * __p) / __b; } else { unsigned int __bits = -(__m & -__m); __bits |= __m >> 32; __bits = (~__bits) << 1; if (!__bits) { __p /= (__m & -__m); __m /= (__m & -__m); } else { __p >>= ({ unsigned int __left = (__bits), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); __m >>= ({ unsigned int __left = (__bits), __nr = 0; if (__left & 0xffff0000) __nr += 16, __left >>= 16; if (__left & 0x0000ff00) __nr += 8, __left >>= 8; if (__left & 0x000000f0) __nr += 4, __left >>= 4; if (__left & 0x0000000c) __nr += 2, __left >>= 2; if (__left & 0x00000002) __nr += 1; __nr; }); } __c = 0; } if (!__c) { asm ( "umull	%Q0, %R0, %1, %Q2\n\t" "mov	%Q0, #0" : "=&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else if (!(__m & ((1ULL << 63) | (1ULL << 31)))) { __res = __m; asm ( "umlal	%Q0, %R0, %Q1, %Q2\n\t" "mov	%Q0, #0" : "+&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else { asm ( "umull	%Q0, %R0, %Q1, %Q2\n\t" "cmn	%Q0, %Q1\n\t" "adcs	%R0, %R0, %R1\n\t" "adc	%Q0, %3, #0" : "=&r" (__res) : "r" (__m), "r" (__n), "r" (__z) : "cc" ); } if (!(__m & ((1ULL << 63) | (1ULL << 31)))) { asm ( "umlal	%R0, %Q0, %R1, %Q2\n\t" "umlal	%R0, %Q0, %Q1, %R2\n\t" "mov	%R0, #0\n\t" "umlal	%Q0, %R0, %R1, %R2" : "+&r" (__res) : "r" (__m), "r" (__n) : "cc" ); } else { asm ( "umlal	%R0, %Q0, %R2, %Q3\n\t" "umlal	%R0, %1, %Q2, %R3\n\t" "mov	%R0, #0\n\t" "adds	%Q0, %1, %Q0\n\t" "adc	%R0, %R0, #0\n\t" "umlal	%Q0, %R0, %R2, %R3" : "+&r" (__res), "+&r" (__z) : "r" (__m), "r" (__n) : "cc" ); } __res /= __p; { unsigned int __res0 = __res; unsigned int __b0 = __b; __r -= __res0 * __b0; } result = __res; } __r; });
 return (unsigned long) result;
# 158 "../../include/linux/cpufreq.h"
};
# 168 "../../include/linux/cpufreq.h"
struct cpufreq_governor {
 char name[16];
...
static inline __attribute__((always_inline)) void cpufreq_verify_within_limits(struct cpufreq_policy *policy, unsigned int min, unsigned int max)
{
 if (policy->min < min)
  policy->min = min;
 if (policy->max < min)
...
# 337 "../../include/linux/cpufreq.h"
unsigned int cpufreq_quick_get(unsigned int cpu);
# 356 "../../include/linux/cpufreq.h"
extern struct cpufreq_governor cpufreq_gov_performance;
# 367 "../../include/linux/cpufreq.h"
extern struct cpufreq_governor cpufreq_gov_ondemand;
# 385 "../../include/linux/cpufreq.h"
...
# 46 "../../drivers/serial/samsung.c" 2



# 1 "../../arch/arm/mach-s5pv310/include/mach/hardware.h" 1
# 50 "../../drivers/serial/samsung.c" 2
...
# 51 "../../drivers/serial/samsung.c" 2

# 1 "../../arch/arm/plat-samsung/include/plat/regs-serial.h" 1
# 229 "../../arch/arm/plat-samsung/include/plat/regs-serial.h"
struct platform_device;
# 244 "../../arch/arm/plat-samsung/include/plat/regs-serial.h"
...
# 258 "../../arch/arm/plat-samsung/include/plat/regs-serial.h"
...
extern struct platform_device *s3c24xx_uart_devs[5];
# 53 "../../drivers/serial/samsung.c" 2

# 1 "../../drivers/serial/samsung.h" 1
# 13 "../../drivers/serial/samsung.h"
...
# 72 "../../drivers/serial/samsung.h"
extern int s3c24xx_serial_probe(struct platform_device *dev,
    struct s3c24xx_uart_info *uart);

extern int __attribute__ ((__section__(".devexit.text"))) __attribute__((__used__)) __attribute__((__cold__)) s3c24xx_serial_remove(struct platform_device *dev);
...
# 55 "../../drivers/serial/samsung.c" 2
# 70 "../../drivers/serial/samsung.c"
static inline __attribute__((always_inline)) struct s3c24xx_uart_port *to_ourport(struct uart_port *port)
{
 return ({ const typeof( ((struct s3c24xx_uart_port *)0)->port ) *__mptr = (port); (struct s3c24xx_uart_port *)( (char *)__mptr - __builtin_offsetof(struct s3c24xx_uart_port,port) );});
}



static inline __attribute__((always_inline)) const char *s3c24xx_serial_portname(struct uart_port *port)
{
 return ({ const typeof( ((struct platform_device *)0)->dev ) *__mptr = ((port->dev)); (struct platform_device *)( (char *)__mptr - __builtin_offsetof(struct platform_device,dev) );})->name;
}

static int s3c24xx_serial_txempty_nofifo(struct uart_port *port)
{
 return ((((void)0, *(volatile unsigned int *)(((port)->membase + ((0x10)))))) & (1<<2));
}
...
static void s3c24xx_serial_rx_enable(struct uart_port *port)
{
 ...
 do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = _raw_spin_lock_irqsave(spinlock_check(&port->lock)); } while (0); } while (0);

 while (--count && !s3c24xx_serial_txempty_nofifo(port))
  (__builtin_constant_p(100) ? ((100) > (2 * 1000) ? __bad_udelay() : __const_udelay((100) * ((2199023U*200)>>11))) : __udelay(100));

 ufcon = (((void)0, *(volatile unsigned int *)(((port)->membase + ((0x08))))));
 ufcon |= (1<<1);
 ((void)0, *(volatile unsigned int *)(((port)->membase + ((0x08)))) = (ufcon));

 ucon = (((void)0, *(volatile unsigned int *)(((port)->membase + ((0x04))))));
 ucon |= (1<<0);
 ((void)0, *(volatile unsigned int *)(((port)->membase + ((0x04)))) = (ucon));
...
static inline __attribute__((always_inline)) struct s3c24xx_uart_info *s3c24xx_port_to_info(struct uart_port *port)
{
 return to_ourport(port)->info;
}

static inline __attribute__((always_inline)) struct s3c2410_uartcfg *s3c24xx_port_to_cfg(struct uart_port *port)
{
 if (port->dev == ((void *)0))
  return ((void *)0);
...
s3c24xx_serial_rx_chars(int irq, void *dev_id)
{
 ...
 while (max_count-- > 0) {
  ufcon = (((void)0, *(volatile unsigned int *)(((port)->membase + ((0x08))))));
  ufstat = (((void)0, *(volatile unsigned int *)(((port)->membase + ((0x18))))));

  if (s3c24xx_serial_rx_fifocnt(ourport, ufstat) == 0)
   break;

  uerstat = (((void)0, *(volatile unsigned int *)(((port)->membase + ((0x14))))));
  ch = (((void)0, *(volatile unsigned char *)(((port)->membase + ((0x24))))));
  ...
  if (__builtin_expect(!!(uerstat & ((1<<0) | (1<<2) | (1<<3))), 0)) {
   do { } while (0);
  ...
  if (uart_handle_sysrq_char(port, 0))
   goto ignore_char;

  uart_insert_char(port, uerstat, (1<<0),
     ch, flag);
...
static irqreturn_t s3c24xx_serial_tx_chars(int irq, void *id)
{
 ...
 if (port->x_char) {
  ((void)0, *(volatile unsigned char *)(((port)->membase + ((0x20)))) = (port->x_char));
  port->icount.tx++;
  port->x_char = 0;
  goto out;
 }
 ...
 if (((xmit)->head == (xmit)->tail) || uart_tx_stopped(port)) {
 ...
 while (!((xmit)->head == (xmit)->tail) && count-- > 0) {
  if ((((void)0, *(volatile unsigned int *)(((port)->membase + ((0x18)))))) & ourport->info->tx_fifofull)
   break;

  ((void)0, *(volatile unsigned char *)(((port)->membase + ((0x20)))) = (xmit->buf[xmit->tail]));
  xmit->tail = (xmit->tail + 1) & (((1UL) << 12) - 1);
  port->icount.tx++;
 }

 if ((((((xmit)->head) - ((xmit)->tail)) & ((((1UL) << 12))-1))) < 256)
...
static unsigned int s3c24xx_serial_tx_empty(struct uart_port *port)
{
 ...
 unsigned long ufstat = (((void)0, *(volatile unsigned int *)(((port)->membase + ((0x18))))));
 unsigned long ufcon = (((void)0, *(volatile unsigned int *)(((port)->membase + ((0x08))))));
...
{
 unsigned int umstat = (((void)0, *(volatile unsigned char *)(((port)->membase + ((0x1C))))));

 if (umstat & (1<<0))
  return 0x040 | 0x100 | 0x020;
 else
  return 0x040 | 0x100;
}
...
static void s3c24xx_serial_set_mctrl(struct uart_port *port, unsigned int mctrl)
{
 ...
 umcon = (((void)0, *(volatile unsigned int *)(((port)->membase + ((0x0C))))));
 ...
 ((void)0, *(volatile unsigned int *)(((port)->membase + ((0x0C)))) = (umcon));
}
         ...
         unsigned int old)
{
 ...
 switch (level) {
 case 3:
  if (!IS_ERR(ourport->baudclk) && ourport->baudclk != ((void *)0))
 ...
 case 0:
  ...
  break;
 default:
  printk("<3>" "s3c24xx_serial: unknown pm %d\n", level);
 }
}
# 499 "../../drivers/serial/samsung.c"
           ...
           struct ktermios *old)
{
 ...
 termios->c_cflag &= ~(0002000 | 010000000000);
 termios->c_cflag |= 0004000;
 ...
 if (baud == 38400 && (port->flags & (( upf_t) (0x1030))) == (( upf_t) (0x0030)))
 ...
 switch (termios->c_cflag & 0000060) {
 case 0000000:
  do { } while (0);
  ulcon = (0x0);
  break;
 ...
 if (termios->c_cflag & 0000100)
  ulcon |= (1<<2);

 umcon = (termios->c_cflag & 020000000000) ? (1<<4) : 0;

 if (termios->c_cflag & 0000400) {
  if (termios->c_cflag & 0001000)
   ulcon |= (0x4 << 3);
  else
   ulcon |= (0x5 << 3);
 } else {
 ...
 ((void)0, *(volatile unsigned int *)(((port)->membase + ((0x00)))) = (ulcon));
 ((void)0, *(volatile unsigned int *)(((port)->membase + ((0x28)))) = (quot));
 ((void)0, *(volatile unsigned int *)(((port)->membase + ((0x0C)))) = (umcon));

 if (ourport->info->has_divslot)
  ((void)0, *(volatile unsigned int *)(((port)->membase + ((0x2C)))) = (udivslot));
 ...
 port->read_status_mask = (1<<0);
 if (termios->c_iflag & 0000020)
  port->read_status_mask |= (1<<2) | (0x1000);




 port->ignore_status_mask = 0;
 if (termios->c_iflag & 0000004)
  port->ignore_status_mask |= (1<<0);
 if (termios->c_iflag & 0000001 && termios->c_iflag & 0000004)
  port->ignore_status_mask |= (1<<2);




 if ((termios->c_cflag & 0000200) == 0)
  port->ignore_status_mask |= (0x10000000);
...
{
 __release_region(&iomem_resource, (port->mapbase), ((0x100)));
}

static int s3c24xx_serial_request_port(struct uart_port *port)
{
 const char *name = s3c24xx_serial_portname(port);
 return __request_region(&iomem_resource, (port->mapbase), ((0x100)), (name), 0) ? 0 : -16;
}
...
s3c24xx_serial_verify_port(struct uart_port *port, struct serial_struct *ser)
{
 ...
 if (ser->type != 0 && ser->type != info->type)
  return -22;
...
static struct s3c24xx_uart_port s3c24xx_serial_ports[5] = {
 [0] = {
  .port = {
   .lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } },
   .iotype = (2),
   .irq = ((16) + (0)),
   .uartclk = 0,
   .fifosize = 16,
...
static inline __attribute__((always_inline)) int s3c24xx_serial_resetport(struct uart_port *port,
          ...
          unsigned long val, void *data)
{
 ...
 port = ({ const typeof( ((struct s3c24xx_uart_port *)0)->freq_transition ) *__mptr = (nb); (struct s3c24xx_uart_port *)( (char *)__mptr - __builtin_offsetof(struct s3c24xx_uart_port,freq_transition) );});
 uport = &port->port;
 ...
 if (val == (0)) {
  ...
  if (termios == ((void *)0)) {
   printk("<4>" "%s: no termios?\n", __func__);
   goto exit;
  }

  s3c24xx_serial_set_termios(uport, termios, ((void *)0));
 }
...
static inline __attribute__((always_inline)) int s3c24xx_serial_cpufreq_register(struct s3c24xx_uart_port *port)
{
...
static inline __attribute__((always_inline)) void s3c24xx_serial_cpufreq_deregister(struct s3c24xx_uart_port *port)
{
 cpufreq_unregister_notifier(&port->freq_transition,
        (0));
}
# 1103 "../../drivers/serial/samsung.c"
        ...
        struct platform_device *platdev)
{
 ...
 cfg = (struct s3c2410_uartcfg *)((&platdev->dev)->platform_data);

 if (port->mapbase != 0)
  return 0;

 if (cfg->hwport > 5) {
  printk("<3>" "%s: port %d bigger than %d\n", __func__,
         cfg->hwport, 5);
  return -34;
 }
 ...
 if (cfg->uart_flags & (( upf_t) (1 << 23))) {
  do { } while (0);
  port->flags |= (( upf_t) (1 << 23));
 }



 res = platform_get_resource(platdev, 0x00000200, 0);
 if (res == ((void *)0)) {
  printk("<3>" "failed to find memory resource for uart\n");
  return -22;
 }
 ...
 port->membase = ((void *)(0xF4000000) + (0x01000000)) + res->start - ((0x13800000) & 0xfff00000);
 ...
 if (cfg->cfg_gpio)
  ...
  ({ int __ret_warn_on = !!(1); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_fmt("../../drivers/serial/samsung.c", 1182, "cfg_gpio is NULL!"); __builtin_expect(!!(__ret_warn_on), 0); });
...
static struct device_attribute dev_attr_clock_source = { .attr = {.name = "clock_source", .mode = (00400|00040|00004) }, .show = s3c24xx_serial_show_clksrc, .store = ((void *)0), };
    ...
    struct s3c24xx_uart_info *info)
{
 ...
 dev_set_drvdata(&(dev)->dev, (&ourport->port));

 ret = device_create_file(&dev->dev, &dev_attr_clock_source);
 if (ret < 0)
  printk("<3>" "%s: failed to add clksrc attr.\n", __func__);
...
extern typeof(s3c24xx_serial_probe) s3c24xx_serial_probe; static const char __kstrtab_s3c24xx_serial_probe[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "s3c24xx_serial_probe"; static const struct kernel_symbol __ksymtab_s3c24xx_serial_probe __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&s3c24xx_serial_probe, __kstrtab_s3c24xx_serial_probe };

int __attribute__ ((__section__(".devexit.text"))) __attribute__((__used__)) __attribute__((__cold__)) s3c24xx_serial_remove(struct platform_device *dev)
{
...
extern typeof(s3c24xx_serial_remove) s3c24xx_serial_remove; static const char __kstrtab_s3c24xx_serial_remove[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "s3c24xx_serial_remove"; static const struct kernel_symbol __ksymtab_s3c24xx_serial_remove __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&s3c24xx_serial_remove, __kstrtab_s3c24xx_serial_remove };
...
extern typeof(s3c24xx_serial_init) s3c24xx_serial_init; static const char __kstrtab_s3c24xx_serial_init[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "s3c24xx_serial_init"; static const struct kernel_symbol __ksymtab_s3c24xx_serial_init __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&s3c24xx_serial_init, __kstrtab_s3c24xx_serial_init };



static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) s3c24xx_serial_modinit(void)
{
 int ret;

 ret = uart_register_driver(&s3c24xx_uart_drv);
 if (ret < 0) {
  printk("<3>" "failed to register UART driver\n");
  return -1;
 }
...
static void __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) s3c24xx_serial_modexit(void)
{
 uart_unregister_driver(&s3c24xx_uart_drv);
}

static initcall_t __initcall_s3c24xx_serial_modinit6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = s3c24xx_serial_modinit;;
static exitcall_t __exitcall_s3c24xx_serial_modexit __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit"))) = s3c24xx_serial_modexit;;
...
s3c24xx_serial_console_txrdy(struct uart_port *port, unsigned int ufcon)
{
 ...
 utrstat = (((void)0, *(volatile unsigned int *)(((port)->membase + ((0x10))))));
...
{
 unsigned int ufcon = (((void)0, *(volatile unsigned int *)(((cons_uart)->membase + ((0x08))))));
 while (!s3c24xx_serial_console_txrdy(port, ufcon))
  __asm__ __volatile__("": : :"memory");
 ((void)0, *(volatile unsigned char *)(((cons_uart)->membase + ((0x20)))) = (ch));
}
...
static void __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function))
      ...
      int *parity, int *bits)
{
 ...
 ulcon = (((void)0, *(volatile unsigned int *)(((port)->membase + ((0x00))))));
 ucon = (((void)0, *(volatile unsigned int *)(((port)->membase + ((0x04))))));
 ubrdiv = (((void)0, *(volatile unsigned int *)(((port)->membase + ((0x28))))));
...

{
 ...
 if (dev == ((void *)0)) {
  printk("<3>" "s3c24xx: no devices for console init\n");
  return 0;
 }
