# 1 "../../drivers/net/wireless/bcmdhd/bcmsdh.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../drivers/net/wireless/bcmdhd/bcmsdh.c"
# 34 "../../drivers/net/wireless/bcmdhd/bcmsdh.c"
...
# 35 "../../drivers/net/wireless/bcmdhd/bcmsdh.c" 2
# 1 "../../drivers/net/wireless/bcmdhd/include/bcmdevs.h" 1
# 36 "../../drivers/net/wireless/bcmdhd/bcmsdh.c" 2
# 1 "../../drivers/net/wireless/bcmdhd/include/bcmendian.h" 1
# 37 "../../drivers/net/wireless/bcmdhd/bcmsdh.c" 2
...
# 78 "../../drivers/net/wireless/bcmdhd/include/bcmutils.h" 2
...
# 38 "../../drivers/net/wireless/bcmdhd/bcmsdh.c" 2
# 1 "../../drivers/net/wireless/bcmdhd/include/hndsoc.h" 1
# 31 "../../drivers/net/wireless/bcmdhd/include/hndsoc.h"
# 1 "../../drivers/net/wireless/bcmdhd/include/sbconfig.h" 1
# 80 "../../drivers/net/wireless/bcmdhd/include/sbconfig.h"
...
# 32 "../../drivers/net/wireless/bcmdhd/include/hndsoc.h" 2
# 1 "../../drivers/net/wireless/bcmdhd/include/aidmp.h" 1
# 117 "../../drivers/net/wireless/bcmdhd/include/aidmp.h"
...
# 33 "../../drivers/net/wireless/bcmdhd/include/hndsoc.h" 2
# 39 "../../drivers/net/wireless/bcmdhd/bcmsdh.c" 2
...
# 40 "../../drivers/net/wireless/bcmdhd/bcmsdh.c" 2



# 1 "../../drivers/net/wireless/bcmdhd/include/bcmsdbus.h" 1
# 50 "../../drivers/net/wireless/bcmdhd/include/bcmsdbus.h"
...
# 44 "../../drivers/net/wireless/bcmdhd/bcmsdh.c" 2
# 1 "../../drivers/net/wireless/bcmdhd/include/sbsdio.h" 1
# 45 "../../drivers/net/wireless/bcmdhd/bcmsdh.c" 2

# 1 "../../drivers/net/wireless/bcmdhd/include/sdio.h" 1
# 33 "../../drivers/net/wireless/bcmdhd/include/sdio.h"
...
# 173 "../../drivers/net/wireless/bcmdhd/include/sdio.h"
typedef volatile struct {
 uint8 devctr;
 uint8 ext_dev;
 uint8 pwr_sel;
...
# 47 "../../drivers/net/wireless/bcmdhd/bcmsdh.c" 2


const uint bcmsdh_msglevel = 0x0001;
...
# 86 "../../drivers/net/wireless/bcmdhd/bcmsdh.c"
bcmsdh_info_t *
bcmsdh_attach(osl_t *osh, void *cfghdl, void **regsva, uint irq)
{
 bcmsdh_info_t *bcmsdh;

 if ((bcmsdh = (bcmsdh_info_t *)osl_malloc((osh), (sizeof(bcmsdh_info_t)))) == ((void *)0)) {
  ;
  return ((void *)0);
 }
 ({ void *__p = (((char *)bcmsdh)); size_t __n = (sizeof(bcmsdh_info_t)); if ((__n) != 0) { if (__builtin_constant_p(('\0')) && ('\0') == 0) __memzero((__p),(__n)); else memset((__p),('\0'),(__n)); } (__p); });
 ...
 bcmsdh->osh = osh;
 bcmsdh->init_success = 1;

 *regsva = (uint32 *)0x18000000;


 bcmsdh->sbwad = 0x18000000;
 return bcmsdh;
}
...
bcmsdh_detach(osl_t *osh, void *sdh)
{
 ...
 if (bcmsdh != ((void *)0)) {
  ...
  osl_mfree((osh), (bcmsdh), (sizeof(bcmsdh_info_t)));
 }
...
bcmsdh_intr_enable(void *sdh)
{
 ...
 status = sdioh_interrupt_set(bcmsdh->sdioh, 1);
 return ((status == 0) ? 0 : -1);
}
...
bcmsdh_intr_disable(void *sdh)
{
 ...
 status = sdioh_interrupt_set(bcmsdh->sdioh, 0);
 return ((status == 0) ? 0 : -1);
}
...
# 228 "../../drivers/net/wireless/bcmdhd/bcmsdh.c"
uint8
...
bcmsdh_cfg_read_word(void *sdh, uint fnc_num, uint32 addr, int *err)
{
 ...
 status = sdioh_request_word(bcmsdh->sdioh, 0, 0, fnc_num,
                             addr, &data, 4);
...
bcmsdh_cfg_write_word(void *sdh, uint fnc_num, uint32 addr, uint32 data, int *err)
{
 ...
 status = sdioh_request_word(bcmsdh->sdioh, 0, 1, fnc_num,
                             addr, &data, 4);
...
bcmsdh_cis_read(void *sdh, uint func, uint8 *cis, uint length)
{
 ...
 if (ascii) {
  ...
  if ((tmp_buf = (uint8 *)osl_malloc((bcmsdh->osh), (length))) == ((void *)0)) {
   ;
   return -27;
  }
  ...
  osl_mfree((bcmsdh->osh), (tmp_buf), (length));
 }
...
{
 int err = 0;
 uint bar0 = address & ~0x07FFF;
 bcmsdh_info_t *bcmsdh = (bcmsdh_info_t *)sdh;

 if (bar0 != bcmsdh->sbwad || force_set) {
  bcmsdh_cfg_write(bcmsdh, 1, 0x1000A,
   (address >> 8) & 0x80, &err);
  if (!err)
   bcmsdh_cfg_write(bcmsdh, 1, 0x1000B,
    (address >> 16) & 0xff, &err);
  if (!err)
   bcmsdh_cfg_write(bcmsdh, 1, 0x1000C,
    (address >> 24) & 0xffU, &err);
...
bcmsdh_reg_read(void *sdh, uint32 addr, uint size)
{
 ...
 if (bcmsdhsdio_set_sbaddr_window(bcmsdh, addr, 0))
  return 0xFFFFFFFF;
 ...
 status = sdioh_request_word(bcmsdh->sdioh, 0,
  0, 1, addr, &word, size);
...
bcmsdh_reg_write(void *sdh, uint32 addr, uint size, uint32 data)
{
 ...
 if ((err = bcmsdhsdio_set_sbaddr_window(bcmsdh, addr, 0)))
  return err;

 addr &= 0x07FFF;
 if (size == 4)
  addr |= 0x08000;
 status = sdioh_request_word(bcmsdh->sdioh, 0, 1, 1,
                             addr, &data, size);
 bcmsdh->regfail = !((status == 0));
                ...
                bcmsdh_cmplt_fn_t complete_fn, void *handle)
{
 ...
 incr_fix = (flags & 0x2) ? 0 : 1;
 width = (flags & 0x1) ? 4 : 2;
 if (width == 4)
  addr |= 0x08000;

 status = sdioh_request_buffer(bcmsdh->sdioh, 0, incr_fix,
                               0, fn, addr, width, nbytes, buf, pkt);

 return ((status == 0) ? 0 : -35);
}
                ...
                bcmsdh_cmplt_fn_t complete_fn, void *handle)
{
 ...
 status = sdioh_request_buffer(bcmsdh->sdioh, 0, incr_fix,
                               1, fn, addr, width, nbytes, buf, pkt);
...
bcmsdh_rwdata(void *sdh, uint rw, uint32 addr, uint8 *buf, uint nbytes)
{
 ...
 status = sdioh_request_buffer(bcmsdh->sdioh, 0, 1,
                               (rw ? 1 : 0), 1,
                               addr, 4, nbytes, buf, ((void *)0));
