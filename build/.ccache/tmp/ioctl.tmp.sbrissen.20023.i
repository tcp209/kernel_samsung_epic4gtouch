...
# 12 "../../fs/ext4/ioctl.c" 2


# 1 "../../include/linux/compat.h" 1
# 15 "../../fs/ext4/ioctl.c" 2
...
# 17 "../../fs/ext4/ioctl.c" 2

# 1 "../../fs/ext4/ext4_jbd2.h" 1
# 20 "../../fs/ext4/ext4_jbd2.h"
# 1 "../../fs/ext4/ext4.h" 1
# 20 "../../fs/ext4/ext4.h"
...
long ext4_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
 ...
 switch (cmd) {
 case (((2U) << (((0 +8)+8)+14)) | ((('f')) << (0 +8)) | (((1)) << 0) | (((((sizeof(long) == sizeof(long[1]) && sizeof(long) < (1 << 14)) ? sizeof(long) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
  ext4_get_inode_flags(ei);
  flags = ei->i_flags & 0x004BDFFF;
  return ({ register const typeof(*((int *) arg)) __r2 asm("r2") = (flags); register const typeof(*((int *) arg)) *__p asm("r0") = ((int *) arg); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; });
 case (((1U) << (((0 +8)+8)+14)) | ((('f')) << (0 +8)) | (((2)) << 0) | (((((sizeof(long) == sizeof(long[1]) && sizeof(long) < (1 << 14)) ? sizeof(long) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))): {
  ...
  if (!(((({ (get_current())->cred->fsuid; })) == (inode)->i_uid) || capable(3)))
   return -13;

  if (({ register const typeof(*((int *) arg)) *__p asm("r0") = ((int *) arg); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } flags = (typeof(*((int *) arg))) __r2; __e; }))
   return -14;
  ...
  if ((flags ^ oldflags) & (0x00000020 | 0x00000010)) {
   if (!capable(9))
    goto flags_out;
  }
  ...
  if ((jflag ^ oldflags) & (0x00004000)) {
   if (!capable(24))
    goto flags_out;
  }
  if (oldflags & 0x00080000) {
  ...
  if (flags & 0x00400000) {
   ...
   if (!(oldflags & 0x00400000)) {
    err = -95;
    goto flags_out;
   }
  } else if (oldflags & 0x00400000)
   ext4_truncate(inode);
  ...
  if ((((inode)->i_sb->s_flags & (16)) || ((inode)->i_flags & 1)))
   ext4_handle_sync(handle);
  err = ext4_reserve_inode_write(handle, inode, &iloc);
  if (err)
   goto flags_err;

  flags = flags & 0x004B80FF;
  flags |= oldflags & ~0x004B80FF;
  ei->i_flags = flags;
...
flags_out:
 ...
 case (((2U) << (((0 +8)+8)+14)) | ((('f')) << (0 +8)) | (((3)) << 0) | (((((sizeof(long) == sizeof(long[1]) && sizeof(long) < (1 << 14)) ? sizeof(long) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
 case (((2U) << (((0 +8)+8)+14)) | ((('v')) << (0 +8)) | (((1)) << 0) | (((((sizeof(long) == sizeof(long[1]) && sizeof(long) < (1 << 14)) ? sizeof(long) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
  return ({ register const typeof(*((int *) arg)) __r2 asm("r2") = (inode->i_generation); register const typeof(*((int *) arg)) *__p asm("r0") = ((int *) arg); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; });
 case (((1U) << (((0 +8)+8)+14)) | ((('f')) << (0 +8)) | (((4)) << 0) | (((((sizeof(long) == sizeof(long[1]) && sizeof(long) < (1 << 14)) ? sizeof(long) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
 case (((1U) << (((0 +8)+8)+14)) | ((('v')) << (0 +8)) | (((2)) << 0) | (((((sizeof(long) == sizeof(long[1]) && sizeof(long) < (1 << 14)) ? sizeof(long) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))): {
  handle_t *handle;
  struct ext4_iloc iloc;
  __u32 generation;
  int err;
  ...
  if (err)
   return err;
  if (({ register const typeof(*((int *) arg)) *__p asm("r0") = ((int *) arg); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } generation = (typeof(*((int *) arg))) __r2; __e; })) {
   err = -14;
   goto setversion_out;
  }
...
# 200 "../../fs/ext4/ioctl.c"
 case (((1U) << (((0 +8)+8)+14)) | ((('f')) << (0 +8)) | (((7)) << 0) | (((((sizeof(unsigned long) == sizeof(unsigned long[1]) && sizeof(unsigned long) < (1 << 14)) ? sizeof(unsigned long) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))): {
  ext4_fsblk_t n_blocks_count;
  ...
  if (({ register const typeof(*((__u32 *)arg)) *__p asm("r0") = ((__u32 *)arg); register unsigned long __r2 asm("r2"); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "1" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "2" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "r3", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%1" "," "r2" " ; .err ; .endif\n\t" "bl	__get_user_" "4" : "=&r" (__e), "=r" (__r2) : "0" (__p) : "lr", "cc"); break; default: __e = __get_user_bad(); break; } n_blocks_count = (typeof(*((__u32 *)arg))) __r2; __e; }))
   return -14;
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('f')) << (0 +8)) | (((15)) << 0) | (((((sizeof(struct move_extent) == sizeof(struct move_extent[1]) && sizeof(struct move_extent) < (1 << 14)) ? sizeof(struct move_extent) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))): {
  struct move_extent me;
  struct file *donor_filp;
  int err;

  if (!(filp->f_mode & (( fmode_t)0x1)) ||
      !(filp->f_mode & (( fmode_t)0x2)))
   return -9;

  if (copy_from_user(&me,
   (struct move_extent *)arg, sizeof(me)))
   return -14;
  me.moved_len = 0;
  ...
  if (!(donor_filp->f_mode & (( fmode_t)0x2))) {
   err = -9;
   goto mext_out;
  }
...
mext_out:
 ...
 case (((1U) << (((0 +8)+8)+14)) | ((('f')) << (0 +8)) | (((8)) << 0) | (((((sizeof(struct ext4_new_group_input) == sizeof(struct ext4_new_group_input[1]) && sizeof(struct ext4_new_group_input) < (1 << 14)) ? sizeof(struct ext4_new_group_input) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))): {
  struct ext4_new_group_data input;
  struct super_block *sb = inode->i_sb;
  int err, err2=0;
  ...
  if (copy_from_user(&input, (struct ext4_new_group_input *)arg,
    sizeof(input)))
   return -14;
 ...
 case (((0U) << (((0 +8)+8)+14)) | ((('f')) << (0 +8)) | (((9)) << 0) | ((0) << ((0 +8)+8))):
 {
  int err;
  if (!(((({ (get_current())->cred->fsuid; })) == (inode)->i_uid) || capable(3)))
   return -13;
 ...
 case (((0U) << (((0 +8)+8)+14)) | ((('f')) << (0 +8)) | (((12)) << 0) | ((0) << ((0 +8)+8))):
 {
  int err;
  if (!(((({ (get_current())->cred->fsuid; })) == (inode)->i_uid) || capable(3)))
   return -13;
