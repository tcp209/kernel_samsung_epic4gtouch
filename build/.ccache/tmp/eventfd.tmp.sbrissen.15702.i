...
int eventfd_signal(struct eventfd_ctx *ctx, int n)
{
 ...
 if (n < 0)
  return -22;
 do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = _raw_spin_lock_irqsave(spinlock_check(&ctx->wqh.lock)); } while (0); } while (0);
 if ((~0ULL) - ctx->count < n)
  n = (int) ((~0ULL) - ctx->count);
 ctx->count += n;
 if (waitqueue_active(&ctx->wqh))
  __wake_up_locked_key((&ctx->wqh), (1 | 2), (void *) (0x0001));
 spin_unlock_irqrestore(&ctx->wqh.lock, flags);

 return n;
}
extern typeof(eventfd_signal) eventfd_signal; static const char __kstrtab_eventfd_signal[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "eventfd_signal"; static const struct kernel_symbol __ksymtab_eventfd_signal __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&eventfd_signal, __kstrtab_eventfd_signal };
...
{
 struct eventfd_ctx *ctx = ({ const typeof( ((struct eventfd_ctx *)0)->kref ) *__mptr = (kref); (struct eventfd_ctx *)( (char *)__mptr - __builtin_offsetof(struct eventfd_ctx,kref) );});
...
extern typeof(eventfd_ctx_get) eventfd_ctx_get; static const char __kstrtab_eventfd_ctx_get[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "eventfd_ctx_get"; static const struct kernel_symbol __ksymtab_eventfd_ctx_get __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&eventfd_ctx_get, __kstrtab_eventfd_ctx_get };
# 104 "../../fs/eventfd.c"
void eventfd_ctx_put(struct eventfd_ctx *ctx)
{
 kref_put(&ctx->kref, eventfd_free);
}
extern typeof(eventfd_ctx_put) eventfd_ctx_put; static const char __kstrtab_eventfd_ctx_put[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "eventfd_ctx_put"; static const struct kernel_symbol __ksymtab_eventfd_ctx_put __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&eventfd_ctx_put, __kstrtab_eventfd_ctx_put };

static int eventfd_release(struct inode *inode, struct file *file)
{
 struct eventfd_ctx *ctx = file->private_data;

 __wake_up(&ctx->wqh, (1 | 2), 1, (void *) (0x0010));
 eventfd_ctx_put(ctx);
 return 0;
}
      ...
      __u64 *cnt)
{
 ...
 if (*cnt != 0 && waitqueue_active(&ctx->wqh))
  __wake_up_locked_key((&ctx->wqh), (1 | 2), (void *) (0x0004));
 spin_unlock_irqrestore(&ctx->wqh.lock, flags);

 return *cnt != 0 ? 0 : -11;
}
extern typeof(eventfd_ctx_remove_wait_queue) eventfd_ctx_remove_wait_queue; static const char __kstrtab_eventfd_ctx_remove_wait_queue[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "eventfd_ctx_remove_wait_queue"; static const struct kernel_symbol __ksymtab_eventfd_ctx_remove_wait_queue __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&eventfd_ctx_remove_wait_queue, __kstrtab_eventfd_ctx_remove_wait_queue };
# 188 "../../fs/eventfd.c"
ssize_t eventfd_ctx_read(struct eventfd_ctx *ctx, int no_wait, __u64 *cnt)
{
 ssize_t res;
...
extern typeof(eventfd_ctx_read) eventfd_ctx_read; static const char __kstrtab_eventfd_ctx_read[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "eventfd_ctx_read"; static const struct kernel_symbol __ksymtab_eventfd_ctx_read __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&eventfd_ctx_read, __kstrtab_eventfd_ctx_read };
       ...
       loff_t *ppos)
{
 ...
 if (count < sizeof(cnt))
  return -22;
 res = eventfd_ctx_read(ctx, file->f_flags & 00004000, &cnt);
 if (res < 0)
  return res;

 return ({ register const typeof(*((__u64 *) buf)) __r2 asm("r2") = (cnt); register const typeof(*((__u64 *) buf)) *__p asm("r0") = ((__u64 *) buf); register int __e asm("r0"); switch (sizeof(*(__p))) { case 1: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "1" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 2: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "2" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 4: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "4" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; case 8: __asm__ __volatile__ ( ".ifnc " "%0" "," "r0" " ; .err ; .endif\n\t" ".ifnc " "%2" "," "r2" " ; .err ; .endif\n\t" "bl	__put_user_" "8" : "=&r" (__e) : "0" (__p), "r" (__r2) : "ip", "lr", "cc"); break; default: __e = __put_user_bad(); break; } __e; }) ? -14 : sizeof(cnt);
}
        ...
        loff_t *ppos)
{
 ...
 spin_lock_irq(&ctx->wqh.lock);
 res = -11;
 if ((~0ULL) - ctx->count > ucnt)
  res = sizeof(ucnt);
 else if (!(file->f_flags & 00004000)) {
  __add_wait_queue(&ctx->wqh, &wait);
  for (res = 0;;) {
   do { (get_current())->state = (1); __asm__ __volatile__ ("dmb" : : : "memory"); } while (0);
   if ((~0ULL) - ctx->count > ucnt) {
...
extern typeof(eventfd_fget) eventfd_fget; static const char __kstrtab_eventfd_fget[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "eventfd_fget"; static const struct kernel_symbol __ksymtab_eventfd_fget __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&eventfd_fget, __kstrtab_eventfd_fget };
# 333 "../../fs/eventfd.c"
struct eventfd_ctx *eventfd_ctx_fdget(int fd)
{
 struct file *file;
...
extern typeof(eventfd_ctx_fdget) eventfd_ctx_fdget; static const char __kstrtab_eventfd_ctx_fdget[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "eventfd_ctx_fdget"; static const struct kernel_symbol __ksymtab_eventfd_ctx_fdget __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&eventfd_ctx_fdget, __kstrtab_eventfd_ctx_fdget };
# 357 "../../fs/eventfd.c"
struct eventfd_ctx *eventfd_ctx_fileget(struct file *file)
{
 if (file->f_op != &eventfd_fops)
...
extern typeof(eventfd_ctx_fileget) eventfd_ctx_fileget; static const char __kstrtab_eventfd_ctx_fileget[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "eventfd_ctx_fileget"; static const struct kernel_symbol __ksymtab_eventfd_ctx_fileget __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&eventfd_ctx_fileget, __kstrtab_eventfd_ctx_fileget };
# 380 "../../fs/eventfd.c"
struct file *eventfd_file_create(unsigned int count, int flags)
{
 struct file *file;
 ...
 if (flags & ~((02000000 | 00004000) | (1 << 0)))
  return ERR_PTR(-22);
 ...
 kref_init(&ctx->kref);
 do { static struct lock_class_key __key; __init_waitqueue_head((&ctx->wqh), &__key); } while (0);
 ctx->count = count;
 ctx->flags = flags;
 ...
 long sys_eventfd2(unsigned int count, int flags)
{
 ...
 error = alloc_fd(0, (flags & (02000000 | 00004000)));
 if (error < 0)
  return error;
 fd = error;
