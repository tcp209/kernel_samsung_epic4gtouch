...
# 10 "../../drivers/scsi/scsi_sysfs.c" 2
...
# 11 "../../drivers/scsi/scsi_sysfs.c" 2
...
extern int __blkdev_driver_ioctl(struct block_device *, fmode_t, unsigned int,
     unsigned long);
# 13 "../../drivers/scsi/scsi_sysfs.c" 2
...
# 16 "../../drivers/scsi/scsi_sysfs.c" 2
...
# 17 "../../drivers/scsi/scsi_sysfs.c" 2
...
# 18 "../../drivers/scsi/scsi_sysfs.c" 2
...
# 6 "../../include/scsi/scsi_tcq.h" 2
# 26 "../../include/scsi/scsi_tcq.h"
static inline __attribute__((always_inline)) int scsi_get_tag_type(struct scsi_device *sdev)
{
...
static inline __attribute__((always_inline)) void scsi_set_tag_type(struct scsi_device *sdev, int tag)
{
 switch (tag) {
 case 0x22:
  sdev->ordered_tags = 1;
...
static inline __attribute__((always_inline)) void scsi_activate_tcq(struct scsi_device *sdev, int depth)
{
 if (!sdev->tagged_supported)
  return;

 if (!test_bit(1, &(sdev->request_queue)->queue_flags))
...
static inline __attribute__((always_inline)) void scsi_deactivate_tcq(struct scsi_device *sdev, int depth)
{
 if (test_bit(1, &(sdev->request_queue)->queue_flags))
...
static inline __attribute__((always_inline)) int scsi_populate_tag_msg(struct scsi_cmnd *cmd, char *msg)
{
        struct request *req = cmd->request;
 struct scsi_device *sdev = cmd->device;

        if (((req)->cmd_flags & (1 << __REQ_QUEUED))) {
  if (sdev->ordered_tags && req->cmd_flags & (1 << __REQ_HARDBARRIER))
                 *msg++ = 0x22;
         else
                 *msg++ = 0x20;
         *msg++ = req->tag;
...
# 122 "../../include/scsi/scsi_tcq.h"
static inline __attribute__((always_inline)) struct scsi_cmnd *scsi_find_tag(struct scsi_device *sdev, int tag)
{
        ...
        if (tag != (-1)) {
         ...
         return req ? (struct scsi_cmnd *)req->special : ((void *)0);
 }
...
static inline __attribute__((always_inline)) int scsi_init_shared_tag_map(struct Scsi_Host *shost, int depth)
{
...
# 165 "../../include/scsi/scsi_tcq.h"
static inline __attribute__((always_inline)) struct scsi_cmnd *scsi_host_find_tag(struct Scsi_Host *shost,
      int tag)
{
 struct request *req;
...
# 19 "../../drivers/scsi/scsi_sysfs.c" 2
# 1 "../../include/scsi/scsi_transport.h" 1
# 23 "../../include/scsi/scsi_transport.h"
# 1 "../../include/linux/transport_class.h" 1
# 13 "../../include/linux/transport_class.h"
# 1 "../../include/linux/attribute_container.h" 1
...
int __attribute__((warn_unused_result)) attribute_container_unregister(struct attribute_container *cont);
...
# 14 "../../include/linux/transport_class.h" 2
...
# 38 "../../include/linux/transport_class.h"
struct anon_transport_class {
 struct transport_class tclass;
 struct attribute_container container;
};
# 56 "../../include/linux/transport_class.h"
struct transport_container {
...
static inline __attribute__((always_inline)) int transport_container_register(struct transport_container *tc)
{
 return attribute_container_register(&tc->ac);
}

static inline __attribute__((always_inline)) void transport_container_unregister(struct transport_container *tc)
{
 if (__builtin_expect(!!(attribute_container_unregister(&tc->ac)), 0))
  do { *(int *)0 = 0; } while (1);
}
...
# 24 "../../include/scsi/scsi_transport.h" 2
...
# 68 "../../include/scsi/scsi_transport.h"
 enum blk_eh_timer_return (*eh_timed_out)(struct scsi_cmnd *);
...
# 91 "../../include/scsi/scsi_transport.h"
static inline __attribute__((always_inline)) void
scsi_transport_reserve_target(struct scsi_transport_template * t, int space)
{
 do { if (__builtin_expect(!!(t->target_private_offset != 0), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 t->target_private_offset = ((((t->target_size)) + ((typeof((t->target_size)))((sizeof(void *))) - 1)) & ~((typeof((t->target_size)))((sizeof(void *))) - 1));
 t->target_size = t->target_private_offset + space;
}
static inline __attribute__((always_inline)) void
scsi_transport_reserve_device(struct scsi_transport_template * t, int space)
{
 do { if (__builtin_expect(!!(t->device_private_offset != 0), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 t->device_private_offset = ((((t->device_size)) + ((typeof((t->device_size)))((sizeof(void *))) - 1)) & ~((typeof((t->device_size)))((sizeof(void *))) - 1));
...
# 21 "../../drivers/scsi/scsi_sysfs.c" 2
...
static inline __attribute__((always_inline)) void scsi_log_send(struct scsi_cmnd *cmd)
 { };
static inline __attribute__((always_inline)) void scsi_log_completion(struct scsi_cmnd *cmd, int disposition)
 { };
...
extern int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) scsi_init_devinfo(void);
...
static inline __attribute__((always_inline)) void scsi_netlink_init(void) {}
static inline __attribute__((always_inline)) void scsi_netlink_exit(void) {}
# 153 "../../drivers/scsi/scsi_priv.h"
extern int scsi_internal_device_block(struct scsi_device *sdev);
extern int scsi_internal_device_unblock(struct scsi_device *sdev);
# 23 "../../drivers/scsi/scsi_sysfs.c" 2
# 1 "../../drivers/scsi/scsi_logging.h" 1
# 39 "../../drivers/scsi/scsi_logging.h"
extern unsigned int scsi_logging_level;
# 24 "../../drivers/scsi/scsi_sysfs.c" 2
...
const char *scsi_device_state_name(enum scsi_device_state state)
{
 ...
 for (i = 0; i < (sizeof(sdev_states) / sizeof((sdev_states)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(sdev_states), typeof(&sdev_states[0]))); }))); i++) {
...
const char *scsi_host_state_name(enum scsi_host_state state)
{
 ...
 for (i = 0; i < (sizeof(shost_states) / sizeof((shost_states)[0]) + (sizeof(struct { int:-!!(__builtin_types_compatible_p(typeof(shost_states), typeof(&shost_states[0]))); }))); i++) {
...
# 148 "../../drivers/scsi/scsi_sysfs.c"
static ssize_t
store_scan(struct device *dev, struct device_attribute *attr,
    const char *buf, size_t count)
{
 struct Scsi_Host *shost = ({ const typeof( ((struct Scsi_Host *)0)->shost_dev ) *__mptr = (dev); (struct Scsi_Host *)( (char *)__mptr - __builtin_offsetof(struct Scsi_Host,shost_dev) );});
 int res;
...
static struct device_attribute dev_attr_scan = { .attr = {.name = "scan", .mode = 00200 }, .show = ((void *)0), .store = store_scan, };
...
struct device_attribute dev_attr_hstate =
 { .attr = {.name = "state", .mode = (00400|00040|00004) | 00200 }, .show = show_shost_state, .store = store_shost_state, };
...
static struct device_attribute dev_attr_supported_mode = { .attr = {.name = "supported_mode", .mode = (00400|00040|00004) | 00200 }, .show = show_shost_supported_mode, .store = ((void *)0), };
         ...
         struct device_attribute *attr, char *buf)
{
 ...
 if (shost->active_mode == 0x00)
  return snprintf(buf, 20, "unknown\n");
 else
  return show_shost_mode(shost->active_mode, buf);
}

static struct device_attribute dev_attr_active_mode = { .attr = {.name = "active_mode", .mode = (00400|00040|00004) | 00200 }, .show = show_shost_active_mode, .store = ((void *)0), };

static ssize_t show_unique_id (struct device *dev, struct device_attribute *attr, char *buf) { struct Scsi_Host *shost = ({ const typeof( ((struct Scsi_Host *)0)->shost_dev ) *__mptr = (dev); (struct Scsi_Host *)( (char *)__mptr - __builtin_offsetof(struct Scsi_Host,shost_dev) );}); return snprintf (buf, 20, "%u\n", shost->unique_id); } static struct device_attribute dev_attr_unique_id = { .attr = {.name = "unique_id", .mode = (00400|00040|00004) }, .show = show_unique_id, .store = ((void *)0), };;
static ssize_t show_host_busy (struct device *dev, struct device_attribute *attr, char *buf) { struct Scsi_Host *shost = ({ const typeof( ((struct Scsi_Host *)0)->shost_dev ) *__mptr = (dev); (struct Scsi_Host *)( (char *)__mptr - __builtin_offsetof(struct Scsi_Host,shost_dev) );}); return snprintf (buf, 20, "%hu\n", shost->host_busy); } static struct device_attribute dev_attr_host_busy = { .attr = {.name = "host_busy", .mode = (00400|00040|00004) }, .show = show_host_busy, .store = ((void *)0), };;
static ssize_t show_cmd_per_lun (struct device *dev, struct device_attribute *attr, char *buf) { struct Scsi_Host *shost = ({ const typeof( ((struct Scsi_Host *)0)->shost_dev ) *__mptr = (dev); (struct Scsi_Host *)( (char *)__mptr - __builtin_offsetof(struct Scsi_Host,shost_dev) );}); return snprintf (buf, 20, "%hd\n", shost->cmd_per_lun); } static struct device_attribute dev_attr_cmd_per_lun = { .attr = {.name = "cmd_per_lun", .mode = (00400|00040|00004) }, .show = show_cmd_per_lun, .store = ((void *)0), };;
static ssize_t show_can_queue (struct device *dev, struct device_attribute *attr, char *buf) { struct Scsi_Host *shost = ({ const typeof( ((struct Scsi_Host *)0)->shost_dev ) *__mptr = (dev); (struct Scsi_Host *)( (char *)__mptr - __builtin_offsetof(struct Scsi_Host,shost_dev) );}); return snprintf (buf, 20, "%hd\n", shost->can_queue); } static struct device_attribute dev_attr_can_queue = { .attr = {.name = "can_queue", .mode = (00400|00040|00004) }, .show = show_can_queue, .store = ((void *)0), };;
static ssize_t show_sg_tablesize (struct device *dev, struct device_attribute *attr, char *buf) { struct Scsi_Host *shost = ({ const typeof( ((struct Scsi_Host *)0)->shost_dev ) *__mptr = (dev); (struct Scsi_Host *)( (char *)__mptr - __builtin_offsetof(struct Scsi_Host,shost_dev) );}); return snprintf (buf, 20, "%hu\n", shost->sg_tablesize); } static struct device_attribute dev_attr_sg_tablesize = { .attr = {.name = "sg_tablesize", .mode = (00400|00040|00004) }, .show = show_sg_tablesize, .store = ((void *)0), };;
static ssize_t show_unchecked_isa_dma (struct device *dev, struct device_attribute *attr, char *buf) { struct Scsi_Host *shost = ({ const typeof( ((struct Scsi_Host *)0)->shost_dev ) *__mptr = (dev); (struct Scsi_Host *)( (char *)__mptr - __builtin_offsetof(struct Scsi_Host,shost_dev) );}); return snprintf (buf, 20, "%d\n", shost->unchecked_isa_dma); } static struct device_attribute dev_attr_unchecked_isa_dma = { .attr = {.name = "unchecked_isa_dma", .mode = (00400|00040|00004) }, .show = show_unchecked_isa_dma, .store = ((void *)0), };;
static ssize_t show_prot_capabilities (struct device *dev, struct device_attribute *attr, char *buf) { struct Scsi_Host *shost = ({ const typeof( ((struct Scsi_Host *)0)->shost_dev ) *__mptr = (dev); (struct Scsi_Host *)( (char *)__mptr - __builtin_offsetof(struct Scsi_Host,shost_dev) );}); return snprintf (buf, 20, "%u\n", shost->prot_capabilities); } static struct device_attribute dev_attr_prot_capabilities = { .attr = {.name = "prot_capabilities", .mode = (00400|00040|00004) }, .show = show_prot_capabilities, .store = ((void *)0), };;
static ssize_t show_prot_guard_type (struct device *dev, struct device_attribute *attr, char *buf) { struct Scsi_Host *shost = ({ const typeof( ((struct Scsi_Host *)0)->shost_dev ) *__mptr = (dev); (struct Scsi_Host *)( (char *)__mptr - __builtin_offsetof(struct Scsi_Host,shost_dev) );}); return snprintf (buf, 20, "%hd\n", shost->prot_guard_type); } static struct device_attribute dev_attr_prot_guard_type = { .attr = {.name = "prot_guard_type", .mode = (00400|00040|00004) }, .show = show_prot_guard_type, .store = ((void *)0), };;
static ssize_t show_proc_name (struct device *dev, struct device_attribute *attr, char *buf) { struct Scsi_Host *shost = ({ const typeof( ((struct Scsi_Host *)0)->shost_dev ) *__mptr = (dev); (struct Scsi_Host *)( (char *)__mptr - __builtin_offsetof(struct Scsi_Host,shost_dev) );}); return snprintf (buf, 20, "%s\n", shost->hostt->proc_name); } static struct device_attribute dev_attr_proc_name = { .attr = {.name = "proc_name", .mode = (00400|00040|00004) }, .show = show_proc_name, .store = ((void *)0), };;
...
static void scsi_device_cls_release(struct device *class_dev)
{
 ...
 sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_dev ) *__mptr = (class_dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_dev) );});
...
static void scsi_device_dev_release_usercontext(struct work_struct *work)
{
 ...
 sdev = ({ const typeof( ((struct scsi_device *)0)->ew.work ) *__mptr = (work); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,ew.work) );});

 parent = sdev->sdev_gendev.parent;
 starget = ({ const typeof( ((struct scsi_target *)0)->dev ) *__mptr = (parent); (struct scsi_target *)( (char *)__mptr - __builtin_offsetof(struct scsi_target,dev) );});

 do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = _raw_spin_lock_irqsave(spinlock_check(sdev->host->host_lock)); } while (0); } while (0);
 starget->reap_ref++;
 ...
 for (this = (&sdev->event_list)->next, tmp = this->next; this != (&sdev->event_list); this = tmp, tmp = this->next) {
  struct scsi_event *evt;

  evt = ({ const typeof( ((struct scsi_event *)0)->node ) *__mptr = (this); (struct scsi_event *)( (char *)__mptr - __builtin_offsetof(struct scsi_event,node) );});
  list_del(&evt->node);
  kfree(evt);
 }

 if (sdev->request_queue) {
  sdev->request_queue->queuedata = ((void *)0);

  scsi_free_queue(sdev->request_queue);


  sdev->request_queue = ((void *)0);
 }
...
static int scsi_bus_match(struct device *dev, struct device_driver *gendrv)
{
 ...
 sdp = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );});
 if (sdp->no_uld_attach)
  return 0;
 return (sdp->inq_periph_qual == 0x00)? 1: 0;
}
...
static int scsi_bus_uevent(struct device *dev, struct kobj_uevent_env *env)
{
 ...
 sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );});

 add_uevent_var(env, "MODALIAS=" "scsi:t-0x%02x", sdev->type);
 return 0;
}
...
extern typeof(scsi_bus_type) scsi_bus_type; static const char __kstrtab_scsi_bus_type[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "scsi_bus_type"; static const struct kernel_symbol __ksymtab_scsi_bus_type __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&scsi_bus_type, __kstrtab_scsi_bus_type };
...
int scsi_sysfs_register(void)
{
 ...
 if (!error) {
  error = ({ static struct lock_class_key __key; __class_register(&sdev_class, &__key); });
  if (error)
...
# 540 "../../drivers/scsi/scsi_sysfs.c"
static ssize_t sdev_show_device_blocked (struct device *dev, struct device_attribute *attr, char *buf) { struct scsi_device *sdev; sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}); return snprintf (buf, 20, "%d\n", sdev->device_blocked); } static struct device_attribute dev_attr_device_blocked = { .attr = {.name = "device_blocked", .mode = (00400|00040|00004) }, .show = sdev_show_device_blocked, .store = ((void *)0), };;
static ssize_t sdev_show_queue_depth (struct device *dev, struct device_attribute *attr, char *buf) { struct scsi_device *sdev; sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}); return snprintf (buf, 20, "%d\n", sdev->queue_depth); } static struct device_attribute dev_attr_queue_depth = { .attr = {.name = "queue_depth", .mode = (00400|00040|00004) }, .show = sdev_show_queue_depth, .store = ((void *)0), };;
static ssize_t sdev_show_type (struct device *dev, struct device_attribute *attr, char *buf) { struct scsi_device *sdev; sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}); return snprintf (buf, 20, "%d\n", sdev->type); } static struct device_attribute dev_attr_type = { .attr = {.name = "type", .mode = (00400|00040|00004) }, .show = sdev_show_type, .store = ((void *)0), };;
static ssize_t sdev_show_scsi_level (struct device *dev, struct device_attribute *attr, char *buf) { struct scsi_device *sdev; sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}); return snprintf (buf, 20, "%d\n", sdev->scsi_level); } static struct device_attribute dev_attr_scsi_level = { .attr = {.name = "scsi_level", .mode = (00400|00040|00004) }, .show = sdev_show_scsi_level, .store = ((void *)0), };;
static ssize_t sdev_show_vendor (struct device *dev, struct device_attribute *attr, char *buf) { struct scsi_device *sdev; sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}); return snprintf (buf, 20, "%.8s\n", sdev->vendor); } static struct device_attribute dev_attr_vendor = { .attr = {.name = "vendor", .mode = (00400|00040|00004) }, .show = sdev_show_vendor, .store = ((void *)0), };;
static ssize_t sdev_show_model (struct device *dev, struct device_attribute *attr, char *buf) { struct scsi_device *sdev; sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}); return snprintf (buf, 20, "%.16s\n", sdev->model); } static struct device_attribute dev_attr_model = { .attr = {.name = "model", .mode = (00400|00040|00004) }, .show = sdev_show_model, .store = ((void *)0), };;
static ssize_t sdev_show_rev (struct device *dev, struct device_attribute *attr, char *buf) { struct scsi_device *sdev; sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}); return snprintf (buf, 20, "%.4s\n", sdev->rev); } static struct device_attribute dev_attr_rev = { .attr = {.name = "rev", .mode = (00400|00040|00004) }, .show = sdev_show_rev, .store = ((void *)0), };;
...
sdev_show_timeout (struct device *dev, struct device_attribute *attr, char *buf)
{
 struct scsi_device *sdev;
 sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );});
 return snprintf(buf, 20, "%d\n", sdev->request_queue->rq_timeout / 200);
}
      ...
      const char *buf, size_t count)
{
 ...
 sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );});
 sscanf (buf, "%d\n", &timeout);
 blk_queue_rq_timeout(sdev->request_queue, timeout * 200);
 return count;
}
static struct device_attribute dev_attr_timeout = { .attr = {.name = "timeout", .mode = (00400|00040|00004) | 00200 }, .show = sdev_show_timeout, .store = sdev_store_timeout, };
...
static struct device_attribute dev_attr_rescan = { .attr = {.name = "rescan", .mode = 00200 }, .show = ((void *)0), .store = store_rescan_field, };

static void sdev_store_delete_callback(struct device *dev)
{
 scsi_remove_device(({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}));
}
    ...
    const char *buf, size_t count)
{
 ...
 rc = device_schedule_callback_owner(dev, sdev_store_delete_callback, ((struct module *)0));
 if (rc)
  count = rc;
 return count;
};
static struct device_attribute dev_attr_delete = { .attr = {.name = "delete", .mode = 00200 }, .show = ((void *)0), .store = sdev_store_delete, };
...
{
 int i;
 struct scsi_device *sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );});
...
static struct device_attribute dev_attr_state = { .attr = {.name = "state", .mode = (00400|00040|00004) | 00200 }, .show = show_state_field, .store = store_state_field, };
...
static struct device_attribute dev_attr_queue_type = { .attr = {.name = "queue_type", .mode = (00400|00040|00004) }, .show = show_queue_type_field, .store = ((void *)0), };
...
static struct device_attribute dev_attr_iocounterbits = { .attr = {.name = "iocounterbits", .mode = (00400|00040|00004) }, .show = show_iostat_counterbits, .store = ((void *)0), };
# 676 "../../drivers/scsi/scsi_sysfs.c"
static ssize_t show_iostat_iorequest_cnt(struct device *dev, struct device_attribute *attr, char *buf) { struct scsi_device *sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}); unsigned long long count = (*(volatile int *)&(&sdev->iorequest_cnt)->counter); return snprintf(buf, 20, "0x%llx\n", count); } static struct device_attribute dev_attr_iorequest_cnt = { .attr = {.name = "iorequest_cnt", .mode = (00400|00040|00004) }, .show = show_iostat_iorequest_cnt, .store = ((void *)0), };
static ssize_t show_iostat_iodone_cnt(struct device *dev, struct device_attribute *attr, char *buf) { struct scsi_device *sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}); unsigned long long count = (*(volatile int *)&(&sdev->iodone_cnt)->counter); return snprintf(buf, 20, "0x%llx\n", count); } static struct device_attribute dev_attr_iodone_cnt = { .attr = {.name = "iodone_cnt", .mode = (00400|00040|00004) }, .show = show_iostat_iodone_cnt, .store = ((void *)0), };
static ssize_t show_iostat_ioerr_cnt(struct device *dev, struct device_attribute *attr, char *buf) { struct scsi_device *sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}); unsigned long long count = (*(volatile int *)&(&sdev->ioerr_cnt)->counter); return snprintf(buf, 20, "0x%llx\n", count); } static struct device_attribute dev_attr_ioerr_cnt = { .attr = {.name = "ioerr_cnt", .mode = (00400|00040|00004) }, .show = show_iostat_ioerr_cnt, .store = ((void *)0), };
...
sdev_show_modalias(struct device *dev, struct device_attribute *attr, char *buf)
{
 struct scsi_device *sdev;
 sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );});
 return snprintf (buf, 20, "scsi:t-0x%02x" "\n", sdev->type);
}
static struct device_attribute dev_attr_modalias = { .attr = {.name = "modalias", .mode = (00400|00040|00004) }, .show = sdev_show_modalias, .store = ((void *)0), };
# 722 "../../drivers/scsi/scsi_sysfs.c"
static ssize_t sdev_show_evt_media_change(struct device *dev, struct device_attribute *attr, char *buf) { struct scsi_device *sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}); int val = test_bit(SDEV_EVT_MEDIA_CHANGE, sdev->supported_events); return snprintf(buf, 20, "%d\n", val); } static ssize_t sdev_store_evt_media_change(struct device *dev, struct device_attribute *attr, const char *buf, size_t count) { struct scsi_device *sdev = ({ const typeof( ((struct scsi_device *)0)->sdev_gendev ) *__mptr = (dev); (struct scsi_device *)( (char *)__mptr - __builtin_offsetof(struct scsi_device,sdev_gendev) );}); int val = simple_strtoul(buf, ((void *)0), 0); if (val == 0) _clear_bit_le(SDEV_EVT_MEDIA_CHANGE,sdev->supported_events); else if (val == 1) _set_bit_le(SDEV_EVT_MEDIA_CHANGE,sdev->supported_events); else return -22; return count; } static struct device_attribute dev_attr_evt_media_change = { .attr = {.name = "evt_media_change", .mode = (00400|00040|00004) }, .show = sdev_show_evt_media_change, .store = sdev_store_evt_media_change, };
...
static struct attribute *scsi_sdev_attrs[] = {
 ...
 &dev_attr_evt_media_change.attr,
 ((void *)0)
};
...
static struct device_attribute sdev_attr_queue_depth_rw =
 { .attr = {.name = "queue_depth", .mode = (00400|00040|00004) | 00200 }, .show = sdev_show_queue_depth, .store = sdev_store_queue_depth_rw, };
...
static struct device_attribute sdev_attr_queue_ramp_up_period =
 { .attr = {.name = "queue_ramp_up_period", .mode = (00400|00040|00004) | 00200 }, .show = sdev_show_queue_ramp_up_period, .store = sdev_store_queue_ramp_up_period, };
...
static int scsi_target_add(struct scsi_target *starget)
{
 ...
 if (error) {
  printk("<3>" "%s %s: " "target device_add failed, error %d\n" , dev_driver_string(&starget->dev) , dev_name(&starget->dev) , error);
  return error;
 }
...
static struct device_attribute sdev_attr_queue_type_rw =
 { .attr = {.name = "queue_type", .mode = (00400|00040|00004) | 00200 }, .show = show_queue_type_field, .store = sdev_store_queue_type_rw, };
# 875 "../../drivers/scsi/scsi_sysfs.c"
int scsi_sysfs_add_sdev(struct scsi_device *sdev)
{
 ...
 error = bsg_register_queue(rq, &sdev->sdev_gendev, ((void *)0), ((void *)0));

 if (error)


  printk("<6>" "%s %s: " "Failed to register bsg queue, errno=%d\n" , dev_driver_string(&(sdev)->sdev_gendev) , dev_name(&(sdev)->sdev_gendev) , error);
...
extern typeof(scsi_remove_device) scsi_remove_device; static const char __kstrtab_scsi_remove_device[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "scsi_remove_device"; static const struct kernel_symbol __ksymtab_scsi_remove_device __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&scsi_remove_device, __kstrtab_scsi_remove_device };
...
static void __scsi_remove_target(struct scsi_target *starget)
{
 ...
 do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = _raw_spin_lock_irqsave(spinlock_check(shost->host_lock)); } while (0); } while (0);
 starget->reap_ref++;
 restart:
 for (sdev = ({ const typeof( ((typeof(*sdev) *)0)->siblings ) *__mptr = ((&shost->__devices)->next); (typeof(*sdev) *)( (char *)__mptr - __builtin_offsetof(typeof(*sdev),siblings) );}); prefetch(sdev->siblings.next), &sdev->siblings != (&shost->__devices); sdev = ({ const typeof( ((typeof(*sdev) *)0)->siblings ) *__mptr = (sdev->siblings.next); (typeof(*sdev) *)( (char *)__mptr - __builtin_offsetof(typeof(*sdev),siblings) );})) {
...
static int __remove_child (struct device * dev, void * data)
{
 if (scsi_is_target_device(dev))
  __scsi_remove_target(({ const typeof( ((struct scsi_target *)0)->dev ) *__mptr = (dev); (struct scsi_target *)( (char *)__mptr - __builtin_offsetof(struct scsi_target,dev) );}));
 return 0;
}
# 1019 "../../drivers/scsi/scsi_sysfs.c"
void scsi_remove_target(struct device *dev)
{
 ...
 rdev = get_device(dev);
 device_for_each_child(dev, ((void *)0), __remove_child);
 put_device(rdev);
}
extern typeof(scsi_remove_target) scsi_remove_target; static const char __kstrtab_scsi_remove_target[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "scsi_remove_target"; static const struct kernel_symbol __ksymtab_scsi_remove_target __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&scsi_remove_target, __kstrtab_scsi_remove_target };
...
extern typeof(scsi_register_driver) scsi_register_driver; static const char __kstrtab_scsi_register_driver[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "scsi_register_driver"; static const struct kernel_symbol __ksymtab_scsi_register_driver __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&scsi_register_driver, __kstrtab_scsi_register_driver };
...
extern typeof(scsi_register_interface) scsi_register_interface; static const char __kstrtab_scsi_register_interface[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "scsi_register_interface"; static const struct kernel_symbol __ksymtab_scsi_register_interface __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&scsi_register_interface, __kstrtab_scsi_register_interface };
...
extern typeof(scsi_is_sdev_device) scsi_is_sdev_device; static const char __kstrtab_scsi_is_sdev_device[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "scsi_is_sdev_device"; static const struct kernel_symbol __ksymtab_scsi_is_sdev_device __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&scsi_is_sdev_device, __kstrtab_scsi_is_sdev_device };



struct scsi_transport_template blank_transport_template = { { { {((void *)0), }, }, }, };
