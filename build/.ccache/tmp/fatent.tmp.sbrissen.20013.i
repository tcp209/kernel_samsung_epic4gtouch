...
static spinlock_t fat12_entry_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } };
         ...
         int *offset, sector_t *blocknr)
{
 ...
 ({ int __ret_warn_on = !!(entry < 2 || sbi->max_cluster <= entry); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 29); __builtin_expect(!!(__ret_warn_on), 0); });
       ...
       int *offset, sector_t *blocknr)
{
 ...
 ({ int __ret_warn_on = !!(entry < 2 || sbi->max_cluster <= entry); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 39); __builtin_expect(!!(__ret_warn_on), 0); });
 *offset = bytes & (sb->s_blocksize - 1);
 *blocknr = sbi->fat_start + (bytes >> sb->s_blocksize_bits);
}
...
static void fat12_ent_set_ptr(struct fat_entry *fatent, int offset)
{
 ...
 if (fatent->nr_bhs == 1) {
  ({ int __ret_warn_on = !!(offset >= (bhs[0]->b_size - 1)); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 48); __builtin_expect(!!(__ret_warn_on), 0); });
  fatent->u.ent12_p[0] = bhs[0]->b_data + offset;
  fatent->u.ent12_p[1] = bhs[0]->b_data + (offset + 1);
 } else {
  ({ int __ret_warn_on = !!(offset != (bhs[0]->b_size - 1)); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 52); __builtin_expect(!!(__ret_warn_on), 0); });
  fatent->u.ent12_p[0] = bhs[0]->b_data + offset;
...
{
 ({ int __ret_warn_on = !!(offset & (2 - 1)); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 60); __builtin_expect(!!(__ret_warn_on), 0); });
 fatent->u.ent16_p = (__le16 *)(fatent->bhs[0]->b_data + offset);
}

static void fat32_ent_set_ptr(struct fat_entry *fatent, int offset)
{
 ({ int __ret_warn_on = !!(offset & (4 - 1)); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 66); __builtin_expect(!!(__ret_warn_on), 0); });
      ...
      int offset, sector_t blocknr)
{
 ...
 ({ int __ret_warn_on = !!(blocknr < MSDOS_SB(sb)->fat_start); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 75); __builtin_expect(!!(__ret_warn_on), 0); });
...
err_brelse:
 brelse(bhs[0]);
err:
 printk("<3>" "FAT: FAT read failed (blocknr %llu)\n", (llu)blocknr);
 return -5;
}
    ...
    int offset, sector_t blocknr)
{
 ...
 ({ int __ret_warn_on = !!(blocknr < MSDOS_SB(sb)->fat_start); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 107); __builtin_expect(!!(__ret_warn_on), 0); });
 fatent->fat_inode = MSDOS_SB(sb)->fat_inode;
...
{
 int next = (( __u16)(__le16)(*fatent->u.ent16_p));
 ({ int __ret_warn_on = !!((unsigned long)fatent->u.ent16_p & (2 - 1)); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 141); __builtin_expect(!!(__ret_warn_on), 0); });
 if (next >= 0xFFF7)
  next = (0x0FFFFFFF);
 return next;
}
...
{
 int next = (( __u32)(__le32)(*fatent->u.ent32_p)) & 0x0fffffff;
 ({ int __ret_warn_on = !!((unsigned long)fatent->u.ent32_p & (4 - 1)); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 150); __builtin_expect(!!(__ret_warn_on), 0); });
 if (next >= 0x0FFFFFF7)
  next = (0x0FFFFFFF);
 return next;
}
 ...
 *fatent->u.ent16_p = (( __le16)(__u16)(new));
 mark_buffer_dirty_inode(fatent->bhs[0], fatent->fat_inode);
}
...
static void fat32_ent_put(struct fat_entry *fatent, int new)
{
 ...
 ({ int __ret_warn_on = !!(new & 0xf0000000); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 192); __builtin_expect(!!(__ret_warn_on), 0); });
 new |= (( __u32)(__le32)(*fatent->u.ent32_p)) & ~0x0fffffff;
 *fatent->u.ent32_p = (( __le32)(__u32)(new));
 mark_buffer_dirty_inode(fatent->bhs[0], fatent->fat_inode);
}
...
static int fat12_ent_next(struct fat_entry *fatent)
{
 ...
 fatent->entry++;
 if (fatent->nr_bhs == 1) {
  ({ int __ret_warn_on = !!(ent12_p[0] > (u8 *)(bhs[0]->b_data + (bhs[0]->b_size - 2))); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 206); __builtin_expect(!!(__ret_warn_on), 0); });
  ({ int __ret_warn_on = !!(ent12_p[1] > (u8 *)(bhs[0]->b_data + (bhs[0]->b_size - 1))); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 207); __builtin_expect(!!(__ret_warn_on), 0); });
  ...
  ({ int __ret_warn_on = !!(ent12_p[0] != (u8 *)(bhs[0]->b_data + (bhs[0]->b_size - 1))); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 214); __builtin_expect(!!(__ret_warn_on), 0); });
  ({ int __ret_warn_on = !!(ent12_p[1] != (u8 *)bhs[1]->b_data); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../fs/fat/fatent.c", 215); __builtin_expect(!!(__ret_warn_on), 0); });
  ent12_p[0] = nextp - 1;
  ent12_p[1] = nextp;
  brelse(bhs[0]);
  bhs[0] = bhs[1];
...
static inline __attribute__((always_inline)) void lock_fat(struct msdos_sb_info *sbi)
{
 mutex_lock(&sbi->fat_lock);
}

static inline __attribute__((always_inline)) void unlock_fat(struct msdos_sb_info *sbi)
{
...
void fat_ent_access_init(struct super_block *sb)
{
 ...
 do { static struct lock_class_key __key; __mutex_init((&sbi->fat_lock), "&sbi->fat_lock", &__key); } while (0);
...
static inline __attribute__((always_inline)) int fat_ent_update_ptr(struct super_block *sb,
...
int fat_ent_read(struct inode *inode, struct fat_entry *fatent, int entry)
{
 ...
 if (entry < 2 || sbi->max_cluster <= entry) {
  fatent_brelse(fatent);
  __fat_fs_error(sb, 1, "invalid access to FAT (entry 0x%08x)" , entry);
  return -5;
 }
...
static inline __attribute__((always_inline)) int fat_ent_next(struct msdos_sb_info *sbi,
          struct fat_entry *fatent)
{
...
static inline __attribute__((always_inline)) int fat_ent_read_block(struct super_block *sb,
         struct fat_entry *fatent)
{
 struct fatent_operations *ops = MSDOS_SB(sb)->fatent_ops;
 sector_t blocknr;
...
int fat_alloc_clusters(struct inode *inode, int *cluster, int nr_cluster)
{
 ...
 do { if (__builtin_expect(!!(nr_cluster > ((((1UL) << 12) / 512) / 2)), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 ...
 while (count < sbi->max_cluster) {
  ...
  do {
   if (ops->ent_get(&fatent) == (0)) {
    int entry = fatent.entry;


    ops->ent_put(&fatent, (0x0FFFFFFF));
    if (prev_ent.nr_bhs)
...
int fat_free_clusters(struct inode *inode, int cluster)
{
 ...
 do {
  ...
  if (cluster < 0) {
   ...
   __fat_fs_error(sb, 1, "%s: deleting FAT entry beyond EOF" , __func__);
  ...
  ops->ent_put(&fatent, (0));
  if (sbi->free_clusters != -1) {
   sbi->free_clusters++;
   sb->s_dirt = 1;
  }

  if (nr_bhs + fatent.nr_bhs > (((1UL) << 12) / 512)) {
   if (sb->s_flags & 16) {
    err = fat_sync_bhs(bhs, nr_bhs);
    if (err)
     goto error;
...
extern typeof(fat_free_clusters) fat_free_clusters; static const char __kstrtab_fat_free_clusters[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "fat_free_clusters"; static const struct kernel_symbol __ksymtab_fat_free_clusters __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&fat_free_clusters, __kstrtab_fat_free_clusters };
...
int fat_count_free_clusters(struct super_block *sb)
{
 ...
 reada_blocks = (128 * 1024) >> sb->s_blocksize_bits;
 reada_mask = reada_blocks - 1;
 cur_block = 0;

 free = 0;
 fatent_init(&fatent);
 fatent_set_entry(&fatent, 2);
 while (fatent.entry < sbi->max_cluster) {

  if ((cur_block & reada_mask) == 0) {
   unsigned long rest = sbi->fat_length - cur_block;
   fat_ent_reada(sb, &fatent, ({ typeof(reada_blocks) _min1 = (reada_blocks); typeof(rest) _min2 = (rest); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; }));
  }
  cur_block++;
