...
int inode_change_ok(const struct inode *inode, struct iattr *attr)
{
 ...
 if ((ia_valid & (1 << 1)) &&
     ((({ (get_current())->cred->fsuid; })) != inode->i_uid ||
      attr->ia_uid != inode->i_uid) && !capable(0))
  goto error;
 ...
 if (ia_valid & (1 << 0)) {
  ...
  if (!in_group_p((ia_valid & (1 << 2)) ? attr->ia_gid :
    inode->i_gid) && !capable(4))
   attr->ia_mode &= ~0002000;
 }


 if (ia_valid & ((1 << 8) | (1 << 7) | (1 << 16))) {
  if (!(((({ (get_current())->cred->fsuid; })) == (inode)->i_uid) || capable(3)))
   goto error;
 }
fine:
...
extern typeof(inode_change_ok) inode_change_ok; static const char __kstrtab_inode_change_ok[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "inode_change_ok"; static const struct kernel_symbol __ksymtab_inode_change_ok __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&inode_change_ok, __kstrtab_inode_change_ok };
# 79 "../../fs/attr.c"
int inode_newsize_ok(const struct inode *inode, loff_t offset)
{
 ...
 return 0;
out_sig:
 send_sig(25, (get_current()), 0);
out_big:
 return -27;
}
extern typeof(inode_newsize_ok) inode_newsize_ok; static const char __kstrtab_inode_newsize_ok[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "inode_newsize_ok"; static const struct kernel_symbol __ksymtab_inode_newsize_ok __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&inode_newsize_ok, __kstrtab_inode_newsize_ok };
# 122 "../../fs/attr.c"
void generic_setattr(struct inode *inode, const struct iattr *attr)
{
 ...
 if (ia_valid & (1 << 0)) {
  ...
  if (!in_group_p(inode->i_gid) && !capable(4))
   mode &= ~0002000;
  inode->i_mode = mode;
 }
}
extern typeof(generic_setattr) generic_setattr; static const char __kstrtab_generic_setattr[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "generic_setattr"; static const struct kernel_symbol __ksymtab_generic_setattr __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&generic_setattr, __kstrtab_generic_setattr };
...
extern typeof(inode_setattr) inode_setattr; static const char __kstrtab_inode_setattr[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "inode_setattr"; static const struct kernel_symbol __ksymtab_inode_setattr __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&inode_setattr, __kstrtab_inode_setattr };
...
int notify_change(struct dentry * dentry, struct iattr * attr)
{
 ...
 if (ia_valid & ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 16))) {
  if (((inode)->i_flags & 8) || ((inode)->i_flags & 4))
   return -1;
 }
...
# 211 "../../fs/attr.c"
 if ((ia_valid & ((1 << 11)|(1 << 12))) &&
     (ia_valid & (1 << 0)))
  do { *(int *)0 = 0; } while (1);

 if (ia_valid & (1 << 11)) {
  if (mode & 0004000) {
   ia_valid = attr->ia_valid |= (1 << 0);
   attr->ia_mode = (inode->i_mode & ~0004000);
  }
 }
 if (ia_valid & (1 << 12)) {
...
extern typeof(notify_change) notify_change; static const char __kstrtab_notify_change[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "notify_change"; static const struct kernel_symbol __ksymtab_notify_change __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&notify_change, __kstrtab_notify_change };
