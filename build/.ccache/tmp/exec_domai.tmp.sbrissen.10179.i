# 1 "../../kernel/exec_domain.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../kernel/exec_domain.c"
# 10 "../../kernel/exec_domain.c"
...
# 22 "../../kernel/exec_domain.c" 2


static void default_handler(int, struct pt_regs *);

static struct exec_domain *exec_domains = &default_exec_domain;
static rwlock_t exec_domains_lock = (rwlock_t) { .raw_lock = { 0 }, };
...
{
 (((get_current())->personality == (0)) ? 0 : __set_personality(0));

 if (current_thread_info()->exec_domain->handler != default_handler)
  current_thread_info()->exec_domain->handler(segment, regp);
 else
  send_sig(11, (get_current()), 1);
}

static struct exec_domain *
lookup_exec_domain(unsigned int personality)
{
 unsigned int pers = (personality & PER_MASK);
 struct exec_domain *ep;

 _raw_read_lock(&exec_domains_lock);
 ...
 _raw_read_unlock(&exec_domains_lock);
 __request_module(true, "personality-%d", pers);
 _raw_read_lock(&exec_domains_lock);
...
register_exec_domain(struct exec_domain *ep)
{
 ...
 _raw_write_lock(&exec_domains_lock);
...
out:
 _raw_write_unlock(&exec_domains_lock);
 return (err);
}
...
static int execdomains_proc_show(struct seq_file *m, void *v)
{
 ...
 for (ep = exec_domains; ep; ep = ep->next)
  seq_printf(m, "%d-%d\t%-16s\t[%s]\n",
          ...
          ({ struct module *__mod = (ep->module); __mod ? __mod->name : "kernel"; }));
 _raw_read_unlock(&exec_domains_lock);
 return 0;
}
...
{
 return single_open(file, execdomains_proc_show, ((void *)0));
}
...
static int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) proc_execdomains_init(void)
{
 proc_create("execdomains", 0, ((void *)0), &execdomains_proc_fops);
 return 0;
}
static initcall_t __initcall_proc_execdomains_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = proc_execdomains_init;;
 ...
 long sys_personality(unsigned int personality)
{
 ...
 if (personality != 0xffffffff) {
  (((get_current())->personality == (personality)) ? 0 : __set_personality(personality));
  if ((get_current())->personality != personality)
   return -22;
 }
...
extern typeof(register_exec_domain) register_exec_domain; static const char __kstrtab_register_exec_domain[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "register_exec_domain"; static const struct kernel_symbol __ksymtab_register_exec_domain __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&register_exec_domain, __kstrtab_register_exec_domain };
extern typeof(unregister_exec_domain) unregister_exec_domain; static const char __kstrtab_unregister_exec_domain[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "unregister_exec_domain"; static const struct kernel_symbol __ksymtab_unregister_exec_domain __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&unregister_exec_domain, __kstrtab_unregister_exec_domain };
extern typeof(__set_personality) __set_personality; static const char __kstrtab___set_personality[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__set_personality"; static const struct kernel_symbol __ksymtab___set_personality __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&__set_personality, __kstrtab___set_personality };
