# 1 "../../net/unix/sysctl_net_unix.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/generated/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "../../net/unix/sysctl_net_unix.c"
# 12 "../../net/unix/sysctl_net_unix.c"
...
# 13 "../../net/unix/sysctl_net_unix.c" 2
...
# 14 "../../net/unix/sysctl_net_unix.c" 2
...
# 15 "../../net/unix/sysctl_net_unix.c" 2

# 1 "../../include/net/af_unix.h" 1
...
# 17 "../../net/unix/sysctl_net_unix.c" 2
...
int __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) unix_sysctl_register(struct net *net)
{
 struct ctl_table *table;

 table = kmemdup(unix_table, sizeof(unix_table), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (table == ((void *)0))
  goto err_alloc;

 table[0].data = &net->unx.sysctl_max_dgram_qlen;
 net->unx.ctl = register_net_sysctl_table(net, unix_path, table);
 if (net->unx.ctl == ((void *)0))
  goto err_reg;
