...
# 34 "../../kernel/workqueue.c" 2



# 1 "../../include/trace/events/workqueue.h" 1
# 9 "../../include/trace/events/workqueue.h"
# 1 "../../include/linux/tracepoint.h" 1
# 10 "../../include/trace/events/workqueue.h" 2

;
# 33 "../../include/trace/events/workqueue.h"
static inline __attribute__((always_inline)) void trace_workqueue_insertion(struct task_struct *wq_thread, struct work_struct *work) { } static inline __attribute__((always_inline)) int register_trace_workqueue_insertion(void (*probe)(void *__data, struct task_struct *wq_thread, struct work_struct *work), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_workqueue_insertion(void (*probe)(void *__data, struct task_struct *wq_thread, struct work_struct *work), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_workqueue_insertion(void (*cb)(void *__data, struct task_struct *wq_thread, struct work_struct *work)) { };
...
static inline __attribute__((always_inline)) void trace_workqueue_execution(struct task_struct *wq_thread, struct work_struct *work) { } static inline __attribute__((always_inline)) int register_trace_workqueue_execution(void (*probe)(void *__data, struct task_struct *wq_thread, struct work_struct *work), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_workqueue_execution(void (*probe)(void *__data, struct task_struct *wq_thread, struct work_struct *work), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_workqueue_execution(void (*cb)(void *__data, struct task_struct *wq_thread, struct work_struct *work)) { };
...
static inline __attribute__((always_inline)) void trace_workqueue_creation(struct task_struct *wq_thread, int cpu) { } static inline __attribute__((always_inline)) int register_trace_workqueue_creation(void (*probe)(void *__data, struct task_struct *wq_thread, int cpu), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_workqueue_creation(void (*probe)(void *__data, struct task_struct *wq_thread, int cpu), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_workqueue_creation(void (*cb)(void *__data, struct task_struct *wq_thread, int cpu)) { };
# 70 "../../include/trace/events/workqueue.h"
static inline __attribute__((always_inline)) void trace_workqueue_destruction(struct task_struct *wq_thread) { } static inline __attribute__((always_inline)) int register_trace_workqueue_destruction(void (*probe)(void *__data, struct task_struct *wq_thread), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_workqueue_destruction(void (*probe)(void *__data, struct task_struct *wq_thread), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_workqueue_destruction(void (*cb)(void *__data, struct task_struct *wq_thread)) { };
# 92 "../../include/trace/events/workqueue.h"
# 1 "../../include/trace/define_trace.h" 1
...
# 92 "../../include/trace/events/workqueue.h"
# 1 "../../include/trace/define_trace.h" 1
# 92 "../../include/trace/events/workqueue.h" 2
# 67 "../../include/trace/define_trace.h" 2
# 92 "../../include/trace/events/workqueue.h" 2
# 38 "../../kernel/workqueue.c" 2
...
# 177 "../../kernel/workqueue.c"
static inline __attribute__((always_inline)) void debug_work_activate(struct work_struct *work) { }
static inline __attribute__((always_inline)) void debug_work_deactivate(struct work_struct *work) { }



static spinlock_t workqueue_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } };
static struct list_head workqueues = { &(workqueues), &(workqueues) };

static int singlethread_cpu ;
static const struct cpumask *cpu_singlethread_map ;
...
static inline __attribute__((always_inline)) int is_wq_single_threaded(struct workqueue_struct *wq)
{
...
{
 if (__builtin_expect(!!(is_wq_single_threaded(wq)), 0))
  cpu = singlethread_cpu;
 return ({ do { const void *__vpp_verify = (typeof(((wq->cpu_wq))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*((wq->cpu_wq))) *)((wq->cpu_wq)))); (typeof((typeof(*((wq->cpu_wq))) *)((wq->cpu_wq)))) (__ptr + (((__per_cpu_offset[(cpu)])))); }); });
}
...
static inline __attribute__((always_inline)) void set_wq_data(struct work_struct *work,
    struct cpu_workqueue_struct *cwq)
{
 unsigned long new;

 do { if (__builtin_expect(!!(!test_bit(0, ((unsigned long *)(&(work)->data)))), 0)) do { *(int *)0 = 0; } while (1); } while(0);

 new = (unsigned long) cwq | (1UL << 0);
 new |= (3UL) & *((unsigned long *)(&(work)->data));
...
static inline __attribute__((always_inline)) void clear_wq_data(struct work_struct *work)
{
 unsigned long flags = *((unsigned long *)(&(work)->data)) &
    (1UL << 1);
...
{
 return (void *) (atomic_long_read(&work->data) & (~(3UL)));
}
   ...
   struct work_struct *work, struct list_head *head)
{
 ...
 __wake_up(&cwq->more_work, (1 | 2), 1, ((void *)0));
}
    ...
    struct work_struct *work)
{
 ...
 do { do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); flags = _raw_spin_lock_irqsave(spinlock_check(&cwq->lock)); } while (0); } while (0);
 insert_work(cwq, work, &cwq->worklist);
 spin_unlock_irqrestore(&cwq->lock, flags);
}
# 284 "../../kernel/workqueue.c"
int queue_work(struct workqueue_struct *wq, struct work_struct *work)
{
 int ret;

 ret = queue_work_on(({ do { do { (current_thread_info()->preempt_count) += (1); } while (0); __asm__ __volatile__("": : :"memory"); } while (0); (current_thread_info()->cpu); }), wq, work);
 do { do { __asm__ __volatile__("": : :"memory"); do { (current_thread_info()->preempt_count) -= (1); } while (0); } while (0); __asm__ __volatile__("": : :"memory"); do { if (__builtin_expect(!!(test_ti_thread_flag(current_thread_info(), 1)), 0)) preempt_schedule(); } while (0); } while (0);

 return ret;
}
extern typeof(queue_work) queue_work; static const char __kstrtab_queue_work[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "queue_work"; static const struct kernel_symbol __ksymtab_queue_work __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&queue_work, __kstrtab_queue_work };
# 306 "../../kernel/workqueue.c"
int
queue_work_on(int cpu, struct workqueue_struct *wq, struct work_struct *work)
{
 int ret = 0;

 if (!_test_and_set_bit_le(0,((unsigned long *)(&(work)->data)))) {
  do { if (__builtin_expect(!!(!list_empty(&work->entry)), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  __queue_work(wq_per_cpu(wq, cpu), work);
  ret = 1;
 }
 return ret;
}
extern typeof(queue_work_on) queue_work_on; static const char __kstrtab_queue_work_on[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "queue_work_on"; static const struct kernel_symbol __ksymtab_queue_work_on __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&queue_work_on, __kstrtab_queue_work_on };
...
static void delayed_work_timer_fn(unsigned long __data)
{
 ...
 __queue_work(wq_per_cpu(wq, (current_thread_info()->cpu)), &dwork->work);
}
# 337 "../../kernel/workqueue.c"
...
extern typeof(queue_delayed_work) queue_delayed_work; static const char __kstrtab_queue_delayed_work[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "queue_delayed_work"; static const struct kernel_symbol __ksymtab_queue_delayed_work __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&queue_delayed_work, __kstrtab_queue_delayed_work };
# 356 "../../kernel/workqueue.c"
   ...
   struct delayed_work *dwork, unsigned long delay)
{
 ...
 if (!_test_and_set_bit_le(0,((unsigned long *)(&(work)->data)))) {
  do { if (__builtin_expect(!!(timer_pending(timer)), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  do { if (__builtin_expect(!!(!list_empty(&work->entry)), 0)) do { *(int *)0 = 0; } while (1); } while(0);

  timer_stats_timer_set_start_info(&dwork->timer);


  set_wq_data(work, wq_per_cpu(wq, (current_thread_info()->cpu)));
  timer->expires = jiffies + delay;
  timer->data = (unsigned long)dwork;
  timer->function = delayed_work_timer_fn;

  if (__builtin_expect(!!(cpu >= 0), 0))
...
extern typeof(queue_delayed_work_on) queue_delayed_work_on; static const char __kstrtab_queue_delayed_work_on[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "queue_delayed_work_on"; static const struct kernel_symbol __ksymtab_queue_delayed_work_on __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&queue_delayed_work_on, __kstrtab_queue_delayed_work_on };

static void run_workqueue(struct cpu_workqueue_struct *cwq)
{
 spin_lock_irq(&cwq->lock);
 while (!list_empty(&cwq->worklist)) {
  struct work_struct *work = ({ const typeof( ((struct work_struct *)0)->entry ) *__mptr = (cwq->worklist.next); (struct work_struct *)( (char *)__mptr - __builtin_offsetof(struct work_struct,entry) );});

  work_func_t f = work->func;
# 403 "../../kernel/workqueue.c"
  ...
  do { if (__builtin_expect(!!(get_wq_data(work) != cwq), 0)) do { *(int *)0 = 0; } while (1); } while(0);
  _clear_bit_le(0,((unsigned long *)(&(work)->data)));
  do { } while (0);
  do { } while (0);
  f(work);
  do { } while (0);
  ...
  if (__builtin_expect(!!((((current_thread_info()->preempt_count) & ~0x40000000) != ((get_current())->lock_depth >= 0)) || (0) > 0), 0)) {
   printk("<3>" "BUG: workqueue leaked lock or atomic: "
     "%s/0x%08x/%d\n",
     (get_current())->comm, (current_thread_info()->preempt_count),
            task_pid_nr((get_current())));
   printk("<3>" "    last function: ");
   print_symbol("%s\n", (unsigned long)f);
   debug_show_held_locks((get_current()));
   dump_stack();
  }

  spin_lock_irq(&cwq->lock);
  cwq->current_work = ((void *)0);
 }
 spin_unlock_irq(&cwq->lock);
}
...
static int worker_thread(void *__cwq)
{
 ...
 for (;;) {
  prepare_to_wait(&cwq->more_work, &wait, 1);
  if (!freezing((get_current())) &&
      !kthread_should_stop() &&
...
{
 struct wq_barrier *barr = ({ const typeof( ((struct wq_barrier *)0)->work ) *__mptr = (work); (struct wq_barrier *)( (char *)__mptr - __builtin_offsetof(struct wq_barrier,work) );});
 complete(&barr->done);
}
   ...
   struct wq_barrier *barr, struct list_head *head)
{
 ...
 do { do { __init_work(((&barr->work)), 1); ((&barr->work))->data = (atomic_long_t) { (0) }; INIT_LIST_HEAD(&((&barr->work))->entry); do { (((&barr->work)))->func = (((wq_barrier_func))); } while (0); } while (0); } while (0);
 __set_bit(0, ((unsigned long *)(&(&barr->work)->data)));
...
static int flush_cpu_workqueue(struct cpu_workqueue_struct *cwq)
{
 ...
 ({ int __ret_warn_on = !!(cwq->thread == (get_current())); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_slowpath_null("../../kernel/workqueue.c", 495); __builtin_expect(!!(__ret_warn_on), 0); });
...
void flush_workqueue(struct workqueue_struct *wq)
{
 ...
 do { } while (0);
 do { } while (0);
 for ((cpu) = -1; (cpu) = cpumask_next((cpu), (cpu_map)), (cpu) < nr_cpu_ids;)
  flush_cpu_workqueue(({ do { const void *__vpp_verify = (typeof(((wq->cpu_wq))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*((wq->cpu_wq))) *)((wq->cpu_wq)))); (typeof((typeof(*((wq->cpu_wq))) *)((wq->cpu_wq)))) (__ptr + (((__per_cpu_offset[(cpu)])))); }); }));
}
extern typeof(flush_workqueue) flush_workqueue; static const char __kstrtab_flush_workqueue[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "flush_workqueue"; static const struct kernel_symbol __ksymtab_flush_workqueue __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&flush_workqueue, __kstrtab_flush_workqueue };
# 548 "../../kernel/workqueue.c"
int flush_work(struct work_struct *work)
{
 ...
 if (!list_empty(&work->entry)) {
  ...
  __asm__ __volatile__ ("dmb" : : : "memory");
  if (__builtin_expect(!!(cwq != get_wq_data(work)), 0))
   goto out;
  prev = &work->entry;
 } else {
...
extern typeof(flush_work) flush_work; static const char __kstrtab_flush_work[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "flush_work"; static const struct kernel_symbol __ksymtab_flush_work __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&flush_work, __kstrtab_flush_work };
    ...
    struct work_struct *work)
{
 ...
 spin_lock_irq(&cwq->lock);
 if (__builtin_expect(!!(cwq->current_work == work), 0)) {
...
static void wait_on_work(struct work_struct *work)
{
 ...
 for ((cpu) = -1; (cpu) = cpumask_next((cpu), (cpu_map)), (cpu) < nr_cpu_ids;)
  wait_on_cpu_work(({ do { const void *__vpp_verify = (typeof(((wq->cpu_wq))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*((wq->cpu_wq))) *)((wq->cpu_wq)))); (typeof((typeof(*((wq->cpu_wq))) *)((wq->cpu_wq)))) (__ptr + (((__per_cpu_offset[(cpu)])))); }); }), work);
}
    ...
    struct timer_list* timer)
{
 ...
 do {
  ret = (timer && __builtin_expect(!!(del_timer(timer)), 1));
  if (!ret)
   ret = try_to_grab_pending(work);
  wait_on_work(work);
 } while (__builtin_expect(!!(ret < 0), 0));

 clear_wq_data(work);
 return ret;
}
# 709 "../../kernel/workqueue.c"
int cancel_work_sync(struct work_struct *work)
{
 return __cancel_work_timer(work, ((void *)0));
}
extern typeof(cancel_work_sync) cancel_work_sync; static const char __kstrtab_cancel_work_sync[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "cancel_work_sync"; static const struct kernel_symbol __ksymtab_cancel_work_sync __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&cancel_work_sync, __kstrtab_cancel_work_sync };
# 724 "../../kernel/workqueue.c"
int cancel_delayed_work_sync(struct delayed_work *dwork)
{
 return __cancel_work_timer(&dwork->work, &dwork->timer);
}
extern typeof(cancel_delayed_work_sync) cancel_delayed_work_sync; static const char __kstrtab_cancel_delayed_work_sync[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "cancel_delayed_work_sync"; static const struct kernel_symbol __ksymtab_cancel_delayed_work_sync __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&cancel_delayed_work_sync, __kstrtab_cancel_delayed_work_sync };

static struct workqueue_struct *keventd_wq ;
# 743 "../../kernel/workqueue.c"
int schedule_work(struct work_struct *work)
{
 return queue_work(keventd_wq, work);
}
extern typeof(schedule_work) schedule_work; static const char __kstrtab_schedule_work[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "schedule_work"; static const struct kernel_symbol __ksymtab_schedule_work __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&schedule_work, __kstrtab_schedule_work };
# 756 "../../kernel/workqueue.c"
int schedule_work_on(int cpu, struct work_struct *work)
{
 return queue_work_on(cpu, keventd_wq, work);
}
extern typeof(schedule_work_on) schedule_work_on; static const char __kstrtab_schedule_work_on[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "schedule_work_on"; static const struct kernel_symbol __ksymtab_schedule_work_on __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&schedule_work_on, __kstrtab_schedule_work_on };
# 770 "../../kernel/workqueue.c"
int schedule_delayed_work(struct delayed_work *dwork,
     unsigned long delay)
{
 return queue_delayed_work(keventd_wq, dwork, delay);
}
extern typeof(schedule_delayed_work) schedule_delayed_work; static const char __kstrtab_schedule_delayed_work[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "schedule_delayed_work"; static const struct kernel_symbol __ksymtab_schedule_delayed_work __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&schedule_delayed_work, __kstrtab_schedule_delayed_work };
...
void flush_delayed_work(struct delayed_work *dwork)
{
 if (del_timer_sync(&dwork->timer)) {
  struct cpu_workqueue_struct *cwq;
  cwq = wq_per_cpu(get_wq_data(&dwork->work)->wq, ({ do { do { (current_thread_info()->preempt_count) += (1); } while (0); __asm__ __volatile__("": : :"memory"); } while (0); (current_thread_info()->cpu); }));
  __queue_work(cwq, &dwork->work);
  do { do { __asm__ __volatile__("": : :"memory"); do { (current_thread_info()->preempt_count) -= (1); } while (0); } while (0); __asm__ __volatile__("": : :"memory"); do { if (__builtin_expect(!!(test_ti_thread_flag(current_thread_info(), 1)), 0)) preempt_schedule(); } while (0); } while (0);
 }
 flush_work(&dwork->work);
}
extern typeof(flush_delayed_work) flush_delayed_work; static const char __kstrtab_flush_delayed_work[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "flush_delayed_work"; static const struct kernel_symbol __ksymtab_flush_delayed_work __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&flush_delayed_work, __kstrtab_flush_delayed_work };
# 804 "../../kernel/workqueue.c"
int schedule_delayed_work_on(int cpu,
   struct delayed_work *dwork, unsigned long delay)
{
 return queue_delayed_work_on(cpu, keventd_wq, dwork, delay);
}
extern typeof(schedule_delayed_work_on) schedule_delayed_work_on; static const char __kstrtab_schedule_delayed_work_on[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "schedule_delayed_work_on"; static const struct kernel_symbol __ksymtab_schedule_delayed_work_on __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&schedule_delayed_work_on, __kstrtab_schedule_delayed_work_on };
# 820 "../../kernel/workqueue.c"
int schedule_on_each_cpu(work_func_t func)
{
 ...
 works = (typeof(struct work_struct) *)__alloc_percpu(sizeof(struct work_struct), __alignof__(struct work_struct));
 if (!works)
  return -12;
 ...
 if (current_is_keventd())
  orig = (current_thread_info()->cpu);

 for (((cpu)) = -1; ((cpu)) = cpumask_next(((cpu)), (cpu_online_mask)), ((cpu)) < nr_cpu_ids;) {
  struct work_struct *work = ({ do { const void *__vpp_verify = (typeof(((works))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*((works))) *)((works)))); (typeof((typeof(*((works))) *)((works)))) (__ptr + (((__per_cpu_offset[(cpu)])))); }); });

  do { do { __init_work(((work)), 0); ((work))->data = (atomic_long_t) { (0) }; INIT_LIST_HEAD(&((work))->entry); do { (((work)))->func = (((func))); } while (0); } while (0); } while (0);
  if (cpu != orig)
   schedule_work_on(cpu, work);
 }
 if (orig >= 0)
  func(({ do { const void *__vpp_verify = (typeof(((works))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*((works))) *)((works)))); (typeof((typeof(*((works))) *)((works)))) (__ptr + (((__per_cpu_offset[(orig)])))); }); }));

 for (((cpu)) = -1; ((cpu)) = cpumask_next(((cpu)), (cpu_online_mask)), ((cpu)) < nr_cpu_ids;)
  flush_work(({ do { const void *__vpp_verify = (typeof(((works))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*((works))) *)((works)))); (typeof((typeof(*((works))) *)((works)))) (__ptr + (((__per_cpu_offset[(cpu)])))); }); }));

 put_online_cpus();
 free_percpu(works);
 return 0;
}
# 882 "../../kernel/workqueue.c"
void flush_scheduled_work(void)
{
 flush_workqueue(keventd_wq);
}
extern typeof(flush_scheduled_work) flush_scheduled_work; static const char __kstrtab_flush_scheduled_work[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "flush_scheduled_work"; static const struct kernel_symbol __ksymtab_flush_scheduled_work __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&flush_scheduled_work, __kstrtab_flush_scheduled_work };
# 900 "../../kernel/workqueue.c"
int execute_in_process_context(work_func_t fn, struct execute_work *ew)
{
 ...
 do { do { __init_work(((&ew->work)), 0); ((&ew->work))->data = (atomic_long_t) { (0) }; INIT_LIST_HEAD(&((&ew->work))->entry); do { (((&ew->work)))->func = (((fn))); } while (0); } while (0); } while (0);
 schedule_work(&ew->work);

 return 1;
}
extern typeof(execute_in_process_context) execute_in_process_context; static const char __kstrtab_execute_in_process_context[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "execute_in_process_context"; static const struct kernel_symbol __ksymtab_execute_in_process_context __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&execute_in_process_context, __kstrtab_execute_in_process_context };
...
int current_is_keventd(void)
{
 ...
 do { if (__builtin_expect(!!(!keventd_wq), 0)) do { *(int *)0 = 0; } while (1); } while(0);

 cwq = ({ do { const void *__vpp_verify = (typeof(((keventd_wq->cpu_wq))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*((keventd_wq->cpu_wq))) *)((keventd_wq->cpu_wq)))); (typeof((typeof(*((keventd_wq->cpu_wq))) *)((keventd_wq->cpu_wq)))) (__ptr + (((__per_cpu_offset[(cpu)])))); }); });
...
{
 struct cpu_workqueue_struct *cwq = ({ do { const void *__vpp_verify = (typeof(((wq->cpu_wq))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*((wq->cpu_wq))) *)((wq->cpu_wq)))); (typeof((typeof(*((wq->cpu_wq))) *)((wq->cpu_wq)))) (__ptr + (((__per_cpu_offset[(cpu)])))); }); });

 cwq->wq = wq;
 do { spinlock_check(&cwq->lock); do { *(&(&cwq->lock)->rlock) = (raw_spinlock_t) { .raw_lock = { 0 }, }; } while (0); } while (0);
 INIT_LIST_HEAD(&cwq->worklist);
 do { static struct lock_class_key __key; __init_waitqueue_head((&cwq->more_work), &__key); } while (0);
...
{
 struct sched_param param = { .sched_priority = 100 -1 };
 struct workqueue_struct *wq = cwq->wq;
 const char *fmt = is_wq_single_threaded(wq) ? "%s" : "%s/%d";
 struct task_struct *p;

 p = kthread_create(worker_thread, cwq, fmt, wq->name, cpu);
# 964 "../../kernel/workqueue.c"
 if (IS_ERR(p))
  return PTR_ERR(p);
 if (cwq->wq->rt)
      ...
      const char *lock_name)
{
 ...
 wq = kzalloc(sizeof(*wq), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!wq)
  return ((void *)0);

 wq->cpu_wq = (typeof(struct cpu_workqueue_struct) *)__alloc_percpu(sizeof(struct cpu_workqueue_struct), __alignof__(struct cpu_workqueue_struct));
 if (!wq->cpu_wq) {
  kfree(wq);
  return ((void *)0);
 }
 ...
 wq->name = name;
 do { (void)(lock_name); (void)(key); } while (0);
 ...
 if (singlethread) {
  ...
  for (((cpu)) = -1; ((cpu)) = cpumask_next(((cpu)), (cpu_possible_mask)), ((cpu)) < nr_cpu_ids;) {
   ...
   if (err || !test_bit(cpumask_check((cpu)), (((cpu_online_mask))->bits)))
    continue;
...
extern typeof(__create_workqueue_key) __create_workqueue_key; static const char __kstrtab___create_workqueue_key[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "__create_workqueue_key"; static const struct kernel_symbol __ksymtab___create_workqueue_key __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&__create_workqueue_key, __kstrtab___create_workqueue_key };
...
void destroy_workqueue(struct workqueue_struct *wq)
{
 ...
 for ((cpu) = -1; (cpu) = cpumask_next((cpu), (cpu_map)), (cpu) < nr_cpu_ids;)
  cleanup_workqueue_thread(({ do { const void *__vpp_verify = (typeof(((wq->cpu_wq))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*((wq->cpu_wq))) *)((wq->cpu_wq)))); (typeof((typeof(*((wq->cpu_wq))) *)((wq->cpu_wq)))) (__ptr + (((__per_cpu_offset[(cpu)])))); }); }));
  cpu_maps_update_done();

 free_percpu(wq->cpu_wq);
 kfree(wq);
}
extern typeof(destroy_workqueue) destroy_workqueue; static const char __kstrtab_destroy_workqueue[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "destroy_workqueue"; static const struct kernel_symbol __ksymtab_destroy_workqueue __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&destroy_workqueue, __kstrtab_destroy_workqueue };

static int __attribute__ ((__section__(".devinit.text"))) __attribute__((__cold__)) workqueue_cpu_callback(struct notifier_block *nfb,
...
undo:
 for (wq = ({ const typeof( ((typeof(*wq) *)0)->list ) *__mptr = ((&workqueues)->next); (typeof(*wq) *)( (char *)__mptr - __builtin_offsetof(typeof(*wq),list) );}); prefetch(wq->list.next), &wq->list != (&workqueues); wq = ({ const typeof( ((typeof(*wq) *)0)->list ) *__mptr = (wq->list.next); (typeof(*wq) *)( (char *)__mptr - __builtin_offsetof(typeof(*wq),list) );})) {
  cwq = ({ do { const void *__vpp_verify = (typeof(((wq->cpu_wq))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*((wq->cpu_wq))) *)((wq->cpu_wq)))); (typeof((typeof(*((wq->cpu_wq))) *)((wq->cpu_wq)))) (__ptr + (((__per_cpu_offset[(cpu)])))); }); });
  ...
  case 0x0003:
   ...
   if (!err)
    break;
   printk("<3>" "workqueue [%s] for %i failed\n",
    wq->name, cpu);
   action = 0x0004;
   err = -12;
   goto undo;
...
# 1184 "../../kernel/workqueue.c"
long work_on_cpu(unsigned int cpu, long (*fn)(void *), void *arg)
{
 struct task_struct *sub_thread;
 struct work_for_cpu wfc = {
  .completion = ({ init_completion(&wfc.completion); wfc.completion; }),
  .fn = fn,
  .arg = arg,
 };
...
extern typeof(work_on_cpu) work_on_cpu; static const char __kstrtab_work_on_cpu[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "work_on_cpu"; static const struct kernel_symbol __ksymtab_work_on_cpu __attribute__((__used__)) __attribute__((section("__ksymtab" "_gpl"), unused)) = { (unsigned long)&work_on_cpu, __kstrtab_work_on_cpu };


void __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) init_workqueues(void)
{
 alloc_cpumask_var(&cpu_populated_map, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));

 cpumask_copy(cpu_populated_map, cpu_online_mask);
 singlethread_cpu = cpumask_first(cpu_possible_mask);
 cpu_singlethread_map = (get_cpu_mask(singlethread_cpu));
 { static struct notifier_block workqueue_cpu_callback_nb __attribute__ ((__section__(".cpuinit.data"))) = { .notifier_call = workqueue_cpu_callback, .priority = 0 }; register_cpu_notifier(&workqueue_cpu_callback_nb); };
 keventd_wq = __create_workqueue_key((("events")), (0), (0), (0), ((void *)0), ((void *)0));
 do { if (__builtin_expect(!!(!keventd_wq), 0)) do { *(int *)0 = 0; } while (1); } while(0);
}
