         ...
         struct ext4_new_group_data *input)
{
 ...
 unsigned overhead = ext4_bg_has_super(sb, group) ?
  (1 + ext4_bg_num_gdb(sb, group) +
   (( __u16)(__le16)(es->s_reserved_gdt_blocks))) : 0;
 ...
 if ((EXT4_SB(sb)->s_mount_opt & 0x00008))
  printk("<7>" "EXT4-fs: adding %s group %u: %u blocks "
         "(%d free, %u reserved)\n",
         ext4_bg_has_super(sb, input->group) ? "normal" :
         "no-super", input->group, input->blocks_count,
         free_blocks_count, input->reserved_blocks);

 ext4_get_group_no_and_offset(sb, start, ((void *)0), &offset);
 if (group != sbi->s_groups_count)
  __ext4_warning(sb, __func__, "Cannot add at group %u (only %u groups)", input->group, sbi->s_groups_count);

 else if (offset != 0)
   __ext4_warning(sb, __func__, "Last group not full");
 else if (input->reserved_blocks > input->blocks_count / 5)
  __ext4_warning(sb, __func__, "Reserved blocks too high (%u)", input->reserved_blocks);

 else if (free_blocks_count < 0)
  __ext4_warning(sb, __func__, "Bad blocks count %u", input->blocks_count);

 else if (!(bh = sb_bread(sb, end - 1)))
  __ext4_warning(sb, __func__, "Cannot read last block (%llu)", end - 1);

 else if (((input->block_bitmap) < (start) || (input->block_bitmap) >= (end)))
  __ext4_warning(sb, __func__, "Block bitmap not in group (block %llu)", (unsigned long long)input->block_bitmap);

 else if (((input->inode_bitmap) < (start) || (input->inode_bitmap) >= (end)))
  __ext4_warning(sb, __func__, "Inode bitmap not in group (block %llu)", (unsigned long long)input->inode_bitmap);

 else if (((input->inode_table) < (start) || (input->inode_table) >= (end)) ||
   ((itend - 1) < (start) || (itend - 1) >= (end)))
  __ext4_warning(sb, __func__, "Inode table not in group (blocks %llu-%llu)", (unsigned long long)input->inode_table, itend - 1);

 else if (input->inode_bitmap == input->block_bitmap)
  __ext4_warning(sb, __func__, "Block bitmap same as inode bitmap (%llu)", (unsigned long long)input->block_bitmap);

 else if (((input->block_bitmap) >= (input->inode_table) && (input->block_bitmap) < (itend)))
  __ext4_warning(sb, __func__, "Block bitmap (%llu) in inode table " "(%llu-%llu)", (unsigned long long)input->block_bitmap, (unsigned long long)input->inode_table, itend - 1);



 else if (((input->inode_bitmap) >= (input->inode_table) && (input->inode_bitmap) < (itend)))
  __ext4_warning(sb, __func__, "Inode bitmap (%llu) in inode table " "(%llu-%llu)", (unsigned long long)input->inode_bitmap, (unsigned long long)input->inode_table, itend - 1);



 else if (((input->block_bitmap) >= (start) && (input->block_bitmap) < (metaend)))
  __ext4_warning(sb, __func__, "Block bitmap (%llu) in GDT table (%llu-%llu)", (unsigned long long)input->block_bitmap, start, metaend - 1);


 else if (((input->inode_bitmap) >= (start) && (input->inode_bitmap) < (metaend)))
  __ext4_warning(sb, __func__, "Inode bitmap (%llu) in GDT table (%llu-%llu)", (unsigned long long)input->inode_bitmap, start, metaend - 1);


 else if (((input->inode_table) >= (start) && (input->inode_table) < (metaend)) ||
   ((itend - 1) >= (start) && (itend - 1) < (metaend)))
  __ext4_warning(sb, __func__, "Inode table (%llu-%llu) overlaps GDT table " "(%llu-%llu)", (unsigned long long)input->inode_table, itend - 1, start, metaend - 1);
      ...
      ext4_fsblk_t blk)
{
 ...
 if (!bh)
  return ERR_PTR(-5);
 if ((err = __ext4_journal_get_write_access(__func__, (handle), (bh)))) {
  brelse(bh);
  bh = ERR_PTR(err);
 } else {
  lock_buffer(bh);
  ({ void *__p = (bh->b_data); size_t __n = sb->s_blocksize; if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
      ...
      struct buffer_head *bh)
{
 ...
 err = ext4_journal_extend(handle, 64U);
 if (err < 0)
  return err;
 if (err) {
  if ((err = ext4_journal_restart(handle, 64U)))
   return err;
  if ((err = __ext4_journal_get_write_access(__func__, (handle), (bh))))
   return err;
 }
      ...
      struct ext4_new_group_data *input)
{
 ...
 int reserved_gdb = ext4_bg_has_super(sb, input->group) ?
  (( __u16)(__le16)(sbi->s_es->s_reserved_gdt_blocks)) : 0;
 ...
 handle = ext4_journal_start_sb(sb, 64U);
 ...
 if (ext4_bg_has_super(sb, input->group)) {
  do {} while (0);
  __test_and_set_bit(((0)), (unsigned long *)(bh->b_data));
 }
 ...
 for (i = 0, bit = 1, block = start + 1;
  ...
  if ((err = __ext4_journal_get_write_access(__func__, (handle), (gdb)))) {
   brelse(gdb);
   goto exit_bh;
  }
  lock_buffer(gdb);
  ...
  unlock_buffer(gdb);
  __ext4_handle_dirty_metadata(__func__, (handle), (((void *)0)), (gdb));
  __test_and_set_bit(((bit)), (unsigned long *)(bh->b_data));
  brelse(gdb);
 }
 ...
 __test_and_set_bit(((input->block_bitmap - start)), (unsigned long *)(bh->b_data));
 do {} while (0);

 __test_and_set_bit(((input->inode_bitmap - start)), (unsigned long *)(bh->b_data));
 ...
 for (i = 0, block = input->inode_table, bit = block - start;
  ...
  __ext4_handle_dirty_metadata(__func__, (handle), (((void *)0)), (it));
  brelse(it);
  __test_and_set_bit(((bit)), (unsigned long *)(bh->b_data));
 }
 ...
 __ext4_handle_dirty_metadata(__func__, (handle), (((void *)0)), (bh));
 brelse(bh);
 ...
 mark_bitmap_end((EXT4_SB(sb)->s_inodes_per_group), sb->s_blocksize * 8,
   bh->b_data);
 __ext4_handle_dirty_metadata(__func__, (handle), (((void *)0)), (bh));
exit_bh:
 brelse(bh);
...
exit_journal:
 ...
 if ((err2 = __ext4_journal_stop(__func__, (handle))) && !err)
  err = err2;

 return err;
}
# 307 "../../fs/ext4/resize.c"
      ...
      unsigned *five, unsigned *seven)
{
 ...
 if (!((EXT4_SB(sb)->s_es->s_feature_ro_compat & (( __le32)(__u32)(0x0001))) != 0)) {
          ...
          struct buffer_head *primary)
{
 ...
 while ((grp = ext4_list_backups(sb, &three, &five, &seven)) < end) {
  if ((( __u32)(__le32)(*p++)) !=
      grp * (EXT4_SB(sb)->s_blocks_per_group) + blk){
   __ext4_warning(sb, __func__, "reserved GDT %llu" " missing grp %d (%llu)", blk, grp, grp * (ext4_fsblk_t)(EXT4_SB(sb)->s_blocks_per_group) + blk);
  ...
  if (++gdbackups > (((sb)->s_blocksize) / sizeof(__u32)))
   return -27;
 }

 return gdbackups;
}
# 384 "../../fs/ext4/resize.c"
         ...
         struct buffer_head **primary)
{
 ...
 unsigned long gdb_num = input->group / (EXT4_SB(sb)->s_desc_per_block);
 ...
 if (EXT4_SB(sb)->s_sbh->b_blocknr !=
     (( __u32)(__le32)(EXT4_SB(sb)->s_es->s_first_data_block))) {
  __ext4_warning(sb, __func__, "won't resize using backup superblock at %llu", (unsigned long long)EXT4_SB(sb)->s_sbh->b_blocknr);
 ...
 *primary = sb_bread(sb, gdblock);
 ...
 data = EXT4_I(inode)->i_data + (12 + 1);
 dind = sb_bread(sb, (( __u32)(__le32)(*data)));
 if (!dind) {
  err = -5;
  goto exit_bh;
 }
 ...
 if ((( __u32)(__le32)(data[gdb_num % (((sb)->s_blocksize) / sizeof(__u32))])) != gdblock) {
  __ext4_warning(sb, __func__, "new group %u GDT block %llu not reserved", input->group, gdblock);

  err = -22;
  goto exit_dind;
 }

 if ((err = __ext4_journal_get_write_access(__func__, (handle), (EXT4_SB(sb)->s_sbh))))
  goto exit_dind;

 if ((err = __ext4_journal_get_write_access(__func__, (handle), (*primary))))
  goto exit_sbh;

 if ((err = __ext4_journal_get_write_access(__func__, (handle), (dind))))
  goto exit_primary;
 ...
 if (!n_group_desc) {
  err = -12;
  __ext4_warning(sb, __func__, "not enough memory for %lu groups", gdb_num + 1);

  goto exit_inode;
 }
# 471 "../../fs/ext4/resize.c"
 data[gdb_num % (((sb)->s_blocksize) / sizeof(__u32))] = 0;
 __ext4_handle_dirty_metadata(__func__, (handle), (((void *)0)), (dind));
 brelse(dind);
 inode->i_blocks -= (gdbackups + 1) * sb->s_blocksize >> 9;
 ext4_mark_iloc_dirty(handle, inode, &iloc);
 ({ void *__p = ((*primary)->b_data); size_t __n = sb->s_blocksize; if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
 __ext4_handle_dirty_metadata(__func__, (handle), (((void *)0)), (*primary));
 ...
 __ext4_handle_dirty_metadata(__func__, (handle), (((void *)0)), (EXT4_SB(sb)->s_sbh));
...
# 523 "../../fs/ext4/resize.c"
static int reserve_backup_gdb(handle_t *handle, struct inode *inode,
         struct ext4_new_group_data *input)
{
 struct super_block *sb = inode->i_sb;
 int reserved_gdb =(( __u16)(__le16)(EXT4_SB(sb)->s_es->s_reserved_gdt_blocks));
 struct buffer_head **primary;
 struct buffer_head *dind;
 struct ext4_iloc iloc;
 ext4_fsblk_t blk;
 ...
 primary = kmalloc(reserved_gdb * sizeof(*primary), ((( gfp_t)0x10u) | (( gfp_t)0x40u)));
 if (!primary)
  return -12;
 ...
 data = (__le32 *)dind->b_data + (EXT4_SB(sb)->s_gdb_count %
      (((sb)->s_blocksize) / sizeof(__u32)));
 end = (__le32 *)dind->b_data + (((sb)->s_blocksize) / sizeof(__u32));


 for (res = 0; res < reserved_gdb; res++, blk++) {
  if ((( __u32)(__le32)(*data)) != blk) {
   __ext4_warning(sb, __func__, "reserved block %llu" " not at offset %ld", blk, (long)(data - (__le32 *)dind->b_data));
 ...
 for (i = 0; i < reserved_gdb; i++) {
  if ((err = __ext4_journal_get_write_access(__func__, (handle), (primary[i])))) {
 ...
 blk = input->group * (EXT4_SB(sb)->s_blocks_per_group);
 for (i = 0; i < reserved_gdb; i++) {
  int err2;
  ...
  data[gdbackups] = (( __le32)(__u32)(blk + primary[i]->b_blocknr));
  err2 = __ext4_handle_dirty_metadata(__func__, (handle), (((void *)0)), (primary[i]));
  if (!err)
   err = err2;
 }
...
# 637 "../../fs/ext4/resize.c"
static void update_backups(struct super_block *sb,
      int blk_off, char *data, int size)
{
 struct ext4_sb_info *sbi = EXT4_SB(sb);
 const ext4_group_t last = sbi->s_groups_count;
 const int bpg = (EXT4_SB(sb)->s_blocks_per_group);
 unsigned three = 1;
 unsigned five = 5;
 unsigned seven = 7;
 ext4_group_t group;
 ...
 while ((group = ext4_list_backups(sb, &three, &five, &seven)) < last) {
  ...
  if (ext4_handle_valid(handle) &&
      ...
      ext4_journal_extend(handle, 64U) &&
      (err = ext4_journal_restart(handle, 64U)))
   break;
  ...
  if (rest)
   ({ void *__p = (bh->b_data + size); size_t __n = rest; if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
  set_buffer_uptodate(bh);
  unlock_buffer(bh);
  __ext4_handle_dirty_metadata(__func__, (handle), (((void *)0)), (bh));
  brelse(bh);
 ...
 if ((err2 = __ext4_journal_stop(__func__, (handle))) && !err)
  err = err2;
# 699 "../../fs/ext4/resize.c"
exit_err:
 if (err) {
  __ext4_warning(sb, __func__, "can't update backup for group %u (err %d), " "forcing fsck on next reboot", group, err);

  sbi->s_mount_state &= ~0x0001;
  sbi->s_es->s_state &= (( __le16)(__u16)(~0x0001));
  mark_buffer_dirty(sbi->s_sbh);
 }
}
# 722 "../../fs/ext4/resize.c"
int ext4_group_add(struct super_block *sb, struct ext4_new_group_data *input)
{
 ...
 int reserved_gdb = ext4_bg_has_super(sb, input->group) ?
  (( __u16)(__le16)(es->s_reserved_gdt_blocks)) : 0;
 struct buffer_head *primary = ((void *)0);
 struct ext4_group_desc *gdp;
 ...
 gdb_num = input->group / (EXT4_SB(sb)->s_desc_per_block);
 gdb_off = input->group % (EXT4_SB(sb)->s_desc_per_block);

 if (gdb_off == 0 && !((EXT4_SB(sb)->s_es->s_feature_ro_compat & (( __le32)(__u32)(0x0001))) != 0)) {

  __ext4_warning(sb, __func__, "Can't resize non-sparse filesystem further");
  return -1;
 }

 if (ext4_blocks_count(es) + input->blocks_count <
     ext4_blocks_count(es)) {
  __ext4_warning(sb, __func__, "blocks_count overflow");
  return -22;
 }

 if ((( __u32)(__le32)(es->s_inodes_count)) + (EXT4_SB(sb)->s_inodes_per_group) <
     (( __u32)(__le32)(es->s_inodes_count))) {
  __ext4_warning(sb, __func__, "inodes_count overflow");
  return -22;
 }

 if (reserved_gdb || gdb_off == 0) {
  if (!((EXT4_SB(sb)->s_es->s_feature_compat & (( __le32)(__u32)(0x0010))) != 0)

      || !(( __u16)(__le16)(es->s_reserved_gdt_blocks))) {
   __ext4_warning(sb, __func__, "No reserved GDT blocks, can't resize");

   return -1;
  }
  inode = ext4_iget(sb, 7);
  if (IS_ERR(inode)) {
   __ext4_warning(sb, __func__, "Error opening resize inode");
...
# 785 "../../fs/ext4/resize.c"
 ...
 mutex_lock(&sbi->s_resize_lock);
 if (input->group != sbi->s_groups_count) {
  __ext4_warning(sb, __func__, "multiple resizers run on filesystem!");
  err = -16;
  goto exit_journal;
 }

 if ((err = __ext4_journal_get_write_access(__func__, (handle), (sbi->s_sbh))))
  goto exit_journal;
 ...
 if (gdb_off) {
  ...
  goto exit_journal;
# 840 "../../fs/ext4/resize.c"
 gdp = (struct ext4_group_desc *)((char *)primary->b_data +
      gdb_off * (EXT4_SB(sb)->s_desc_size));

 ({ void *__p = (gdp); size_t __n = (EXT4_SB(sb)->s_desc_size); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
 ...
 ext4_free_inodes_set(sb, gdp, (EXT4_SB(sb)->s_inodes_per_group));
 gdp->bg_flags = (( __le16)(__u16)(0x0004));
 ...
 if (err)
  goto exit_journal;
# 870 "../../fs/ext4/resize.c"
 ext4_blocks_count_set(es, ext4_blocks_count(es) +
  input->blocks_count);
 le32_add_cpu(&es->s_inodes_count, (EXT4_SB(sb)->s_inodes_per_group));
# 896 "../../fs/ext4/resize.c"
 __asm__ __volatile__ ("dmb" : : : "memory");
 ...
 if (((EXT4_SB(sb)->s_es->s_feature_incompat & (( __le32)(__u32)(0x0200))) != 0) &&
     sbi->s_log_groups_per_flex) {
  ext4_group_t flex_group;
  flex_group = ext4_flex_group(sbi, input->group);
  atomic_add(input->free_blocks_count,
      &sbi->s_flex_groups[flex_group].free_blocks);
  atomic_add((EXT4_SB(sb)->s_inodes_per_group),
      &sbi->s_flex_groups[flex_group].free_inodes);
 }

 __ext4_handle_dirty_metadata(__func__, (handle), (((void *)0)), (sbi->s_sbh));
 sb->s_dirt = 1;
        ...
        ext4_fsblk_t n_blocks_count)
{
 ...
 if ((EXT4_SB(sb)->s_mount_opt & 0x00008))
  printk("<7>" "EXT4-fs: extending last group from %llu uto %llu blocks\n",
 ...
 if (n_blocks_count > (sector_t)(~0ULL) >> (sb->s_blocksize_bits - 9)) {
  printk("<3>" "EXT4-fs: filesystem on %s:"
   " too large to resize to %llu blocks safely\n",
   sb->s_id, n_blocks_count);
  if (sizeof(sector_t) < 8)
   __ext4_warning(sb, __func__, "CONFIG_LBDAF not enabled");
  return -22;
 }

 if (n_blocks_count < o_blocks_count) {
  __ext4_warning(sb, __func__, "can't shrink FS - resize aborted");
  return -16;
 }
 ...
 if (last == 0) {
  __ext4_warning(sb, __func__, "need to use ext2online to resize further");
  return -1;
 }

 add = (EXT4_SB(sb)->s_blocks_per_group) - last;
 ...
 if (o_blocks_count + add < n_blocks_count)
  __ext4_warning(sb, __func__, "will only finish group (%llu blocks, %u new)", o_blocks_count + add, add);



 bh = sb_bread(sb, o_blocks_count + add - 1);
 if (!bh) {
  __ext4_warning(sb, __func__, "can't read last block, resize aborted");
  return -28;
 }
 brelse(bh);
 ...
 if (IS_ERR(handle)) {
  err = PTR_ERR(handle);
  __ext4_warning(sb, __func__, "error %d on journal start", err);
  goto exit_put;
 }
 ...
 if ((err = __ext4_journal_get_write_access(__func__, (handle), (EXT4_SB(sb)->s_sbh)))) {
  ...
  __ext4_warning(sb, __func__, "error %d on journal write access", err);
  mutex_unlock(&EXT4_SB(sb)->s_resize_lock);
  __ext4_journal_stop(__func__, (handle));
  goto exit_put;
 }
 ...
 if ((err = __ext4_journal_stop(__func__, (handle))))
  goto exit_put;

 if ((EXT4_SB(sb)->s_mount_opt & 0x00008))
  printk("<7>" "EXT4-fs: extended group to %llu blocks\n",
         ext4_blocks_count(es));
