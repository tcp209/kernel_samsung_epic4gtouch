...
# 1 "../../include/trace/events/block.h" 1
...
# 1 "../../include/linux/blktrace_api.h" 1
...
{
# 98 "../../include/linux/relay.h"
 int (*subbuf_start) (struct rchan_buf *buf,
        void *subbuf,
        void *prev_subbuf,
        size_t prev_padding);
# 110 "../../include/linux/relay.h"
        void (*buf_mapped)(struct rchan_buf *buf,
      struct file *filp);
# 120 "../../include/linux/relay.h"
        void (*buf_unmapped)(struct rchan_buf *buf,
        struct file *filp);
# 145 "../../include/linux/relay.h"
...
extern size_t relay_switch_subbuf(struct rchan_buf *buf,
      size_t length);
# 201 "../../include/linux/relay.h"
static inline __attribute__((always_inline)) void relay_write(struct rchan *chan,
          const void *data,
          size_t length)
{
 unsigned long flags;
 ...
 do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); ({ __asm__ __volatile__( "mrs	%0, cpsr		@ local_irq_save\n" "cpsid	i" : "=r" (flags) : : "memory", "cc"); }); do { } while (0); } while (0);
 buf = chan->buf[(current_thread_info()->cpu)];
 if (__builtin_expect(!!(buf->offset + length > chan->subbuf_size), 0))
  length = relay_switch_subbuf(buf, length);
 memcpy(buf->data + buf->offset, data, length);
 buf->offset += length;
 do { ({ unsigned long __dummy; typeof(flags) __dummy2; (void)(&__dummy == &__dummy2); 1; }); if (({ (int)((flags) & 0x00000080); })) { __asm__ __volatile__( "msr	cpsr_c, %0		@ local_irq_restore\n" : : "r" (flags) : "memory", "cc"); do { } while (0); } else { do { } while (0); __asm__ __volatile__( "msr	cpsr_c, %0		@ local_irq_restore\n" : : "r" (flags) : "memory", "cc"); } } while (0);
}
# 229 "../../include/linux/relay.h"
static inline __attribute__((always_inline)) void __relay_write(struct rchan *chan,
     const void *data,
     size_t length)
{
 struct rchan_buf *buf;

 buf = chan->buf[({ do { do { (current_thread_info()->preempt_count) += (1); } while (0); __asm__ __volatile__("": : :"memory"); } while (0); (current_thread_info()->cpu); })];
 if (__builtin_expect(!!(buf->offset + length > buf->chan->subbuf_size), 0))
  length = relay_switch_subbuf(buf, length);
 memcpy(buf->data + buf->offset, data, length);
 buf->offset += length;
 do { do { __asm__ __volatile__("": : :"memory"); do { (current_thread_info()->preempt_count) -= (1); } while (0); } while (0); __asm__ __volatile__("": : :"memory"); do { if (__builtin_expect(!!(test_ti_thread_flag(current_thread_info(), 1)), 0)) preempt_schedule(); } while (0); } while (0);
}
# 254 "../../include/linux/relay.h"
static inline __attribute__((always_inline)) void *relay_reserve(struct rchan *chan, size_t length)
{
 void *reserved;
 struct rchan_buf *buf = chan->buf[(current_thread_info()->cpu)];
...
# 278 "../../include/linux/relay.h"
static inline __attribute__((always_inline)) void subbuf_start_reserve(struct rchan_buf *buf,
     size_t length)
{
 do { if (__builtin_expect(!!(length >= buf->chan->subbuf_size - 1), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 buf->offset = length;
}
...
# 8 "../../include/linux/blktrace_api.h" 2
...
# 216 "../../include/linux/blktrace_api.h"
static inline __attribute__((always_inline)) int blk_trace_init_sysfs(struct device *dev)
{
 return 0;
}
# 8 "../../include/trace/events/block.h" 2

# 1 "../../include/linux/tracepoint.h" 1
# 10 "../../include/trace/events/block.h" 2

;
# 53 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_rq_abort(struct request_queue *q, struct request *rq) { } static inline __attribute__((always_inline)) int register_trace_block_rq_abort(void (*probe)(void *__data, struct request_queue *q, struct request *rq), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_rq_abort(void (*probe)(void *__data, struct request_queue *q, struct request *rq), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_rq_abort(void (*cb)(void *__data, struct request_queue *q, struct request *rq)) { };
# 69 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_rq_requeue(struct request_queue *q, struct request *rq) { } static inline __attribute__((always_inline)) int register_trace_block_rq_requeue(void (*probe)(void *__data, struct request_queue *q, struct request *rq), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_rq_requeue(void (*probe)(void *__data, struct request_queue *q, struct request *rq), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_rq_requeue(void (*cb)(void *__data, struct request_queue *q, struct request *rq)) { };
# 87 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_rq_complete(struct request_queue *q, struct request *rq) { } static inline __attribute__((always_inline)) int register_trace_block_rq_complete(void (*probe)(void *__data, struct request_queue *q, struct request *rq), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_rq_complete(void (*probe)(void *__data, struct request_queue *q, struct request *rq), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_rq_complete(void (*cb)(void *__data, struct request_queue *q, struct request *rq)) { };
...
;
# 138 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_rq_insert(struct request_queue *q, struct request *rq) { } static inline __attribute__((always_inline)) int register_trace_block_rq_insert(void (*probe)(void *__data, struct request_queue *q, struct request *rq), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_rq_insert(void (*probe)(void *__data, struct request_queue *q, struct request *rq), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_rq_insert(void (*cb)(void *__data, struct request_queue *q, struct request *rq)) { };
# 153 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_rq_issue(struct request_queue *q, struct request *rq) { } static inline __attribute__((always_inline)) int register_trace_block_rq_issue(void (*probe)(void *__data, struct request_queue *q, struct request *rq), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_rq_issue(void (*probe)(void *__data, struct request_queue *q, struct request *rq), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_rq_issue(void (*cb)(void *__data, struct request_queue *q, struct request *rq)) { };
# 171 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_bio_bounce(struct request_queue *q, struct bio *bio) { } static inline __attribute__((always_inline)) int register_trace_block_bio_bounce(void (*probe)(void *__data, struct request_queue *q, struct bio *bio), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_bio_bounce(void (*probe)(void *__data, struct request_queue *q, struct bio *bio), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_bio_bounce(void (*cb)(void *__data, struct request_queue *q, struct bio *bio)) { };
# 208 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_bio_complete(struct request_queue *q, struct bio *bio) { } static inline __attribute__((always_inline)) int register_trace_block_bio_complete(void (*probe)(void *__data, struct request_queue *q, struct bio *bio), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_bio_complete(void (*probe)(void *__data, struct request_queue *q, struct bio *bio), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_bio_complete(void (*cb)(void *__data, struct request_queue *q, struct bio *bio)) { };
# 235 "../../include/trace/events/block.h"
;
# 271 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_bio_backmerge(struct request_queue *q, struct bio *bio) { } static inline __attribute__((always_inline)) int register_trace_block_bio_backmerge(void (*probe)(void *__data, struct request_queue *q, struct bio *bio), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_bio_backmerge(void (*probe)(void *__data, struct request_queue *q, struct bio *bio), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_bio_backmerge(void (*cb)(void *__data, struct request_queue *q, struct bio *bio)) { };
# 286 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_bio_frontmerge(struct request_queue *q, struct bio *bio) { } static inline __attribute__((always_inline)) int register_trace_block_bio_frontmerge(void (*probe)(void *__data, struct request_queue *q, struct bio *bio), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_bio_frontmerge(void (*probe)(void *__data, struct request_queue *q, struct bio *bio), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_bio_frontmerge(void (*cb)(void *__data, struct request_queue *q, struct bio *bio)) { };
# 300 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_bio_queue(struct request_queue *q, struct bio *bio) { } static inline __attribute__((always_inline)) int register_trace_block_bio_queue(void (*probe)(void *__data, struct request_queue *q, struct bio *bio), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_bio_queue(void (*probe)(void *__data, struct request_queue *q, struct bio *bio), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_bio_queue(void (*cb)(void *__data, struct request_queue *q, struct bio *bio)) { };
...
;
# 345 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_getrq(struct request_queue *q, struct bio *bio, int rw) { } static inline __attribute__((always_inline)) int register_trace_block_getrq(void (*probe)(void *__data, struct request_queue *q, struct bio *bio, int rw), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_getrq(void (*probe)(void *__data, struct request_queue *q, struct bio *bio, int rw), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_getrq(void (*cb)(void *__data, struct request_queue *q, struct bio *bio, int rw)) { };
# 363 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_sleeprq(struct request_queue *q, struct bio *bio, int rw) { } static inline __attribute__((always_inline)) int register_trace_block_sleeprq(void (*probe)(void *__data, struct request_queue *q, struct bio *bio, int rw), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_sleeprq(void (*probe)(void *__data, struct request_queue *q, struct bio *bio, int rw), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_sleeprq(void (*cb)(void *__data, struct request_queue *q, struct bio *bio, int rw)) { };
# 378 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_plug(struct request_queue *q) { } static inline __attribute__((always_inline)) int register_trace_block_plug(void (*probe)(void *__data, struct request_queue *q), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_plug(void (*probe)(void *__data, struct request_queue *q), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_plug(void (*cb)(void *__data, struct request_queue *q)) { };
# 395 "../../include/trace/events/block.h"
;
# 421 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_unplug_timer(struct request_queue *q) { } static inline __attribute__((always_inline)) int register_trace_block_unplug_timer(void (*probe)(void *__data, struct request_queue *q), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_unplug_timer(void (*probe)(void *__data, struct request_queue *q), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_unplug_timer(void (*cb)(void *__data, struct request_queue *q)) { };
# 435 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_unplug_io(struct request_queue *q) { } static inline __attribute__((always_inline)) int register_trace_block_unplug_io(void (*probe)(void *__data, struct request_queue *q), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_unplug_io(void (*probe)(void *__data, struct request_queue *q), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_unplug_io(void (*cb)(void *__data, struct request_queue *q)) { };
# 453 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_split(struct request_queue *q, struct bio *bio, unsigned int new_sector) { } static inline __attribute__((always_inline)) int register_trace_block_split(void (*probe)(void *__data, struct request_queue *q, struct bio *bio, unsigned int new_sector), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_split(void (*probe)(void *__data, struct request_queue *q, struct bio *bio, unsigned int new_sector), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_split(void (*cb)(void *__data, struct request_queue *q, struct bio *bio, unsigned int new_sector)) { };
# 493 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_remap(struct request_queue *q, struct bio *bio, dev_t dev, sector_t from) { } static inline __attribute__((always_inline)) int register_trace_block_remap(void (*probe)(void *__data, struct request_queue *q, struct bio *bio, dev_t dev, sector_t from), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_remap(void (*probe)(void *__data, struct request_queue *q, struct bio *bio, dev_t dev, sector_t from), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_remap(void (*cb)(void *__data, struct request_queue *q, struct bio *bio, dev_t dev, sector_t from)) { };
# 537 "../../include/trace/events/block.h"
static inline __attribute__((always_inline)) void trace_block_rq_remap(struct request_queue *q, struct request *rq, dev_t dev, sector_t from) { } static inline __attribute__((always_inline)) int register_trace_block_rq_remap(void (*probe)(void *__data, struct request_queue *q, struct request *rq, dev_t dev, sector_t from), void *data) { return -38; } static inline __attribute__((always_inline)) int unregister_trace_block_rq_remap(void (*probe)(void *__data, struct request_queue *q, struct request *rq, dev_t dev, sector_t from), void *data) { return -38; } static inline __attribute__((always_inline)) void check_trace_callback_type_block_rq_remap(void (*cb)(void *__data, struct request_queue *q, struct request *rq, dev_t dev, sector_t from)) { };
# 573 "../../include/trace/events/block.h"
# 1 "../../include/trace/define_trace.h" 1
# 574 "../../include/trace/events/block.h" 2
# 20 "../../mm/bounce.c" 2
...
static __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) int init_emergency_pool(void)
{
 struct sysinfo i;
 si_meminfo(&i);
 do { (&i)->freeswap = (&i)->totalswap = 0; } while (0);

 if (!i.totalhigh)
  return 0;

 page_pool = mempool_create_page_pool(64, 0);
 do { if (__builtin_expect(!!(!page_pool), 0)) do { *(int *)0 = 0; } while (1); } while(0);
 printk("highmem bounce pool size: %d pages\n", 64);

 return 0;
}

static initcall_t __initcall_init_emergency_pool6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = init_emergency_pool;
...
{
 return mempool_alloc_pages(gfp_mask | (( gfp_t)0x01u), data);
}
...
int init_emergency_isa_pool(void)
{
 ...
 isa_page_pool = mempool_create(16, mempool_alloc_pages_isa,
           mempool_free_pages, (void *) 0);
 do { if (__builtin_expect(!!(!isa_page_pool), 0)) do { *(int *)0 = 0; } while (1); } while(0);
...
static void copy_to_high_bio_irq(struct bio *to, struct bio *from)
{
 ...
 for (tovec = (&(((to))->bi_io_vec[((0))])), i = (0); i < (to)->bi_vcnt; tovec++, i++) {
...
static void bounce_end_io(struct bio *bio, mempool_t *pool, int err)
{
 ...
 if (test_bit(7, &bio->bi_flags))
  _set_bit_le(7,&bio_orig->bi_flags);




 for (bvec = (&(((bio))->bi_io_vec[((0))])), i = (0); i < (bio)->bi_vcnt; bvec++, i++) {
          ...
          mempool_t *pool)
{
 ...
 int i, rw = ((*bio_orig)->bi_rw & 1);
 struct bio_vec *to, *from;

 for (from = (&(((*bio_orig))->bi_io_vec[(((*bio_orig)->bi_idx))])), i = ((*bio_orig)->bi_idx); i < (*bio_orig)->bi_vcnt; from++, i++) {
  page = from->bv_page;




  if (({ struct page *__pg = (page); int __sec = page_to_section(__pg); (unsigned long)(__pg - __section_mem_map_addr(__nr_to_section(__sec))); }) <= queue_bounce_pfn(q))
   continue;
  ...
  if (!bio) {
   ...
   bio = bio_alloc(((( gfp_t)0x10u)), cnt);
   ({ void *__p = (bio->bi_io_vec); size_t __n = cnt * sizeof(struct bio_vec); if ((__n) != 0) { if (__builtin_constant_p((0)) && (0) == 0) __memzero((__p),(__n)); else memset((__p),(0),(__n)); } (__p); });
  }
 ...
 for (from = (&(((*bio_orig))->bi_io_vec[((0))])), i = (0); i < (*bio_orig)->bi_vcnt; from++, i++) {
  to = (&((bio)->bi_io_vec[(i)]));
  if (!to->bv_page) {
...
extern typeof(blk_queue_bounce) blk_queue_bounce; static const char __kstrtab_blk_queue_bounce[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "blk_queue_bounce"; static const struct kernel_symbol __ksymtab_blk_queue_bounce __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&blk_queue_bounce, __kstrtab_blk_queue_bounce };
