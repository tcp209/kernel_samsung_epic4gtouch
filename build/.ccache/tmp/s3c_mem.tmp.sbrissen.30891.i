...
# 37 "../../drivers/char/s3c_mem.c" 2
# 1 "include/linux/version.h" 1
# 38 "../../drivers/char/s3c_mem.c" 2
...
# 39 "../../drivers/char/s3c_mem.c" 2
# 1 "../../arch/arm/mach-s5pv310/include/mach/hardware.h" 1
# 40 "../../drivers/char/s3c_mem.c" 2

# 1 "../../drivers/char/s3c_mem.h" 1
# 41 "../../drivers/char/s3c_mem.h"
static struct mutex mem_alloc_lock = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } } , .wait_list = { &(mem_alloc_lock.wait_list), &(mem_alloc_lock.wait_list) } };
static struct mutex mem_free_lock = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } } , .wait_list = { &(mem_free_lock.wait_list), &(mem_free_lock.wait_list) } };

static struct mutex mem_share_alloc_lock = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } } , .wait_list = { &(mem_share_alloc_lock.wait_list), &(mem_share_alloc_lock.wait_list) } };
static struct mutex mem_share_free_lock = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } } , .wait_list = { &(mem_share_free_lock.wait_list), &(mem_share_free_lock.wait_list) } };

static struct mutex mem_cacheable_alloc_lock = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } } , .wait_list = { &(mem_cacheable_alloc_lock.wait_list), &(mem_cacheable_alloc_lock.wait_list) } };
static struct mutex mem_cacheable_share_alloc_lock = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, } } } , .wait_list = { &(mem_cacheable_share_alloc_lock.wait_list), &(mem_cacheable_share_alloc_lock.wait_list) } };
  ...
  unsigned int cmd, unsigned long arg)
{
 ...
 switch (cmd) {
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((310)) << 0) | (((((sizeof(struct s3c_mem_alloc) == sizeof(struct s3c_mem_alloc[1]) && sizeof(struct s3c_mem_alloc) < (1 << 14)) ? sizeof(struct s3c_mem_alloc) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
  ...
  if (param.vir_addr == -22) {
   printk("<6>" "S3C_MEM_ALLOC FAILED\n");
   flag = 0;
   mutex_unlock(&mem_alloc_lock);
   return -14;
  }
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((316)) << 0) | (((((sizeof(struct s3c_mem_alloc) == sizeof(struct s3c_mem_alloc[1]) && sizeof(struct s3c_mem_alloc) < (1 << 14)) ? sizeof(struct s3c_mem_alloc) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((314)) << 0) | (((((sizeof(struct s3c_mem_alloc) == sizeof(struct s3c_mem_alloc[1]) && sizeof(struct s3c_mem_alloc) < (1 << 14)) ? sizeof(struct s3c_mem_alloc) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
  ...
  if (param.vir_addr == -22) {
   printk("<6>" "S3C_MEM_SHARE_ALLOC FAILED\n");
   flag = 0;
   mutex_unlock(&mem_share_alloc_lock);
   return -14;
  }
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((317)) << 0) | (((((sizeof(struct s3c_mem_alloc) == sizeof(struct s3c_mem_alloc[1]) && sizeof(struct s3c_mem_alloc) < (1 << 14)) ? sizeof(struct s3c_mem_alloc) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((311)) << 0) | (((((sizeof(struct s3c_mem_alloc) == sizeof(struct s3c_mem_alloc[1]) && sizeof(struct s3c_mem_alloc) < (1 << 14)) ? sizeof(struct s3c_mem_alloc) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((315)) << 0) | (((((sizeof(struct s3c_mem_alloc) == sizeof(struct s3c_mem_alloc[1]) && sizeof(struct s3c_mem_alloc) < (1 << 14)) ? sizeof(struct s3c_mem_alloc) : __invalid_size_argument_for_IOC))) << ((0 +8)+8))):
  ...
  if (do_munmap(mm, param.vir_addr, param.size) < 0) {
   printk("<6>" "do_munmap() failed - MEM_SHARE_FREE!!\n");
   mutex_unlock(&mem_share_free_lock);
   return -22;
  }
...
extern typeof(s3c_mem_ioctl) s3c_mem_ioctl; static const char __kstrtab_s3c_mem_ioctl[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "s3c_mem_ioctl"; static const struct kernel_symbol __ksymtab_s3c_mem_ioctl __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&s3c_mem_ioctl, __kstrtab_s3c_mem_ioctl };
...
int s3c_mem_mmap(struct file *filp, struct vm_area_struct *vma)
{
 ...
 case 3:
  ...
  virt_addr = kmalloc(size, (( gfp_t)0x01u)|((( gfp_t)0x20u)));

  if (!virt_addr) {
   printk("<6>" "kmalloc() failed !\n");
   return -22;
  }
  do {} while (0);
  ...
  cpu_cache.dma_map_area(virt_addr, size / sizeof(unsigned long), 2);
 ...
 case 4:
  ...
  pageFrameNo = ((physical_address) >> 12);
  do {} while (0);
 ...
 if (remap_pfn_range(vma, vma->vm_start, pageFrameNo,
  ...
  printk("<6>" "s3c_mem_mmap() : remap_pfn_range() failed !\n");
  return -22;
 }

 return 0;
}
extern typeof(s3c_mem_mmap) s3c_mem_mmap; static const char __kstrtab_s3c_mem_mmap[] __attribute__((section("__ksymtab_strings"), aligned(1))) = "" "s3c_mem_mmap"; static const struct kernel_symbol __ksymtab_s3c_mem_mmap __attribute__((__used__)) __attribute__((section("__ksymtab" ""), unused)) = { (unsigned long)&s3c_mem_mmap, __kstrtab_s3c_mem_mmap };
